...
static const IntrinsicData IntrinsicsWithoutChain[] = {
    ...
    X86_INTRINSIC_DATA(avx10_mask_vcvtpd2uqq256, INTR_TYPE_1OP_MASK,
                       X86ISD::CVTP2UI, X86ISD::CVTP2UI_RND),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2bf8512128, TRUNCATE_TO_REG,
                       X86ISD::VCVTPH2BF8512, X86ISD::VMCVTNEPH2BF8),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2bf8512256, INTR_TYPE_1OP_MASK,
                       X86ISD::VCVTPH2BF8512, 0),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2bf8512512, INTR_TYPE_1OP_MASK,
                       X86ISD::VCVTPH2BF8512, 0),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2bf8512s128, TRUNCATE_TO_REG,
                       X86ISD::VCVTPH2BF8512S, X86ISD::VMCVTNEPH2BF8S),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2bf8512s256, INTR_TYPE_1OP_MASK,
                       X86ISD::VCVTPH2BF8512S, 0),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2bf8512s512, INTR_TYPE_1OP_MASK,
                       X86ISD::VCVTPH2BF8512S, 0),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2dq256, INTR_TYPE_1OP_MASK,
                       X86ISD::CVTP2SI, X86ISD::CVTP2SI_RND),
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2hf8128, TRUNCATE_TO_REG,
                       X86ISD::VCVTPH2HF8, X86ISD::VMCVTNEPH2HF8),
    ...
    X86_INTRINSIC_DATA(avx10_mask_vcvtph2hf8s128, TRUNCATE_TO_REG,
                       X86ISD::VCVTPH2HF8S, X86ISD::VMCVTNEPH2HF8S),
    ...
    X86_INTRINSIC_DATA(avx512_vpshufbitqmb_512, INTR_TYPE_2OP,
                       X86ISD::VPSHUFBITQMB, 0), // bfloat16
    ...
    X86_INTRINSIC_DATA(avx512fp16_vcomi_sh, COMI_RM, X86ISD::COMI,
                       X86ISD::UCOMI), /*fp16 scalar convert instruction*/
