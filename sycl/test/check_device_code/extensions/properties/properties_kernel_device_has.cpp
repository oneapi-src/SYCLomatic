...
static constexpr auto device_has_all = device_has<
    ...
    aspect::usm_system_allocations, aspect::pci_address, aspect::cpu,
    aspect::gpu, aspect::accelerator, aspect::gpu_eu_count,
    ...
    aspect::atomic64, aspect::uuid,
    aspect::ext_oneapi_srgb, aspect::gpu_eu_simd_width,
    aspect::gpu_slices, aspect::ext_oneapi_native_assert,
    aspect::host_debuggable, aspect::gpu_hw_threads_per_eu,
...
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"pci_address", i32 [[pci_address_ASPECT_MD:[0-9]+]]}
...
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"gpu_eu_count", i32 [[gpu_eu_count_ASPECT_MD:[0-9]+]]}
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"gpu_subslices_per_slice", i32 [[gpu_subslices_per_slice_ASPECT_MD:[0-9]+]]}
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"gpu_eu_count_per_subslice", i32 [[gpu_eu_count_per_subslice_ASPECT_MD:[0-9]+]]}
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"max_mem_bandwidth", i32 [[max_mem_bandwidth_ASPECT_MD:[0-9]+]]}
...
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"uuid", i32 [[uuid_ASPECT_MD:[0-9]+]]}
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"ext_oneapi_srgb", i32 [[ext_oneapi_srgb_ASPECT_MD:[0-9]+]]}
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"gpu_eu_simd_width", i32 [[gpu_eu_simd_width_ASPECT_MD:[0-9]+]]}
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"gpu_slices", i32 [[gpu_slices_ASPECT_MD:[0-9]+]]}
...
// CHECK-IR-DAG: !{{[0-9]+}} = !{!"gpu_hw_threads_per_eu", i32 [[gpu_hw_threads_per_eu_ASPECT_MD:[0-9]+]]}
