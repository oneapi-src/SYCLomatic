...
def main():
    ...
    parser.add_argument(
        ...
        metavar="<file path>",
        required=True,
        help="Specify the execution log file generated by instrumented CUDA code.",
    )
    parser.add_argument(
        "--instrumented-sycl-log",
        metavar="<file path>",
        required=True,
        help="Specify the execution log file generated by instrumented SYCL code.",
    )
    ...
    parser.add_argument(
        ...
        metavar="<file path>",
        required=False,
        help="Specify the tolerance epsilon JSON file for floating point comparison. The key is float type, value is epsilon. For example: \n"
        "{\n"
        '    "bf16": 7.81e-03,,\n'
        '    "fp16": 9.77e-04,\n'
        '    "float": 1.19e-7,\n'
