...
def main():
    ...
    parser.add_argument(
        ...
        metavar="<file path>",
        required=False,
        help="Specify the tolerance epsilon JSON file for floating point data comparison. The JSON file contains the key-value pairs, the key is a specific float type, value is the corresponding epsilon. For example: \n"
        "{\n"
        '    "bf16": 7.81e-03,\n'
        '    "fp16": 9.77e-04,\n'
        '    "float": 1.19e-7,\n'
