...
def compare_checkpoint_list(cuda_prolog_checkpoint_list, cuda_epilog_checkpoint_list, sycl_prolog_checkpoint_list, sycl_epilog_checkpoint_list):
    ...
    for id, cuda_prolog_checkpoint in cuda_prolog_checkpoint_list.items():
        ...
        try:
            ...
            # if the epilog is dismatching, then check the prolog data.
...
def main():
    ...
    cuda_prolog_checkpoint_list, cuda_epilog_checkpoint_list = get_checkpoint_list_from_json_file(args.instrumented_cuda_log)
    sycl_prolog_checkpoint_list, sycl_epilog_checkpoint_list = get_checkpoint_list_from_json_file(args.instrumented_sycl_log)
    
    failed_log = compare_checkpoint_list(cuda_prolog_checkpoint_list, cuda_epilog_checkpoint_list, sycl_prolog_checkpoint_list, sycl_epilog_checkpoint_list)
