    ...
    MapNames::BLASFuncReplInfoMap{
        ...
        {"cublasIsamax_v2",
         {std::vector<int>{2, 4}, std::vector<int>{},
          std::vector<std::string>{"float", "int64_t"}, "mkl::isamax"}},
        {"cublasIdamax_v2",
         {std::vector<int>{2, 4}, std::vector<int>{},
          std::vector<std::string>{"double", "int64_t"}, "mkl::idamax"}},
        {"cublasIsamin_v2",
         {std::vector<int>{2, 4}, std::vector<int>{},
          std::vector<std::string>{"float", "int64_t"}, "mkl::isamin"}},
        {"cublasIdamin_v2",
         {std::vector<int>{2, 4}, std::vector<int>{},
          std::vector<std::string>{"double", "int64_t"}, "mkl::idamin"}},
        {"cublasSasum_v2",
         {std::vector<int>{2, 4}, std::vector<int>{},
    ...
    MapNames::LegacyBLASFuncReplInfoMap{
        ...
        {"cublasIsamax",
         {std::vector<int>{1}, std::vector<int>{},
          std::vector<std::string>{"float", "int64_t"}, std::vector<int>{}, -1,
          -1, -1, "mkl::isamax"}},
        {"cublasIdamax",
         {std::vector<int>{1}, std::vector<int>{},
          std::vector<std::string>{"double", "int64_t"}, std::vector<int>{}, -1,
          -1, -1, "mkl::idamax"}},
        {"cublasIsamin",
         {std::vector<int>{1}, std::vector<int>{},
          std::vector<std::string>{"float", "int64_t"}, std::vector<int>{}, -1,
        ...
        {"cublasSspr",
         {std::vector<int>{3, 5}, std::vector<int>{},
          std::vector<std::string>{"float", "float"}, std::vector<int>{}, 0, -1,
          -1, "mkl::sspr"}},
        {"cublasDspr",
         {std::vector<int>{3, 5}, std::vector<int>{},
          std::vector<std::string>{"double", "double"}, std::vector<int>{}, 0,
          -1, -1, "mkl::dspr"}},
        {"cublasSspr2",
         {std::vector<int>{3, 5, 7}, std::vector<int>{},
          std::vector<std::string>{"float", "float", "float"},
        ...
        {"cublasStbmv",
         {std::vector<int>{5, 7}, std::vector<int>{},
          std::vector<std::string>{"float", "float"}, std::vector<int>{1}, 0,
          -1, 2, "mkl::stbmv"}},
        {"cublasDtbmv",
         {std::vector<int>{5, 7}, std::vector<int>{},
          std::vector<std::string>{"double", "double"}, std::vector<int>{1}, 0,
          -1, 2, "mkl::dtbmv"}},
        {"cublasStbsv",
         {std::vector<int>{5, 7}, std::vector<int>{},
          std::vector<std::string>{"float", "float"}, std::vector<int>{1}, 0,
        ...
        {"cublasStrsm",
         {std::vector<int>{7, 9}, std::vector<int>{},
          std::vector<std::string>{"float", "float"}, std::vector<int>{2}, 1, 0,
          3, "mkl::strsm"}},
        {"cublasDtrsm",
         {std::vector<int>{7, 9}, std::vector<int>{},
