...
const MapNames::MapTy MathFunctionsRule::SingleDoubleFunctionNamesMap{
    ...
    //{"cyl_bessel_i0f", "cl::sycl::"},
    //{"cyl_bessel_i1f", "cl::sycl::"},
    {"erfcf", "cl::sycl::erfc"},
    //{"erfcinvf", ""},
    //{"erfcxf", "cl::sycl::"},
    {"erff", "cl::sycl::erf"},
...
const MapNames::MapTy MathFunctionsRule::TypecastFunctionNamesMap{
    ...
    {"__half2ushort_ru", ""},
    {"__half2ushort_rz", ""},
    {"__half_as_short", "short"},
    {"__half_as_ushort", "unsigned short"},
    {"__halves2half2", ""},
    {"__high2float", ""},
    {"__high2half", ""},
    {"__high2half2", ""},
    ...
    {"__lowhigh2highlow", ""},
    {"__lows2half2", ""},
    //{"__shfl_down_sync", "cl::sycl::"},
    //{"__shfl_sync", "cl::sycl::"},
    //{"__shfl_up_sync", "cl::sycl::"},
    //{"__shfl_xor_sync", "cl::sycl::"},
    {"__short2half_rd", ""},
    {"__short2half_rn", ""},
    {"__short2half_ru", ""},
    {"__short2half_rz", ""},
    {"__short_as_half", "half"},
    {"__uint2half_rd", ""},
    {"__uint2half_rn", ""},
    {"__uint2half_ru", ""},
    {"__uint2half_rz", ""},
    ...
    {"__double2ull_ru", ""},
    {"__double2ull_rz", ""},
    {"__double_as_longlong", "long long"},
    {"__float2int_rd", ""},
    {"__float2int_rn", ""},
    {"__float2int_ru", ""},
    {"__float2int_rz", ""},
    ...
    {"__float2ull_rz", ""},
    {"__float_as_int", "int"},
    {"__float_as_uint", "unsigned"},
    //{"__hiloint2double", "syclct::"}, // TODO
    {"__int2double_rn", ""},
    {"__int2float_rd", ""},
    {"__int2float_rn", ""},
    {"__int2float_ru", ""},
    {"__int2float_rz", ""},
    {"__int_as_float", "float"},
    {"__ll2double_rd", ""},
    {"__ll2double_rn", ""},
    {"__ll2double_ru", ""},
    {"__ll2double_rz", ""},
    ...
    {"__ll2float_ru", ""},
    {"__ll2float_rz", ""},
    {"__longlong_as_double", "double"},
    {"__uint2double_rn", ""},
    {"__uint2float_rd", ""},
    {"__uint2float_rn", ""},
    {"__uint2float_ru", ""},
    {"__uint2float_rz", ""},
    {"__uint_as_float", "float"},
    {"__ull2double_rd", ""},
    {"__ull2double_rn", ""},
    {"__ull2double_ru", ""},
    {"__ull2double_rz", ""},
...
const MapNames::MapTy MathFunctionsRule::FunctionNamesMap{
    ...
    //{"__ffs", "cl::sycl::"},
    //{"__ffsll", "cl::sycl::"},
    //{"__funnelshift_l", "cl::sycl::"},
    //{"__funnelshift_lc", "cl::sycl::"},
    //{"__funnelshift_r", "cl::sycl::"},
    //{"__funnelshift_rc", "cl::sycl::"},
    {"__hadd", "cl::sycl::hadd"},
