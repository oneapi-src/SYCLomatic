...
void updateHelperNameContentMap(
  ...
  for (const auto &FileFeatureMap : TUR.FeatureMap) {
    ...
    if (Iter != HelperFileIDMap.end()) {
      ...
      processFeatureMap(FileFeatureMap.second, HelperFileEnum::C2S,
                        APINameCallerSrcFilesMap);
    }
  }
}
...
#define C2S_CONTENT_END                                                       \
  ...
  ,
#include "clang/C2S/atomic.inc"
#include "clang/C2S/blas_utils.inc"
#include "clang/C2S/device.inc"
#include "clang/C2S/c2s.inc"
#include "clang/C2S/dpl_extras/algorithm.inc"
#include "clang/C2S/dpl_extras/functional.inc"
#include "clang/C2S/dpl_extras/iterators.inc"
#include "clang/C2S/dpl_extras/memory.inc"
#include "clang/C2S/dpl_extras/numeric.inc"
#include "clang/C2S/dpl_extras/vector.inc"
#include "clang/C2S/dpl_extras/dpcpp_extensions.inc"
#include "clang/C2S/dpl_utils.inc"
#include "clang/C2S/image.inc"
#include "clang/C2S/kernel.inc"
#include "clang/C2S/memory.inc"
#include "clang/C2S/util.inc"
#include "clang/C2S/rng_utils.inc"
#include "clang/C2S/lib_common_utils.inc"
#undef C2S_CONTENT_BEGIN
#undef C2S_DEPENDENCY
...
const std::string C2SAllContentStr =
#include "clang/C2S/c2s.all.inc"
    ;
const std::string AtomicAllContentStr =
#include "clang/C2S/atomic.all.inc"
    ;
const std::string BlasUtilsAllContentStr =
#include "clang/C2S/blas_utils.all.inc"
    ;
const std::string DeviceAllContentStr =
#include "clang/C2S/device.all.inc"
    ;
const std::string DplUtilsAllContentStr =
#include "clang/C2S/dpl_utils.all.inc"
    ;
const std::string ImageAllContentStr =
#include "clang/C2S/image.all.inc"
    ;
const std::string KernelAllContentStr =
#include "clang/C2S/kernel.all.inc"
    ;
const std::string MemoryAllContentStr =
#include "clang/C2S/memory.all.inc"
    ;
const std::string UtilAllContentStr =
#include "clang/C2S/util.all.inc"
    ;
const std::string RngUtilsAllContentStr =
#include "clang/C2S/rng_utils.all.inc"
    ;
const std::string LibCommonUtilsAllContentStr =
#include "clang/C2S/lib_common_utils.all.inc"
    ;
const std::string DplExtrasAlgorithmAllContentStr =
#include "clang/C2S/dpl_extras/algorithm.all.inc"
    ;
const std::string DplExtrasFunctionalAllContentStr =
#include "clang/C2S/dpl_extras/functional.all.inc"
    ;
const std::string DplExtrasIteratorsAllContentStr =
#include "clang/C2S/dpl_extras/iterators.all.inc"
    ;
const std::string DplExtrasMemoryAllContentStr =
#include "clang/C2S/dpl_extras/memory.all.inc"
    ;
const std::string DplExtrasNumericAllContentStr =
#include "clang/C2S/dpl_extras/numeric.all.inc"
    ;
const std::string DplExtrasVectorAllContentStr =
#include "clang/C2S/dpl_extras/vector.all.inc"
    ;
