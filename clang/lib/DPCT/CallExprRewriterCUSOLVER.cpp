...
void CallExprRewriterFactoryBase::initRewriterMapCUSOLVER() {
  ...
  {ASSIGNABLE_FACTORY(
  ASSIGN_FACTORY_ENTRY("cusolverDnSetStream", ARG(0), ARG(1)))
   ASSIGNABLE_FACTORY(
   ASSIGN_FACTORY_ENTRY("cusolverDnGetStream", DEREF(1), ARG(0)))
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::LapackUtils_potrf_batch,
   CALL_FACTORY_ENTRY("cusolverDnSpotrfBatched",
                      CALL(MapNames::getDpctNamespace() + "lapack::potrf_batch",
                           DEREF(0), ARG(1), ARG(2), ARG(3), ARG(4), ARG(5),
                           ARG(6))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::LapackUtils_potrf_batch,
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::LapackUtils_potrs_batch,
   CALL_FACTORY_ENTRY("cusolverDnSpotrsBatched",
                      CALL(MapNames::getDpctNamespace() + "lapack::potrs_batch",
                           DEREF(0), ARG(1), ARG(2), ARG(3), ARG(4), ARG(5),
