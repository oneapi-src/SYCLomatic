...
#define ENTRY_TEMPLATED(SOURCEAPINAME, ...)                                    \
  ...
  ENTRY_RENAMED("cudaCreateChannelDesc",
                MapNames::getDpctNamespace() + "image_channel")),
  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_channel_create,
  ENTRY_TEMPLATED(
  "cudaCreateChannelDesc",
  TEMPLATED_CALLEE(MapNames::getDpctNamespace() + "image_channel::create",
  ...
  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper,
  ...
  ASSIGNABLE_FACTORY(
  ENTRY_BIND("cudaBindTexture", 1 /*start arg idx*/, 2 /*size in bytes*/)))
  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_attach,
  ...
  CALL(MapNames::getDpctNamespace() + "create_image_wrapper", DEREF(1),
       DEREF(2)))))
  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_create_image_wrapper,
  ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
  ...
  NEW(MapNames::getDpctNamespace() + "image_matrix",
      STRUCT_DISMANTLE(1, "channel_type_ct1", "channel_num_ct1", "x_ct1",
                       "y_ct1"))))),
  ...
  ENTRY_UNSUPPORTED("cuTexObjectGetResourceViewDesc",
                    Diagnostics::API_NOT_MIGRATED)
  FEATURE_REQUEST_FACTORY(
  ...
  ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY("cuTexRefSetAddressMode", ARG(0),
                                               true, "set", ARG(2))))
  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_set_filtering_mode,
  ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY("cuTexRefSetFilterMode", ARG(0),
                                               true, "set", ARG(1))))

  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_get_addressing_mode,
  ASSIGNABLE_FACTORY(
  ASSIGN_FACTORY_ENTRY("cuTexRefGetAddressMode", DEREF(0),
                       MEMBER_CALL(ARG(1), true, "get_addressing_mode"))))

  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_get_filtering_mode,
  ASSIGNABLE_FACTORY(
  ASSIGN_FACTORY_ENTRY("cuTexRefGetFilterMode", DEREF(0),
                       MEMBER_CALL(ARG(1), true, "get_filtering_mode"))))
  ...
  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_attach,
  ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY("cuTexRefSetAddress_v2", ARG(1),
                                               true, "attach", ARG(2), ARG(3))))

  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_attach,
  ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
  "cuTexRefSetAddress2D_v3", ARG(0), true, "attach", ARG(2),
  STRUCT_DISMANTLE(1, "x_ct1", "y_ct1"), ARG(3))))
  ...
  "cuTexRefSetFormat", MEMBER_CALL(ARG(0), true, "set_channel_type", ARG(1)),
