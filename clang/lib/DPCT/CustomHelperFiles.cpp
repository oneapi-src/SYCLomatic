...
#define GENERATE_DPL_EXTRAS_ALL_FILE_CONTENT(FILE_NAME)                        \
  ...
  GENERATE_ALL_FILE_CONTENT(AtomicHelper)
...
void generateHelperFunctions() {
  ...
  std::vector<clang::dpct::HelperFunc> AtomicHelperFileContent;
...
#define ADD_INCLUDE_DIRECTIVE(FILENAME)                                        \
  ...
  ADD_INCLUDE_DIRECTIVE(AtomicHelper)
...
#include "clang/DPCT/atomic_helper.inc"
...
std::unordered_map<clang::dpct::HelperFileEnum, std::string> HelperFileNameMap{
    ...
    {clang::dpct::HelperFileEnum::AtomicHelper, "atomic_helper.hpp"},
...
std::unordered_map<std::string, clang::dpct::HelperFileEnum> HelperFileIDMap{
    ...
    {"atomic_helper.hpp", clang::dpct::HelperFileEnum::AtomicHelper},
...
const std::unordered_map<clang::dpct::HelperFileEnum, std::string>
    HelperFileHeaderGuardMacroMap{
        ...
        {clang::dpct::HelperFileEnum::AtomicHelper, "__DPCT_ATOMIC_HELPER_HPP__"},
...
#include "clang/DPCT/ccl_utils.all.inc"
    ;
const std::string AtomicHelperAllContentStr =
#include "clang/DPCT/atomic_helper.all.inc"
    ;
