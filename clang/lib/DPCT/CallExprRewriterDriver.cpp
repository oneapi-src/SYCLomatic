...
void CallExprRewriterFactoryBase::initRewriterMapDriver() {
  ...
  CALL("(dpct::image_wrapper_base_p)GetProcAddress", ARG(1), ARG(2)))))
  ...
  ASSIGN_FACTORY_ENTRY(
  "cuModuleGetFunction", DEREF(0),
  CALL("(dpct::kernel_functor)dlsym", ARG(1), EXTENDSTR(2, "_wrapper")))

  FEATURE_REQUEST_FACTORY(
  HelperFeatureEnum::Image_image_wrapper_base_p_alias,
  ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
  "cuModuleGetTexRef", DEREF(0),
  CALL("(dpct::image_wrapper_base_p)dlsym", ARG(1), ARG(2)))))
...
#undef RANGES_CTOR
  ...
  ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
  "cuFuncGetAttribute", DEREF(0),
  makeMemberExprCreator(
  CALL(MapNames::getDpctNamespace() + "get_kernel_function_info",
  ...
  ASSIGNABLE_FACTORY(
  ASSIGN_FACTORY_ENTRY("cudaHostGetFlags", DEREF(0), ARG("0")))

  ASSIGNABLE_FACTORY(
  ASSIGN_FACTORY_ENTRY("cuMemHostGetFlags", DEREF(0), ARG("0")))
  ...
  Diagnostics::FUNC_CALL_REMOVED, std::string("cuMemHostRegister"),
  getRemovedAPIWarningMessage("cuMemHostRegister_v2")),
  WARNING_FACTORY_ENTRY(
  "cuMemHostRegister_v2",
  TOSTRING_FACTORY_ENTRY("cuMemHostRegister_v2", LITERAL("0")),
  Diagnostics::FUNC_CALL_REMOVED_0, std::string("cuMemHostRegister"),
  getRemovedAPIWarningMessage("cuMemHostRegister_v2")))
  ...
  Diagnostics::FUNC_CALL_REMOVED, std::string("cuMemHostUnregister"),
  getRemovedAPIWarningMessage("cuMemHostUnregister")),
  WARNING_FACTORY_ENTRY(
  "cuMemHostUnregister",
  TOSTRING_FACTORY_ENTRY("cuMemHostUnregister", LITERAL("0")),
  Diagnostics::FUNC_CALL_REMOVED_0, std::string("cuMemHostUnregister"),
  getRemovedAPIWarningMessage("cuMemHostUnregister")))
  ...
  ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
  "cuDriverGetVersion", DEREF(0),
  CALL("std::stoi",
       CALL(MapNames::getDpctNamespace() + "get_current_device().get_info<" +
  ...
  ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
  "cuCtxGetApiVersion", DEREF(1),
  CALL(MapNames::getDpctNamespace() + "get_sycl_language_version"))))
