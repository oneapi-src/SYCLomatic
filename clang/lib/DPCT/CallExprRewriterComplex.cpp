...
void CallExprRewriterFactoryBase::initRewriterMapComplex() {
  ...
  {CALL_FACTORY_ENTRY("make_cuComplex",
   ...
   CALL_FACTORY_ENTRY("make_cuDoubleComplex",
                      CALL(MapNames::getClNamespace() + "double2",
                           ...
                           makeCallArgCreatorWithCall(1)))
   CALL_FACTORY_ENTRY(
   "__saturatef", CALL(MapNames::getClNamespace() + "clamp<float>",
                       makeCallArgCreatorWithCall(0),
                       makeCallArgCreator("0.0f"), makeCallArgCreator("1.0f")))
   MEMBER_CALL_FACTORY_ENTRY("cuCreal", makeDerefArgCreatorWithCall(0), false,
                             "x")
   MEMBER_CALL_FACTORY_ENTRY("cuCimag", makeDerefArgCreatorWithCall(0), false,
                             "y")
   ...
   HelperFeatureEnum::Util_cabs,
   CALL_FACTORY_ENTRY("cuCabs",
                      CALL(MapNames::getDpctNamespace() + "cabs<double>",
                           makeCallArgCreatorWithCall(0))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_conj,
   CALL_FACTORY_ENTRY("cuConj",
                      CALL(MapNames::getDpctNamespace() + "conj<double>",
                           makeCallArgCreatorWithCall(0))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_cabs,
   CALL_FACTORY_ENTRY("cuCabsf",
                      CALL(MapNames::getDpctNamespace() + "cabs<float>",
                           makeCallArgCreatorWithCall(0))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_conj,
   CALL_FACTORY_ENTRY("cuConjf",
                      CALL(MapNames::getDpctNamespace() + "conj<float>",
                           makeCallArgCreatorWithCall(0))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_cmul,
   CALL_FACTORY_ENTRY("cuCmul",
                      CALL(MapNames::getDpctNamespace() + "cmul<double>",
                           makeCallArgCreatorWithCall(0),
                           makeCallArgCreatorWithCall(1))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_cdiv,
   CALL_FACTORY_ENTRY("cuCdiv",
                      CALL(MapNames::getDpctNamespace() + "cdiv<double>",
                           makeCallArgCreatorWithCall(0),
                           makeCallArgCreatorWithCall(1))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_cmul,
   CALL_FACTORY_ENTRY("cuCmulf",
                      CALL(MapNames::getDpctNamespace() + "cmul<float>",
                           makeCallArgCreatorWithCall(0),
                           makeCallArgCreatorWithCall(1))))
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::Util_cdiv,
   CALL_FACTORY_ENTRY("cuCdivf",
                      CALL(MapNames::getDpctNamespace() + "cdiv<float>",
                           makeCallArgCreatorWithCall(0),
                           makeCallArgCreatorWithCall(1))))
