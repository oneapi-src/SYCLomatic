...
void MapNames::setExplicitNamespaceMap() {
  ...
  TypeNamesMap = {
      ...
      {"int2", std::make_shared<TypeNameRule>(getClNamespace() + "mint2")},
      {"double2", std::make_shared<TypeNameRule>(getClNamespace() + "mdouble2")},
      {"__half", std::make_shared<TypeNameRule>(getClNamespace() + "half")},
      {"__half2", std::make_shared<TypeNameRule>(getClNamespace() + "mhalf2")},
      {"half", std::make_shared<TypeNameRule>(getClNamespace() + "half")},
      {"half2", std::make_shared<TypeNameRule>(getClNamespace() + "mhalf2")},
      {"cudaEvent_t",
      ...
      {"char2", std::make_shared<TypeNameRule>(getClNamespace() + "mchar2")},
      {"char3", std::make_shared<TypeNameRule>(getClNamespace() + "mchar3")},
      {"char4", std::make_shared<TypeNameRule>(getClNamespace() + "mchar4")},
      {"double1", std::make_shared<TypeNameRule>("double")},
      {"double2", std::make_shared<TypeNameRule>(getClNamespace() + "mdouble2")},
      {"double3", std::make_shared<TypeNameRule>(getClNamespace() + "mdouble3")},
      {"double4", std::make_shared<TypeNameRule>(getClNamespace() + "mdouble4")},
      {"float1", std::make_shared<TypeNameRule>("float")},
      {"float2", std::make_shared<TypeNameRule>(getClNamespace() + "mfloat2")},
      {"float3", std::make_shared<TypeNameRule>(getClNamespace() + "mfloat3")},
      {"float4", std::make_shared<TypeNameRule>(getClNamespace() + "mfloat4")},
      {"int1", std::make_shared<TypeNameRule>("int")},
      {"int2", std::make_shared<TypeNameRule>(getClNamespace() + "mint2")},
      {"int3", std::make_shared<TypeNameRule>(getClNamespace() + "mint3")},
      {"int4", std::make_shared<TypeNameRule>(getClNamespace() + "mint4")},
      {"long1", std::make_shared<TypeNameRule>("long")},
      {"long2", std::make_shared<TypeNameRule>(getClNamespace() + "mlong2")},
      {"long3", std::make_shared<TypeNameRule>(getClNamespace() + "mlong3")},
      {"long4", std::make_shared<TypeNameRule>(getClNamespace() + "mlong4")},
      {"longlong1", std::make_shared<TypeNameRule>("int64_t")},
      {"longlong2",
       std::make_shared<TypeNameRule>(getClNamespace() + "mlonglong2")},
      {"longlong3",
       std::make_shared<TypeNameRule>(getClNamespace() + "mlonglong3")},
      {"longlong4",
       std::make_shared<TypeNameRule>(getClNamespace() + "mlonglong4")},
      {"short1", std::make_shared<TypeNameRule>("short")},
      {"short2", std::make_shared<TypeNameRule>(getClNamespace() + "mshort2")},
      {"short3", std::make_shared<TypeNameRule>(getClNamespace() + "mshort3")},
      {"short4", std::make_shared<TypeNameRule>(getClNamespace() + "mshort4")},
      {"uchar1", std::make_shared<TypeNameRule>("uint8_t")},
      {"uchar2", std::make_shared<TypeNameRule>(getClNamespace() + "muchar2")},
      {"uchar3", std::make_shared<TypeNameRule>(getClNamespace() + "muchar3")},
      {"uchar4", std::make_shared<TypeNameRule>(getClNamespace() + "muchar4")},
      {"uint1", std::make_shared<TypeNameRule>("uint32_t")},
      {"uint2", std::make_shared<TypeNameRule>(getClNamespace() + "muint2")},
      {"uint3", std::make_shared<TypeNameRule>(getClNamespace() + "muint3")},
      {"uint4", std::make_shared<TypeNameRule>(getClNamespace() + "muint4")},
      {"ulong1", std::make_shared<TypeNameRule>("uint64_t")},
      {"ulong2", std::make_shared<TypeNameRule>(getClNamespace() + "mulong2")},
      {"ulong3", std::make_shared<TypeNameRule>(getClNamespace() + "mulong3")},
      {"ulong4", std::make_shared<TypeNameRule>(getClNamespace() + "mulong4")},
      {"ulonglong1", std::make_shared<TypeNameRule>("uint64_t")},
      {"ulonglong2",
       std::make_shared<TypeNameRule>(getClNamespace() + "mulonglong2")},
      {"ulonglong3",
       std::make_shared<TypeNameRule>(getClNamespace() + "mulonglong3")},
      {"ulonglong4",
       std::make_shared<TypeNameRule>(getClNamespace() + "mulonglong4")},
      {"ushort1", std::make_shared<TypeNameRule>("uint16_t")},
      {"ushort2", std::make_shared<TypeNameRule>(getClNamespace() + "mushort2")},
      {"ushort3", std::make_shared<TypeNameRule>(getClNamespace() + "mushort3")},
      {"ushort4", std::make_shared<TypeNameRule>(getClNamespace() + "mushort4")},
      {"cublasHandle_t",
       std::make_shared<TypeNameRule>(getDpctNamespace() + "queue_ptr",
       HelperFeatureEnum::Device_typedef_queue_ptr)},
      ...
      {"cublasComputeType_t",
       std::make_shared<TypeNameRule>(
           ...
           HelperFeatureEnum::LibCommonUtils_library_data_t)},
      {"cuComplex",
       std::make_shared<TypeNameRule>(getClNamespace() + "mfloat2")},
      {"cuFloatComplex",
       std::make_shared<TypeNameRule>(getClNamespace() + "mfloat2")},
      {"cuDoubleComplex",
       std::make_shared<TypeNameRule>(getClNamespace() + "mdouble2")},
  ...
  BLASTGemmExTypeInfoMap = {
      ...
      {"4:4",
       {"std::complex<float>", "std::complex<float>",
        getClNamespace() + "mfloat2", "std::complex<float>",
        getClNamespace() + "mfloat2", "std::complex<float>"}}};
