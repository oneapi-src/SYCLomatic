...
#undef ENTRY
  ...
  BLASAPIWithRewriter = {
      ...
      {"cublasIamaxEx", getLibraryHelperNamespace() + "blas::iamaxmin<true>"},
      {"cublasIaminEx", getLibraryHelperNamespace() + "blas::iamaxmin<false>"},
      ...
      {"cublasIamaxEx_64",
       getLibraryHelperNamespace() + "blas::iamaxmin<true>"},
      {"cublasIaminEx_64",
       getLibraryHelperNamespace() + "blas::iamaxmin<false>"},
