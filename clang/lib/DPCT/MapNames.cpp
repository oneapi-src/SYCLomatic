...
void MapNames::setExplicitNamespaceMap() {
  ...
  TypeNamesMap = {
      ...
      {"cudaError_t", std::make_shared<TypeNameRule>(getDpctNamespace() + "err_tmp0")},
      {"cudaError", std::make_shared<TypeNameRule>(getDpctNamespace() + "err_tmp0")},
  ...
  CuDNNTypeNamesMap = {
      ...
      {"cudnnStatus_t", std::make_shared<TypeNameRule>(getDpctNamespace() + "err_tmp1")},
