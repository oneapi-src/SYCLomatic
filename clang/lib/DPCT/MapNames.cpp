...
#undef ENTRY
  ...
  BLASAPIWithRewriter = {
      ...
      {"cublasSrotg_v2_64", "oneapi::mkl::blas::column_major::rotg"},
      {"cublasDrotg_v2_64", "oneapi::mkl::blas::column_major::rotg"},
      {"cublasCrotg_v2_64", "oneapi::mkl::blas::column_major::rotg"},
      {"cublasZrotg_v2_64", "oneapi::mkl::blas::column_major::rotg"},
      {"cublasSrotm_v2_64", "oneapi::mkl::blas::column_major::rotm"},
      {"cublasDrotm_v2_64", "oneapi::mkl::blas::column_major::rotm"},
      {"cublasSrotmg_v2_64", "oneapi::mkl::blas::column_major::rotmg"},
      {"cublasDrotmg_v2_64", "oneapi::mkl::blas::column_major::rotmg"},
  };
