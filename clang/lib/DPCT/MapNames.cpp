...
#undef ENTRY
  ...
  BLASAPIWithRewriter = {
      ...
      {"cublasCdotu_v2_64", "oneapi::mkl::blas::column_major::dot"},
      {"cublasCdotc_v2_64", "oneapi::mkl::blas::column_major::dot"},
      {"cublasZdotu_v2_64", "oneapi::mkl::blas::column_major::dot"},
      {"cublasZdotc_v2_64", "oneapi::mkl::blas::column_major::dot"},
      ...
      {"cublasCdotu_v2", "oneapi::mkl::blas::column_major::dot"},
      {"cublasCdotc_v2", "oneapi::mkl::blas::column_major::dot"},
      {"cublasZdotu_v2", "oneapi::mkl::blas::column_major::dot"},
      {"cublasZdotc_v2", "oneapi::mkl::blas::column_major::dot"},
