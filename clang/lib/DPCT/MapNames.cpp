...
void MapNames::setExplicitNamespaceMap() {
  ...
  TypeNamesMap = {
      ...
      {"longlong2",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<std::int64_t, 2>")},
      {"longlong3",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<std::int64_t, 3>")},
      {"longlong4",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<std::int64_t, 4>")},
      ...
      {"ulonglong2",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<std::uint64_t, 2>")},
      {"ulonglong3",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<std::uint64_t, 3>")},
      {"ulonglong4",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<std::uint64_t, 4>")},
