...
void MapNames::setExplicitNamespaceMap() {
  ...
  EnumConstantRule::EnumNamesMap = {
      ...
      {"CUFFT_Z2Z", std::make_shared<EnumNameRule>(
                        ...
                        HelperFeatureEnum::FftUtils_fft_type)},
      {"ncclSum", std::make_shared<EnumNameRule>("oneapi::ccl::sum")},
      {"ncclProd", std::make_shared<EnumNameRule>("oneapi::ccl::prod")},
      {"ncclMin", std::make_shared<EnumNameRule>("oneapi::ccl::min")},
      {"ncclMax", std::make_shared<EnumNameRule>("oneapi::ccl::max")},
      {"ncclInt8", std::make_shared<EnumNameRule>("oneapi::ccl::int8")},
      {"ncclChar", std::make_shared<EnumNameRule>("oneapi::ccl::int8")},
      {"ncclUint8", std::make_shared<EnumNameRule>("oneapi::ccl::uint8")},
      {"ncclInt32", std::make_shared<EnumNameRule>("oneapi::ccl::int32")},
      {"ncclInt", std::make_shared<EnumNameRule>("oneapi::ccl::int32")},
      {"ncclUint32", std::make_shared<EnumNameRule>("oneapi::ccl::uint32")},
      {"ncclInt64", std::make_shared<EnumNameRule>("oneapi::ccl::int64")},
      {"ncclUint64", std::make_shared<EnumNameRule>("oneapi::ccl::uint64")},
      {"ncclFloat16", std::make_shared<EnumNameRule>("oneapi::ccl::float16")},
      {"ncclHalf", std::make_shared<EnumNameRule>("oneapi::ccl::float16")},
      {"ncclFloat32", std::make_shared<EnumNameRule>("oneapi::ccl::float32")},
      {"ncclFloat", std::make_shared<EnumNameRule>("oneapi::ccl::float32")},
      {"ncclFloat64", std::make_shared<EnumNameRule>("oneapi::ccl::float64")},
      {"ncclDouble", std::make_shared<EnumNameRule>("oneapi::ccl::float64")},
      {"ncclBfloat16", std::make_shared<EnumNameRule>("oneapi::ccl::bfloat16")},
      // ...
  };
