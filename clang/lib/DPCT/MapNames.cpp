...
void MapNames::setExplicitNamespaceMap() {
  ...
  TypeNamesMap = {
      ...
      {"longlong2",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<long long, 2>")},
      {"longlong3",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<long long, 3>")},
      {"longlong4",
       std::make_shared<TypeNameRule>(getClNamespace() + "vec<long long, 4>")},
      ...
      {"ulonglong2", std::make_shared<TypeNameRule>(
                         getClNamespace() + "vec<unsigned long long, 2>")},
      {"ulonglong3", std::make_shared<TypeNameRule>(
                         getClNamespace() + "vec<unsigned long long, 3>")},
      {"ulonglong4", std::make_shared<TypeNameRule>(
                         getClNamespace() + "vec<unsigned long long, 4>")},
