...
#undef ENTRY
  ...
  BLASAPIWithRewriter = {
      ...
      {"cublasSsyrkx", getDpctNamespace() + "blas::syrkx"},
      {"cublasDsyrkx", getDpctNamespace() + "blas::syrkx"},
      {"cublasCsyrkx", getDpctNamespace() + "blas::syrkx"},
      {"cublasZsyrkx", getDpctNamespace() + "blas::syrkx"},
      {"cublasCherkx", getDpctNamespace() + "blas::hrkx"},
      {"cublasZherkx", getDpctNamespace() + "blas::hrkx"},
