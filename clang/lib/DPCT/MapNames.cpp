...
#undef ENTRY
  ...
  BLASAPIWithRewriter = {
      ...
      {"cublasHgemmStridedBatched", "oneapi::mkl::blas::column_major::gemm_batch"},
      {"cublasSgemmStridedBatched", "oneapi::mkl::blas::column_major::gemm_batch"},
      {"cublasDgemmStridedBatched", "oneapi::mkl::blas::column_major::gemm_batch"},
      {"cublasCgemmStridedBatched", "oneapi::mkl::blas::column_major::gemm_batch"},
      {"cublasZgemmStridedBatched", "oneapi::mkl::blas::column_major::gemm_batch"},
