...
#undef ENTRY
  ...
  BLASAPIWithRewriter = {
      ...
      {"cublasSsyrkx", getDpctNamespace() + "syrk"},
      {"cublasDsyrkx", getDpctNamespace() + "syrk"},
      {"cublasCsyrkx", getDpctNamespace() + "syrk"},
      {"cublasZsyrkx", getDpctNamespace() + "syrk"},
      {"cublasCherkx", getDpctNamespace() + "herk"},
      {"cublasZherkx", getDpctNamespace() + "herk"},
      ...
      {"cublasStrmm_v2_64", getDpctNamespace() + "trmm"},
      {"cublasDtrmm_v2_64", getDpctNamespace() + "trmm"},
      {"cublasCtrmm_v2_64", getDpctNamespace() + "trmm"},
      {"cublasZtrmm_v2_64", getDpctNamespace() + "trmm"},
      ...
      {"cublasSsyrkx_64", getDpctNamespace() + "syrk"},
      {"cublasDsyrkx_64", getDpctNamespace() + "syrk"},
      {"cublasCsyrkx_64", getDpctNamespace() + "syrk"},
      {"cublasZsyrkx_64", getDpctNamespace() + "syrk"},
      {"cublasCherkx_64", getDpctNamespace() + "herk"},
      {"cublasZherkx_64", getDpctNamespace() + "herk"},
