...
auto UseIntelDeviceMathExt = [](const CallExpr *C) -> bool {
  return DpctGlobalInfo::useIntelDeviceMath();
};
auto UseOptmizeMigration = [](const CallExpr *C) -> bool {
...
auto IsContextPureDevice = makeCheckOr(
