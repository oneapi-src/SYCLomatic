...
#define ENTRY_DEVICE(SOURCEAPINAME, TARGETAPINAME) FUNC_NAME_FACTORY_ENTRY(SOURCEAPINAME, TARGETAPINAME)
#define ENTRY_BOTH(SOURCEAPINAME, TARGETAPINAME)  FUNC_NAME_FACTORY_ENTRY(SOURCEAPINAME, TARGETAPINAME)
