  ...
  MF.addMatcher(
      typeLoc(
          loc(qualType(hasDeclaration(namedDecl(hasAnyName(
              ...
              "thrust::tuple", "thrust::maximum", "thrust::plus",
              "cudaDataType_t", "cudaError_t", "CUresult", "CUdevice",
              "cudaEvent_t", "cublasStatus_t", "cuComplex", "cuFloatComplex",
              ...
              "curandStateMRG32k3a_t", "curandStateMRG32k3a", "thrust::negate",
