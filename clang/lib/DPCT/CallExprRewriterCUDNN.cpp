...
void CallExprRewriterFactoryBase::initRewriterMapCUDNN() {
  ...
  {// Base API
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY("cudnnCreate", DEREF(ARG_WC(0)),
                                                false, "create_engine")))
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_engine_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY("cudnnSetStream", ARG_WC(0),
                                                false, "set_queue", ARG_WC(1))))
   ...
   "cudnnSetTensor4dDescriptor", ARG_WC(0), false, "set", ARG_WC(1), ARG_WC(2),
   ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_memory_desc_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSetTensor4dDescriptorEx", ARG_WC(0), false, "set", ARG_WC(1),
   ARG_WC(2), ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6), ARG_WC(7), ARG_WC(8),
   ARG_WC(9))))
   ...
   HelperFeatureEnum::DnnlUtils_memory_desc_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetTensor4dDescriptor", ARG_WC(0), false, "get", ARG_WC(1), ARG_WC(2),
   ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6), ARG_WC(7), ARG_WC(8),
   ARG_WC(9))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_memory_desc_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetTensorNdDescriptor", ARG_WC(0), false, "get", ARG_WC(1), ARG_WC(2),
   ARG_WC(3), ARG_WC(4), ARG_WC(5))))
   ...
   // Simple Operation
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_reorder,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnTransformTensor", ARG_WC(0), false, "async_reorder", DEREF(ARG_WC(1)),
   ARG_WC(2), ARG_WC(3), DEREF(ARG_WC(4)), ARG_WC(5), ARG_WC(6))))
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_sum,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnAddTensor", ARG_WC(0), false, "async_sum", DEREF(ARG_WC(1)), ARG_WC(2),
   ...
   HelperFeatureEnum::DnnlUtils_activation_desc,
   ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
   "cudnnGetActivationDescriptorSwishBeta", DEREF(ARG_WC(1)),
   MEMBER_CALL(ARG_WC(0), false, "get_beta"))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_activation_forward,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnActivationForward", ARG_WC(0), false, "async_activation_forward",
   ARG_WC(1), DEREF(ARG_WC(2)), ARG_WC(3), ARG_WC(4), DEREF(ARG_WC(5)),
   ARG_WC(6), ARG_WC(7))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_activation_backward,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnActivationBackward", ARG_WC(0), false, "async_activation_backward",
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_lrn_forward,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnLRNCrossChannelForward", ARG_WC(0), false, "async_lrn_forward",
   ARG_WC(1), DEREF(ARG_WC(3)), ARG_WC(4), ARG_WC(5), DEREF(ARG_WC(6)),
   ARG_WC(7), ARG_WC(8))))
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnLRNCrossChannelBackward", ARG_WC(0), false, "async_lrn_backward",
   ARG_WC(1), DEREF(ARG_WC(3)), ARG_WC(4), ARG_WC(5), ARG_WC(6), ARG_WC(7),
   ARG_WC(8), ARG_WC(9), DEREF(ARG_WC(10)), ARG_WC(11), ARG_WC(12))),
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSetPooling2dDescriptor", ARG_WC(0), false, "set", ARG_WC(1), ARG_WC(3),
   ARG_WC(4), ARG_WC(5), ARG_WC(6), ARG_WC(7), ARG_WC(8))),
   Diagnostics::API_NOT_MIGRATED, ARG("Nan numbers propagation option")))
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSetPoolingNdDescriptor", ARG_WC(0), false, "set", ARG_WC(1), ARG_WC(3),
   ARG_WC(4), ARG_WC(5), ARG_WC(6))),
   Diagnostics::API_NOT_MIGRATED, ARG("Nan numbers propagation option")))
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetPooling2dDescriptor", ARG_WC(0), false, "get", ARG_WC(1), ARG_WC(3),
   ARG_WC(4), ARG_WC(5), ARG_WC(6), ARG_WC(7), ARG_WC(8))),
   Diagnostics::API_NOT_MIGRATED, ARG("Nan numbers propagation option")))
   ...
   "cudnnGetPooling2dDescriptor",
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetPoolingNdDescriptor", ARG_WC(0), false, "get", ARG_WC(1), ARG_WC(2),
   ...
   HelperFeatureEnum::DnnlUtils_pooling_desc,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetPoolingNdForwardOutputDim", ARG_WC(0), false,
   "get_forward_output_dim", ARG_WC(1), ARG_WC(2), ARG_WC(3))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_pooling_forward,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnPoolingForward", ARG_WC(0), false, "async_pooling_forward", ARG_WC(1),
   DEREF(ARG_WC(2)), ARG_WC(3), ARG_WC(4), DEREF(ARG_WC(5)), ARG_WC(6),
   ARG_WC(7))))
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnPoolingBackward", ARG_WC(0), false, "async_pooling_backward",
   ARG_WC(1), DEREF(ARG_WC(2)), ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6),
   ARG_WC(7), ARG_WC(8), DEREF(ARG_WC(9)), ARG_WC(10), ARG_WC(11))),
   Diagnostics::PRIMITIVE_WORKSPACE, ARG("async_pooling_backward"),
   ARG("async_pooling_forward")))

   // Softmax Layer
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_softmax_forward,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSoftmaxForward", ARG_WC(0), false, "async_softmax_forward", ARG_WC(1),
   ARG_WC(2), DEREF(ARG_WC(3)), ARG_WC(4), ARG_WC(5), DEREF(ARG_WC(6)),
   ARG_WC(7), ARG_WC(8))))
   ...
   ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY("cudnnSetReduceTensorDescriptor",
                                           ARG_WC(0), ARG_WC(1))),
   Diagnostics::API_NOT_MIGRATED,
   ...
   ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY("cudnnGetReduceTensorDescriptor",
   ...
   "cudnnReduceTensor",
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnReduceTensor", ARG_WC(0), false, "async_reduction", ARG_WC(1),
   DEREF(ARG_WC(6)), ARG_WC(7), ARG_WC(8), DEREF(ARG_WC(9)), ARG_WC(10),
   ARG_WC(11))),
   Diagnostics::API_NOT_MIGRATED, ARG("reduction index")))
   ...
   ASSIGNABLE_FACTORY(
   ASSIGN_FACTORY_ENTRY("cudnnSetOpTensorDescriptor", ARG_WC(0), ARG_WC(1))),
   Diagnostics::API_NOT_MIGRATED,
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_binary,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnOpTensor", ARG_WC(0), false, "async_binary", ARG_WC(1),
   DEREF(ARG_WC(2)), ARG_WC(3), ARG_WC(4), DEREF(ARG_WC(5)), ARG_WC(6),
   ARG_WC(7), DEREF(ARG_WC(8)), ARG_WC(9), ARG_WC(10))))
   ...
   ARG_WC(20), ARG_WC(17), ARG_WC(14), DEREF(ARG_WC(3)), ARG_WC(5), ARG_WC(6),
   DEREF(ARG_WC(4)), ARG_WC(9), ARG_WC(10), ARG_WC(7), ARG_WC(8), ARG_WC(11),
   ARG_WC(12), ARG_WC(13), ARG_WC(15), ARG_WC(16), ARG_WC(18), ARG_WC(19),
   ARG_WC(24), ARG_WC(23))))
   ...
   "async_batch_normalization_backward", ARG_WC(1), ARG_WC(16),
   DEREF(ARG_WC(2)), ARG_WC(6), ARG_WC(7), ARG_WC(8), ARG_WC(9),
   DEREF(ARG_WC(3)), ARG_WC(10), ARG_WC(11), DEREF(ARG_WC(4)), ARG_WC(12),
   ARG_WC(13), DEREF(ARG_WC(5)), ARG_WC(14), ARG_WC(15), ARG_WC(17),
   ARG_WC(18))))
   ...
   ARG_WC(22), DEREF(ARG_WC(3)), ARG_WC(7), ARG_WC(8), ARG_WC(9), ARG_WC(10),
   ARG_WC(11), ARG_WC(12), DEREF(ARG_WC(4)), ARG_WC(15), ARG_WC(16), ARG_WC(13),
   ARG_WC(14), DEREF(ARG_WC(5)), ARG_WC(17), ARG_WC(18), ARG_WC(19),
   DEREF(ARG_WC(6)), ARG_WC(20), ARG_WC(21), ARG_WC(23), ARG_WC(24), ARG_WC(29),
   ARG_WC(28))))
   ...
   ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
   "cudnnGetBatchNormalizationForwardTrainingExWorkspaceSize", DEREF(ARG_WC(8)),
   ARG("0")))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_get_batch_normalization_workspace_size,
   ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
   "cudnnGetBatchNormalizationTrainingExReserveSpaceSize", DEREF(ARG_WC(5)),
   ...
   ASSIGNABLE_FACTORY(
   ASSIGN_FACTORY_ENTRY("cudnnGetNormalizationForwardTrainingWorkspaceSize",
                        DEREF(ARG_WC(10)), ARG("0")))

   ASSIGNABLE_FACTORY(ASSIGN_FACTORY_ENTRY(
   "cudnnGetNormalizationBackwardWorkspaceSize", DEREF(ARG_WC(12)), ARG("0")))
   ...
   DEREF(ARG_WC(5)), ARG_WC(17), ARG_WC(18), ARG_WC(14), ARG_WC(15), ARG_WC(8),
   ARG_WC(9), ARG_WC(10), ARG_WC(11), ARG_WC(12), ARG_WC(13))))
   ...
   "async_batch_normalization_forward_training", ARG_WC(1), ARG_WC(2),
   ARG_WC(18), ARG_WC(15), ARG_WC(11), DEREF(ARG_WC(4)), ARG_WC(6), ARG_WC(7),
   DEREF(ARG_WC(5)), ARG_WC(21), ARG_WC(22), ARG_WC(19), ARG_WC(20), ARG_WC(8),
   ARG_WC(9), ARG_WC(10), ARG_WC(12), ARG_WC(13), ARG_WC(14), ARG_WC(16),
   ARG_WC(17), ARG_WC(26), ARG_WC(25))))
   ...
   ARG_WC(23), DEREF(ARG_WC(4)), ARG_WC(8), ARG_WC(9), ARG_WC(10), ARG_WC(11),
   ARG_WC(12), ARG_WC(13), DEREF(ARG_WC(5)), ARG_WC(16), ARG_WC(17), ARG_WC(14),
   ARG_WC(15), DEREF(ARG_WC(6)), ARG_WC(18), ARG_WC(19), ARG_WC(20),
   DEREF(ARG_WC(7)), ARG_WC(21), ARG_WC(22), ARG_WC(24), ARG_WC(25), ARG_WC(26),
   ARG_WC(31), ARG_WC(30))))
   ...
   HelperFeatureEnum::DnnlUtils_memory_desc_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetFilter4dDescriptor", ARG_WC(0), false, "get", ARG_WC(1), ARG_WC(2),
   ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_memory_desc_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetFilterNdDescriptor", ARG_WC(0), false, "get", ARG_WC(1), ARG_WC(2),
   ARG_WC(3), ARG_WC(4), ARG_WC(5))))
   ...
   HelperFeatureEnum::DnnlUtils_memory_desc_ext,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSetFilter4dDescriptor", ARG_WC(0), false, "set", ARG_WC(2), ARG_WC(1),
   ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6))))
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSetConvolution2dDescriptor", ARG_WC(0), false, "set", ARG_WC(1),
   ARG_WC(2), ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6))),
   Diagnostics::API_NOT_MIGRATED,
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnSetConvolutionNdDescriptor", ARG_WC(0), false, "set", ARG_WC(1),
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetConvolution2dDescriptor", ARG_WC(0), false, "get", ARG_WC(1),
   ARG_WC(2), ARG_WC(3), ARG_WC(4), ARG_WC(5), ARG_WC(6))),
   Diagnostics::API_NOT_MIGRATED,
   ARG("convolution mode and computation datatype option")))
   ...
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetConvolutionNdDescriptor", ARG_WC(0), false, "get", ARG_WC(1),
   ARG_WC(2), ARG_WC(3), ARG_WC(4), ARG_WC(5))),
   Diagnostics::API_NOT_MIGRATED,
   ARG("convolution mode and computation datatype option")))
   ...
   HelperFeatureEnum::DnnlUtils_pooling_desc,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetConvolution2dForwardOutputDim", ARG_WC(0), false,
   "get_forward_output_dim", ARG_WC(1), ARG_WC(2), ARG_WC(3), ARG_WC(4),
   ARG_WC(5), ARG_WC(6))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_pooling_desc,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnGetConvolutionNdForwardOutputDim", ARG_WC(0), false,
   "get_forward_output_dim", ARG_WC(1), ARG_WC(2), ARG_WC(3), ARG_WC(4))))
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_convolution_forward_ex,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnConvolutionBiasActivationForward", ARG_WC(0), false,
   "async_convolution_forward", ARG_WC(6), ARG_WC(7), ARG_WC(15),
   DEREF(ARG_WC(1)), ARG_WC(2), ARG_WC(3), ARG_WC(4), ARG_WC(5),
   DEREF(ARG_WC(10)), ARG_WC(11), ARG_WC(12), ARG_WC(13), ARG_WC(14),
   ARG_WC(16), ARG_WC(17))))

   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_convolution_backward_data,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnConvolutionBackwardData", ARG_WC(0), false,
   "async_convolution_backward_data", ARG_WC(6), ARG_WC(7), DEREF(ARG_WC(1)),
   ARG_WC(2), ARG_WC(3), ARG_WC(4), ARG_WC(5), DEREF(ARG_WC(10)), ARG_WC(11),
   ARG_WC(12))))
   ...
   FEATURE_REQUEST_FACTORY(
   HelperFeatureEnum::DnnlUtils_convolution_backward_bias,
   ASSIGNABLE_FACTORY(MEMBER_CALL_FACTORY_ENTRY(
   "cudnnConvolutionBackwardBias", ARG_WC(0), false,
   "async_convolution_backward_bias", DEREF(ARG_WC(1)), ARG_WC(2), ARG_WC(3),
