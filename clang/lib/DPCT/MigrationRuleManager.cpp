...
MigrationRuleManager::RuleFactoryMapType &
MigrationRuleManager::getMap(PassKind Kind) {
  static MigrationRuleManager::RuleFactoryMapType Map[static_cast<unsigned>(PassKind::PK_End)];
