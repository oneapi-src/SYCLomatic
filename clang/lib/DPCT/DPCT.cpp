...
const char *const CtHelpMessage =
    ...
    "  dpct --compilation-database-path=<path to location of compilation database file>\n\n"
    "Migrate one file in compilation database:\n\n"
    "  dpct --compilation-database-path=<path to location of compilation database file>  source.cpp\n\n"
#if defined(_WIN32)
