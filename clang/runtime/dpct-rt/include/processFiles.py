...
content_files_list = ["atomic", "blas_utils", "device",
                      "dpct", "dpl_utils", "image", "kernel", "memory", "util", "rng_utils", 
                      "lib_common_utils", "dnnl_utils", "atomic_ref_ext"]
...
content_files_name_list = ["Atomic", "BlasUtils", "Device",
                           "Dpct", "DplUtils", "Image", "Kernel", "Memory", "Util", "RngUtils", 
                           "LibCommonUtils", "DnnlUtils", "AtomicRefExt"]
