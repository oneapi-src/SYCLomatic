...
class dropout_desc {
  struct dropout_desc_imp {
    ...
    dropout_desc_imp()
        : _rng_engine(::dpct::detail::dispatch::get_default_queue(), 1) {}
  };
...
public:
  ...
  void create_engine() {
#if USE_DPCT_HELPER
    _q = &::dpct::detail::dispatch::get_current_device().default_queue();
#else
    _q = ::dpct::detail::dispatch::get_current_device().default_queue();
#endif
    _eng = std::make_shared<::dnnl::engine>(::dnnl::sycl_interop::make_engine(
        ::dpct::detail::dispatch::get_current_device(),
        ::dpct::detail::dispatch::get_current_device().get_context()));
