...
//
#include <CL/sycl.hpp>
#include "../include/dpct_memory.hpp"
...
void test1() {
  ...
  dpct::dpct_malloc((void **)&d_A, Num * sizeof(float));
  dpct::dpct_memcpy((void*) d_A, (void*) h_A, N1 * sizeof(float), dpct::memcpy_direction::host_to_device);
  dpct::dpct_memcpy((void*) (d_A + N1), (void*) h_B, (Num-N1) * sizeof(float), dpct::memcpy_direction::host_to_device);
  dpct::dpct_memcpy((void*) h_C, (void*) d_A, Num * sizeof(float), dpct::memcpy_direction::device_to_host);
...
void test1_1() {
  ...
  // deviceA[0..4999] -> hostC[0..4999]
  dpct::dpct_malloc((void **)&d_A, Num * sizeof(float));
  dpct::dpct_memcpy((void*) d_A, (void*) h_A, N1 * sizeof(float), dpct::memcpy_direction::automatic);
  dpct::dpct_memcpy((void*) (d_A + N1), (void*) h_B, (Num-N1) * sizeof(float), dpct::memcpy_direction::automatic);
  dpct::dpct_memcpy((void*) h_C, (void*) d_A, Num * sizeof(float), dpct::memcpy_direction::automatic);
  dpct::dpct_free((void*)d_A);
...
// TODO: corresponding API is to be removed from dpct. We keep this code for
...
void test2() {
  ...
  // deviceA -> hostC
  dpct::dpct_malloc((void **)&d_A, Num * sizeof(float));
  dpct::dpct_malloc((void **)&d_B, Num * sizeof(float));
  dpct::dpct_malloc((void **)&d_C, Num * sizeof(float));
  dpct::dpct_memcpy((void*) d_A, (void*) h_A, Num * sizeof(float), dpct::memcpy_direction::host_to_device);
  dpct::dpct_memcpy((void*) d_B, (void*) h_B, Num * sizeof(float), dpct::memcpy_direction::host_to_device);
  ...
  {
    dpct::get_device_manager().current_device().default_queue().submit(
      [=](cl::sycl::handler &cgh) {
  ...
  dpct::dpct_memcpy((void*) (h_C+Offset), (void*) d_C, (Num-Offset) * sizeof(float), dpct::memcpy_direction::device_to_host);
...
void test3() {
...

  {
    dpct::get_device_manager().current_device().default_queue().submit(
      [=](cl::sycl::handler &cgh) {
      auto buffer_and_offset_A = dpct::get_buffer_and_offset(d_A);
      size_t offset_A = buffer_and_offset_A.second;
      auto buffer_and_offset_B = dpct::get_buffer_and_offset(d_B);
      size_t offset_B = buffer_and_offset_A.second;
      auto buffer_and_offset_C = dpct::get_buffer_and_offset(d_C);
...
void test4() {
  ...
  dpct::dpct_malloc((void **)&d_A, Num * sizeof(int));
  // hostA -> deviceA
  dpct::dpct_memcpy((void*) d_A, (void*) h_A, Num * sizeof(int), dpct::memcpy_direction::host_to_device);

  // set d_A[0,..., 6] = 0
  dpct::dpct_memset((void*) d_A, 0, (Num - 3) * sizeof(int));

  // deviceA -> hostA
  dpct::dpct_memcpy((void*) h_A, (void*) d_A, Num * sizeof(int), dpct::memcpy_direction::device_to_host);
...
void test5() {
  ...
  dpct::dpct_memcpy_to_symbol((void *)d_A.get_ptr(), (void *)&h_A[0], N1 * sizeof(float), 0, dpct::memcpy_direction::host_to_device);
  dpct::dpct_memcpy_to_symbol(d_A.get_ptr(), (void*) h_B, (Num-N1) * sizeof(float), N1 * sizeof(float), dpct::memcpy_direction::automatic);
  dpct::dpct_memcpy((void *)h_C, (void *)d_A.get_ptr(), Num * sizeof(float),   dpct::memcpy_direction::device_to_host);

  dpct::dpct_memcpy_to_symbol((void *)d_B.get_ptr(), (void *)d_A.get_ptr(), N1 * sizeof(float), 0, dpct::memcpy_direction::device_to_device);
  dpct::dpct_memcpy_to_symbol((void *)d_B.get_ptr(), (void *)((size_t)d_A.get_ptr() + N1* sizeof(float)), (Num - N1) * sizeof(float), N1 * sizeof(float), dpct::memcpy_direction::automatic);
  dpct::dpct_memcpy((void *)h_D, (void *)d_B.get_ptr(), Num * sizeof(float),   dpct::memcpy_direction::device_to_host);
