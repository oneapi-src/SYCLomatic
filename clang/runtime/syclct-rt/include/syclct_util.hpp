...
inline half2 float22half2_rn(float2 f2) {
...
inline float double2float_rd(double d) {
  double1 d1{d};
  float1 f1 = d1.convert<float, rounding_mode::rtn>();
  return f1.get_value(0);
}

inline float double2float_rn(double d) {
  double1 d1{d};
  float1 f1 = d1.convert<float, rounding_mode::rte>();
  return f1.get_value(0);
}

inline float double2float_ru(double d) {
  double1 d1{d};
  float1 f1 = d1.convert<float, rounding_mode::rtp>();
  return f1.get_value(0);
}

inline float double2float_rz(double d) {
  double1 d1{d};
...
inline unsigned float_as_uint(float f) {
...
inline double longlong_as_double(long long ll) {
  return *reinterpret_cast<long long*>(&ll);
}

inline float uint_as_float(unsigned ui) {
