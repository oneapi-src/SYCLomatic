...
void test(cudnnNormMode_t m, cudnnNormOps_t op, cudnnNormAlgo_t alg,
          ...
          cudnnTensorDescriptor_t diff_src_d, cudnnTensorDescriptor_t diff_p1_d,
  ...
  cudnnGetNormalizationBackwardWorkspaceSize(
      ...
      diff_p1_d /*cudnnTensorDescriptor_t*/,
      adesc /*cudnnActivationDescriptor_t*/, p2_d /*cudnnTensorDescriptor_t*/,
      size /*size_t **/, group_count /*int*/);
  // End
}