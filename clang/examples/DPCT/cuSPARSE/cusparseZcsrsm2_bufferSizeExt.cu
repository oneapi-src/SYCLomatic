...
void test(cusparseHandle_t handle, int algo, cusparseOperation_t trans_a,
          ...
          const cuDoubleComplex *b, int ldb, csrsm2Info_t info,
  ...
  cusparseZcsrsm2_bufferSizeExt(
      ...
      row_ptr /*const int **/, col_ind /*const int **/,
      b /*const cuDoubleComplex **/, ldb /*int*/, info /*csrsm2Info_t*/,
      policy /*cusparseSolvePolicy_t*/, buffer_size /*size_t **/);
  // End
}
