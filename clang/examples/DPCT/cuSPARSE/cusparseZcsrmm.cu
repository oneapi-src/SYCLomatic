...
void test(cusparseHandle_t handle, cusparseOperation_t trans, int m, int n,
          ...
          const int *row_ptr, const int *col_idx, const cuDoubleComplex *B,
          int ldb, const cuDoubleComplex *beta, cuDoubleComplex *C, int ldc) {
  // Start
  cusparseZcsrmm(
      handle /*cusparseHandle_t*/, trans /*cusparseOperation_t*/, m /*int*/,
      n /*int*/, k /*int*/, nnz /*int*/, alpha /*const cuDoubleComplex **/,
      desc /*const cusparseMatDescr_t*/, value /*const cuDoubleComplex **/,
