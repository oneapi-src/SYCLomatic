...
void test(cusparseHandle_t handle, int m, int n, int nnz, const void *csr_value,
          ...
          cusparseIndexBase_t base, cusparseCsr2CscAlg_t alg) {
  // Start
  size_t buffer_size;
  cusparseCsr2cscEx2_bufferSize(
      handle /*cusparseHandle_t*/, m /*int*/, n /*int*/, nnz /*int*/,
      csr_value /*const void **/, row_ptr /*const int **/,
      col_idx /*const int **/, csc_value /*void **/, col_ptr /*int **/,
      row_ind /*int **/, value_type /*cudaDataType*/, act /*cusparseAction_t*/,
