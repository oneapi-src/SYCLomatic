...
void test(cusparseHandle_t handle, cusparseOperation_t trans, const void *alpha,
          ...
          cudaDataType compute_type, cusparseSpMVAlg_t alg, void *buffer) {
  // Start
  cusparseSpMV(handle /*cusparseHandle_t*/, trans /*cusparseOperation_t*/,
               ...
               alg /*cusparseSpMVAlg_t*/, buffer /*void **/);
  // End
}
