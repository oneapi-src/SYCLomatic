...
void test(cublasHandle_t handle, cublasFillMode_t upper_lower,
          ...
          const double *a, int64_t lda, const double *beta, double *c,
          int64_t ldc) {
  // Start
  cublasDsyrk_64(handle /*cublasHandle_t*/, upper_lower /*cublasFillMode_t*/,
                 trans /*cublasOperation_t*/, n /*int64_t*/, k /*int64_t*/,
                 alpha /*const double **/, a /*const double **/,
                 lda /*int64_t*/, beta /*const double **/, c /*double **/,
                 ldc /*int64_t*/);
  // End
}
