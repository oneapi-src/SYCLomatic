...
void fooo() {
    ...
    // CHECK: syclct::sycl_memcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
    cudaMemcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
    // CHECK: syclct::sycl_memcpy(h_A, d_A, size, cudaMemcpyDeviceToHost);
...
// CHECK-NEXT:SYCLCT1003: Translated api does not return error code. (*, 0) is inserted. You may want to rewrite this code
// CHECK-NEXT:*/
// CHECK-NEXT:  err = (syclct::sycl_memcpy(d_A, h_A, size, cudaMemcpyHostToDevice), 0);
  err = cudaMemcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
// CHECK:/*
// CHECK-NEXT:SYCLCT1003: Translated api does not return error code. (*, 0) is inserted. You may want to rewrite this code
// CHECK-NEXT:*/
// CHECK-NEXT:  checkError((syclct::sycl_memcpy(d_A, h_A, size, cudaMemcpyHostToDevice), 0));
...
// CHECK-NEXT:SYCLCT1003: Translated api does not return error code. (*, 0) is inserted. You may want to rewrite this code
// CHECK-NEXT:*/
// CHECK-NEXT:  err = (syclct::sycl_memcpy(h_A, d_A, size, cudaMemcpyDeviceToHost), 0);
  err = cudaMemcpy(h_A, d_A, size, cudaMemcpyDeviceToHost);
// CHECK:/*
// CHECK-NEXT:SYCLCT1003: Translated api does not return error code. (*, 0) is inserted. You may want to rewrite this code
// CHECK-NEXT:*/
// CHECK-NEXT:  checkError((syclct::sycl_memcpy(h_A, d_A, size, cudaMemcpyDeviceToHost), 0));
