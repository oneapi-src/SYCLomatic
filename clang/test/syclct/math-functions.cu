...
__device__ float4 fun() {
  float4 a, b, c;
  // TOCHECK: cl::sycl::fma(static_cast<float>(a.x()), static_cast<float>(b.x()), static_cast<float>(c.x()));
  __fmaf_rn(a.x, b.x, c.x);
  // TOCHECK: return cl::sycl::float4(cl::sycl::fma(static_cast<float>(a.x()), static_cast<float>(b.x()), static_cast<float>(c.x())), cl::sycl::fma(static_cast<float>(a.y()), static_cast<float>(b.y()), static_cast<float>(c.y())), cl::sycl::fma(static_cast<float>(a.z()), static_cast<float>(b.z()), static_cast<float>(c.z())), cl::sycl::fma(static_cast<float>(a.w()), static_cast<float>(b.w()), static_cast<float>(c.w())));
