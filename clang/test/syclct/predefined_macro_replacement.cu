...
#include <stdio.h>
//CHECK: #ifdef SYCL_ARCH_TEMPLY_USED_MACRO
...
//CHECK: #ifndef SYCL_ARCH_TEMPLY_USED_MACRO
#ifndef __NVCC__
void hello2() { printf("hello2"); }
#endif
//CHECK: #if defined(SYCL_ARCH_TEMPLY_USED_MACRO)
...
//CHECK: #elif defined(SYCL_ARCH_TEMPLY_USED_MACRO)
