...
int main() {
  ...
  *result_D = cublasDnrm2(n, x_D, incx);
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::sgbmv(syclct::get_default_queue(), (((transpose_ct_0)=='N'||(transpose_ct_0)=='n')?(mkl::transpose::nontrans):(((transpose_ct_0)=='T'||(transpose_ct_0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, m, n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_S, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dgbmv(syclct::get_default_queue(), (((transpose_ct_0)=='N'||(transpose_ct_0)=='n')?(mkl::transpose::nontrans):(((transpose_ct_0)=='T'||(transpose_ct_0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, m, n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_D, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::sgemv(syclct::get_default_queue(), (((transpose_ct_0)=='N'||(transpose_ct_0)=='n')?(mkl::transpose::nontrans):(((transpose_ct_0)=='T'||(transpose_ct_0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_S, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dgemv(syclct::get_default_queue(), (((transpose_ct_0)=='N'||(transpose_ct_0)=='n')?(mkl::transpose::nontrans):(((transpose_ct_0)=='T'||(transpose_ct_0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_D, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::ssbmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_S, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dsbmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_D, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::sspmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_S, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dspmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_D, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::sspr(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dspr(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::sspr2(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dspr2(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::ssymv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_S, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dsymv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, beta_D, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::ssyr(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dsyr(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::ssyr2(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, y_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dsyr2(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incx, y_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::stbmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, n, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtbmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, n, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::stbsv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, n, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtbsv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, n, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::stpmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtpmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::stpsv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtpsv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::strmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtrmv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(result_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::strsv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(result_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(result_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtrsv(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_2)=='N'||(diagtype_ct_2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, x_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, result_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: mkl::ssymm(syclct::get_default_queue(), (((sidemode_ct_0)=='L'||(sidemode_ct_0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct_1)=='L'||(fillmode_ct_1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_S, A_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, B_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldb, beta_S, C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: mkl::dsymm(syclct::get_default_queue(), (((sidemode_ct_0)=='L'||(sidemode_ct_0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct_1)=='L'||(fillmode_ct_1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_D, A_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, B_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldb, beta_D, C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::ssyrk(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, k, alpha_S, A_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, beta_S, C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dsyrk(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, k, alpha_D, A_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, beta_D, C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::ssyr2k(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, k, alpha_S, A_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, B_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldb, beta_S, C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dsyr2k(syclct::get_default_queue(), (((fillmode_ct_0)=='L'||(fillmode_ct_0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, k, alpha_D, A_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, B_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldb, beta_D, C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(C_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: mkl::strsm(syclct::get_default_queue(), (((sidemode_ct_0)=='L'||(sidemode_ct_0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct_1)=='L'||(fillmode_ct_1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_2)=='N'||(transpose_ct_2)=='n')?(mkl::transpose::nontrans):(((transpose_ct_2)=='T'||(transpose_ct_2)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_3)=='N'||(diagtype_ct_3)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), m, n, alpha_S, A_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, C_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dtrsm(syclct::get_default_queue(), (((sidemode_ct_0)=='L'||(sidemode_ct_0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct_1)=='L'||(fillmode_ct_1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct_2)=='N'||(transpose_ct_2)=='n')?(mkl::transpose::nontrans):(((transpose_ct_2)=='T'||(transpose_ct_2)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct_3)=='N'||(diagtype_ct_3)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), m, n, alpha_D, A_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, lda, C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, ldc);
  // CHECK-NEXT: }
  cublasDtrsm('l', 'U', 'N', 'N', m, n, alpha_D, A_D, lda, C_D, ldc);

  // CHECK: {
  // CHECK-NEXT: auto transpose_ct_0 = 'T';
  // CHECK-NEXT: auto transpose_ct_1 = 'C';
  // CHECK-NEXT: auto A_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(A_S);
  // CHECK-NEXT: cl::sycl::buffer<float,1> A_S_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = A_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<float, 1>(cl::sycl::range<1>(A_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(float)));
  // CHECK-NEXT: auto B_S_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(B_S);
  ...
  // CHECK-NEXT: auto C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}} = syclct::memory_manager::get_instance().translate_ptr(C_D);
  // CHECK-NEXT: cl::sycl::buffer<double,1> C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}} = C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.buffer.reinterpret<double, 1>(cl::sycl::range<1>(C_D_{{[0-9]+}}_allocation_{{[0-9a-z]+}}.size/sizeof(double)));
  // CHECK-NEXT: mkl::dgemm(syclct::get_default_queue(), (((transpose_ct_0)=='N'||(transpose_ct_0)=='n')?(mkl::transpose::nontrans):(((transpose_ct_0)=='T'||(transpose_ct_0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((transpose_ct_1)=='N'||(transpose_ct_1)=='n')?(mkl::transpose::nontrans):(((transpose_ct_1)=='T'||(transpose_ct_1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, n, n, alpha_D, A_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, n, B_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, n, beta_D, C_D_{{[0-9]+}}_buffer_{{[0-9a-z]+}}, n);
  // CHECK-NEXT: }
