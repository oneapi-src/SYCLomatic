...
// RUN: FileCheck --input-file %T/min_cast.sycl.cpp --match-full-lines %s
...
__global__ void func() {
  ...
  int CHUNK_SIZE2 = 64;
  int numz2;
  //CHECK: const int zlength2 = cl::sycl::min(CHUNK_SIZE2, numz2);
  ...
  int numz3;
  //CHECK: const int zlength3 = cl::sycl::min(CHUNK_SIZE3, (unsigned int)(numz3));
  ...
  int CHUNK_SIZE0 = 64;
  int numz0;
  //CHECK: const int zlength0 = cl::sycl::min((unsigned int)(CHUNK_SIZE0), (unsigned int)(numz0 - item_ct1.get_group(0) * CHUNK_SIZE0));
  ...
  int numz1;
  //CHECK: const int zlength1 = cl::sycl::min(CHUNK_SIZE1, (unsigned int)(numz1 - item_ct1.get_group(0) * CHUNK_SIZE1));
