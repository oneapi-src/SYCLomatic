...
#include <stdio.h>
#define SIZE 100
// CHECK: void staticReverse(int *d, int n, cl::sycl::nd_item<3> item_ct1, syclct::syclct_accessor<syclct::byte_t, syclct::shared, 1> syclct_extern_memory) {
...
// CHECK-NEXT: void templateReverse(TData *d, TData n, cl::sycl::nd_item<3> item_ct1, syclct::syclct_accessor<syclct::byte_t, syclct::shared, 1> syclct_extern_memory) {
...
void testTemplate(){
  ...
  // CHECK-NEXT:      auto syclct_extern_memory_range_ct1 = syclct_extern_memory.get_range();
  // CHECK-NEXT:      auto syclct_extern_memory_acc_ct1 = syclct_extern_memory.get_access(cgh);
  ...
  // CHECK-NEXT:          templateReverse<T>(d_d, n, [[ITEM]], syclct::syclct_accessor<syclct::byte_t, syclct::shared, 1>(syclct_extern_memory_acc_ct1, syclct_extern_memory_range_ct1));
  // CHECK-NEXT:        });
  // CHECK-NEXT:    });
  // CHECK-NEXT:}
...
int main(void) {
  ...
  // CHECK-NEXT:          staticReverse(d_d, n, [[ITEM]], syclct::syclct_accessor<syclct::byte_t, syclct::shared, 1>(syclct_extern_memory_acc_ct1, syclct_extern_memory_range_ct1));
  // CHECK-NEXT:        });
  // CHECK-NEXT:    });
  // CHECK-NEXT:}
  ...
  // CHECK-NEXT:        [=](cl::sycl::nd_item<3> [[ITEM:item_ct1]]) {
  // CHECK-NEXT:          int *d_d = (int*)(&d_d_acc[0] + d_d_offset);
  // CHECK-NEXT:          templateReverse<int>(d_d, n, [[ITEM]], syclct::syclct_accessor<syclct::byte_t, syclct::shared, 1>(syclct_extern_memory_acc_ct1, syclct_extern_memory_range_ct1));
  // CHECK-NEXT:        });
  // CHECK-NEXT:    });
  // CHECK-NEXT:}
