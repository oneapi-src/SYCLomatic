// RUN: c2s --format-range=none -out-root %T/complex %s --cuda-include-path="%cuda-path/include" -- -std=c++14 -x cuda --cuda-host-only
...
// CHECK: #define COMPLEX_D_MUL(a, b) c2s::cmul<double>(a, b)
// CHECK: #define COMPLEX_D_DIV(a, b) c2s::cdiv<double>(a, b)
// CHECK: #define COMPLEX_D_ABS(a) c2s::cabs<double>(a)
// CHECK: #define COMPLEX_D_ABS1(a) (sycl::fabs((a).x()) + sycl::fabs((a).y()))
// CHECK: #define COMPLEX_D_CONJ(a) c2s::conj<double>(a)
...
// CHECK: #define COMPLEX_F_MUL(a, b) c2s::cmul<float>(a, b)
// CHECK: #define COMPLEX_F_DIV(a, b) c2s::cdiv<float>(a, b)
// CHECK: #define COMPLEX_F_ABS(a) c2s::cabs<float>(a)
// CHECK: #define COMPLEX_F_ABS1(a) (sycl::fabs((a).x()) + sycl::fabs((a).y()))
// CHECK: #define COMPLEX_F_CONJ(a) c2s::conj<float>(a)
