...
// UNSUPPORTED: v8.0
// RUN: dpct -out-root %T/thrust_replace_usm %s --cuda-include-path="%cuda-path/include" --usm-level=restricted
// RUN: FileCheck --input-file %T/thrust_replace_usm/thrust_replace_usm.dp.cpp --match-full-lines %s
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHECK:oneapi::dpl::replace_if(oneapi::dpl::execution::par_unseq, AH.begin(), AH.end(), pred, 0);
// CHECK-NEXT:oneapi::dpl::replace_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), pred, 0);
// CHECK-NEXT:oneapi::dpl::replace_if(oneapi::dpl::execution::par_unseq, h_ptr, h_ptr + 4, pred, 0);
// CHECK-NEXT:oneapi::dpl::replace_if(oneapi::dpl::execution::par_unseq, d_ptr, d_ptr + 4, pred, 0);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHECK:dpct::replace_if(oneapi::dpl::execution::par_unseq, AH.begin(), AH.end(), SH.begin(), pred, 0);
// CHECK-NEXT:dpct::replace_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), SD.begin(), pred, 0);
// CHECK-NEXT:dpct::replace_if(oneapi::dpl::execution::par_unseq, h_ptr, h_ptr + 4, SH.begin(), pred, 0);
// CHECK-NEXT:dpct::replace_if(oneapi::dpl::execution::par_unseq, d_ptr, d_ptr + 4, SD.begin(), pred, 0);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHECK:oneapi::dpl::replace_copy_if(oneapi::dpl::execution::par_unseq, AH.begin(), AH.end(), BH.begin(), pred, 0);
// CHECK-NEXT:oneapi::dpl::replace_copy_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), BD.begin(), pred, 0);
// CHECK-NEXT:oneapi::dpl::replace_copy_if(oneapi::dpl::execution::par_unseq, h_ptr, h_ptr + 4, BH.begin(), pred, 0);
// CHECK-NEXT:oneapi::dpl::replace_copy_if(oneapi::dpl::execution::par_unseq, d_ptr, d_ptr + 4, BD.begin(), pred, 0);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHECK:dpct::replace_copy_if(oneapi::dpl::execution::par_unseq, AH.begin(), AH.end(), SH.begin(), BH.begin(), pred, 0);
// CHECK-NEXT:dpct::replace_copy_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), SD.begin(), BD.begin(), pred, 0);
// CHECK-NEXT:dpct::replace_copy_if(oneapi::dpl::execution::par_unseq, h_ptr, h_ptr + 4, SH.begin(), BH.begin(), pred, 0);
