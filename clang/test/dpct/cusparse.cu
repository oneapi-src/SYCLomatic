...
int main(){
  ...
  //CHECK: int mode = 0;
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseGetPointerMode was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseSetPointerMode was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  ...
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseSetMatDiagType was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseSetMatFillMode was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: descrA = oneapi::mkl::index_base::zero;
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseSetMatType was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1027:{{[0-9]+}}: The call to cusparseGetMatDiagType was replaced with 0 because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: diag0 = (oneapi::mkl::diag)0;
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1027:{{[0-9]+}}: The call to cusparseGetMatFillMode was replaced with 0 because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: fill0 = (oneapi::mkl::uplo)0;
  //CHECK-NEXT: base0 = descrA;
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1027:{{[0-9]+}}: The call to cusparseGetMatType was replaced with 0 because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: type0 = 0;
  ...
  //CHECK: int info;
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseCreateSolveAnalysisInfo was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseScsrsv_analysis was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseDestroySolveAnalysisInfo was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  ...
  //CHECK: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseCcsrsv_analysis was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  cusparseCcsrsv_analysis(handle, transA, m, nnz, descrA, csrValA_C, csrRowPtrA, csrColIndA, info);

  //CHECK: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseDestroyMatDescr was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
