...
// RUN: %if build_lit %{icpx -c -fsycl %T/sizeof_double2_insert_namespace/sizeof_double2_insert_namespace.dp.cpp -o %T/sizeof_double2_insert_namespace/sizeof_double2_insert_namespace.dp.o %}
