...
// RUN: %if build_lit %{icpx -c -fsycl %T/macro_win/macro_win.dp.cpp -o %T/macro_win/macro_win.dp.o %}
...
// CHECK: void __stdcall my_callback(dpct::queue_ptr stream, dpct::err0 status, void *data) {
