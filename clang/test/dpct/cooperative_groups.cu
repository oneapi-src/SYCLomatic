...
__device__ void foo() {
  ...
  // CHECK: const auto cblock = sycl::ext::oneapi::this_work_item::get_work_group<3>();
  ...
  // CHECK: const auto catile32 = sycl::ext::oneapi::this_work_item::get_sub_group();
  const auto catile32 = cg::tiled_partition<32>(block);
  // CHECK: auto atile32 = sycl::ext::oneapi::this_work_item::get_sub_group(); 
  auto atile32 = cg::tiled_partition<32>(block);
  // CHECK: const sycl::sub_group ctile32 = sycl::ext::oneapi::this_work_item::get_sub_group(); 
  ...
  // const auto catile16 = dpct::experimental::logical_group(item_ct1, sycl::ext::oneapi::this_work_item::get_work_group<3>(), 16);
  const auto catile16 = cg::tiled_partition<16>(block);
  // auto atile16 = dpct::experimental::logical_group(item_ct1, sycl::ext::oneapi::this_work_item::get_work_group<3>(), 16);
  auto atile16 = cg::tiled_partition<16>(block);
  // const dpct::experimental::logical_group ctile16 = dpct::experimental::logical_group(item_ct1, sycl::ext::oneapi::this_work_item::get_work_group<3>(), 16);
  const cg::thread_block_tile<16> ctile16 = cg::tiled_partition<16>(block);
  // dpct::experimental::logical_group tile16 = dpct::experimental::logical_group(item_ct1, sycl::ext::oneapi::this_work_item::get_work_group<3>(), 16);
  ...
  // CHECK-COUNT-5: sycl::group_barrier(sycl::ext::oneapi::this_work_item::get_sub_group());
  ...
  // CHECK-COUNT-5: sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_id();
  ...
  // CHECK: dpct::experimental::logical_group(item_ct1, sycl::ext::oneapi::this_work_item::get_work_group<3>(), 16).get_local_linear_id();
  ...
  // X.size()
  // CHECK-COUNT-5: sycl::ext::oneapi::this_work_item::get_work_group<3>().get_local_linear_range();
  ...
  // CHECK-COUNT-5: sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_range();
  ...
  // CHECK: dpct::experimental::logical_group(item_ct1, sycl::ext::oneapi::this_work_item::get_work_group<3>(), 16).get_local_linear_range();
  ...
  // X.shfl_down()
  // CHECK-COUNT-5: sycl::shift_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0);
  ...
  // CHECK-COUNT-5: dpct::shift_sub_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 16);
  ...
  // CHECK: dpct::shift_sub_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 8);
  cg::tiled_partition<8>(block).shfl_down(1, 0);
  // CHECK: dpct::shift_sub_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 4);
  cg::tiled_partition<4>(block).shfl_down(1, 0);
  // CHECK: dpct::shift_sub_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 2);
  cg::tiled_partition<2>(block).shfl_down(1, 0);
  // CHECK: dpct::shift_sub_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 1);
  cg::tiled_partition<1>(block).shfl_down(1, 0);

  // X.shfl()
  // CHECK-COUNT-5: sycl::select_from_group(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0);
  ...
  // CHECK-COUNT-5: dpct::select_from_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 16);
  ...
  // CHECK: dpct::select_from_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 8);
  cg::tiled_partition<8>(block).shfl(1, 0);
  // CHECK: dpct::select_from_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 4);
  cg::tiled_partition<4>(block).shfl(1, 0);
  // CHECK: dpct::select_from_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 2);
  cg::tiled_partition<2>(block).shfl(1, 0);
  // CHECK: dpct::select_from_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 1);
  cg::tiled_partition<1>(block).shfl(1, 0);

  // X.shfl_up()
  // CHECK-COUNT-5: sycl::shift_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0);
  ...
  // CHECK-COUNT-5: dpct::shift_sub_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 16);
  ...
  // CHECK: dpct::shift_sub_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 8);
  cg::tiled_partition<8>(block).shfl_up(1, 0);
  // CHECK: dpct::shift_sub_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 4);
  cg::tiled_partition<4>(block).shfl_up(1, 0);
  // CHECK: dpct::shift_sub_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 2);
  cg::tiled_partition<2>(block).shfl_up(1, 0);
  // CHECK: dpct::shift_sub_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 1);
  cg::tiled_partition<1>(block).shfl_up(1, 0);

  // X.shfl_xor()
  // CHECK-COUNT-5: sycl::permute_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0);
  ...
  // CHECK-COUNT-5: dpct::permute_sub_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 16);
  ...
  // CHECK: dpct::permute_sub_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 8);
  cg::tiled_partition<8>(block).shfl_xor(1, 0);
  // CHECK: dpct::permute_sub_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 4);
  cg::tiled_partition<4>(block).shfl_xor(1, 0);
  // CHECK: dpct::permute_sub_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 2);
  cg::tiled_partition<2>(block).shfl_xor(1, 0);
  // CHECK: dpct::permute_sub_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), 1, 0, 1);
