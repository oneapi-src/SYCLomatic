...
// CHECK-NEXT:  sycl::group_barrier(sycl::ext::oneapi::experimental::this_group<1>());
// CHECK-NEXT:  TB(b);
// CHECK-NEXT:  a = (sycl::group_barrier(sycl::ext::oneapi::experimental::this_group<1>()), sycl::all_of_group(sycl::ext::oneapi::experimental::this_group<1>(), a));
...
// CHECK-NEXT:  sycl::group_barrier(sycl::ext::oneapi::experimental::this_group<3>());
// CHECK-NEXT:  TB1(b);
// CHECK-NEXT:  sycl::all_of_group(sycl::ext::oneapi::experimental::this_sub_group(), a);
// CHECK-NEXT:  dpct::select_from_sub_group(sycl::ext::oneapi::experimental::this_sub_group(), a, a);
// CHECK-NEXT:}
