...
// RUN: %if build_lit %{icpx -c -fsycl %T/tm-usm-restricted-profiling/tm-usm-restricted-profiling.dp.cpp -o %T/tm-usm-restricted-profiling/tm-usm-restricted-profiling.dp.o %}
