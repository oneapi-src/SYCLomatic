...
int foo(int aaaaa){
  ...
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseDcsrsv_analysis was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
  //CHECK-NEXT: /*
  ...
  //CHECK: /*
  //CHECK-NEXT: DPCT1026:{{[0-9]+}}: The call to cusparseZcsrsv_analysis was removed because the function call is redundant in SYCL.
  //CHECK-NEXT: */
