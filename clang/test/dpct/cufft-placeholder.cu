...
//CHECK-NEXT:  plan->compute<sycl::double2, double>(idata, odata, dpct::fft::transform_direction::bwd);
//CHECK-NEXT:}
...
//CHECK-NEXT:  plan->compute<sycl::float2, float>(idata, odata, dpct::fft::transform_direction::bwd);
//CHECK-NEXT:}
