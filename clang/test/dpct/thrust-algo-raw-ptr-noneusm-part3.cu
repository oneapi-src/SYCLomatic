...
// RUN: %if build_lit %{icpx -c -fsycl %T/thrust-algo-raw-ptr-noneusm-part3/thrust-algo-raw-ptr-noneusm-part3.dp.cpp -o %T/thrust-algo-raw-ptr-noneusm-part3/thrust-algo-raw-ptr-noneusm-part3.dp.o %}
