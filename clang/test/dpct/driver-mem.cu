...
int main(){
    ...
    // CHECK-NEXT: cpy2.to.pos_x_byte = 1;
    // CHECK-EMPTY:
    ...
    // CHECK-NEXT: cpy2.from.pos_x_byte = 1;
    // CHECK-EMPTY:
    // CHECK-NEXT: cpy2.size_x_byte = 3;
