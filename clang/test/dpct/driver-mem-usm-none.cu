...
int main(){
    ...
    //CHECK-NEXT: dpct::dpct_memset_d32(f_D, v32, 1, 4, 6);
    //CHECK-NEXT: dpct::dpct_memset_d16(f_D, v16, 1, 4 * 2, 6);
    //CHECK-NEXT: dpct::dpct_memset(f_D, v8, 1, 4 * 4, 6);
    //CHECK-NEXT: dpct::async_dpct_memset_d32(f_D, v32, 1, 4, 6, *stream);
    //CHECK-NEXT: dpct::async_dpct_memset_d16(f_D, v16, 1, 4 * 2, 6, *stream);
    //CHECK-NEXT: dpct::async_dpct_memset(f_D, v8, 1, 4 * 4, 6, *stream);
    ...
    cuMemsetD2D32(f_D, v32, 1, 4, 6);
    cuMemsetD2D16(f_D, v16, 1, 4 * 2, 6);
    cuMemsetD2D8(f_D, v8, 1, 4 * 4, 6);
    cuMemsetD2D32Async(f_D, v32, 1, 4, 6, stream);
    cuMemsetD2D16Async(f_D, v16, 1, 4 * 2, 6, stream);
    cuMemsetD2D8Async(f_D, v8, 1 , 4 * 4, 6, stream);
