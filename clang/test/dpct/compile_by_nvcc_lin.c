...
// RUN: %if build_lit %{icpx -c -fsycl %T/compile_by_nvcc/compile_by_nvcc_lin.c.dp.cpp -o %T/compile_by_nvcc/compile_by_nvcc_lin.c.dp.o %}
...
// CHECK: int a = 0;
// CHECK-NEXT: inline dpct::constant_memory<float, 1> const_angle(360);
