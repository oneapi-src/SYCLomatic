...
int CUBLAS_GEMM_EX(cublasHandle_t handle,
  ...
  // CHECK: int status = DPCT_CHECK_ERROR(dpct::blas::gemm(handle->get_queue(), transa, transb, m, n, k, (const void *)alpha, (const void *)A, cublas_dtype_16, (transa == oneapi::mkl::transpose::nontrans) ? m : k, (const void *)B, cublas_dtype_16, (transb == oneapi::mkl::transpose::nontrans) ? k : n, (const void *)beta, (void *)C, cublas_dtype_16, m, dpct::library_data_t::real_float));
