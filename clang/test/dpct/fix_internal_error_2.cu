...
// RUN: dpct --out-root %T/fix_internal_error_2 %s --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" > %T/fix_internal_error_2/output.txt 2>&1 || true
