...
// RUN: %if build_lit %{icpx -c -fsycl -DNO_BUILD_TEST %T/thrust_sort_by_key_usm/thrust_sort_by_key_usm.dp.cpp -o %T/thrust_sort_by_key_usm/thrust_sort_by_key_usm.dp.o %}
