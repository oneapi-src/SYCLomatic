...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHECK:dpct::sort(oneapi::dpl::execution::par_unseq, AH.begin(), AH.end(), BH.begin());
// CHECK-NEXT:dpct::sort(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), BD.begin());
// CHECK-NEXT:dpct::sort(oneapi::dpl::execution::par_unseq, h_ptr, h_ptr + 4, BH.begin());
// CHECK-NEXT:dpct::sort(oneapi::dpl::execution::par_unseq, d_ptr, d_ptr + 4, BD.begin());
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHECK:dpct::sort(oneapi::dpl::execution::par_unseq, AH.begin(), AH.end(), BH.begin(), std::greater<int>());
// CHECK-NEXT:dpct::sort(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), BD.begin(), std::greater<int>());
// CHECK-NEXT:dpct::sort(oneapi::dpl::execution::par_unseq, h_ptr, h_ptr + 4, BH.begin(), std::greater<int>());
// CHECK-NEXT:dpct::sort(oneapi::dpl::execution::par_unseq, d_ptr, d_ptr + 4, BD.begin(), std::greater<int>());
