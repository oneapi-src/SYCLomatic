...
// RUN: %if build_lit %{icpx -c -fsycl %T/duplicate2/duplicate1.dp.cpp -o %T/duplicate2/duplicate1.dp.o %}
// RUN: FileCheck %S/duplicate2.cu --match-full-lines --input-file %T/duplicate2/duplicate2.dp.cpp
// RUN: %if build_lit %{icpx -c -fsycl %T/duplicate2/duplicate2.dp.cpp -o %T/duplicate2/duplicate2.dp.o %}
