...
// RUN: %if build_lit %{icpx -c -fsycl %T/atomic_functions/atomic_functions.dp.cpp -o %T/atomic_functions/atomic_functions.dp.o %}
...
// CHECK:inline dpct::global_memory<uint32_t, 1> dmem(100);
