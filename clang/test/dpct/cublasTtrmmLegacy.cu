...
int main(){
  ...
  // CHECK-NEXT:mkl::blas::trmm(dpct::get_default_queue(), mkl::side::left, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::nonunit, m, n, alpha_S, A_S_buf_ct{{[0-9]+}}, lda, B_S_buf_ct{{[0-9]+}}, ldb);
  // CHECK-NEXT:}
  ...
  // CHECK-NEXT:mkl::blas::trmm(dpct::get_default_queue(), mkl::side::left, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::nonunit, m, n, alpha_D, A_D_buf_ct{{[0-9]+}}, lda, B_D_buf_ct{{[0-9]+}}, ldb);
  // CHECK-NEXT:}
  ...
  // CHECK-NEXT:mkl::blas::trmm(dpct::get_default_queue(), mkl::side::left, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::nonunit, m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), A_C_buf_ct{{[0-9]+}}, lda, B_C_buf_ct{{[0-9]+}}, ldb);
  // CHECK-NEXT:}
  ...
  // CHECK-NEXT:mkl::blas::trmm(dpct::get_default_queue(), mkl::side::left, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::nonunit, m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), A_Z_buf_ct{{[0-9]+}}, lda, B_Z_buf_ct{{[0-9]+}}, ldb);
  // CHECK-NEXT:}
