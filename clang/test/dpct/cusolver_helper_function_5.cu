...
// RUN: %if build_lit %{icpx -c -fsycl %T/cusolver_helper_function_5/cusolver_helper_function_5.dp.cpp -o %T/cusolver_helper_function_5/cusolver_helper_function_5.dp.o %}
