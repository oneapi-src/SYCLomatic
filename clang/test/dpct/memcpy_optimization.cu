...
int main(){
    ...
    float *a, *b;
//CHECK:  /*
//CHECK:  DPCT1114:{{[0-9]+}}: There is no synchronization operation append after memcpy. This is based on the assumption that the source host memory is pageable. If this assumption doesn't hold, please append .wait() after memcpy for correct synchronization behavior.
//CHECK:  */
