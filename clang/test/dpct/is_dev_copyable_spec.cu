...
//      CHECK: DPCT1127:{{[0-9]+}}: This type is used in kernel but it is not device copyable. Below part(s) is(are) not meet the requirements: copy constructor. Please rewrite the code.
// CHECK-NEXT: */
