// UNSUPPORTED: cuda-8.0, cuda-9.2, cuda-10.1, cuda-10.2, cuda-11.0, cuda-11.1, cuda-11.2, cuda-11.3
// UNSUPPORTED: v8.0, cuda-9.2, v10.1, v10.2, v11.0, v11.1, v11.2, v11.3
...
// RUN: %if build_lit %{icpx -c -fsycl %T/thrust-algo-supplement/thrust-algo-supplement.dp.cpp -o %T/thrust-algo-supplement/thrust-algo-supplement.dp.o %}
#include <vector>
