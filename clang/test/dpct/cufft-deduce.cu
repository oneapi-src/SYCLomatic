...
int main() {
  ...
  //CHECK-NEXT:plan1 = std::make_shared<dpct::fft::fft_engine>(rank, n, inembed, istride, idist, onembed, ostride, odist, type, 12);
  cufftHandle plan1;
  ...
  //CHECK-NEXT:plan2 = std::make_shared<dpct::fft::fft_engine>(rank, n, inembed, istride, idist, onembed, ostride, odist, type, 12);
  cufftHandle plan2;
  cufftMakePlanMany(plan2, rank, n, inembed, istride, idist, onembed, ostride, odist, type, 12, work_size);

  //CHECK:std::shared_ptr<dpct::fft::fft_engine> plan3;
  //CHECK-NEXT:plan3 = std::make_shared<dpct::fft::fft_engine>(rank, n, inembed, istride, idist, onembed, ostride, odist, type2, 12);
  cufftHandle plan3;
