...
// RUN: c2s -format-range=none -out-root %T/test_with_different_macro_defined_output %T/test_with_different_macro_defined_output/test_with_different_macro_defined.cu --cuda-include-path="%cuda-path/include" -- -x cuda --cuda-host-only -DFOO_1
// RUN: c2s -format-range=none -out-root %T/test_with_different_macro_defined_output %T/test_with_different_macro_defined_output/test_with_different_macro_defined.cu --cuda-include-path="%cuda-path/include" -- -x cuda --cuda-host-only -DFOO_2
