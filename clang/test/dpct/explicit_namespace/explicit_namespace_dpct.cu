...
// RUN: %if build_lit %{icpx -c -fsycl -DBUILD_TEST  %T/explicit_namespace_dpct/explicit_namespace_dpct.dp.cpp -o %T/explicit_namespace_dpct/explicit_namespace_dpct.dp.o %}
