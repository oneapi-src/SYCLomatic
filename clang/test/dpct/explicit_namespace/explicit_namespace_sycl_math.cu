...
// RUN: %if build_lit %{icpx -c -fsycl -DBUILD_TEST  %T/explicit_namespace_sycl_math/explicit_namespace_sycl_math.dp.cpp -o %T/explicit_namespace_sycl_math/explicit_namespace_sycl_math.dp.o %}
