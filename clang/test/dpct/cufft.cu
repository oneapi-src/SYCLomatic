...
int main() {
  ...
  //CHECK-NEXT:plan_1d_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_1d_Z2D_buf_ct{{[0-9]+}}0 = dpct::get_buffer<double>(odata_1d_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_1d_Z2D, idata_1d_Z2D_buf_ct{{[0-9]+}}, odata_1d_Z2D_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_1d_D2Z_buf_ct{{[0-9]+}}1 = dpct::get_buffer<double>(idata_1d_D2Z);
  //CHECK-NEXT:if ((void *)idata_1d_D2Z == (void *)odata_1d_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_1d_D2Z, idata_1d_D2Z_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_1d_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_1d_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_1d_D2Z_buf_ct{{[0-9]+}}2 = dpct::get_buffer<double>(odata_1d_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_1d_D2Z, idata_1d_D2Z_buf_ct{{[0-9]+}}1, odata_1d_D2Z_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_2d_C2C_buf_ct{{[0-9]+}}3 = dpct::get_buffer<float>(idata_2d_C2C);
  //CHECK-NEXT:if ((void *)idata_2d_C2C == (void *)odata_2d_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_2d_C2C, idata_2d_C2C_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_2d_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_2d_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_2d_C2C_buf_ct{{[0-9]+}}4 = dpct::get_buffer<float>(odata_2d_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_2d_C2C, idata_2d_C2C_buf_ct{{[0-9]+}}3, odata_2d_C2C_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_2d_C2R_buf_ct{{[0-9]+}}5 = dpct::get_buffer<float>(idata_2d_C2R);
  //CHECK-NEXT:if ((void *)idata_2d_C2R == (void *)odata_2d_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_2d_C2R, idata_2d_C2R_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_2d_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_2d_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_2d_C2R_buf_ct{{[0-9]+}}6 = dpct::get_buffer<float>(odata_2d_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_2d_C2R, idata_2d_C2R_buf_ct{{[0-9]+}}5, odata_2d_C2R_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_2d_R2C_buf_ct{{[0-9]+}}7 = dpct::get_buffer<float>(idata_2d_R2C);
  //CHECK-NEXT:if ((void *)idata_2d_R2C == (void *)odata_2d_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_2d_R2C, idata_2d_R2C_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_2d_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_2d_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_2d_R2C_buf_ct{{[0-9]+}}8 = dpct::get_buffer<float>(odata_2d_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_2d_R2C, idata_2d_R2C_buf_ct{{[0-9]+}}7, odata_2d_R2C_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_2d_Z2Z_buf_ct{{[0-9]+}}9 = dpct::get_buffer<double>(idata_2d_Z2Z);
  //CHECK-NEXT:if ((void *)idata_2d_Z2Z == (void *)odata_2d_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_2d_Z2Z, idata_2d_Z2Z_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_2d_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_2d_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_2d_Z2Z_buf_ct{{[0-9]+}}0 = dpct::get_buffer<double>(odata_2d_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_2d_Z2Z, idata_2d_Z2Z_buf_ct{{[0-9]+}}9, odata_2d_Z2Z_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_2d_Z2D_buf_ct{{[0-9]+}}1 = dpct::get_buffer<double>(idata_2d_Z2D);
  //CHECK-NEXT:if ((void *)idata_2d_Z2D == (void *)odata_2d_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_2d_Z2D, idata_2d_Z2D_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_2d_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_2d_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_2d_Z2D_buf_ct{{[0-9]+}}2 = dpct::get_buffer<double>(odata_2d_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_2d_Z2D, idata_2d_Z2D_buf_ct{{[0-9]+}}1, odata_2d_Z2D_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_2d_D2Z_buf_ct{{[0-9]+}}3 = dpct::get_buffer<double>(idata_2d_D2Z);
  //CHECK-NEXT:if ((void *)idata_2d_D2Z == (void *)odata_2d_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_2d_D2Z, idata_2d_D2Z_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_2d_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_2d_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_2d_D2Z_buf_ct{{[0-9]+}}4 = dpct::get_buffer<double>(odata_2d_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_2d_D2Z, idata_2d_D2Z_buf_ct{{[0-9]+}}3, odata_2d_D2Z_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_3d_C2C_buf_ct{{[0-9]+}}5 = dpct::get_buffer<float>(idata_3d_C2C);
  //CHECK-NEXT:if ((void *)idata_3d_C2C == (void *)odata_3d_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_3d_C2C, idata_3d_C2C_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_3d_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_3d_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_3d_C2C_buf_ct{{[0-9]+}}6 = dpct::get_buffer<float>(odata_3d_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_3d_C2C, idata_3d_C2C_buf_ct{{[0-9]+}}5, odata_3d_C2C_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_3d_C2R_buf_ct{{[0-9]+}}7 = dpct::get_buffer<float>(idata_3d_C2R);
  //CHECK-NEXT:if ((void *)idata_3d_C2R == (void *)odata_3d_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_3d_C2R, idata_3d_C2R_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_3d_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_3d_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_3d_C2R_buf_ct{{[0-9]+}}8 = dpct::get_buffer<float>(odata_3d_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_3d_C2R, idata_3d_C2R_buf_ct{{[0-9]+}}7, odata_3d_C2R_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_3d_R2C_buf_ct{{[0-9]+}}9 = dpct::get_buffer<float>(idata_3d_R2C);
  //CHECK-NEXT:if ((void *)idata_3d_R2C == (void *)odata_3d_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_3d_R2C, idata_3d_R2C_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_3d_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_3d_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_3d_R2C_buf_ct{{[0-9]+}}0 = dpct::get_buffer<float>(odata_3d_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_3d_R2C, idata_3d_R2C_buf_ct{{[0-9]+}}9, odata_3d_R2C_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_3d_Z2Z_buf_ct{{[0-9]+}}1 = dpct::get_buffer<double>(idata_3d_Z2Z);
  //CHECK-NEXT:if ((void *)idata_3d_Z2Z == (void *)odata_3d_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_3d_Z2Z, idata_3d_Z2Z_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_3d_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_3d_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_3d_Z2Z_buf_ct{{[0-9]+}}2 = dpct::get_buffer<double>(odata_3d_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_3d_Z2Z, idata_3d_Z2Z_buf_ct{{[0-9]+}}1, odata_3d_Z2Z_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_3d_Z2D_buf_ct{{[0-9]+}}3 = dpct::get_buffer<double>(idata_3d_Z2D);
  //CHECK-NEXT:if ((void *)idata_3d_Z2D == (void *)odata_3d_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_3d_Z2D, idata_3d_Z2D_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_3d_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_3d_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_3d_Z2D_buf_ct{{[0-9]+}}4 = dpct::get_buffer<double>(odata_3d_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_3d_Z2D, idata_3d_Z2D_buf_ct{{[0-9]+}}3, odata_3d_Z2D_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_3d_D2Z_buf_ct{{[0-9]+}}5 = dpct::get_buffer<double>(idata_3d_D2Z);
  //CHECK-NEXT:if ((void *)idata_3d_D2Z == (void *)odata_3d_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_3d_D2Z, idata_3d_D2Z_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_3d_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_3d_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_3d_D2Z_buf_ct{{[0-9]+}}6 = dpct::get_buffer<double>(odata_3d_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_3d_D2Z, idata_3d_D2Z_buf_ct{{[0-9]+}}5, odata_3d_D2Z_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_many_C2C_buf_ct{{[0-9]+}}7 = dpct::get_buffer<float>(idata_many_C2C);
  //CHECK-NEXT:if ((void *)idata_many_C2C == (void *)odata_many_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_many_C2C, idata_many_C2C_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_many_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_many_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_many_C2C_buf_ct{{[0-9]+}}8 = dpct::get_buffer<float>(odata_many_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_many_C2C, idata_many_C2C_buf_ct{{[0-9]+}}7, odata_many_C2C_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_many_C2R_buf_ct{{[0-9]+}}9 = dpct::get_buffer<float>(idata_many_C2R);
  //CHECK-NEXT:if ((void *)idata_many_C2R == (void *)odata_many_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_many_C2R, idata_many_C2R_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_many_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_many_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_many_C2R_buf_ct{{[0-9]+}}0 = dpct::get_buffer<float>(odata_many_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_many_C2R, idata_many_C2R_buf_ct{{[0-9]+}}9, odata_many_C2R_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_many_R2C_buf_ct{{[0-9]+}}1 = dpct::get_buffer<float>(idata_many_R2C);
  //CHECK-NEXT:if ((void *)idata_many_R2C == (void *)odata_many_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_many_R2C, idata_many_R2C_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_many_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_many_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_many_R2C_buf_ct{{[0-9]+}}2 = dpct::get_buffer<float>(odata_many_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_many_R2C, idata_many_R2C_buf_ct{{[0-9]+}}1, odata_many_R2C_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_many_Z2Z_buf_ct{{[0-9]+}}3 = dpct::get_buffer<double>(idata_many_Z2Z);
  //CHECK-NEXT:if ((void *)idata_many_Z2Z == (void *)odata_many_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_many_Z2Z, idata_many_Z2Z_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_many_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_many_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_many_Z2Z_buf_ct{{[0-9]+}}4 = dpct::get_buffer<double>(odata_many_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_many_Z2Z, idata_many_Z2Z_buf_ct{{[0-9]+}}3, odata_many_Z2Z_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_many_Z2D_buf_ct{{[0-9]+}}5 = dpct::get_buffer<double>(idata_many_Z2D);
  //CHECK-NEXT:if ((void *)idata_many_Z2D == (void *)odata_many_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_many_Z2D, idata_many_Z2D_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_many_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_many_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_many_Z2D_buf_ct{{[0-9]+}}6 = dpct::get_buffer<double>(odata_many_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_many_Z2D, idata_many_Z2D_buf_ct{{[0-9]+}}5, odata_many_Z2D_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_many_D2Z_buf_ct{{[0-9]+}}7 = dpct::get_buffer<double>(idata_many_D2Z);
  //CHECK-NEXT:if ((void *)idata_many_D2Z == (void *)odata_many_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_many_D2Z, idata_many_D2Z_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_many_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_many_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_many_D2Z_buf_ct{{[0-9]+}}8 = dpct::get_buffer<double>(odata_many_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_many_D2Z, idata_many_D2Z_buf_ct{{[0-9]+}}7, odata_many_D2Z_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m1d_C2C_buf_ct{{[0-9]+}}9 = dpct::get_buffer<float>(idata_m1d_C2C);
  //CHECK-NEXT:if ((void *)idata_m1d_C2C == (void *)odata_m1d_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m1d_C2C, idata_m1d_C2C_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m1d_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m1d_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_m1d_C2C_buf_ct{{[0-9]+}}0 = dpct::get_buffer<float>(odata_m1d_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m1d_C2C, idata_m1d_C2C_buf_ct{{[0-9]+}}9, odata_m1d_C2C_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m1d_C2R_buf_ct{{[0-9]+}}1 = dpct::get_buffer<float>(idata_m1d_C2R);
  //CHECK-NEXT:if ((void *)idata_m1d_C2R == (void *)odata_m1d_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m1d_C2R, idata_m1d_C2R_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m1d_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m1d_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_m1d_C2R_buf_ct{{[0-9]+}}2 = dpct::get_buffer<float>(odata_m1d_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m1d_C2R, idata_m1d_C2R_buf_ct{{[0-9]+}}1, odata_m1d_C2R_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m1d_R2C_buf_ct{{[0-9]+}}3 = dpct::get_buffer<float>(idata_m1d_R2C);
  //CHECK-NEXT:if ((void *)idata_m1d_R2C == (void *)odata_m1d_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m1d_R2C, idata_m1d_R2C_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m1d_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m1d_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_m1d_R2C_buf_ct{{[0-9]+}}4 = dpct::get_buffer<float>(odata_m1d_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m1d_R2C, idata_m1d_R2C_buf_ct{{[0-9]+}}3, odata_m1d_R2C_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m1d_Z2Z_buf_ct{{[0-9]+}}5 = dpct::get_buffer<double>(idata_m1d_Z2Z);
  //CHECK-NEXT:if ((void *)idata_m1d_Z2Z == (void *)odata_m1d_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m1d_Z2Z, idata_m1d_Z2Z_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m1d_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m1d_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_m1d_Z2Z_buf_ct{{[0-9]+}}6 = dpct::get_buffer<double>(odata_m1d_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m1d_Z2Z, idata_m1d_Z2Z_buf_ct{{[0-9]+}}5, odata_m1d_Z2Z_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m1d_Z2D_buf_ct{{[0-9]+}}7 = dpct::get_buffer<double>(idata_m1d_Z2D);
  //CHECK-NEXT:if ((void *)idata_m1d_Z2D == (void *)odata_m1d_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m1d_Z2D, idata_m1d_Z2D_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m1d_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m1d_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_m1d_Z2D_buf_ct{{[0-9]+}}8 = dpct::get_buffer<double>(odata_m1d_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m1d_Z2D, idata_m1d_Z2D_buf_ct{{[0-9]+}}7, odata_m1d_Z2D_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m1d_D2Z_buf_ct{{[0-9]+}}9 = dpct::get_buffer<double>(idata_m1d_D2Z);
  //CHECK-NEXT:if ((void *)idata_m1d_D2Z == (void *)odata_m1d_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m1d_D2Z, idata_m1d_D2Z_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m1d_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m1d_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_m1d_D2Z_buf_ct{{[0-9]+}}0 = dpct::get_buffer<double>(odata_m1d_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m1d_D2Z, idata_m1d_D2Z_buf_ct{{[0-9]+}}9, odata_m1d_D2Z_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m2d_C2C_buf_ct{{[0-9]+}}1 = dpct::get_buffer<float>(idata_m2d_C2C);
  //CHECK-NEXT:if ((void *)idata_m2d_C2C == (void *)odata_m2d_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m2d_C2C, idata_m2d_C2C_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m2d_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m2d_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_m2d_C2C_buf_ct{{[0-9]+}}2 = dpct::get_buffer<float>(odata_m2d_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m2d_C2C, idata_m2d_C2C_buf_ct{{[0-9]+}}1, odata_m2d_C2C_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m2d_C2R_buf_ct{{[0-9]+}}3 = dpct::get_buffer<float>(idata_m2d_C2R);
  //CHECK-NEXT:if ((void *)idata_m2d_C2R == (void *)odata_m2d_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m2d_C2R, idata_m2d_C2R_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m2d_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m2d_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_m2d_C2R_buf_ct{{[0-9]+}}4 = dpct::get_buffer<float>(odata_m2d_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m2d_C2R, idata_m2d_C2R_buf_ct{{[0-9]+}}3, odata_m2d_C2R_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m2d_R2C_buf_ct{{[0-9]+}}5 = dpct::get_buffer<float>(idata_m2d_R2C);
  //CHECK-NEXT:if ((void *)idata_m2d_R2C == (void *)odata_m2d_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m2d_R2C, idata_m2d_R2C_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m2d_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m2d_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_m2d_R2C_buf_ct{{[0-9]+}}6 = dpct::get_buffer<float>(odata_m2d_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m2d_R2C, idata_m2d_R2C_buf_ct{{[0-9]+}}5, odata_m2d_R2C_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m2d_Z2Z_buf_ct{{[0-9]+}}7 = dpct::get_buffer<double>(idata_m2d_Z2Z);
  //CHECK-NEXT:if ((void *)idata_m2d_Z2Z == (void *)odata_m2d_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m2d_Z2Z, idata_m2d_Z2Z_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m2d_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m2d_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_m2d_Z2Z_buf_ct{{[0-9]+}}8 = dpct::get_buffer<double>(odata_m2d_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m2d_Z2Z, idata_m2d_Z2Z_buf_ct{{[0-9]+}}7, odata_m2d_Z2Z_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m2d_Z2D_buf_ct{{[0-9]+}}9 = dpct::get_buffer<double>(idata_m2d_Z2D);
  //CHECK-NEXT:if ((void *)idata_m2d_Z2D == (void *)odata_m2d_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m2d_Z2D, idata_m2d_Z2D_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m2d_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m2d_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_m2d_Z2D_buf_ct{{[0-9]+}}0 = dpct::get_buffer<double>(odata_m2d_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m2d_Z2D, idata_m2d_Z2D_buf_ct{{[0-9]+}}9, odata_m2d_Z2D_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m2d_D2Z_buf_ct{{[0-9]+}}1 = dpct::get_buffer<double>(idata_m2d_D2Z);
  //CHECK-NEXT:if ((void *)idata_m2d_D2Z == (void *)odata_m2d_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m2d_D2Z, idata_m2d_D2Z_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m2d_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m2d_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_m2d_D2Z_buf_ct{{[0-9]+}}2 = dpct::get_buffer<double>(odata_m2d_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m2d_D2Z, idata_m2d_D2Z_buf_ct{{[0-9]+}}1, odata_m2d_D2Z_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m3d_C2C_buf_ct{{[0-9]+}}3 = dpct::get_buffer<float>(idata_m3d_C2C);
  //CHECK-NEXT:if ((void *)idata_m3d_C2C == (void *)odata_m3d_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m3d_C2C, idata_m3d_C2C_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m3d_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m3d_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_m3d_C2C_buf_ct{{[0-9]+}}4 = dpct::get_buffer<float>(odata_m3d_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m3d_C2C, idata_m3d_C2C_buf_ct{{[0-9]+}}3, odata_m3d_C2C_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m3d_C2R_buf_ct{{[0-9]+}}5 = dpct::get_buffer<float>(idata_m3d_C2R);
  //CHECK-NEXT:if ((void *)idata_m3d_C2R == (void *)odata_m3d_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m3d_C2R, idata_m3d_C2R_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m3d_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m3d_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_m3d_C2R_buf_ct{{[0-9]+}}6 = dpct::get_buffer<float>(odata_m3d_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m3d_C2R, idata_m3d_C2R_buf_ct{{[0-9]+}}5, odata_m3d_C2R_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m3d_R2C_buf_ct{{[0-9]+}}7 = dpct::get_buffer<float>(idata_m3d_R2C);
  //CHECK-NEXT:if ((void *)idata_m3d_R2C == (void *)odata_m3d_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m3d_R2C, idata_m3d_R2C_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m3d_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m3d_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_m3d_R2C_buf_ct{{[0-9]+}}8 = dpct::get_buffer<float>(odata_m3d_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m3d_R2C, idata_m3d_R2C_buf_ct{{[0-9]+}}7, odata_m3d_R2C_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m3d_Z2Z_buf_ct{{[0-9]+}}9 = dpct::get_buffer<double>(idata_m3d_Z2Z);
  //CHECK-NEXT:if ((void *)idata_m3d_Z2Z == (void *)odata_m3d_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m3d_Z2Z, idata_m3d_Z2Z_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m3d_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m3d_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_m3d_Z2Z_buf_ct{{[0-9]+}}0 = dpct::get_buffer<double>(odata_m3d_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m3d_Z2Z, idata_m3d_Z2Z_buf_ct{{[0-9]+}}9, odata_m3d_Z2Z_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m3d_Z2D_buf_ct{{[0-9]+}}1 = dpct::get_buffer<double>(idata_m3d_Z2D);
  //CHECK-NEXT:if ((void *)idata_m3d_Z2D == (void *)odata_m3d_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m3d_Z2D, idata_m3d_Z2D_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m3d_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m3d_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_m3d_Z2D_buf_ct{{[0-9]+}}2 = dpct::get_buffer<double>(odata_m3d_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_m3d_Z2D, idata_m3d_Z2D_buf_ct{{[0-9]+}}1, odata_m3d_Z2D_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_m3d_D2Z_buf_ct{{[0-9]+}}3 = dpct::get_buffer<double>(idata_m3d_D2Z);
  //CHECK-NEXT:if ((void *)idata_m3d_D2Z == (void *)odata_m3d_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m3d_D2Z, idata_m3d_D2Z_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_m3d_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_m3d_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_m3d_D2Z_buf_ct{{[0-9]+}}4 = dpct::get_buffer<double>(odata_m3d_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_m3d_D2Z, idata_m3d_D2Z_buf_ct{{[0-9]+}}3, odata_m3d_D2Z_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany_C2C_buf_ct{{[0-9]+}}5 = dpct::get_buffer<float>(idata_mmany_C2C);
  //CHECK-NEXT:if ((void *)idata_mmany_C2C == (void *)odata_mmany_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany_C2C, idata_mmany_C2C_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany_C2C_buf_ct{{[0-9]+}}6 = dpct::get_buffer<float>(odata_mmany_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany_C2C, idata_mmany_C2C_buf_ct{{[0-9]+}}5, odata_mmany_C2C_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany_C2R_buf_ct{{[0-9]+}}7 = dpct::get_buffer<float>(idata_mmany_C2R);
  //CHECK-NEXT:if ((void *)idata_mmany_C2R == (void *)odata_mmany_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany_C2R, idata_mmany_C2R_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany_C2R_buf_ct{{[0-9]+}}8 = dpct::get_buffer<float>(odata_mmany_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany_C2R, idata_mmany_C2R_buf_ct{{[0-9]+}}7, odata_mmany_C2R_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany_R2C_buf_ct{{[0-9]+}}9 = dpct::get_buffer<float>(idata_mmany_R2C);
  //CHECK-NEXT:if ((void *)idata_mmany_R2C == (void *)odata_mmany_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany_R2C, idata_mmany_R2C_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany_R2C_buf_ct{{[0-9]+}}0 = dpct::get_buffer<float>(odata_mmany_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany_R2C, idata_mmany_R2C_buf_ct{{[0-9]+}}9, odata_mmany_R2C_buf_ct{{[0-9]+}}0);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany_Z2Z_buf_ct{{[0-9]+}}1 = dpct::get_buffer<double>(idata_mmany_Z2Z);
  //CHECK-NEXT:if ((void *)idata_mmany_Z2Z == (void *)odata_mmany_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany_Z2Z, idata_mmany_Z2Z_buf_ct{{[0-9]+}}1);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany_Z2Z_buf_ct{{[0-9]+}}2 = dpct::get_buffer<double>(odata_mmany_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany_Z2Z, idata_mmany_Z2Z_buf_ct{{[0-9]+}}1, odata_mmany_Z2Z_buf_ct{{[0-9]+}}2);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany_Z2D_buf_ct{{[0-9]+}}3 = dpct::get_buffer<double>(idata_mmany_Z2D);
  //CHECK-NEXT:if ((void *)idata_mmany_Z2D == (void *)odata_mmany_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany_Z2D, idata_mmany_Z2D_buf_ct{{[0-9]+}}3);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany_Z2D_buf_ct{{[0-9]+}}4 = dpct::get_buffer<double>(odata_mmany_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany_Z2D, idata_mmany_Z2D_buf_ct{{[0-9]+}}3, odata_mmany_Z2D_buf_ct{{[0-9]+}}4);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany_D2Z_buf_ct{{[0-9]+}}5 = dpct::get_buffer<double>(idata_mmany_D2Z);
  //CHECK-NEXT:if ((void *)idata_mmany_D2Z == (void *)odata_mmany_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany_D2Z, idata_mmany_D2Z_buf_ct{{[0-9]+}}5);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany_D2Z_buf_ct{{[0-9]+}}6 = dpct::get_buffer<double>(odata_mmany_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany_D2Z, idata_mmany_D2Z_buf_ct{{[0-9]+}}5, odata_mmany_D2Z_buf_ct{{[0-9]+}}6);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany64_C2C_buf_ct{{[0-9]+}}7 = dpct::get_buffer<float>(idata_mmany64_C2C);
  //CHECK-NEXT:if ((void *)idata_mmany64_C2C == (void *)odata_mmany64_C2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany64_C2C, idata_mmany64_C2C_buf_ct{{[0-9]+}}7);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany64_C2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany64_C2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany64_C2C_buf_ct{{[0-9]+}}8 = dpct::get_buffer<float>(odata_mmany64_C2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany64_C2C, idata_mmany64_C2C_buf_ct{{[0-9]+}}7, odata_mmany64_C2C_buf_ct{{[0-9]+}}8);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany64_C2R_buf_ct{{[0-9]+}}9 = dpct::get_buffer<float>(idata_mmany64_C2R);
  //CHECK-NEXT:if ((void *)idata_mmany64_C2R == (void *)odata_mmany64_C2R) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany64_C2R, idata_mmany64_C2R_buf_ct{{[0-9]+}}9);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany64_C2R->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany64_C2R->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany64_C2R_buf_ct{{[0-9]+}}00 = dpct::get_buffer<float>(odata_mmany64_C2R);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany64_C2R, idata_mmany64_C2R_buf_ct{{[0-9]+}}9, odata_mmany64_C2R_buf_ct{{[0-9]+}}00);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany64_R2C_buf_ct{{[0-9]+}}01 = dpct::get_buffer<float>(idata_mmany64_R2C);
  //CHECK-NEXT:if ((void *)idata_mmany64_R2C == (void *)odata_mmany64_R2C) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany64_R2C, idata_mmany64_R2C_buf_ct{{[0-9]+}}01);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany64_R2C->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany64_R2C->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany64_R2C_buf_ct{{[0-9]+}}02 = dpct::get_buffer<float>(odata_mmany64_R2C);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany64_R2C, idata_mmany64_R2C_buf_ct{{[0-9]+}}01, odata_mmany64_R2C_buf_ct{{[0-9]+}}02);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany64_Z2Z_buf_ct{{[0-9]+}}03 = dpct::get_buffer<double>(idata_mmany64_Z2Z);
  //CHECK-NEXT:if ((void *)idata_mmany64_Z2Z == (void *)odata_mmany64_Z2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany64_Z2Z, idata_mmany64_Z2Z_buf_ct{{[0-9]+}}03);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany64_Z2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany64_Z2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany64_Z2Z_buf_ct{{[0-9]+}}04 = dpct::get_buffer<double>(odata_mmany64_Z2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany64_Z2Z, idata_mmany64_Z2Z_buf_ct{{[0-9]+}}03, odata_mmany64_Z2Z_buf_ct{{[0-9]+}}04);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany64_Z2D_buf_ct{{[0-9]+}}05 = dpct::get_buffer<double>(idata_mmany64_Z2D);
  //CHECK-NEXT:if ((void *)idata_mmany64_Z2D == (void *)odata_mmany64_Z2D) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany64_Z2D, idata_mmany64_Z2D_buf_ct{{[0-9]+}}05);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany64_Z2D->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany64_Z2D->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany64_Z2D_buf_ct{{[0-9]+}}06 = dpct::get_buffer<double>(odata_mmany64_Z2D);
  //CHECK-NEXT:oneapi::mkl::dft::compute_backward(*plan_mmany64_Z2D, idata_mmany64_Z2D_buf_ct{{[0-9]+}}05, odata_mmany64_Z2D_buf_ct{{[0-9]+}}06);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
  ...
  //CHECK:{
  //CHECK-NEXT:auto idata_mmany64_D2Z_buf_ct{{[0-9]+}}07 = dpct::get_buffer<double>(idata_mmany64_D2Z);
  //CHECK-NEXT:if ((void *)idata_mmany64_D2Z == (void *)odata_mmany64_D2Z) {
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany64_D2Z, idata_mmany64_D2Z_buf_ct{{[0-9]+}}07);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:plan_mmany64_D2Z->set_value(oneapi::mkl::dft::config_param::PLACEMENT, DFTI_CONFIG_VALUE::DFTI_NOT_INPLACE);
  //CHECK-NEXT:plan_mmany64_D2Z->commit(q_ct1);
  //CHECK-NEXT:auto odata_mmany64_D2Z_buf_ct{{[0-9]+}}08 = dpct::get_buffer<double>(odata_mmany64_D2Z);
  //CHECK-NEXT:oneapi::mkl::dft::compute_forward(*plan_mmany64_D2Z, idata_mmany64_D2Z_buf_ct{{[0-9]+}}07, odata_mmany64_D2Z_buf_ct{{[0-9]+}}08);
  //CHECK-NEXT:}
  //CHECK-NEXT:}
