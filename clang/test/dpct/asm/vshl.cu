...
__global__ void vshl() {
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32);
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  ...
  asm("vshl.s32.s32.u32.warp %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshl.s32.u32.u32.warp %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshl.u32.s32.u32.warp %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  asm("vshl.u32.u32.u32.warp %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.sat.warp %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshl.s32.u32.u32.sat.warp %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshl.u32.s32.u32.sat.warp %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  asm("vshl.u32.u32.u32.sat.warp %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.warp.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.s32.u32.u32.warp.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.s32.u32.warp.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.u32.u32.warp.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.sat.warp.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.s32.u32.u32.sat.warp.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.s32.u32.sat.warp.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.u32.u32.sat.warp.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.warp.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.s32.u32.u32.warp.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.s32.u32.warp.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.u32.u32.warp.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.sat.warp.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.s32.u32.u32.sat.warp.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.s32.u32.sat.warp.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.u32.u32.sat.warp.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.warp.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.s32.u32.u32.warp.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.s32.u32.warp.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.u32.u32.warp.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshl.s32.s32.u32.sat.warp.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.s32.u32.u32.sat.warp.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.s32.u32.sat.warp.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshl.u32.u32.u32.sat.warp.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
}
