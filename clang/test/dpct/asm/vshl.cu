...
__global__ void vshl() {
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32);
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shl_sat_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shl_sat_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
