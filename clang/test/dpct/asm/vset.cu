...
__global__ void vset(unsigned *d) {
  ...
  // CHECK: *d = dpct::extend_compare<int32_t, int32_t>(e, std::equal_to<>());
  // CHECK: *d = dpct::extend_compare<int32_t, int32_t>(e, std::not_equal_to<>());
  // CHECK: *d = dpct::extend_compare<int32_t, int32_t>(e, std::less<>());
  // CHECK: *d = dpct::extend_compare<int32_t, int32_t>(e, std::less_equal<>());
  // CHECK: *d = dpct::extend_compare<int32_t, int32_t>(e, std::greater<>());
  // CHECK: *d = dpct::extend_compare<int32_t, int32_t>(e, std::greater_equal<>());
  ...
  // CHECK: *d = dpct::extend_compare<uint32_t, int32_t>(a, std::equal_to<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, int32_t>(a, std::not_equal_to<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, int32_t>(a, std::less<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, int32_t>(a, std::less_equal<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, int32_t>(a, std::greater<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, int32_t>(a, std::greater_equal<>());
  ...
  // CHECK: *d = dpct::extend_compare<int32_t, uint32_t>(e, std::equal_to<>());
  // CHECK: *d = dpct::extend_compare<int32_t, uint32_t>(e, std::not_equal_to<>());
  // CHECK: *d = dpct::extend_compare<int32_t, uint32_t>(e, std::less<>());
  // CHECK: *d = dpct::extend_compare<int32_t, uint32_t>(e, std::less_equal<>());
  // CHECK: *d = dpct::extend_compare<int32_t, uint32_t>(e, std::greater<>());
  // CHECK: *d = dpct::extend_compare<int32_t, uint32_t>(e, std::greater_equal<>());
  ...
  // CHECK: *d = dpct::extend_compare<uint32_t, uint32_t>(a, std::equal_to<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, uint32_t>(a, std::not_equal_to<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, uint32_t>(a, std::less<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, uint32_t>(a, std::less_equal<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, uint32_t>(a, std::greater<>());
  // CHECK: *d = dpct::extend_compare<uint32_t, uint32_t>(a, std::greater_equal<>());
