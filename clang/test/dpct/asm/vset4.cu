...
__global__ void vset4(unsigned *d) {
  ...
  // CHECK: *d = dpct::extend_vcompare4_add(e, f, a, std::equal_to<>());
  // CHECK: *d = dpct::extend_vcompare4_add(e, f, a, std::not_equal_to<>());
  // CHECK: *d = dpct::extend_vcompare4_add(e, f, a, std::less<>());
  // CHECK: *d = dpct::extend_vcompare4_add(e, f, a, std::less_equal<>());
  // CHECK: *d = dpct::extend_vcompare4_add(e, f, a, std::greater<>());
  // CHECK: *d = dpct::extend_vcompare4_add(e, f, a, std::greater_equal<>());
