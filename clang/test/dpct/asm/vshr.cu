...
__global__ void vshr() {
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32);
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_wrap<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_wrap<uint32_t>(i32, u32, u32, sycl::maximum<>());
  ...
  asm("vshr.s32.s32.u32.wrap %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshr.s32.u32.u32.wrap %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshr.u32.s32.u32.wrap %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  asm("vshr.u32.u32.u32.wrap %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.sat.wrap %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshr.s32.u32.u32.sat.wrap %0, %1, %2;" : "=r"(i32) : "r"(i32), "r"(u32));
  asm("vshr.u32.s32.u32.sat.wrap %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  asm("vshr.u32.u32.u32.sat.wrap %0, %1, %2;" : "=r"(u32) : "r"(i32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.wrap.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.s32.u32.u32.wrap.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.s32.u32.wrap.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.u32.u32.wrap.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.sat.wrap.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.s32.u32.u32.sat.wrap.add %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.s32.u32.sat.wrap.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.u32.u32.sat.wrap.add %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.wrap.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.s32.u32.u32.wrap.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.s32.u32.wrap.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.u32.u32.wrap.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.sat.wrap.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.s32.u32.u32.sat.wrap.min %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.s32.u32.sat.wrap.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.u32.u32.sat.wrap.min %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.wrap.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.s32.u32.u32.wrap.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.s32.u32.wrap.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.u32.u32.wrap.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  ...
  asm("vshr.s32.s32.u32.sat.wrap.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.s32.u32.u32.sat.wrap.max %0, %1, %2, %3;" : "=r"(i32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.s32.u32.sat.wrap.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
  asm("vshr.u32.u32.u32.sat.wrap.max %0, %1, %2, %3;" : "=r"(u32) : "r"(i32), "r"(u32), "r"(u32));
}
