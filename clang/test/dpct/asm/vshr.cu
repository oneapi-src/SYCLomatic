...
__global__ void vshr() {
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_clamp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32);
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32);
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32);
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32, u32, sycl::plus<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32, u32, sycl::minimum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  ...
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_clamp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: i32 = dpct::extend_shr_sat_warp<int32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
  // CHECK-NEXT: u32 = dpct::extend_shr_sat_warp<uint32_t>(i32, u32, u32, sycl::maximum<>());
