...
// CHECK: nvmlInit_v2();
    ...
    char Ver[10];
// CHECK: /*
// CHECK: DPCT1007:2: Migration of this CUDA API is not supported by the Intel(R) DPC++ Compatibility Tool.
// CHECK: */
// CHECK: nvmlSystemGetDriverVersion(Ver, 10);
    ...
    unsigned int dc;
// CHECK: /*
// CHECK: DPCT1007:3: Migration of this CUDA API is not supported by the Intel(R) DPC++ Compatibility Tool.
// CHECK: */
// CHECK: nvmlDeviceGetCount_v2(&dc);
    nvmlDeviceGetCount_v2(&dc);

// CHECK: /*
// CHECK: DPCT1007:4: Migration of this CUDA API is not supported by the Intel(R) DPC++ Compatibility Tool.
// CHECK: */
// CHECK: nvmlShutdown();
    nvmlShutdown();
