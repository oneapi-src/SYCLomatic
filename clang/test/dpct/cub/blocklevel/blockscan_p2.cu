...
//CHECK:  void ExclusiveSumKernel2(int* data) {
//CHECK:    auto item_ct1 = sycl::ext::oneapi::this_work_item::get_nd_item<3>();
...
//CHECK:  void ExclusiveSumKernel3(int* data) {
//CHECK:    auto item_ct1 = sycl::ext::oneapi::this_work_item::get_nd_item<3>();
...
//CHECK:  void InclusiveSumKernel2(int* data) {
...
//CHECK:  void InclusiveSumKernel3(int* data) {
...
int main() {
  ...
  //CHECK:      ExclusiveSumKernel1(dev_data, dev_agg);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      ExclusiveSumKernel2(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      ExclusiveSumKernel3(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      ExclusiveScanKernel1(dev_data, dev_agg);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      ExclusiveScanKernel2(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      ExclusiveScanKernel3(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      InclusiveSumKernel1(dev_data, dev_agg);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      InclusiveSumKernel2(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      InclusiveSumKernel3(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      InclusiveScanKernel1(dev_data, dev_agg);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      InclusiveScanKernel2(dev_data);
  //CHECK:    });
  ...
  //CHECK:    sycl::nd_range<3>(GridSize * BlockSize, BlockSize),
  //CHECK:    [=](sycl::nd_item<3> item_ct1) {
  //CHECK:      InclusiveScanKernel3(dev_data);
  //CHECK:    });
