...
//CHECK-EMPTY:
//CHECK-NEXT:  /*
//CHECK-NEXT:  DPCT1085:{{[0-9]+}}: The function inclusive_scan_over_group requires subgroup size to be 16, while other subgroup function in same DPC++ kernel requires differnt subgroup size. You may need to adjust the code.
//CHECK-NEXT:  */
//CHECK-NEXT:  output = sycl::inclusive_scan_over_group(item_ct1.get_sub_group(), input, sycl::ONEAPI::plus<>());
...
//CHECK-NEXT:  int data;
//CHECK-NEXT:  /*
//CHECK-NEXT:  DPCT1085:{{[0-9]+}}: The function inclusive_scan_over_group requires subgroup size to be 32, while other subgroup function in same DPC++ kernel requires differnt subgroup size. You may need to adjust the code.
//CHECK-NEXT:  */
...
//CHECK-NEXT:  int data;
//CHECK-NEXT:  /*
//CHECK-NEXT:  DPCT1085:{{[0-9]+}}: The function reduce_over_group requires subgroup size to be 16, while other subgroup function in same DPC++ kernel requires differnt subgroup size. You may need to adjust the code.
//CHECK-NEXT:  */
