...
// RUN: %if build_lit %{icpx -c -fsycl %T/devicelevel/device_segmented_sort_keys/device_segmented_sort_keys.dp.cpp -o %T/devicelevel/device_segmented_sort_keys/device_segmented_sort_keys.dp.o %}
