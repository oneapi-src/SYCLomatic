...
// RUN: %if build_lit %{icpx -c -fsycl %T/devicelevel/device_inclusive_sum/device_inclusive_sum.dp.cpp -o %T/devicelevel/device_inclusive_sum/device_inclusive_sum.dp.o %}
