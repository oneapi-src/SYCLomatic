...
// RUN: %if build_lit %{icpx -c -fsycl %T/devicelevel/device_inclusive_scan/device_inclusive_scan.dp.cpp -o %T/devicelevel/device_inclusive_scan/device_inclusive_scan.dp.o %}
