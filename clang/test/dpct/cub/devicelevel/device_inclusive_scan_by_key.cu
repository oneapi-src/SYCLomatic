...
// RUN: %if build_lit %{icpx -c -fsycl -DNO_BUILD_TEST  %T/devicelevel/device_inclusive_scan_by_key/device_inclusive_scan_by_key.dp.cpp -o %T/devicelevel/device_inclusive_scan_by_key/device_inclusive_scan_by_key.dp.o %}
