...
// CHECK-NEXT: out[1] = dpct::read_image_array(tex42, 1.0f, 1.0f, 12);
...
int main() {
  ...
  // CHECK-NEXT: dpct::attach_image(tex21, d_data21, desc21, 32 * sizeof(sycl::uint2));
  // CHECK-NEXT: dpct::attach_image(tex21, d_data21, 32 * sizeof(sycl::uint2));
  // CHECK-NEXT: dpct::attach_image(tex21, d_data21, desc21, 32 * sizeof(sycl::uint2));
  uint2 *d_data21;
