...
// RUN: %if build_lit %{icpx -c -fsycl -DBUILD_TEST  %T/test_inc_inroot_exclude/test_inc_inroot_exclude.dp.cpp -o %T/test_inc_inroot_exclude/test_inc_inroot_exclude.dp.o %}
#ifndef BUILD_TEST
