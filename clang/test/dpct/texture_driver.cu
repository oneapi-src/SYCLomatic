...
void test_texref() {
  ...
  // CHECK: /*
  // CHECK-NEXT: DPCT1074:4: SYCL Image doesn't support some of the flags used in the original code and unsupported flags were ignored. Data read from SYCL Image could not be normalized as specified in the original code.
  // CHECK-NEXT: */
  // CHECK-NEXT: tex->set_coordinate_normalization_mode(flags & 0x02);
  // CHECK-NEXT: /*
  // CHECK-NEXT: DPCT1074:5: SYCL Image doesn't support some of the flags used in the original code and unsupported flags were ignored. Data read from SYCL Image could not be normalized as specified in the original code.
  // CHECK-NEXT: */
