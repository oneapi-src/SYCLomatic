...
// RUN: %if build_lit %{icpx -c -fsycl %T/bar/util.gpu.dp.cpp -o %T/bar/util.gpu.dp.o %}
...
// RUN: %if build_lit %{icpx -c -fsycl %T/bar/util_bar.cc.dp.cpp -o %T/bar/util_bar.cc.dp.o %}
...
// RUN: %if build_lit %{icpx -c -fsycl %T/main.gpu.dp.cpp -o %T/main.gpu.dp.o %}
