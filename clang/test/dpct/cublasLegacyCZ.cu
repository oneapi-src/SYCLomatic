...
int main() {
  ...
  // CHECK-NEXT: mkl::iamax(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, result_temp_buffer);
  ...
  *result = cublasIzamax(n, x_Z, incx);
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: cl::sycl::buffer<int64_t,1> result_temp_buffer(cl::sycl::range<1>(1));
  // CHECK-NEXT: mkl::iamin(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, result_temp_buffer);
  // CHECK-NEXT: *result = result_temp_buffer.get_access<cl::sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  ...
  *result = cublasIzamin(n, x_Z, incx);
  ...
  // CHECK-NEXT: mkl::asum(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, result_temp_buffer);
  ...
  *result_D = cublasDzasum(n, x_Z, incx);
  ...
  // CHECK-NEXT: mkl::dotu(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, result_temp_buffer);
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> result_temp_buffer(cl::sycl::range<1>(1));
  // CHECK-NEXT: mkl::dotc(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, result_temp_buffer);
  ...
  *result_Z = cublasZdotc(n, x_Z, incx, y_Z, incy);
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: cl::sycl::buffer<float,1> result_temp_buffer(cl::sycl::range<1>(1));
  // CHECK-NEXT: mkl::nrm2(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, result_temp_buffer);
  // CHECK-NEXT: *result_S = result_temp_buffer.get_access<cl::sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  ...
  *result_D = cublasDznrm2(n, x_Z, incx);
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::axpy(dpct::get_default_queue(), n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::axpy(dpct::get_default_queue(), n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::copy(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::rot(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, *x_S, *y_S);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::rot(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, *x_D, *y_D);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(x_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::scal(dpct::get_default_queue(), n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(x_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::scal(dpct::get_default_queue(), n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(x_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::scal(dpct::get_default_queue(), n, alpha_S, buffer_ct{{[0-9]+}}, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(x_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::scal(dpct::get_default_queue(), n, alpha_D, buffer_ct{{[0-9]+}}, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::swap(dpct::get_default_queue(), n, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::gbmv(dpct::get_default_queue(), (((transpose_ct0)=='N'||(transpose_ct0)=='n')?(mkl::transpose::nontrans):(((transpose_ct0)=='T'||(transpose_ct0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::gbmv(dpct::get_default_queue(), (((transpose_ct0)=='N'||(transpose_ct0)=='n')?(mkl::transpose::nontrans):(((transpose_ct0)=='T'||(transpose_ct0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::gemv(dpct::get_default_queue(), (((transpose_ct0)=='N'||(transpose_ct0)=='n')?(mkl::transpose::nontrans):(((transpose_ct0)=='T'||(transpose_ct0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::gemv(dpct::get_default_queue(), (((transpose_ct0)=='N'||(transpose_ct0)=='n')?(mkl::transpose::nontrans):(((transpose_ct0)=='T'||(transpose_ct0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::geru(dpct::get_default_queue(), m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::gerc(dpct::get_default_queue(), m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::geru(dpct::get_default_queue(), m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::gerc(dpct::get_default_queue(), m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::tbsv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct1)=='N'||(transpose_ct1)=='n')?(mkl::transpose::nontrans):(((transpose_ct1)=='T'||(transpose_ct1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct2)=='N'||(diagtype_ct2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, n, buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::tpsv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct1)=='N'||(transpose_ct1)=='n')?(mkl::transpose::nontrans):(((transpose_ct1)=='T'||(transpose_ct1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct2)=='N'||(diagtype_ct2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, buffer_ct{{[0-9]+}}, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(result_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::trsv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct1)=='N'||(transpose_ct1)=='n')?(mkl::transpose::nontrans):(((transpose_ct1)=='T'||(transpose_ct1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((diagtype_ct2)=='N'||(diagtype_ct2)=='n')?(mkl::diag::nonunit):(mkl::diag::unit)), n, buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::hemv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::hemv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::hbmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, k, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::hbmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, k, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, incx, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::hpmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, buffer_ct{{[0-9]+}}, incx, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(y_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::hpmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, buffer_ct{{[0-9]+}}, incx, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::her(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::her(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::her2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::her2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::hpr(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::hpr(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::hpr2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::hpr2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, incx, buffer_ct{{[0-9]+}}, incy, buffer_ct{{[0-9]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::gemm(dpct::get_default_queue(), (((transpose_ct0)=='N'||(transpose_ct0)=='n')?(mkl::transpose::nontrans):(((transpose_ct0)=='T'||(transpose_ct0)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), (((transpose_ct1)=='N'||(transpose_ct1)=='n')?(mkl::transpose::nontrans):(((transpose_ct1)=='T'||(transpose_ct1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), m, n, k, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, ldb, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::symm(dpct::get_default_queue(), (((sidemode_ct0)=='L'||(sidemode_ct0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct1)=='L'||(fillmode_ct1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, ldb, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::symm(dpct::get_default_queue(), (((sidemode_ct0)=='L'||(sidemode_ct0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct1)=='L'||(fillmode_ct1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, ldb, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::herk(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct1)=='N'||(transpose_ct1)=='n')?(mkl::transpose::nontrans):(((transpose_ct1)=='T'||(transpose_ct1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, k, alpha_S, buffer_ct{{[0-9]+}}, lda, beta_S, buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::herk(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), (((transpose_ct1)=='N'||(transpose_ct1)=='n')?(mkl::transpose::nontrans):(((transpose_ct1)=='T'||(transpose_ct1)=='t')?(mkl::transpose::nontrans):(mkl::transpose::conjtrans))), n, k, alpha_D, buffer_ct{{[0-9]+}}, lda, beta_D, buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_C);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<float>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<float>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<float>)));
  // CHECK-NEXT: mkl::hemm(dpct::get_default_queue(), (((sidemode_ct0)=='L'||(sidemode_ct0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct1)=='L'||(fillmode_ct1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, std::complex<float>((alpha_C).x(),(alpha_C).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, ldb, std::complex<float>((beta_C).x(),(beta_C).y()), buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto allocation_ct{{[0-9]+}} = dpct::memory_manager::get_instance().translate_ptr(C_Z);
  // CHECK-NEXT: cl::sycl::buffer<std::complex<double>,1> buffer_ct{{[0-9]+}} = allocation_ct{{[0-9]+}}.buffer.reinterpret<std::complex<double>, 1>(cl::sycl::range<1>(allocation_ct{{[0-9]+}}.size/sizeof(std::complex<double>)));
  // CHECK-NEXT: mkl::hemm(dpct::get_default_queue(), (((sidemode_ct0)=='L'||(sidemode_ct0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct1)=='L'||(fillmode_ct1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, std::complex<double>((alpha_Z).x(),(alpha_Z).y()), buffer_ct{{[0-9]+}}, lda, buffer_ct{{[0-9]+}}, ldb, std::complex<double>((beta_Z).x(),(beta_Z).y()), buffer_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
