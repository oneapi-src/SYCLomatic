...
int main() {
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::iamax(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  ...
  // CHECK-NEXT: sycl::buffer<int64_t> res_temp_buf_ct{{[0-9]+}}(sycl::range<1>(1));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::iamax(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  ...
  *result = cublasIzamax(n, x_Z, incx);
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: sycl::buffer<int64_t> res_temp_buf_ct{{[0-9]+}}(sycl::range<1>(1));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::iamin(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  // CHECK-NEXT: *result = res_temp_buf_ct{{[0-9]+}}.get_access<sycl::access_mode::read>()[0];
  // CHECK-NEXT: }
  *result = cublasIcamin(n, x_C, incx);
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: sycl::buffer<int64_t> res_temp_buf_ct{{[0-9]+}}(sycl::range<1>(1));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::iamin(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  // CHECK-NEXT: *result = res_temp_buf_ct{{[0-9]+}}.get_access<sycl::access_mode::read>()[0];
  // CHECK-NEXT: }
  *result = cublasIzamin(n, x_Z, incx);
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::asum(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  ...
  *result_S = cublasScasum(n, x_C, incx);
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::asum(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  ...
  *result_Z = cublasZdotc(n, x_Z, incx, y_Z, incy);
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: sycl::buffer<float> res_temp_buf_ct{{[0-9]+}}(sycl::range<1>(1));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::nrm2(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  // CHECK-NEXT: *result_S = res_temp_buf_ct{{[0-9]+}}.get_access<sycl::access_mode::read>()[0];
  // CHECK-NEXT: }
  *result_S = cublasScnrm2(n, x_C, incx);
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: sycl::buffer<double> res_temp_buf_ct{{[0-9]+}}(sycl::range<1>(1));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::nrm2(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, res_temp_buf_ct{{[0-9]+}});
  // CHECK-NEXT: *result_D = res_temp_buf_ct{{[0-9]+}}.get_access<sycl::access_mode::read>()[0];
  // CHECK-NEXT: }
  *result_D = cublasDznrm2(n, x_Z, incx);
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::copy(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::copy(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto y_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(y_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::rot(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, y_C_buf_ct{{[0-9]+}}, incy, *x_S, *y_S);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto y_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(y_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::rot(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, y_Z_buf_ct{{[0-9]+}}, incy, *x_D, *y_D);
  // CHECK-NEXT: }
  ...
  // CHECK: {
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::scal(*dpct::get_current_device().get_saved_queue(), n, alpha_S, x_C_buf_ct{{[0-9]+}}, incx);
  // CHECK-NEXT: }
  cublasCsscal(n, alpha_S, x_C, incx);

  // CHECK: {
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::scal(*dpct::get_current_device().get_saved_queue(), n, alpha_D, x_Z_buf_ct{{[0-9]+}}, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto y_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(y_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::swap(*dpct::get_current_device().get_saved_queue(), n, x_C_buf_ct{{[0-9]+}}, incx, y_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto y_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(y_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::swap(*dpct::get_current_device().get_saved_queue(), n, x_Z_buf_ct{{[0-9]+}}, incx, y_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tbmv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, n, x_C_buf_ct{{[0-9]+}}, lda, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tbmv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, n, x_Z_buf_ct{{[0-9]+}}, lda, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tbsv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::lower, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, n, x_C_buf_ct{{[0-9]+}}, lda, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tbsv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::lower, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, n, x_Z_buf_ct{{[0-9]+}}, lda, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tpmv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_C_buf_ct{{[0-9]+}}, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tpmv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_Z_buf_ct{{[0-9]+}}, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tpsv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_C_buf_ct{{[0-9]+}}, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::tpsv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_Z_buf_ct{{[0-9]+}}, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::trmv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_C_buf_ct{{[0-9]+}}, lda, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::trmv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_Z_buf_ct{{[0-9]+}}, lda, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto result_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(result_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::trsv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_C_buf_ct{{[0-9]+}}, lda, result_C_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto result_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(result_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::trsv(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::unit, n, x_Z_buf_ct{{[0-9]+}}, lda, result_Z_buf_ct{{[0-9]+}}, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::her(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, n, alpha_S, x_C_buf_ct{{[0-9]+}}, incx, C_C_buf_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::her(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, n, alpha_D, x_Z_buf_ct{{[0-9]+}}, incx, C_Z_buf_ct{{[0-9]+}}, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(x_C);
  // CHECK-NEXT: auto C_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(C_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::hpr(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, n, alpha_S, x_C_buf_ct{{[0-9]+}}, incx, C_C_buf_ct{{[0-9]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(x_Z);
  // CHECK-NEXT: auto C_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(C_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::hpr(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, n, alpha_D, x_Z_buf_ct{{[0-9]+}}, incx, C_Z_buf_ct{{[0-9]+}});
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto A_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(A_C);
  // CHECK-NEXT: auto C_C_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<float>>(C_C);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::herk(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::trans, n, k, alpha_S, A_C_buf_ct{{[0-9]+}}, lda, beta_S, C_C_buf_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto A_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(A_Z);
  // CHECK-NEXT: auto C_Z_buf_ct{{[0-9]+}} = dpct::get_buffer<std::complex<double>>(C_Z);
  // CHECK-NEXT: oneapi::mkl::blas::column_major::herk(*dpct::get_current_device().get_saved_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::trans, n, k, alpha_D, A_Z_buf_ct{{[0-9]+}}, lda, beta_D, C_Z_buf_ct{{[0-9]+}}, ldc);
  // CHECK-NEXT: }
