...
__global__ void kernel8() {
  ...
  int srcLane;
  // CHECK: /*
  // CHECK-NEXT: DPCT1023:{{[0-9]+}}: The SYCL sub-group does not support mask options for dpct::select_from_sub_group. You can specify "--use-experimental-features=masked_sub_group_function" to use the dpct experimental helper function to migrate __shfl_sync.
  // CHECK-NEXT: */
  // CHECK-NEXT: /*
...
__global__ void kernel11() {
  ...
  unsigned delta;
  // CHECK: /*
  // CHECK-NEXT:DPCT1023:{{[0-9]+}}: The SYCL sub-group does not support mask options for dpct::shift_sub_group_right. You can specify "--use-experimental-features=masked_sub_group_function" to use the dpct experimental helper function to migrate __shfl_up_sync.
  // CHECK-NEXT: */
...
__global__ void kernel14() {
  ...
  unsigned delta;
  // CHECK: /*
  // CHECK-NEXT: DPCT1023:{{[0-9]+}}: The SYCL sub-group does not support mask options for dpct::shift_sub_group_left. You can specify "--use-experimental-features=masked_sub_group_function" to use the dpct experimental helper function to migrate __shfl_down_sync.
  // CHECK-NEXT: */
...
__global__ void kernel17() {
  ...
  int laneMask;
  // CHECK: /*
  // CHECK-NEXT: DPCT1023:{{[0-9]+}}: The SYCL sub-group does not support mask options for dpct::permute_sub_group_by_xor. You can specify "--use-experimental-features=masked_sub_group_function" to use the dpct experimental helper function to migrate __shfl_xor_sync.
  // CHECK-NEXT: */
