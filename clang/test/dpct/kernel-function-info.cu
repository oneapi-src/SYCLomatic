...
void getTemplateFuncAttrs()
{
  ...
  //CHECK: CHECK_SYCL_ERROR(dpct::get_kernel_function_info(&attrs, (const void *)testTemplateKernel<T>));
...
void getFuncAttrs()
{
  ...
  //CHECK: CHECK_SYCL_ERROR(dpct::get_kernel_function_info(&attrs, (const void *)testKernel));
