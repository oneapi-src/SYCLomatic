...
//CHECK-NEXT:     sycl::accessor<uint8_t, 1, sycl::access::mode::read_write, sycl::access::target::local> dpct_local_acc_ct1(sycl::range<1>(localMemSize), cgh);
...
//CHECK-NEXT:       [&](sycl::handler &cgh) {
//CHECK-NEXT:         sycl::accessor<uint8_t, 1, sycl::access::mode::read_write, sycl::access::target::local> dpct_local_acc_ct1(sycl::range<1>(0), cgh);
