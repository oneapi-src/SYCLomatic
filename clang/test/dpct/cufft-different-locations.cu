...
int main() {
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:int res2 = (plan1->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0);
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:res2 = (plan2->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0);
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:HANDLE_CUFFT_ERROR((plan3->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0));
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:if ((plan4->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0)) {
  //CHECK-NEXT:/*
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:} else if((plan5->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0)) {
  //CHECK-NEXT:}
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:if(int res = (plan6->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0)) {
  //CHECK-NEXT:}
  ...
  //CHECK:for (plan7->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward);;) {
  //CHECK-NEXT:}
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:for (;(plan8->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0);) {
  //CHECK-NEXT:}
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:while ((plan9->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0) != 0) {
  //CHECK-NEXT:}
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:} while ((plan10->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0));
  do {
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:switch (int stat = (plan11->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0)){
  //CHECK-NEXT:}
...
cufftResult foo2(cufftHandle plan) {
  ...
  //CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You may need to rewrite this code.
  //CHECK-NEXT:*/
  //CHECK-NEXT:return (plan->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward), 0);
...
cufftResult foo4(cufftHandle plan) {
  //CHECK:plan->compute<sycl::mdouble2, double>(idata, odata, dpct::fft::fft_direction::backward);
