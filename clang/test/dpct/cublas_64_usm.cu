...
void foo() {
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::gemm(handle->get_queue(), transa, transb, m, n, k, dpct::get_value(alpha_s, handle->get_queue()), A_s, lda, B_s, ldb, dpct::get_value(beta_s, handle->get_queue()), C_s, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::gemm(handle->get_queue(), transa, transb, m, n, k, dpct::get_value(alpha_d, handle->get_queue()), A_d, lda, B_d, ldb, dpct::get_value(beta_d, handle->get_queue()), C_d, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::gemm(handle->get_queue(), transa, transb, m, n, k, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, (std::complex<float>*)B_c, ldb, dpct::get_value(beta_c, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::gemm(handle->get_queue(), transa, transb, m, n, k, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, (std::complex<double>*)B_z, ldb, dpct::get_value(beta_z, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syrk(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_s, handle->get_queue()), A_s, lda, dpct::get_value(beta_s, handle->get_queue()), C_s, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syrk(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_d, handle->get_queue()), A_d, lda, dpct::get_value(beta_d, handle->get_queue()), C_d, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syrk(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, dpct::get_value(beta_c, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syrk(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, dpct::get_value(beta_z, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::symm(handle->get_queue(), side, uplo, m, n, dpct::get_value(alpha_s, handle->get_queue()), A_s, lda, B_s, ldb, dpct::get_value(beta_s, handle->get_queue()), C_s, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::symm(handle->get_queue(), side, uplo, m, n, dpct::get_value(alpha_d, handle->get_queue()), A_d, lda, B_d, ldb, dpct::get_value(beta_d, handle->get_queue()), C_d, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::symm(handle->get_queue(), side, uplo, m, n, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, (std::complex<float>*)B_c, ldb, dpct::get_value(beta_c, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::symm(handle->get_queue(), side, uplo, m, n, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, (std::complex<double>*)B_z, ldb, dpct::get_value(beta_z, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::trsm(handle->get_queue(), side, uplo, transa, diag, m, n, dpct::get_value(alpha_s, handle->get_queue()), A_s, lda, C_s, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::trsm(handle->get_queue(), side, uplo, transa, diag, m, n, dpct::get_value(alpha_d, handle->get_queue()), A_d, lda, C_d, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::trsm(handle->get_queue(), side, uplo, transa, diag, m, n, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::trsm(handle->get_queue(), side, uplo, transa, diag, m, n, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::hemm(handle->get_queue(), side, uplo, m, n, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, (std::complex<float>*)B_c, ldb, dpct::get_value(beta_c, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::hemm(handle->get_queue(), side, uplo, m, n, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, (std::complex<double>*)B_z, ldb, dpct::get_value(beta_z, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::herk(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_s, handle->get_queue()), (std::complex<float>*)A_c, lda, dpct::get_value(beta_s, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::herk(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_d, handle->get_queue()), (std::complex<double>*)A_z, lda, dpct::get_value(beta_d, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syr2k(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_s, handle->get_queue()), A_s, lda, B_s, ldb, dpct::get_value(beta_s, handle->get_queue()), C_s, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syr2k(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_d, handle->get_queue()), A_d, lda, B_d, ldb, dpct::get_value(beta_d, handle->get_queue()), C_d, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syr2k(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, (std::complex<float>*)B_c, ldb, dpct::get_value(beta_c, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syr2k(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, (std::complex<double>*)B_z, ldb, dpct::get_value(beta_z, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  ...
  //      CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::her2k(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_c, handle->get_queue()), (std::complex<float>*)A_c, lda, (std::complex<float>*)B_c, ldb, dpct::get_value(beta_s, handle->get_queue()), (std::complex<float>*)C_c, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
  // CHECK-NEXT: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::her2k(handle->get_queue(), uplo, transa, n, k, dpct::get_value(alpha_z, handle->get_queue()), (std::complex<double>*)A_z, lda, (std::complex<double>*)B_z, ldb, dpct::get_value(beta_d, handle->get_queue()), (std::complex<double>*)C_z, ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), true)));
