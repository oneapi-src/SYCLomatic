...
// CHECK: void func3_longlong2(sycl::vec<long long, 2> a, sycl::vec<long long, 2> b, sycl::vec<long long, 2> c) {
void func3_longlong2(longlong2 a, longlong2 b, longlong2 c) {
}
// CHECK: void func_longlong2(sycl::vec<long long, 2> a) {
void func_longlong2(longlong2 a) {
}
// CHECK: void kernel_longlong2(sycl::vec<long long, 2> *a, sycl::vec<long long, 2> *b) {
__global__ void kernel_longlong2(longlong2 *a, longlong2 *b) {
}

int main_longlong2() {
  // range default constructor does the right thing.
  // CHECK: sycl::vec<long long, 2> longlong2_a;
  longlong2 longlong2_a;
  // CHECK: sycl::vec<long long, 2> longlong2_b = sycl::vec<long long, 2>(1, 2);
  longlong2 longlong2_b = make_longlong2(1, 2);
  // CHECK: sycl::vec<long long, 2> longlong2_c = sycl::vec<long long, 2>(longlong2_b);
  longlong2 longlong2_c = longlong2(longlong2_b);
  // CHECK: sycl::vec<long long, 2> longlong2_d(longlong2_c);
  longlong2 longlong2_d(longlong2_c);
  // CHECK: func3_longlong2(longlong2_b, sycl::vec<long long, 2>(longlong2_b), (sycl::vec<long long, 2>)longlong2_b);
  func3_longlong2(longlong2_b, longlong2(longlong2_b), (longlong2)longlong2_b);
  // CHECK: sycl::vec<long long, 2> *longlong2_e;
  longlong2 *longlong2_e;
  // CHECK: sycl::vec<long long, 2> *longlong2_f;
  ...
  // CHECK: sycl::vec<long long, 2> longlong2_h[16];
  longlong2 longlong2_h[16];
  // CHECK: sycl::vec<long long, 2> longlong2_i[32];
  longlong2 longlong2_i[32];
  // CHECK: if (longlong2_h[12].x() == longlong2_i[12].x()) {}
  if (longlong2_h[12].x == longlong2_i[12].x) {}
  // CHECK: longlong2_f = (sycl::vec<long long, 2> *)longlong2_i;
  longlong2_f = (longlong2 *)longlong2_i;
  // CHECK: longlong2_a = (sycl::vec<long long, 2>)longlong2_c;
  longlong2_a = (longlong2)longlong2_c;
  // CHECK: longlong2_b = sycl::vec<long long, 2>(longlong2_b);
  longlong2_b = longlong2(longlong2_b);
  // CHECK: sycl::vec<long long, 2> longlong2_j, longlong2_k, longlong2_l, longlong2_m[16], *longlong2_n[32];
  longlong2 longlong2_j, longlong2_k, longlong2_l, longlong2_m[16], *longlong2_n[32];
  // CHECK: int longlong2_o = sizeof(sycl::vec<long long, 2>);
  ...
  // CHECK: dpct::get_out_of_order_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<long long, 2> *> longlong2_e_acc_ct0(longlong2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<long long, 2> *> longlong2_cast_acc_ct1((sycl::vec<long long, 2> *)longlong2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::vec<long long, 2> longlong2_r = (sycl::vec<long long, 2>){1,1};
  // CHECK-NEXT: auto longlong2_s = (sycl::vec<long long, 2>){1,1};
  longlong2 longlong2_r = (longlong2){1,1};
  auto longlong2_s = (longlong2){1,1};
  return 0;
}

// CHECK: void func3_longlong3(sycl::vec<long long, 3> a, sycl::vec<long long, 3> b, sycl::vec<long long, 3> c) {
void func3_longlong3(longlong3 a, longlong3 b, longlong3 c) {
}
// CHECK: void func_longlong3(sycl::vec<long long, 3> a) {
void func_longlong3(longlong3 a) {
}
// CHECK: void kernel_longlong3(sycl::vec<long long, 3> *a, sycl::vec<long long, 3> *b) {
__global__ void kernel_longlong3(longlong3 *a, longlong3 *b) {
}

int main_longlong3() {
  // range default constructor does the right thing.
  // CHECK: sycl::vec<long long, 3> longlong3_a;
  longlong3 longlong3_a;
  // CHECK: sycl::vec<long long, 3> longlong3_b = sycl::vec<long long, 3>(1, 2, 3);
  longlong3 longlong3_b = make_longlong3(1, 2, 3);
  // CHECK: sycl::vec<long long, 3> longlong3_c = sycl::vec<long long, 3>(longlong3_b);
  longlong3 longlong3_c = longlong3(longlong3_b);
  // CHECK: sycl::vec<long long, 3> longlong3_d(longlong3_c);
  longlong3 longlong3_d(longlong3_c);
  // CHECK: func3_longlong3(longlong3_b, sycl::vec<long long, 3>(longlong3_b), (sycl::vec<long long, 3>)longlong3_b);
  func3_longlong3(longlong3_b, longlong3(longlong3_b), (longlong3)longlong3_b);
  // CHECK: sycl::vec<long long, 3> *longlong3_e;
  longlong3 *longlong3_e;
  // CHECK: sycl::vec<long long, 3> *longlong3_f;
  ...
  // CHECK: sycl::vec<long long, 3> longlong3_h[16];
  longlong3 longlong3_h[16];
  // CHECK: sycl::vec<long long, 3> longlong3_i[32];
  longlong3 longlong3_i[32];
  // CHECK: if (longlong3_h[12].x() == longlong3_i[12].x()) {}
  if (longlong3_h[12].x == longlong3_i[12].x) {}
  // CHECK: longlong3_f = (sycl::vec<long long, 3> *)longlong3_i;
  longlong3_f = (longlong3 *)longlong3_i;
  // CHECK: longlong3_a = (sycl::vec<long long, 3>)longlong3_c;
  longlong3_a = (longlong3)longlong3_c;
  // CHECK: longlong3_b = sycl::vec<long long, 3>(longlong3_b);
  longlong3_b = longlong3(longlong3_b);
  // CHECK: sycl::vec<long long, 3> longlong3_j, longlong3_k, longlong3_l, longlong3_m[16], *longlong3_n[32];
  longlong3 longlong3_j, longlong3_k, longlong3_l, longlong3_m[16], *longlong3_n[32];
  // CHECK: int longlong3_o = sizeof(sycl::vec<long long, 3>);
  ...
  // CHECK: dpct::get_out_of_order_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<long long, 3> *> longlong3_e_acc_ct0(longlong3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<long long, 3> *> longlong3_cast_acc_ct1((sycl::vec<long long, 3> *)longlong3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::vec<long long, 3> longlong3_r = (sycl::vec<long long, 3>){1,1,1};
  // CHECK-NEXT: auto longlong3_s = (sycl::vec<long long, 3>){1,1,1};
  longlong3 longlong3_r = (longlong3){1,1,1};
  auto longlong3_s = (longlong3){1,1,1};
  return 0;
}

// CHECK: void func3_longlong4(sycl::vec<long long, 4> a, sycl::vec<long long, 4> b, sycl::vec<long long, 4> c) {
void func3_longlong4(longlong4 a, longlong4 b, longlong4 c) {
}
// CHECK: void func_longlong4(sycl::vec<long long, 4> a) {
void func_longlong4(longlong4 a) {
}
// CHECK: void kernel_longlong4(sycl::vec<long long, 4> *a, sycl::vec<long long, 4> *b) {
__global__ void kernel_longlong4(longlong4 *a, longlong4 *b) {
}

int main_longlong4() {
  // range default constructor does the right thing.
  // CHECK: sycl::vec<long long, 4> longlong4_a;
  longlong4 longlong4_a;
  // CHECK: sycl::vec<long long, 4> longlong4_b = sycl::vec<long long, 4>(1, 2, 3, 4);
  longlong4 longlong4_b = make_longlong4(1, 2, 3, 4);
  // CHECK: sycl::vec<long long, 4> longlong4_c = sycl::vec<long long, 4>(longlong4_b);
  longlong4 longlong4_c = longlong4(longlong4_b);
  // CHECK: sycl::vec<long long, 4> longlong4_d(longlong4_c);
  longlong4 longlong4_d(longlong4_c);
  // CHECK: func3_longlong4(longlong4_b, sycl::vec<long long, 4>(longlong4_b), (sycl::vec<long long, 4>)longlong4_b);
  func3_longlong4(longlong4_b, longlong4(longlong4_b), (longlong4)longlong4_b);
  // CHECK: sycl::vec<long long, 4> *longlong4_e;
  longlong4 *longlong4_e;
  // CHECK: sycl::vec<long long, 4> *longlong4_f;
  ...
  // CHECK: sycl::vec<long long, 4> longlong4_h[16];
  longlong4 longlong4_h[16];
  // CHECK: sycl::vec<long long, 4> longlong4_i[32];
  longlong4 longlong4_i[32];
  // CHECK: if (longlong4_h[12].x() == longlong4_i[12].x()) {}
  if (longlong4_h[12].x == longlong4_i[12].x) {}
  // CHECK: longlong4_f = (sycl::vec<long long, 4> *)longlong4_i;
  longlong4_f = (longlong4 *)longlong4_i;
  // CHECK: longlong4_a = (sycl::vec<long long, 4>)longlong4_c;
  longlong4_a = (longlong4)longlong4_c;
  // CHECK: longlong4_b = sycl::vec<long long, 4>(longlong4_b);
  longlong4_b = longlong4(longlong4_b);
  // CHECK: sycl::vec<long long, 4> longlong4_j, longlong4_k, longlong4_l, longlong4_m[16], *longlong4_n[32];
  longlong4 longlong4_j, longlong4_k, longlong4_l, longlong4_m[16], *longlong4_n[32];
  // CHECK: int longlong4_o = sizeof(sycl::vec<long long, 4>);
  ...
  // CHECK: dpct::get_out_of_order_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<long long, 4> *> longlong4_e_acc_ct0(longlong4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<long long, 4> *> longlong4_cast_acc_ct1((sycl::vec<long long, 4> *)longlong4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::vec<long long, 4> longlong4_r = (sycl::vec<long long, 4>){1,1,1,1};
  // CHECK-NEXT: auto longlong4_s = (sycl::vec<long long, 4>){1,1,1,1};
...
// CHECK: void func3_ulonglong2(sycl::vec<unsigned long long, 2> a, sycl::vec<unsigned long long, 2> b, sycl::vec<unsigned long long, 2> c) {
void func3_ulonglong2(ulonglong2 a, ulonglong2 b, ulonglong2 c) {
}
// CHECK: void func_ulonglong2(sycl::vec<unsigned long long, 2> a) {
void func_ulonglong2(ulonglong2 a) {
}
// CHECK: void kernel_ulonglong2(sycl::vec<unsigned long long, 2> *a, sycl::vec<unsigned long long, 2> *b) {
__global__ void kernel_ulonglong2(ulonglong2 *a, ulonglong2 *b) {
}

int main_ulonglong2() {
  // range default constructor does the right thing.
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_a;
  ulonglong2 ulonglong2_a;
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_b = sycl::vec<unsigned long long, 2>(1, 2);
  ulonglong2 ulonglong2_b = make_ulonglong2(1, 2);
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_c = sycl::vec<unsigned long long, 2>(ulonglong2_b);
  ulonglong2 ulonglong2_c = ulonglong2(ulonglong2_b);
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_d(ulonglong2_c);
  ulonglong2 ulonglong2_d(ulonglong2_c);
  // CHECK: func3_ulonglong2(ulonglong2_b, sycl::vec<unsigned long long, 2>(ulonglong2_b), (sycl::vec<unsigned long long, 2>)ulonglong2_b);
  func3_ulonglong2(ulonglong2_b, ulonglong2(ulonglong2_b), (ulonglong2)ulonglong2_b);
  // CHECK: sycl::vec<unsigned long long, 2> *ulonglong2_e;
  ulonglong2 *ulonglong2_e;
  // CHECK: sycl::vec<unsigned long long, 2> *ulonglong2_f;
  ...
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_h[16];
  ulonglong2 ulonglong2_h[16];
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_i[32];
  ulonglong2 ulonglong2_i[32];
  // CHECK: if (ulonglong2_h[12].x() == ulonglong2_i[12].x()) {}
  if (ulonglong2_h[12].x == ulonglong2_i[12].x) {}
  // CHECK: ulonglong2_f = (sycl::vec<unsigned long long, 2> *)ulonglong2_i;
  ulonglong2_f = (ulonglong2 *)ulonglong2_i;
  // CHECK: ulonglong2_a = (sycl::vec<unsigned long long, 2>)ulonglong2_c;
  ulonglong2_a = (ulonglong2)ulonglong2_c;
  // CHECK: ulonglong2_b = sycl::vec<unsigned long long, 2>(ulonglong2_b);
  ulonglong2_b = ulonglong2(ulonglong2_b);
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_j, ulonglong2_k, ulonglong2_l, ulonglong2_m[16], *ulonglong2_n[32];
  ulonglong2 ulonglong2_j, ulonglong2_k, ulonglong2_l, ulonglong2_m[16], *ulonglong2_n[32];
  // CHECK: int ulonglong2_o = sizeof(sycl::vec<unsigned long long, 2>);
  ...
  // CHECK: dpct::get_out_of_order_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<unsigned long long, 2> *> ulonglong2_e_acc_ct0(ulonglong2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<unsigned long long, 2> *> ulonglong2_cast_acc_ct1((sycl::vec<unsigned long long, 2> *)ulonglong2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::vec<unsigned long long, 2> ulonglong2_r = (sycl::vec<unsigned long long, 2>){1,1};
  // CHECK-NEXT: auto ulonglong2_s = (sycl::vec<unsigned long long, 2>){1,1};
  ulonglong2 ulonglong2_r = (ulonglong2){1,1};
  auto ulonglong2_s = (ulonglong2){1,1};
  return 0;
}

// CHECK: void func3_ulonglong3(sycl::vec<unsigned long long, 3> a, sycl::vec<unsigned long long, 3> b, sycl::vec<unsigned long long, 3> c) {
void func3_ulonglong3(ulonglong3 a, ulonglong3 b, ulonglong3 c) {
}
// CHECK: void func_ulonglong3(sycl::vec<unsigned long long, 3> a) {
void func_ulonglong3(ulonglong3 a) {
}
// CHECK: void kernel_ulonglong3(sycl::vec<unsigned long long, 3> *a, sycl::vec<unsigned long long, 3> *b) {
__global__ void kernel_ulonglong3(ulonglong3 *a, ulonglong3 *b) {
}

int main_ulonglong3() {
  // range default constructor does the right thing.
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_a;
  ulonglong3 ulonglong3_a;
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_b = sycl::vec<unsigned long long, 3>(1, 2, 3);
  ulonglong3 ulonglong3_b = make_ulonglong3(1, 2, 3);
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_c = sycl::vec<unsigned long long, 3>(ulonglong3_b);
  ulonglong3 ulonglong3_c = ulonglong3(ulonglong3_b);
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_d(ulonglong3_c);
  ulonglong3 ulonglong3_d(ulonglong3_c);
  // CHECK: func3_ulonglong3(ulonglong3_b, sycl::vec<unsigned long long, 3>(ulonglong3_b), (sycl::vec<unsigned long long, 3>)ulonglong3_b);
  func3_ulonglong3(ulonglong3_b, ulonglong3(ulonglong3_b), (ulonglong3)ulonglong3_b);
  // CHECK: sycl::vec<unsigned long long, 3> *ulonglong3_e;
  ulonglong3 *ulonglong3_e;
  // CHECK: sycl::vec<unsigned long long, 3> *ulonglong3_f;
  ...
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_h[16];
  ulonglong3 ulonglong3_h[16];
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_i[32];
  ulonglong3 ulonglong3_i[32];
  // CHECK: if (ulonglong3_h[12].x() == ulonglong3_i[12].x()) {}
  if (ulonglong3_h[12].x == ulonglong3_i[12].x) {}
  // CHECK: ulonglong3_f = (sycl::vec<unsigned long long, 3> *)ulonglong3_i;
  ulonglong3_f = (ulonglong3 *)ulonglong3_i;
  // CHECK: ulonglong3_a = (sycl::vec<unsigned long long, 3>)ulonglong3_c;
  ulonglong3_a = (ulonglong3)ulonglong3_c;
  // CHECK: ulonglong3_b = sycl::vec<unsigned long long, 3>(ulonglong3_b);
  ulonglong3_b = ulonglong3(ulonglong3_b);
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_j, ulonglong3_k, ulonglong3_l, ulonglong3_m[16], *ulonglong3_n[32];
  ulonglong3 ulonglong3_j, ulonglong3_k, ulonglong3_l, ulonglong3_m[16], *ulonglong3_n[32];
  // CHECK: int ulonglong3_o = sizeof(sycl::vec<unsigned long long, 3>);
  ...
  // CHECK: dpct::get_out_of_order_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<unsigned long long, 3> *> ulonglong3_e_acc_ct0(ulonglong3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<unsigned long long, 3> *> ulonglong3_cast_acc_ct1((sycl::vec<unsigned long long, 3> *)ulonglong3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::vec<unsigned long long, 3> ulonglong3_r = (sycl::vec<unsigned long long, 3>){1,1,1};
  // CHECK-NEXT: auto ulonglong3_s = (sycl::vec<unsigned long long, 3>){1,1,1};
  ulonglong3 ulonglong3_r = (ulonglong3){1,1,1};
  auto ulonglong3_s = (ulonglong3){1,1,1};
  return 0;
}

// CHECK: void func3_ulonglong4(sycl::vec<unsigned long long, 4> a, sycl::vec<unsigned long long, 4> b, sycl::vec<unsigned long long, 4> c) {
void func3_ulonglong4(ulonglong4 a, ulonglong4 b, ulonglong4 c) {
}
// CHECK: void func_ulonglong4(sycl::vec<unsigned long long, 4> a) {
void func_ulonglong4(ulonglong4 a) {
}
// CHECK: void kernel_ulonglong4(sycl::vec<unsigned long long, 4> *a, sycl::vec<unsigned long long, 4> *b) {
__global__ void kernel_ulonglong4(ulonglong4 *a, ulonglong4 *b) {
}

int main_ulonglong4() {
  // range default constructor does the right thing.
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_a;
  ulonglong4 ulonglong4_a;
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_b = sycl::vec<unsigned long long, 4>(1, 2, 3, 4);
  ulonglong4 ulonglong4_b = make_ulonglong4(1, 2, 3, 4);
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_c = sycl::vec<unsigned long long, 4>(ulonglong4_b);
  ulonglong4 ulonglong4_c = ulonglong4(ulonglong4_b);
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_d(ulonglong4_c);
  ulonglong4 ulonglong4_d(ulonglong4_c);
  // CHECK: func3_ulonglong4(ulonglong4_b, sycl::vec<unsigned long long, 4>(ulonglong4_b), (sycl::vec<unsigned long long, 4>)ulonglong4_b);
  func3_ulonglong4(ulonglong4_b, ulonglong4(ulonglong4_b), (ulonglong4)ulonglong4_b);
  // CHECK: sycl::vec<unsigned long long, 4> *ulonglong4_e;
  ulonglong4 *ulonglong4_e;
  // CHECK: sycl::vec<unsigned long long, 4> *ulonglong4_f;
  ...
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_h[16];
  ulonglong4 ulonglong4_h[16];
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_i[32];
  ulonglong4 ulonglong4_i[32];
  // CHECK: if (ulonglong4_h[12].x() == ulonglong4_i[12].x()) {}
  if (ulonglong4_h[12].x == ulonglong4_i[12].x) {}
  // CHECK: ulonglong4_f = (sycl::vec<unsigned long long, 4> *)ulonglong4_i;
  ulonglong4_f = (ulonglong4 *)ulonglong4_i;
  // CHECK: ulonglong4_a = (sycl::vec<unsigned long long, 4>)ulonglong4_c;
  ulonglong4_a = (ulonglong4)ulonglong4_c;
  // CHECK: ulonglong4_b = sycl::vec<unsigned long long, 4>(ulonglong4_b);
  ulonglong4_b = ulonglong4(ulonglong4_b);
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_j, ulonglong4_k, ulonglong4_l, ulonglong4_m[16], *ulonglong4_n[32];
  ulonglong4 ulonglong4_j, ulonglong4_k, ulonglong4_l, ulonglong4_m[16], *ulonglong4_n[32];
  // CHECK: int ulonglong4_o = sizeof(sycl::vec<unsigned long long, 4>);
  ...
  // CHECK: dpct::get_out_of_order_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<unsigned long long, 4> *> ulonglong4_e_acc_ct0(ulonglong4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::vec<unsigned long long, 4> *> ulonglong4_cast_acc_ct1((sycl::vec<unsigned long long, 4> *)ulonglong4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::vec<unsigned long long, 4> ulonglong4_r = (sycl::vec<unsigned long long, 4>){1,1,1,1};
  // CHECK-NEXT: auto ulonglong4_s = (sycl::vec<unsigned long long, 4>){1,1,1,1};
...
// CHECK-NEXT: std::vector<sycl::vec<long long, 2>> foo_longlong2(std::vector<sycl::vec<long long, 2>> a);
// CHECK-NEXT: std::vector<sycl::vec<long long, 3>> foo_longlong3(std::vector<sycl::vec<long long, 3>> a);
// CHECK-NEXT: std::vector<sycl::vec<long long, 4>> foo_longlong4(std::vector<sycl::vec<long long, 4>> a);
...
// CHECK-NEXT: std::vector<sycl::vec<unsigned long long, 2>> foo_ulonglong2(std::vector<sycl::vec<unsigned long long, 2>> a);
// CHECK-NEXT: std::vector<sycl::vec<unsigned long long, 3>> foo_ulonglong3(std::vector<sycl::vec<unsigned long long, 3>> a);
// CHECK-NEXT: std::vector<sycl::vec<unsigned long long, 4>> foo_ulonglong4(std::vector<sycl::vec<unsigned long long, 4>> a);
...
void bar(){
  ...
  // CHECK-NEXT: std::vector<sycl::vec<long long, 2>> *bar_longlong2 = (std::vector<sycl::vec<long long, 2>>*) a;
  // CHECK-NEXT: std::vector<sycl::vec<unsigned long long, 2>> *bar_ulonglong2 = (std::vector<sycl::vec<unsigned long long, 2>>*) a;
...
// CHECK-NEXT: #define vlonglong2_ptr std::vector<sycl::vec<long long, 2>>*
// CHECK-NEXT: #define vulonglong2_ptr std::vector<sycl::vec<unsigned long long, 2>>*
