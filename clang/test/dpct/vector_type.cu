...
// CHECK: void func3_char2(sycl::mchar2 a, sycl::mchar2 b, sycl::mchar2 c) {
void func3_char2(char2 a, char2 b, char2 c) {
}
// CHECK: void func_char2(sycl::mchar2 a) {
void func_char2(char2 a) {
}
// CHECK: void kernel_char2(sycl::mchar2 *a, sycl::mchar2 *b) {
__global__ void kernel_char2(char2 *a, char2 *b) {
}

int main_char2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mchar2 char2_a;
  char2 char2_a;
  // CHECK: sycl::mchar2 char2_b = sycl::mchar2(1, 2);
  char2 char2_b = make_char2(1, 2);
  // CHECK: sycl::mchar2 char2_c = sycl::mchar2(char2_b);
  char2 char2_c = char2(char2_b);
  // CHECK: sycl::mchar2 char2_d(char2_c);
  char2 char2_d(char2_c);
  // CHECK: func3_char2(char2_b, sycl::mchar2(char2_b), (sycl::mchar2)char2_b);
  func3_char2(char2_b, char2(char2_b), (char2)char2_b);
  // CHECK: sycl::mchar2 *char2_e;
  char2 *char2_e;
  // CHECK: sycl::mchar2 *char2_f;
  char2 *char2_f;
  // CHECK: signed char char2_g = char2_c[0];
  signed char char2_g = char2_c.x;
  // CHECK: char2_a[0] = char2_d[0];
  char2_a.x = char2_d.x;
  // CHECK: if (char2_b[0] == char2_d[0]) {}
  if (char2_b.x == char2_d.x) {}
  // CHECK: sycl::mchar2 char2_h[16];
  char2 char2_h[16];
  // CHECK: sycl::mchar2 char2_i[32];
  char2 char2_i[32];
  // CHECK: if (char2_h[12][0] == char2_i[12][0]) {}
  if (char2_h[12].x == char2_i[12].x) {}
  // CHECK: char2_f = (sycl::mchar2 *)char2_i;
  char2_f = (char2 *)char2_i;
  // CHECK: char2_a = (sycl::mchar2)char2_c;
  char2_a = (char2)char2_c;
  // CHECK: char2_b = sycl::mchar2(char2_b);
  char2_b = char2(char2_b);
  // CHECK: sycl::mchar2 char2_j, char2_k, char2_l, char2_m[16], *char2_n[32];
  char2 char2_j, char2_k, char2_l, char2_m[16], *char2_n[32];
  // CHECK: int char2_o = sizeof(sycl::mchar2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mchar2 *> char2_e_acc_ct0(char2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mchar2 *> char2_cast_acc_ct1((sycl::mchar2 *)char2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mchar2 char2_r = (sycl::mchar2){1,1};
  // CHECK-NEXT: auto char2_s = (sycl::mchar2){1,1};
  char2 char2_r = (char2){1,1};
  auto char2_s = (char2){1,1};
  return 0;
}

// CHECK: void func3_char3(sycl::mchar3 a, sycl::mchar3 b, sycl::mchar3 c) {
void func3_char3(char3 a, char3 b, char3 c) {
}
// CHECK: void func_char3(sycl::mchar3 a) {
void func_char3(char3 a) {
}
// CHECK: void kernel_char3(sycl::mchar3 *a, sycl::mchar3 *b) {
__global__ void kernel_char3(char3 *a, char3 *b) {
}

int main_char3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mchar3 char3_a;
  char3 char3_a;
  // CHECK: sycl::mchar3 char3_b = sycl::mchar3(1, 2, 3);
  char3 char3_b = make_char3(1, 2, 3);
  // CHECK: sycl::mchar3 char3_c = sycl::mchar3(char3_b);
  char3 char3_c = char3(char3_b);
  // CHECK: sycl::mchar3 char3_d(char3_c);
  char3 char3_d(char3_c);
  // CHECK: func3_char3(char3_b, sycl::mchar3(char3_b), (sycl::mchar3)char3_b);
  func3_char3(char3_b, char3(char3_b), (char3)char3_b);
  // CHECK: sycl::mchar3 *char3_e;
  char3 *char3_e;
  // CHECK: sycl::mchar3 *char3_f;
  char3 *char3_f;
  // CHECK: signed char char3_g = char3_c[0];
  signed char char3_g = char3_c.x;
  // CHECK: char3_a[0] = char3_d[0];
  char3_a.x = char3_d.x;
  // CHECK: if (char3_b[0] == char3_d[0]) {}
  if (char3_b.x == char3_d.x) {}
  // CHECK: sycl::mchar3 char3_h[16];
  char3 char3_h[16];
  // CHECK: sycl::mchar3 char3_i[32];
  char3 char3_i[32];
  // CHECK: if (char3_h[12][0] == char3_i[12][0]) {}
  if (char3_h[12].x == char3_i[12].x) {}
  // CHECK: char3_f = (sycl::mchar3 *)char3_i;
  char3_f = (char3 *)char3_i;
  // CHECK: char3_a = (sycl::mchar3)char3_c;
  char3_a = (char3)char3_c;
  // CHECK: char3_b = sycl::mchar3(char3_b);
  char3_b = char3(char3_b);
  // CHECK: sycl::mchar3 char3_j, char3_k, char3_l, char3_m[16], *char3_n[32];
  char3 char3_j, char3_k, char3_l, char3_m[16], *char3_n[32];
  // CHECK: int char3_o = sizeof(sycl::mchar3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mchar3 *> char3_e_acc_ct0(char3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mchar3 *> char3_cast_acc_ct1((sycl::mchar3 *)char3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mchar3 char3_r = (sycl::mchar3){1,1,1};
  // CHECK-NEXT: auto char3_s = (sycl::mchar3){1,1,1};
  char3 char3_r = (char3){1,1,1};
  auto char3_s = (char3){1,1,1};
  return 0;
}

// CHECK: void func3_char4(sycl::mchar4 a, sycl::mchar4 b, sycl::mchar4 c) {
void func3_char4(char4 a, char4 b, char4 c) {
}
// CHECK: void func_char4(sycl::mchar4 a) {
void func_char4(char4 a) {
}
// CHECK: void kernel_char4(sycl::mchar4 *a, sycl::mchar4 *b) {
__global__ void kernel_char4(char4 *a, char4 *b) {
}

int main_char4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mchar4 char4_a;
  char4 char4_a;
  // CHECK: sycl::mchar4 char4_b = sycl::mchar4(1, 2, 3, 4);
  char4 char4_b = make_char4(1, 2, 3, 4);
  // CHECK: sycl::mchar4 char4_c = sycl::mchar4(char4_b);
  char4 char4_c = char4(char4_b);
  // CHECK: sycl::mchar4 char4_d(char4_c);
  char4 char4_d(char4_c);
  // CHECK: func3_char4(char4_b, sycl::mchar4(char4_b), (sycl::mchar4)char4_b);
  func3_char4(char4_b, char4(char4_b), (char4)char4_b);
  // CHECK: sycl::mchar4 *char4_e;
  char4 *char4_e;
  // CHECK: sycl::mchar4 *char4_f;
  char4 *char4_f;
  // CHECK: signed char char4_g = char4_c[0];
  signed char char4_g = char4_c.x;
  // CHECK: char4_a[0] = char4_d[0];
  char4_a.x = char4_d.x;
  // CHECK: if (char4_b[0] == char4_d[0]) {}
  if (char4_b.x == char4_d.x) {}
  // CHECK: sycl::mchar4 char4_h[16];
  char4 char4_h[16];
  // CHECK: sycl::mchar4 char4_i[32];
  char4 char4_i[32];
  // CHECK: if (char4_h[12][0] == char4_i[12][0]) {}
  if (char4_h[12].x == char4_i[12].x) {}
  // CHECK: char4_f = (sycl::mchar4 *)char4_i;
  char4_f = (char4 *)char4_i;
  // CHECK: char4_a = (sycl::mchar4)char4_c;
  char4_a = (char4)char4_c;
  // CHECK: char4_b = sycl::mchar4(char4_b);
  char4_b = char4(char4_b);
  // CHECK: sycl::mchar4 char4_j, char4_k, char4_l, char4_m[16], *char4_n[32];
  char4 char4_j, char4_k, char4_l, char4_m[16], *char4_n[32];
  // CHECK: int char4_o = sizeof(sycl::mchar4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mchar4 *> char4_e_acc_ct0(char4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mchar4 *> char4_cast_acc_ct1((sycl::mchar4 *)char4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mchar4 char4_r = (sycl::mchar4){1,1,1,1};
  // CHECK-NEXT: auto char4_s = (sycl::mchar4){1,1,1,1};
...
// CHECK: void func3_double2(sycl::mdouble2 a, sycl::mdouble2 b, sycl::mdouble2 c) {
void func3_double2(double2 a, double2 b, double2 c) {
}
// CHECK: void func_double2(sycl::mdouble2 a) {
void func_double2(double2 a) {
}
// CHECK: void kernel_double2(sycl::mdouble2 *a, sycl::mdouble2 *b) {
__global__ void kernel_double2(double2 *a, double2 *b) {
}

int main_double2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mdouble2 double2_a;
  double2 double2_a;
  // CHECK: sycl::mdouble2 double2_b = sycl::mdouble2(1, 2);
  double2 double2_b = make_double2(1, 2);
  // CHECK: sycl::mdouble2 double2_c = sycl::mdouble2(double2_b);
  double2 double2_c = double2(double2_b);
  // CHECK: sycl::mdouble2 double2_d(double2_c);
  double2 double2_d(double2_c);
  // CHECK: func3_double2(double2_b, sycl::mdouble2(double2_b), (sycl::mdouble2)double2_b);
  func3_double2(double2_b, double2(double2_b), (double2)double2_b);
  // CHECK: sycl::mdouble2 *double2_e;
  double2 *double2_e;
  // CHECK: sycl::mdouble2 *double2_f;
  double2 *double2_f;
  // CHECK: double double2_g = double2_c[0];
  double double2_g = double2_c.x;
  // CHECK: double2_a[0] = double2_d[0];
  double2_a.x = double2_d.x;
  // CHECK: if (double2_b[0] == double2_d[0]) {}
  if (double2_b.x == double2_d.x) {}
  // CHECK: sycl::mdouble2 double2_h[16];
  double2 double2_h[16];
  // CHECK: sycl::mdouble2 double2_i[32];
  double2 double2_i[32];
  // CHECK: if (double2_h[12][0] == double2_i[12][0]) {}
  if (double2_h[12].x == double2_i[12].x) {}
  // CHECK: double2_f = (sycl::mdouble2 *)double2_i;
  double2_f = (double2 *)double2_i;
  // CHECK: double2_a = (sycl::mdouble2)double2_c;
  double2_a = (double2)double2_c;
  // CHECK: double2_b = sycl::mdouble2(double2_b);
  double2_b = double2(double2_b);
  // CHECK: sycl::mdouble2 double2_j, double2_k, double2_l, double2_m[16], *double2_n[32];
  double2 double2_j, double2_k, double2_l, double2_m[16], *double2_n[32];
  // CHECK: int double2_o = sizeof(sycl::mdouble2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mdouble2 *> double2_e_acc_ct0(double2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mdouble2 *> double2_cast_acc_ct1((sycl::mdouble2 *)double2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mdouble2 double2_r = (sycl::mdouble2){1,1};
  // CHECK-NEXT: auto double2_s = (sycl::mdouble2){1,1};
  double2 double2_r = (double2){1,1};
  auto double2_s = (double2){1,1};
  return 0;
}

// CHECK: void func3_double3(sycl::mdouble3 a, sycl::mdouble3 b, sycl::mdouble3 c) {
void func3_double3(double3 a, double3 b, double3 c) {
}
// CHECK: void func_double3(sycl::mdouble3 a) {
void func_double3(double3 a) {
}
// CHECK: void kernel_double3(sycl::mdouble3 *a, sycl::mdouble3 *b) {
__global__ void kernel_double3(double3 *a, double3 *b) {
}

int main_double3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mdouble3 double3_a;
  double3 double3_a;
  // CHECK: sycl::mdouble3 double3_b = sycl::mdouble3(1, 2, 3);
  double3 double3_b = make_double3(1, 2, 3);
  // CHECK: sycl::mdouble3 double3_c = sycl::mdouble3(double3_b);
  double3 double3_c = double3(double3_b);
  // CHECK: sycl::mdouble3 double3_d(double3_c);
  double3 double3_d(double3_c);
  // CHECK: func3_double3(double3_b, sycl::mdouble3(double3_b), (sycl::mdouble3)double3_b);
  func3_double3(double3_b, double3(double3_b), (double3)double3_b);
  // CHECK: sycl::mdouble3 *double3_e;
  double3 *double3_e;
  // CHECK: sycl::mdouble3 *double3_f;
  double3 *double3_f;
  // CHECK: double double3_g = double3_c[0];
  double double3_g = double3_c.x;
  // CHECK: double3_a[0] = double3_d[0];
  double3_a.x = double3_d.x;
  // CHECK: if (double3_b[0] == double3_d[0]) {}
  if (double3_b.x == double3_d.x) {}
  // CHECK: sycl::mdouble3 double3_h[16];
  double3 double3_h[16];
  // CHECK: sycl::mdouble3 double3_i[32];
  double3 double3_i[32];
  // CHECK: if (double3_h[12][0] == double3_i[12][0]) {}
  if (double3_h[12].x == double3_i[12].x) {}
  // CHECK: double3_f = (sycl::mdouble3 *)double3_i;
  double3_f = (double3 *)double3_i;
  // CHECK: double3_a = (sycl::mdouble3)double3_c;
  double3_a = (double3)double3_c;
  // CHECK: double3_b = sycl::mdouble3(double3_b);
  double3_b = double3(double3_b);
  // CHECK: sycl::mdouble3 double3_j, double3_k, double3_l, double3_m[16], *double3_n[32];
  double3 double3_j, double3_k, double3_l, double3_m[16], *double3_n[32];
  // CHECK: int double3_o = sizeof(sycl::mdouble3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mdouble3 *> double3_e_acc_ct0(double3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mdouble3 *> double3_cast_acc_ct1((sycl::mdouble3 *)double3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mdouble3 double3_r = (sycl::mdouble3){1,1,1};
  // CHECK-NEXT: auto double3_s = (sycl::mdouble3){1,1,1};
  double3 double3_r = (double3){1,1,1};
  auto double3_s = (double3){1,1,1};
  return 0;
}

// CHECK: void func3_double4(sycl::mdouble4 a, sycl::mdouble4 b, sycl::mdouble4 c) {
void func3_double4(double4 a, double4 b, double4 c) {
}
// CHECK: void func_double4(sycl::mdouble4 a) {
void func_double4(double4 a) {
}
// CHECK: void kernel_double4(sycl::mdouble4 *a, sycl::mdouble4 *b) {
__global__ void kernel_double4(double4 *a, double4 *b) {
}

int main_double4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mdouble4 double4_a;
  double4 double4_a;
  // CHECK: sycl::mdouble4 double4_b = sycl::mdouble4(1, 2, 3, 4);
  double4 double4_b = make_double4(1, 2, 3, 4);
  // CHECK: sycl::mdouble4 double4_c = sycl::mdouble4(double4_b);
  double4 double4_c = double4(double4_b);
  // CHECK: sycl::mdouble4 double4_d(double4_c);
  double4 double4_d(double4_c);
  // CHECK: func3_double4(double4_b, sycl::mdouble4(double4_b), (sycl::mdouble4)double4_b);
  func3_double4(double4_b, double4(double4_b), (double4)double4_b);
  // CHECK: sycl::mdouble4 *double4_e;
  double4 *double4_e;
  // CHECK: sycl::mdouble4 *double4_f;
  double4 *double4_f;
  // CHECK: double double4_g = double4_c[0];
  double double4_g = double4_c.x;
  // CHECK: double4_a[0] = double4_d[0];
  double4_a.x = double4_d.x;
  // CHECK: if (double4_b[0] == double4_d[0]) {}
  if (double4_b.x == double4_d.x) {}
  // CHECK: sycl::mdouble4 double4_h[16];
  double4 double4_h[16];
  // CHECK: sycl::mdouble4 double4_i[32];
  double4 double4_i[32];
  // CHECK: if (double4_h[12][0] == double4_i[12][0]) {}
  if (double4_h[12].x == double4_i[12].x) {}
  // CHECK: double4_f = (sycl::mdouble4 *)double4_i;
  double4_f = (double4 *)double4_i;
  // CHECK: double4_a = (sycl::mdouble4)double4_c;
  double4_a = (double4)double4_c;
  // CHECK: double4_b = sycl::mdouble4(double4_b);
  double4_b = double4(double4_b);
  // CHECK: sycl::mdouble4 double4_j, double4_k, double4_l, double4_m[16], *double4_n[32];
  double4 double4_j, double4_k, double4_l, double4_m[16], *double4_n[32];
  // CHECK: int double4_o = sizeof(sycl::mdouble4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mdouble4 *> double4_e_acc_ct0(double4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mdouble4 *> double4_cast_acc_ct1((sycl::mdouble4 *)double4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mdouble4 double4_r = (sycl::mdouble4){1,1,1,1};
  // CHECK-NEXT: auto double4_s = (sycl::mdouble4){1,1,1,1};
...
// CHECK: void func3_float2(sycl::mfloat2 a, sycl::mfloat2 b, sycl::mfloat2 c) {
void func3_float2(float2 a, float2 b, float2 c) {
}
// CHECK: void func_float2(sycl::mfloat2 a) {
void func_float2(float2 a) {
}
// CHECK: void kernel_float2(sycl::mfloat2 *a, sycl::mfloat2 *b) {
__global__ void kernel_float2(float2 *a, float2 *b) {
}

int main_float2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mfloat2 float2_a;
  float2 float2_a;
  // CHECK: sycl::mfloat2 float2_b = sycl::mfloat2(1, 2);
  float2 float2_b = make_float2(1, 2);
  // CHECK: sycl::mfloat2 float2_c = sycl::mfloat2(float2_b);
  float2 float2_c = float2(float2_b);
  // CHECK: sycl::mfloat2 float2_d(float2_c);
  float2 float2_d(float2_c);
  // CHECK: func3_float2(float2_b, sycl::mfloat2(float2_b), (sycl::mfloat2)float2_b);
  func3_float2(float2_b, float2(float2_b), (float2)float2_b);
  // CHECK: sycl::mfloat2 *float2_e;
  float2 *float2_e;
  // CHECK: sycl::mfloat2 *float2_f;
  float2 *float2_f;
  // CHECK: float float2_g = float2_c[0];
  float float2_g = float2_c.x;
  // CHECK: float2_a[0] = float2_d[0];
  float2_a.x = float2_d.x;
  // CHECK: if (float2_b[0] == float2_d[0]) {}
  if (float2_b.x == float2_d.x) {}
  // CHECK: sycl::mfloat2 float2_h[16];
  float2 float2_h[16];
  // CHECK: sycl::mfloat2 float2_i[32];
  float2 float2_i[32];
  // CHECK: if (float2_h[12][0] == float2_i[12][0]) {}
  if (float2_h[12].x == float2_i[12].x) {}
  // CHECK: float2_f = (sycl::mfloat2 *)float2_i;
  float2_f = (float2 *)float2_i;
  // CHECK: float2_a = (sycl::mfloat2)float2_c;
  float2_a = (float2)float2_c;
  // CHECK: float2_b = sycl::mfloat2(float2_b);
  float2_b = float2(float2_b);
  // CHECK: sycl::mfloat2 float2_j, float2_k, float2_l, float2_m[16], *float2_n[32];
  float2 float2_j, float2_k, float2_l, float2_m[16], *float2_n[32];
  // CHECK: int float2_o = sizeof(sycl::mfloat2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mfloat2 *> float2_e_acc_ct0(float2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mfloat2 *> float2_cast_acc_ct1((sycl::mfloat2 *)float2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mfloat2 float2_r = (sycl::mfloat2){1,1};
  // CHECK-NEXT: auto float2_s = (sycl::mfloat2){1,1};
  float2 float2_r = (float2){1,1};
  auto float2_s = (float2){1,1};
  return 0;
}

// CHECK: void func3_float3(sycl::mfloat3 a, sycl::mfloat3 b, sycl::mfloat3 c) {
void func3_float3(float3 a, float3 b, float3 c) {
}
// CHECK: void func_float3(sycl::mfloat3 a) {
void func_float3(float3 a) {
}
// CHECK: void kernel_float3(sycl::mfloat3 *a, sycl::mfloat3 *b) {
__global__ void kernel_float3(float3 *a, float3 *b) {
}

int main_float3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mfloat3 float3_a;
  float3 float3_a;
  // CHECK: sycl::mfloat3 float3_b = sycl::mfloat3(1, 2, 3);
  float3 float3_b = make_float3(1, 2, 3);
  // CHECK: sycl::mfloat3 float3_c = sycl::mfloat3(float3_b);
  float3 float3_c = float3(float3_b);
  // CHECK: sycl::mfloat3 float3_d(float3_c);
  float3 float3_d(float3_c);
  // CHECK: func3_float3(float3_b, sycl::mfloat3(float3_b), (sycl::mfloat3)float3_b);
  func3_float3(float3_b, float3(float3_b), (float3)float3_b);
  // CHECK: sycl::mfloat3 *float3_e;
  float3 *float3_e;
  // CHECK: sycl::mfloat3 *float3_f;
  float3 *float3_f;
  // CHECK: float float3_g = float3_c[0];
  float float3_g = float3_c.x;
  // CHECK: float3_a[0] = float3_d[0];
  float3_a.x = float3_d.x;
  // CHECK: if (float3_b[0] == float3_d[0]) {}
  if (float3_b.x == float3_d.x) {}
  // CHECK: sycl::mfloat3 float3_h[16];
  float3 float3_h[16];
  // CHECK: sycl::mfloat3 float3_i[32];
  float3 float3_i[32];
  // CHECK: if (float3_h[12][0] == float3_i[12][0]) {}
  if (float3_h[12].x == float3_i[12].x) {}
  // CHECK: float3_f = (sycl::mfloat3 *)float3_i;
  float3_f = (float3 *)float3_i;
  // CHECK: float3_a = (sycl::mfloat3)float3_c;
  float3_a = (float3)float3_c;
  // CHECK: float3_b = sycl::mfloat3(float3_b);
  float3_b = float3(float3_b);
  // CHECK: sycl::mfloat3 float3_j, float3_k, float3_l, float3_m[16], *float3_n[32];
  float3 float3_j, float3_k, float3_l, float3_m[16], *float3_n[32];
  // CHECK: int float3_o = sizeof(sycl::mfloat3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mfloat3 *> float3_e_acc_ct0(float3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mfloat3 *> float3_cast_acc_ct1((sycl::mfloat3 *)float3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mfloat3 float3_r = (sycl::mfloat3){1,1,1};
  // CHECK-NEXT: auto float3_s = (sycl::mfloat3){1,1,1};
  float3 float3_r = (float3){1,1,1};
  auto float3_s = (float3){1,1,1};
  return 0;
}

// CHECK: void func3_float4(sycl::mfloat4 a, sycl::mfloat4 b, sycl::mfloat4 c) {
void func3_float4(float4 a, float4 b, float4 c) {
}
// CHECK: void func_float4(sycl::mfloat4 a) {
void func_float4(float4 a) {
}
// CHECK: void kernel_float4(sycl::mfloat4 *a, sycl::mfloat4 *b) {
__global__ void kernel_float4(float4 *a, float4 *b) {
}

int main_float4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mfloat4 float4_a;
  float4 float4_a;
  // CHECK: sycl::mfloat4 float4_b = sycl::mfloat4(1, 2, 3, 4);
  float4 float4_b = make_float4(1, 2, 3, 4);
  // CHECK: sycl::mfloat4 float4_c = sycl::mfloat4(float4_b);
  float4 float4_c = float4(float4_b);
  // CHECK: sycl::mfloat4 float4_d(float4_c);
  float4 float4_d(float4_c);
  // CHECK: func3_float4(float4_b, sycl::mfloat4(float4_b), (sycl::mfloat4)float4_b);
  func3_float4(float4_b, float4(float4_b), (float4)float4_b);
  // CHECK: sycl::mfloat4 *float4_e;
  float4 *float4_e;
  // CHECK: sycl::mfloat4 *float4_f;
  float4 *float4_f;
  // CHECK: float float4_g = float4_c[0];
  float float4_g = float4_c.x;
  // CHECK: float4_a[0] = float4_d[0];
  float4_a.x = float4_d.x;
  // CHECK: if (float4_b[0] == float4_d[0]) {}
  if (float4_b.x == float4_d.x) {}
  // CHECK: sycl::mfloat4 float4_h[16];
  float4 float4_h[16];
  // CHECK: sycl::mfloat4 float4_i[32];
  float4 float4_i[32];
  // CHECK: if (float4_h[12][0] == float4_i[12][0]) {}
  if (float4_h[12].x == float4_i[12].x) {}
  // CHECK: float4_f = (sycl::mfloat4 *)float4_i;
  float4_f = (float4 *)float4_i;
  // CHECK: float4_a = (sycl::mfloat4)float4_c;
  float4_a = (float4)float4_c;
  // CHECK: float4_b = sycl::mfloat4(float4_b);
  float4_b = float4(float4_b);
  // CHECK: sycl::mfloat4 float4_j, float4_k, float4_l, float4_m[16], *float4_n[32];
  float4 float4_j, float4_k, float4_l, float4_m[16], *float4_n[32];
  // CHECK: int float4_o = sizeof(sycl::mfloat4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mfloat4 *> float4_e_acc_ct0(float4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mfloat4 *> float4_cast_acc_ct1((sycl::mfloat4 *)float4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mfloat4 float4_r = (sycl::mfloat4){1,1,1,1};
  // CHECK-NEXT: auto float4_s = (sycl::mfloat4){1,1,1,1};
...
// CHECK: void func3_int2(sycl::mint2 a, sycl::mint2 b, sycl::mint2 c) {
void func3_int2(int2 a, int2 b, int2 c) {
}
// CHECK: void func_int2(sycl::mint2 a) {
void func_int2(int2 a) {
}
// CHECK: void kernel_int2(sycl::mint2 *a, sycl::mint2 *b) {
__global__ void kernel_int2(int2 *a, int2 *b) {
}

int main_int2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mint2 int2_a;
  int2 int2_a;
  // CHECK: sycl::mint2 int2_b = sycl::mint2(1, 2);
  int2 int2_b = make_int2(1, 2);
  // CHECK: sycl::mint2 int2_c = sycl::mint2(int2_b);
  int2 int2_c = int2(int2_b);
  // CHECK: sycl::mint2 int2_d(int2_c);
  int2 int2_d(int2_c);
  // CHECK: func3_int2(int2_b, sycl::mint2(int2_b), (sycl::mint2)int2_b);
  func3_int2(int2_b, int2(int2_b), (int2)int2_b);
  // CHECK: sycl::mint2 *int2_e;
  int2 *int2_e;
  // CHECK: sycl::mint2 *int2_f;
  int2 *int2_f;
  // CHECK: int int2_g = int2_c[0];
  int int2_g = int2_c.x;
  // CHECK: int2_a[0] = int2_d[0];
  int2_a.x = int2_d.x;
  // CHECK: if (int2_b[0] == int2_d[0]) {}
  if (int2_b.x == int2_d.x) {}
  // CHECK: sycl::mint2 int2_h[16];
  int2 int2_h[16];
  // CHECK: sycl::mint2 int2_i[32];
  int2 int2_i[32];
  // CHECK: if (int2_h[12][0] == int2_i[12][0]) {}
  if (int2_h[12].x == int2_i[12].x) {}
  // CHECK: int2_f = (sycl::mint2 *)int2_i;
  int2_f = (int2 *)int2_i;
  // CHECK: int2_a = (sycl::mint2)int2_c;
  int2_a = (int2)int2_c;
  // CHECK: int2_b = sycl::mint2(int2_b);
  int2_b = int2(int2_b);
  // CHECK: sycl::mint2 int2_j, int2_k, int2_l, int2_m[16], *int2_n[32];
  int2 int2_j, int2_k, int2_l, int2_m[16], *int2_n[32];
  // CHECK: int int2_o = sizeof(sycl::mint2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mint2 *> int2_e_acc_ct0(int2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mint2 *> int2_cast_acc_ct1((sycl::mint2 *)int2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mint2 int2_r = (sycl::mint2){1,1};
  // CHECK-NEXT: auto int2_s = (sycl::mint2){1,1};
  int2 int2_r = (int2){1,1};
  auto int2_s = (int2){1,1};
  return 0;
}

// CHECK: void func3_int3(sycl::mint3 a, sycl::mint3 b, sycl::mint3 c) {
void func3_int3(int3 a, int3 b, int3 c) {
}
// CHECK: void func_int3(sycl::mint3 a) {
void func_int3(int3 a) {
}
// CHECK: void kernel_int3(sycl::mint3 *a, sycl::mint3 *b) {
__global__ void kernel_int3(int3 *a, int3 *b) {
}

int main_int3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mint3 int3_a;
  int3 int3_a;
  // CHECK: sycl::mint3 int3_b = sycl::mint3(1, 2, 3);
  int3 int3_b = make_int3(1, 2, 3);
  // CHECK: sycl::mint3 int3_c = sycl::mint3(int3_b);
  int3 int3_c = int3(int3_b);
  // CHECK: sycl::mint3 int3_d(int3_c);
  int3 int3_d(int3_c);
  // CHECK: func3_int3(int3_b, sycl::mint3(int3_b), (sycl::mint3)int3_b);
  func3_int3(int3_b, int3(int3_b), (int3)int3_b);
  // CHECK: sycl::mint3 *int3_e;
  int3 *int3_e;
  // CHECK: sycl::mint3 *int3_f;
  int3 *int3_f;
  // CHECK: int int3_g = int3_c[0];
  int int3_g = int3_c.x;
  // CHECK: int3_a[0] = int3_d[0];
  int3_a.x = int3_d.x;
  // CHECK: if (int3_b[0] == int3_d[0]) {}
  if (int3_b.x == int3_d.x) {}
  // CHECK: sycl::mint3 int3_h[16];
  int3 int3_h[16];
  // CHECK: sycl::mint3 int3_i[32];
  int3 int3_i[32];
  // CHECK: if (int3_h[12][0] == int3_i[12][0]) {}
  if (int3_h[12].x == int3_i[12].x) {}
  // CHECK: int3_f = (sycl::mint3 *)int3_i;
  int3_f = (int3 *)int3_i;
  // CHECK: int3_a = (sycl::mint3)int3_c;
  int3_a = (int3)int3_c;
  // CHECK: int3_b = sycl::mint3(int3_b);
  int3_b = int3(int3_b);
  // CHECK: sycl::mint3 int3_j, int3_k, int3_l, int3_m[16], *int3_n[32];
  int3 int3_j, int3_k, int3_l, int3_m[16], *int3_n[32];
  // CHECK: int int3_o = sizeof(sycl::mint3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mint3 *> int3_e_acc_ct0(int3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mint3 *> int3_cast_acc_ct1((sycl::mint3 *)int3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mint3 int3_r = (sycl::mint3){1,1,1};
  // CHECK-NEXT: auto int3_s = (sycl::mint3){1,1,1};
  int3 int3_r = (int3){1,1,1};
  auto int3_s = (int3){1,1,1};
  return 0;
}

// CHECK: void func3_int4(sycl::mint4 a, sycl::mint4 b, sycl::mint4 c) {
void func3_int4(int4 a, int4 b, int4 c) {
}
// CHECK: void func_int4(sycl::mint4 a) {
void func_int4(int4 a) {
}
// CHECK: void kernel_int4(sycl::mint4 *a, sycl::mint4 *b) {
__global__ void kernel_int4(int4 *a, int4 *b) {
}

int main_int4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mint4 int4_a;
  int4 int4_a;
  // CHECK: sycl::mint4 int4_b = sycl::mint4(1, 2, 3, 4);
  int4 int4_b = make_int4(1, 2, 3, 4);
  // CHECK: sycl::mint4 int4_c = sycl::mint4(int4_b);
  int4 int4_c = int4(int4_b);
  // CHECK: sycl::mint4 int4_d(int4_c);
  int4 int4_d(int4_c);
  // CHECK: func3_int4(int4_b, sycl::mint4(int4_b), (sycl::mint4)int4_b);
  func3_int4(int4_b, int4(int4_b), (int4)int4_b);
  // CHECK: sycl::mint4 *int4_e;
  int4 *int4_e;
  // CHECK: sycl::mint4 *int4_f;
  int4 *int4_f;
  // Check: int4_f->x() = int4_e->x();
  int4_f->x = int4_e->x;
  // CHECK: int int4_g = int4_c[0];
  int int4_g = int4_c.x;
  // CHECK: int4_a[0] = int4_d[0];
  int4_a.x = int4_d.x;
  // CHECK: if (int4_b[0] == int4_d[0]) {}
  if (int4_b.x == int4_d.x) {}
  // CHECK: sycl::mint4 int4_h[16];
  int4 int4_h[16];
  // CHECK: sycl::mint4 int4_i[32];
  int4 int4_i[32];
  // CHECK: if (int4_h[12][0] == int4_i[12][0]) {}
  if (int4_h[12].x == int4_i[12].x) {}
  // CHECK: int4_f = (sycl::mint4 *)int4_i;
  int4_f = (int4 *)int4_i;
  // CHECK: int4_a = (sycl::mint4)int4_c;
  int4_a = (int4)int4_c;
  // CHECK: int4_b = sycl::mint4(int4_b);
  int4_b = int4(int4_b);
  // CHECK: sycl::mint4 int4_j, int4_k, int4_l, int4_m[16], *int4_n[32];
  int4 int4_j, int4_k, int4_l, int4_m[16], *int4_n[32];
  // CHECK: int int4_o = sizeof(sycl::mint4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mint4 *> int4_e_acc_ct0(int4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mint4 *> int4_cast_acc_ct1((sycl::mint4 *)int4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mint4 int4_r = (sycl::mint4){1,1,1,1};
  // CHECK-NEXT: auto int4_s = (sycl::mint4){1,1,1,1};
...
// CHECK: void func3_long2(sycl::mlong2 a, sycl::mlong2 b, sycl::mlong2 c) {
void func3_long2(long2 a, long2 b, long2 c) {
}
// CHECK: void func_long2(sycl::mlong2 a) {
void func_long2(long2 a) {
}
// CHECK: void kernel_long2(sycl::mlong2 *a, sycl::mlong2 *b) {
__global__ void kernel_long2(long2 *a, long2 *b) {
}

int main_long2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mlong2 long2_a;
  long2 long2_a;
  // CHECK: sycl::mlong2 long2_b = sycl::mlong2(1, 2);
  long2 long2_b = make_long2(1, 2);
  // CHECK: sycl::mlong2 long2_c = sycl::mlong2(long2_b);
  long2 long2_c = long2(long2_b);
  // CHECK: sycl::mlong2 long2_d(long2_c);
  long2 long2_d(long2_c);
  // CHECK: func3_long2(long2_b, sycl::mlong2(long2_b), (sycl::mlong2)long2_b);
  func3_long2(long2_b, long2(long2_b), (long2)long2_b);
  // CHECK: sycl::mlong2 *long2_e;
  long2 *long2_e;
  // CHECK: sycl::mlong2 *long2_f;
  long2 *long2_f;
  // CHECK: long long2_g = long2_c[0];
  long long2_g = long2_c.x;
  // CHECK: long2_a[0] = long2_d[0];
  long2_a.x = long2_d.x;
  // CHECK: if (long2_b[0] == long2_d[0]) {}
  if (long2_b.x == long2_d.x) {}
  // CHECK: sycl::mlong2 long2_h[16];
  long2 long2_h[16];
  // CHECK: sycl::mlong2 long2_i[32];
  long2 long2_i[32];
  // CHECK: if (long2_h[12][0] == long2_i[12][0]) {}
  if (long2_h[12].x == long2_i[12].x) {}
  // CHECK: long2_f = (sycl::mlong2 *)long2_i;
  long2_f = (long2 *)long2_i;
  // CHECK: long2_a = (sycl::mlong2)long2_c;
  long2_a = (long2)long2_c;
  // CHECK: long2_b = sycl::mlong2(long2_b);
  long2_b = long2(long2_b);
  // CHECK: sycl::mlong2 long2_j, long2_k, long2_l, long2_m[16], *long2_n[32];
  long2 long2_j, long2_k, long2_l, long2_m[16], *long2_n[32];
  // CHECK: int long2_o = sizeof(sycl::mlong2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlong2 *> long2_e_acc_ct0(long2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlong2 *> long2_cast_acc_ct1((sycl::mlong2 *)long2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mlong2 long2_r = (sycl::mlong2){1,1};
  // CHECK-NEXT: auto long2_s = (sycl::mlong2){1,1};
  long2 long2_r = (long2){1,1};
  auto long2_s = (long2){1,1};
  return 0;
}

// CHECK: void func3_long3(sycl::mlong3 a, sycl::mlong3 b, sycl::mlong3 c) {
void func3_long3(long3 a, long3 b, long3 c) {
}
// CHECK: void func_long3(sycl::mlong3 a) {
void func_long3(long3 a) {
}
// CHECK: void kernel_long3(sycl::mlong3 *a, sycl::mlong3 *b) {
__global__ void kernel_long3(long3 *a, long3 *b) {
}

int main_long3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mlong3 long3_a;
  long3 long3_a;
  // CHECK: sycl::mlong3 long3_b = sycl::mlong3(1, 2, 3);
  long3 long3_b = make_long3(1, 2, 3);
  // CHECK: sycl::mlong3 long3_c = sycl::mlong3(long3_b);
  long3 long3_c = long3(long3_b);
  // CHECK: sycl::mlong3 long3_d(long3_c);
  long3 long3_d(long3_c);
  // CHECK: func3_long3(long3_b, sycl::mlong3(long3_b), (sycl::mlong3)long3_b);
  func3_long3(long3_b, long3(long3_b), (long3)long3_b);
  // CHECK: sycl::mlong3 *long3_e;
  long3 *long3_e;
  // CHECK: sycl::mlong3 *long3_f;
  long3 *long3_f;
  // CHECK: long long3_g = long3_c[0];
  long long3_g = long3_c.x;
  // CHECK: long3_a[0] = long3_d[0];
  long3_a.x = long3_d.x;
  // CHECK: if (long3_b[0] == long3_d[0]) {}
  if (long3_b.x == long3_d.x) {}
  // CHECK: sycl::mlong3 long3_h[16];
  long3 long3_h[16];
  // CHECK: sycl::mlong3 long3_i[32];
  long3 long3_i[32];
  // CHECK: if (long3_h[12][0] == long3_i[12][0]) {}
  if (long3_h[12].x == long3_i[12].x) {}
  // CHECK: long3_f = (sycl::mlong3 *)long3_i;
  long3_f = (long3 *)long3_i;
  // CHECK: long3_a = (sycl::mlong3)long3_c;
  long3_a = (long3)long3_c;
  // CHECK: long3_b = sycl::mlong3(long3_b);
  long3_b = long3(long3_b);
  // CHECK: sycl::mlong3 long3_j, long3_k, long3_l, long3_m[16], *long3_n[32];
  long3 long3_j, long3_k, long3_l, long3_m[16], *long3_n[32];
  // CHECK: int long3_o = sizeof(sycl::mlong3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlong3 *> long3_e_acc_ct0(long3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlong3 *> long3_cast_acc_ct1((sycl::mlong3 *)long3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mlong3 long3_r = (sycl::mlong3){1,1,1};
  // CHECK-NEXT: auto long3_s = (sycl::mlong3){1,1,1};
  long3 long3_r = (long3){1,1,1};
  auto long3_s = (long3){1,1,1};
  return 0;
}

// CHECK: void func3_long4(sycl::mlong4 a, sycl::mlong4 b, sycl::mlong4 c) {
void func3_long4(long4 a, long4 b, long4 c) {
}
// CHECK: void func_long4(sycl::mlong4 a) {
void func_long4(long4 a) {
}
// CHECK: void kernel_long4(sycl::mlong4 *a, sycl::mlong4 *b) {
__global__ void kernel_long4(long4 *a, long4 *b) {
}

int main_long4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mlong4 long4_a;
  long4 long4_a;
  // CHECK: sycl::mlong4 long4_b = sycl::mlong4(1, 2, 3, 4);
  long4 long4_b = make_long4(1, 2, 3, 4);
  // CHECK: sycl::mlong4 long4_c = sycl::mlong4(long4_b);
  long4 long4_c = long4(long4_b);
  // CHECK: sycl::mlong4 long4_d(long4_c);
  long4 long4_d(long4_c);
  // CHECK: func3_long4(long4_b, sycl::mlong4(long4_b), (sycl::mlong4)long4_b);
  func3_long4(long4_b, long4(long4_b), (long4)long4_b);
  // CHECK: sycl::mlong4 *long4_e;
  long4 *long4_e;
  // CHECK: sycl::mlong4 *long4_f;
  long4 *long4_f;
  // CHECK: long long4_g = long4_c[0];
  long long4_g = long4_c.x;
  // CHECK: long4_a[0] = long4_d[0];
  long4_a.x = long4_d.x;
  // CHECK: if (long4_b[0] == long4_d[0]) {}
  if (long4_b.x == long4_d.x) {}
  // CHECK: sycl::mlong4 long4_h[16];
  long4 long4_h[16];
  // CHECK: sycl::mlong4 long4_i[32];
  long4 long4_i[32];
  // CHECK: if (long4_h[12][0] == long4_i[12][0]) {}
  if (long4_h[12].x == long4_i[12].x) {}
  // CHECK: long4_f = (sycl::mlong4 *)long4_i;
  long4_f = (long4 *)long4_i;
  // CHECK: long4_a = (sycl::mlong4)long4_c;
  long4_a = (long4)long4_c;
  // CHECK: long4_b = sycl::mlong4(long4_b);
  long4_b = long4(long4_b);
  // CHECK: sycl::mlong4 long4_j, long4_k, long4_l, long4_m[16], *long4_n[32];
  long4 long4_j, long4_k, long4_l, long4_m[16], *long4_n[32];
  // CHECK: int long4_o = sizeof(sycl::mlong4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlong4 *> long4_e_acc_ct0(long4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlong4 *> long4_cast_acc_ct1((sycl::mlong4 *)long4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mlong4 long4_r = (sycl::mlong4){1,1,1,1};
  // CHECK-NEXT: auto long4_s = (sycl::mlong4){1,1,1,1};
...
// CHECK: void func3_longlong2(sycl::mlonglong2 a, sycl::mlonglong2 b, sycl::mlonglong2 c) {
void func3_longlong2(longlong2 a, longlong2 b, longlong2 c) {
}
// CHECK: void func_longlong2(sycl::mlonglong2 a) {
void func_longlong2(longlong2 a) {
}
// CHECK: void kernel_longlong2(sycl::mlonglong2 *a, sycl::mlonglong2 *b) {
__global__ void kernel_longlong2(longlong2 *a, longlong2 *b) {
}

int main_longlong2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mlonglong2 longlong2_a;
  longlong2 longlong2_a;
  // CHECK: sycl::mlonglong2 longlong2_b = sycl::mlonglong2(1, 2);
  longlong2 longlong2_b = make_longlong2(1, 2);
  // CHECK: sycl::mlonglong2 longlong2_c = sycl::mlonglong2(longlong2_b);
  longlong2 longlong2_c = longlong2(longlong2_b);
  // CHECK: sycl::mlonglong2 longlong2_d(longlong2_c);
  longlong2 longlong2_d(longlong2_c);
  // CHECK: func3_longlong2(longlong2_b, sycl::mlonglong2(longlong2_b), (sycl::mlonglong2)longlong2_b);
  func3_longlong2(longlong2_b, longlong2(longlong2_b), (longlong2)longlong2_b);
  // CHECK: sycl::mlonglong2 *longlong2_e;
  longlong2 *longlong2_e;
  // CHECK: sycl::mlonglong2 *longlong2_f;
  longlong2 *longlong2_f;
  // CHECK: long long longlong2_g = longlong2_c[0];
  long long longlong2_g = longlong2_c.x;
  // CHECK: longlong2_a[0] = longlong2_d[0];
  longlong2_a.x = longlong2_d.x;
  // CHECK: if (longlong2_b[0] == longlong2_d[0]) {}
  if (longlong2_b.x == longlong2_d.x) {}
  // CHECK: sycl::mlonglong2 longlong2_h[16];
  longlong2 longlong2_h[16];
  // CHECK: sycl::mlonglong2 longlong2_i[32];
  longlong2 longlong2_i[32];
  // CHECK: if (longlong2_h[12][0] == longlong2_i[12][0]) {}
  if (longlong2_h[12].x == longlong2_i[12].x) {}
  // CHECK: longlong2_f = (sycl::mlonglong2 *)longlong2_i;
  longlong2_f = (longlong2 *)longlong2_i;
  // CHECK: longlong2_a = (sycl::mlonglong2)longlong2_c;
  longlong2_a = (longlong2)longlong2_c;
  // CHECK: longlong2_b = sycl::mlonglong2(longlong2_b);
  longlong2_b = longlong2(longlong2_b);
  // CHECK: sycl::mlonglong2 longlong2_j, longlong2_k, longlong2_l, longlong2_m[16], *longlong2_n[32];
  longlong2 longlong2_j, longlong2_k, longlong2_l, longlong2_m[16], *longlong2_n[32];
  // CHECK: int longlong2_o = sizeof(sycl::mlonglong2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlonglong2 *> longlong2_e_acc_ct0(longlong2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlonglong2 *> longlong2_cast_acc_ct1((sycl::mlonglong2 *)longlong2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mlonglong2 longlong2_r = (sycl::mlonglong2){1,1};
  // CHECK-NEXT: auto longlong2_s = (sycl::mlonglong2){1,1};
  longlong2 longlong2_r = (longlong2){1,1};
  auto longlong2_s = (longlong2){1,1};
  return 0;
}

// CHECK: void func3_longlong3(sycl::mlonglong3 a, sycl::mlonglong3 b, sycl::mlonglong3 c) {
void func3_longlong3(longlong3 a, longlong3 b, longlong3 c) {
}
// CHECK: void func_longlong3(sycl::mlonglong3 a) {
void func_longlong3(longlong3 a) {
}
// CHECK: void kernel_longlong3(sycl::mlonglong3 *a, sycl::mlonglong3 *b) {
__global__ void kernel_longlong3(longlong3 *a, longlong3 *b) {
}

int main_longlong3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mlonglong3 longlong3_a;
  longlong3 longlong3_a;
  // CHECK: sycl::mlonglong3 longlong3_b = sycl::mlonglong3(1, 2, 3);
  longlong3 longlong3_b = make_longlong3(1, 2, 3);
  // CHECK: sycl::mlonglong3 longlong3_c = sycl::mlonglong3(longlong3_b);
  longlong3 longlong3_c = longlong3(longlong3_b);
  // CHECK: sycl::mlonglong3 longlong3_d(longlong3_c);
  longlong3 longlong3_d(longlong3_c);
  // CHECK: func3_longlong3(longlong3_b, sycl::mlonglong3(longlong3_b), (sycl::mlonglong3)longlong3_b);
  func3_longlong3(longlong3_b, longlong3(longlong3_b), (longlong3)longlong3_b);
  // CHECK: sycl::mlonglong3 *longlong3_e;
  longlong3 *longlong3_e;
  // CHECK: sycl::mlonglong3 *longlong3_f;
  longlong3 *longlong3_f;
  // CHECK: long long longlong3_g = longlong3_c[0];
  long long longlong3_g = longlong3_c.x;
  // CHECK: longlong3_a[0] = longlong3_d[0];
  longlong3_a.x = longlong3_d.x;
  // CHECK: if (longlong3_b[0] == longlong3_d[0]) {}
  if (longlong3_b.x == longlong3_d.x) {}
  // CHECK: sycl::mlonglong3 longlong3_h[16];
  longlong3 longlong3_h[16];
  // CHECK: sycl::mlonglong3 longlong3_i[32];
  longlong3 longlong3_i[32];
  // CHECK: if (longlong3_h[12][0] == longlong3_i[12][0]) {}
  if (longlong3_h[12].x == longlong3_i[12].x) {}
  // CHECK: longlong3_f = (sycl::mlonglong3 *)longlong3_i;
  longlong3_f = (longlong3 *)longlong3_i;
  // CHECK: longlong3_a = (sycl::mlonglong3)longlong3_c;
  longlong3_a = (longlong3)longlong3_c;
  // CHECK: longlong3_b = sycl::mlonglong3(longlong3_b);
  longlong3_b = longlong3(longlong3_b);
  // CHECK: sycl::mlonglong3 longlong3_j, longlong3_k, longlong3_l, longlong3_m[16], *longlong3_n[32];
  longlong3 longlong3_j, longlong3_k, longlong3_l, longlong3_m[16], *longlong3_n[32];
  // CHECK: int longlong3_o = sizeof(sycl::mlonglong3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlonglong3 *> longlong3_e_acc_ct0(longlong3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlonglong3 *> longlong3_cast_acc_ct1((sycl::mlonglong3 *)longlong3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mlonglong3 longlong3_r = (sycl::mlonglong3){1,1,1};
  // CHECK-NEXT: auto longlong3_s = (sycl::mlonglong3){1,1,1};
  longlong3 longlong3_r = (longlong3){1,1,1};
  auto longlong3_s = (longlong3){1,1,1};
  return 0;
}

// CHECK: void func3_longlong4(sycl::mlonglong4 a, sycl::mlonglong4 b, sycl::mlonglong4 c) {
void func3_longlong4(longlong4 a, longlong4 b, longlong4 c) {
}
// CHECK: void func_longlong4(sycl::mlonglong4 a) {
void func_longlong4(longlong4 a) {
}
// CHECK: void kernel_longlong4(sycl::mlonglong4 *a, sycl::mlonglong4 *b) {
__global__ void kernel_longlong4(longlong4 *a, longlong4 *b) {
}

int main_longlong4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mlonglong4 longlong4_a;
  longlong4 longlong4_a;
  // CHECK: sycl::mlonglong4 longlong4_b = sycl::mlonglong4(1, 2, 3, 4);
  longlong4 longlong4_b = make_longlong4(1, 2, 3, 4);
  // CHECK: sycl::mlonglong4 longlong4_c = sycl::mlonglong4(longlong4_b);
  longlong4 longlong4_c = longlong4(longlong4_b);
  // CHECK: sycl::mlonglong4 longlong4_d(longlong4_c);
  longlong4 longlong4_d(longlong4_c);
  // CHECK: func3_longlong4(longlong4_b, sycl::mlonglong4(longlong4_b), (sycl::mlonglong4)longlong4_b);
  func3_longlong4(longlong4_b, longlong4(longlong4_b), (longlong4)longlong4_b);
  // CHECK: sycl::mlonglong4 *longlong4_e;
  longlong4 *longlong4_e;
  // CHECK: sycl::mlonglong4 *longlong4_f;
  longlong4 *longlong4_f;
  // CHECK: long long longlong4_g = longlong4_c[0];
  long long longlong4_g = longlong4_c.x;
  // CHECK: longlong4_a[0] = longlong4_d[0];
  longlong4_a.x = longlong4_d.x;
  // CHECK: if (longlong4_b[0] == longlong4_d[0]) {}
  if (longlong4_b.x == longlong4_d.x) {}
  // CHECK: sycl::mlonglong4 longlong4_h[16];
  longlong4 longlong4_h[16];
  // CHECK: sycl::mlonglong4 longlong4_i[32];
  longlong4 longlong4_i[32];
  // CHECK: if (longlong4_h[12][0] == longlong4_i[12][0]) {}
  if (longlong4_h[12].x == longlong4_i[12].x) {}
  // CHECK: longlong4_f = (sycl::mlonglong4 *)longlong4_i;
  longlong4_f = (longlong4 *)longlong4_i;
  // CHECK: longlong4_a = (sycl::mlonglong4)longlong4_c;
  longlong4_a = (longlong4)longlong4_c;
  // CHECK: longlong4_b = sycl::mlonglong4(longlong4_b);
  longlong4_b = longlong4(longlong4_b);
  // CHECK: sycl::mlonglong4 longlong4_j, longlong4_k, longlong4_l, longlong4_m[16], *longlong4_n[32];
  longlong4 longlong4_j, longlong4_k, longlong4_l, longlong4_m[16], *longlong4_n[32];
  // CHECK: int longlong4_o = sizeof(sycl::mlonglong4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlonglong4 *> longlong4_e_acc_ct0(longlong4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mlonglong4 *> longlong4_cast_acc_ct1((sycl::mlonglong4 *)longlong4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mlonglong4 longlong4_r = (sycl::mlonglong4){1,1,1,1};
  // CHECK-NEXT: auto longlong4_s = (sycl::mlonglong4){1,1,1,1};
...
// CHECK: void func3_short2(sycl::mshort2 a, sycl::mshort2 b, sycl::mshort2 c) {
void func3_short2(short2 a, short2 b, short2 c) {
}
// CHECK: void func_short2(sycl::mshort2 a) {
void func_short2(short2 a) {
}
// CHECK: void kernel_short2(sycl::mshort2 *a, sycl::mshort2 *b) {
__global__ void kernel_short2(short2 *a, short2 *b) {
}

int main_short2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mshort2 short2_a;
  short2 short2_a;
  // CHECK: sycl::mshort2 short2_b = sycl::mshort2(1, 2);
  short2 short2_b = make_short2(1, 2);
  // CHECK: sycl::mshort2 short2_c = sycl::mshort2(short2_b);
  short2 short2_c = short2(short2_b);
  // CHECK: sycl::mshort2 short2_d(short2_c);
  short2 short2_d(short2_c);
  // CHECK: func3_short2(short2_b, sycl::mshort2(short2_b), (sycl::mshort2)short2_b);
  func3_short2(short2_b, short2(short2_b), (short2)short2_b);
  // CHECK: sycl::mshort2 *short2_e;
  short2 *short2_e;
  // CHECK: sycl::mshort2 *short2_f;
  short2 *short2_f;
  // CHECK: short short2_g = short2_c[0];
  short short2_g = short2_c.x;
  // CHECK: short2_a[0] = short2_d[0];
  short2_a.x = short2_d.x;
  // CHECK: if (short2_b[0] == short2_d[0]) {}
  if (short2_b.x == short2_d.x) {}
  // CHECK: sycl::mshort2 short2_h[16];
  short2 short2_h[16];
  // CHECK: sycl::mshort2 short2_i[32];
  short2 short2_i[32];
  // CHECK: if (short2_h[12][0] == short2_i[12][0]) {}
  if (short2_h[12].x == short2_i[12].x) {}
  // CHECK: short2_f = (sycl::mshort2 *)short2_i;
  short2_f = (short2 *)short2_i;
  // CHECK: short2_a = (sycl::mshort2)short2_c;
  short2_a = (short2)short2_c;
  // CHECK: short2_b = sycl::mshort2(short2_b);
  short2_b = short2(short2_b);
  // CHECK: sycl::mshort2 short2_j, short2_k, short2_l, short2_m[16], *short2_n[32];
  short2 short2_j, short2_k, short2_l, short2_m[16], *short2_n[32];
  // CHECK: int short2_o = sizeof(sycl::mshort2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mshort2 *> short2_e_acc_ct0(short2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mshort2 *> short2_cast_acc_ct1((sycl::mshort2 *)short2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mshort2 short2_r = (sycl::mshort2){1,1};
  // CHECK-NEXT: auto short2_s = (sycl::mshort2){1,1};
  short2 short2_r = (short2){1,1};
  auto short2_s = (short2){1,1};
  return 0;
}

// CHECK: void func3_short3(sycl::mshort3 a, sycl::mshort3 b, sycl::mshort3 c) {
void func3_short3(short3 a, short3 b, short3 c) {
}
// CHECK: void func_short3(sycl::mshort3 a) {
void func_short3(short3 a) {
}
// CHECK: void kernel_short3(sycl::mshort3 *a, sycl::mshort3 *b) {
__global__ void kernel_short3(short3 *a, short3 *b) {
}

int main_short3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mshort3 short3_a;
  short3 short3_a;
  // CHECK: sycl::mshort3 short3_b = sycl::mshort3(1, 2, 3);
  short3 short3_b = make_short3(1, 2, 3);
  // CHECK: sycl::mshort3 short3_c = sycl::mshort3(short3_b);
  short3 short3_c = short3(short3_b);
  // CHECK: sycl::mshort3 short3_d(short3_c);
  short3 short3_d(short3_c);
  // CHECK: func3_short3(short3_b, sycl::mshort3(short3_b), (sycl::mshort3)short3_b);
  func3_short3(short3_b, short3(short3_b), (short3)short3_b);
  // CHECK: sycl::mshort3 *short3_e;
  short3 *short3_e;
  // CHECK: sycl::mshort3 *short3_f;
  short3 *short3_f;
  // CHECK: short short3_g = short3_c[0];
  short short3_g = short3_c.x;
  // CHECK: short3_a[0] = short3_d[0];
  short3_a.x = short3_d.x;
  // CHECK: if (short3_b[0] == short3_d[0]) {}
  if (short3_b.x == short3_d.x) {}
  // CHECK: sycl::mshort3 short3_h[16];
  short3 short3_h[16];
  // CHECK: sycl::mshort3 short3_i[32];
  short3 short3_i[32];
  // CHECK: if (short3_h[12][0] == short3_i[12][0]) {}
  if (short3_h[12].x == short3_i[12].x) {}
  // CHECK: short3_f = (sycl::mshort3 *)short3_i;
  short3_f = (short3 *)short3_i;
  // CHECK: short3_a = (sycl::mshort3)short3_c;
  short3_a = (short3)short3_c;
  // CHECK: short3_b = sycl::mshort3(short3_b);
  short3_b = short3(short3_b);
  // CHECK: sycl::mshort3 short3_j, short3_k, short3_l, short3_m[16], *short3_n[32];
  short3 short3_j, short3_k, short3_l, short3_m[16], *short3_n[32];
  // CHECK: int short3_o = sizeof(sycl::mshort3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mshort3 *> short3_e_acc_ct0(short3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mshort3 *> short3_cast_acc_ct1((sycl::mshort3 *)short3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mshort3 short3_r = (sycl::mshort3){1,1,1};
  // CHECK-NEXT: auto short3_s = (sycl::mshort3){1,1,1};
  short3 short3_r = (short3){1,1,1};
  auto short3_s = (short3){1,1,1};
  return 0;
}

// CHECK: void func3_short4(sycl::mshort4 a, sycl::mshort4 b, sycl::mshort4 c) {
void func3_short4(short4 a, short4 b, short4 c) {
}
// CHECK: void func_short4(sycl::mshort4 a) {
void func_short4(short4 a) {
}
// CHECK: void kernel_short4(sycl::mshort4 *a, sycl::mshort4 *b) {
__global__ void kernel_short4(short4 *a, short4 *b) {
}

int main_short4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mshort4 short4_a;
  short4 short4_a;
  // CHECK: sycl::mshort4 short4_b = sycl::mshort4(1, 2, 3, 4);
  short4 short4_b = make_short4(1, 2, 3, 4);
  // CHECK: sycl::mshort4 short4_c = sycl::mshort4(short4_b);
  short4 short4_c = short4(short4_b);
  // CHECK: sycl::mshort4 short4_d(short4_c);
  short4 short4_d(short4_c);
  // CHECK: func3_short4(short4_b, sycl::mshort4(short4_b), (sycl::mshort4)short4_b);
  func3_short4(short4_b, short4(short4_b), (short4)short4_b);
  // CHECK: sycl::mshort4 *short4_e;
  short4 *short4_e;
  // CHECK: sycl::mshort4 *short4_f;
  short4 *short4_f;
  // CHECK: short short4_g = short4_c[0];
  short short4_g = short4_c.x;
  // CHECK: short4_a[0] = short4_d[0];
  short4_a.x = short4_d.x;
  // CHECK: if (short4_b[0] == short4_d[0]) {}
  if (short4_b.x == short4_d.x) {}
  // CHECK: sycl::mshort4 short4_h[16];
  short4 short4_h[16];
  // CHECK: sycl::mshort4 short4_i[32];
  short4 short4_i[32];
  // CHECK: if (short4_h[12][0] == short4_i[12][0]) {}
  if (short4_h[12].x == short4_i[12].x) {}
  // CHECK: short4_f = (sycl::mshort4 *)short4_i;
  short4_f = (short4 *)short4_i;
  // CHECK: short4_a = (sycl::mshort4)short4_c;
  short4_a = (short4)short4_c;
  // CHECK: short4_b = sycl::mshort4(short4_b);
  short4_b = short4(short4_b);
  // CHECK: sycl::mshort4 short4_j, short4_k, short4_l, short4_m[16], *short4_n[32];
  short4 short4_j, short4_k, short4_l, short4_m[16], *short4_n[32];
  // CHECK: int short4_o = sizeof(sycl::mshort4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mshort4 *> short4_e_acc_ct0(short4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mshort4 *> short4_cast_acc_ct1((sycl::mshort4 *)short4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mshort4 short4_r = (sycl::mshort4){1,1,1,1};
  // CHECK-NEXT: auto short4_s = (sycl::mshort4){1,1,1,1};
...
// CHECK: void func3_uchar2(sycl::muchar2 a, sycl::muchar2 b, sycl::muchar2 c) {
void func3_uchar2(uchar2 a, uchar2 b, uchar2 c) {
}
// CHECK: void func_uchar2(sycl::muchar2 a) {
void func_uchar2(uchar2 a) {
}
// CHECK: void kernel_uchar2(sycl::muchar2 *a, sycl::muchar2 *b) {
__global__ void kernel_uchar2(uchar2 *a, uchar2 *b) {
}

int main_uchar2() {
  // range default constructor does the right thing.
  // CHECK: sycl::muchar2 uchar2_a;
  uchar2 uchar2_a;
  // CHECK: sycl::muchar2 uchar2_b = sycl::muchar2(1, 2);
  uchar2 uchar2_b = make_uchar2(1, 2);
  // CHECK: sycl::muchar2 uchar2_c = sycl::muchar2(uchar2_b);
  uchar2 uchar2_c = uchar2(uchar2_b);
  // CHECK: sycl::muchar2 uchar2_d(uchar2_c);
  uchar2 uchar2_d(uchar2_c);
  // CHECK: func3_uchar2(uchar2_b, sycl::muchar2(uchar2_b), (sycl::muchar2)uchar2_b);
  func3_uchar2(uchar2_b, uchar2(uchar2_b), (uchar2)uchar2_b);
  // CHECK: sycl::muchar2 *uchar2_e;
  uchar2 *uchar2_e;
  // CHECK: sycl::muchar2 *uchar2_f;
  uchar2 *uchar2_f;
  // CHECK: unsigned char uchar2_g = uchar2_c[0];
  unsigned char uchar2_g = uchar2_c.x;
  // CHECK: uchar2_a[0] = uchar2_d[0];
  uchar2_a.x = uchar2_d.x;
  // CHECK: if (uchar2_b[0] == uchar2_d[0]) {}
  if (uchar2_b.x == uchar2_d.x) {}
  // CHECK: sycl::muchar2 uchar2_h[16];
  uchar2 uchar2_h[16];
  // CHECK: sycl::muchar2 uchar2_i[32];
  uchar2 uchar2_i[32];
  // CHECK: if (uchar2_h[12][0] == uchar2_i[12][0]) {}
  if (uchar2_h[12].x == uchar2_i[12].x) {}
  // CHECK: uchar2_f = (sycl::muchar2 *)uchar2_i;
  uchar2_f = (uchar2 *)uchar2_i;
  // CHECK: uchar2_a = (sycl::muchar2)uchar2_c;
  uchar2_a = (uchar2)uchar2_c;
  // CHECK: uchar2_b = sycl::muchar2(uchar2_b);
  uchar2_b = uchar2(uchar2_b);
  // CHECK: sycl::muchar2 uchar2_j, uchar2_k, uchar2_l, uchar2_m[16], *uchar2_n[32];
  uchar2 uchar2_j, uchar2_k, uchar2_l, uchar2_m[16], *uchar2_n[32];
  // CHECK: int uchar2_o = sizeof(sycl::muchar2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muchar2 *> uchar2_e_acc_ct0(uchar2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muchar2 *> uchar2_cast_acc_ct1((sycl::muchar2 *)uchar2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::muchar2 uchar2_r = (sycl::muchar2){1,1};
  // CHECK-NEXT: auto uchar2_s = (sycl::muchar2){1,1};
  uchar2 uchar2_r = (uchar2){1,1};
  auto uchar2_s = (uchar2){1,1};
  return 0;
}

// CHECK: void func3_uchar3(sycl::muchar3 a, sycl::muchar3 b, sycl::muchar3 c) {
void func3_uchar3(uchar3 a, uchar3 b, uchar3 c) {
}
// CHECK: void func_uchar3(sycl::muchar3 a) {
void func_uchar3(uchar3 a) {
}
// CHECK: void kernel_uchar3(sycl::muchar3 *a, sycl::muchar3 *b) {
__global__ void kernel_uchar3(uchar3 *a, uchar3 *b) {
}

int main_uchar3() {
  // range default constructor does the right thing.
  // CHECK: sycl::muchar3 uchar3_a;
  uchar3 uchar3_a;
  // CHECK: sycl::muchar3 uchar3_b = sycl::muchar3(1, 2, 3);
  uchar3 uchar3_b = make_uchar3(1, 2, 3);
  // CHECK: sycl::muchar3 uchar3_c = sycl::muchar3(uchar3_b);
  uchar3 uchar3_c = uchar3(uchar3_b);
  // CHECK: sycl::muchar3 uchar3_d(uchar3_c);
  uchar3 uchar3_d(uchar3_c);
  // CHECK: func3_uchar3(uchar3_b, sycl::muchar3(uchar3_b), (sycl::muchar3)uchar3_b);
  func3_uchar3(uchar3_b, uchar3(uchar3_b), (uchar3)uchar3_b);
  // CHECK: sycl::muchar3 *uchar3_e;
  uchar3 *uchar3_e;
  // CHECK: sycl::muchar3 *uchar3_f;
  uchar3 *uchar3_f;
  // CHECK: unsigned char uchar3_g = uchar3_c[0];
  unsigned char uchar3_g = uchar3_c.x;
  // CHECK: uchar3_a[0] = uchar3_d[0];
  uchar3_a.x = uchar3_d.x;
  // CHECK: if (uchar3_b[0] == uchar3_d[0]) {}
  if (uchar3_b.x == uchar3_d.x) {}
  // CHECK: sycl::muchar3 uchar3_h[16];
  uchar3 uchar3_h[16];
  // CHECK: sycl::muchar3 uchar3_i[32];
  uchar3 uchar3_i[32];
  // CHECK: if (uchar3_h[12][0] == uchar3_i[12][0]) {}
  if (uchar3_h[12].x == uchar3_i[12].x) {}
  // CHECK: uchar3_f = (sycl::muchar3 *)uchar3_i;
  uchar3_f = (uchar3 *)uchar3_i;
  // CHECK: uchar3_a = (sycl::muchar3)uchar3_c;
  uchar3_a = (uchar3)uchar3_c;
  // CHECK: uchar3_b = sycl::muchar3(uchar3_b);
  uchar3_b = uchar3(uchar3_b);
  // CHECK: sycl::muchar3 uchar3_j, uchar3_k, uchar3_l, uchar3_m[16], *uchar3_n[32];
  uchar3 uchar3_j, uchar3_k, uchar3_l, uchar3_m[16], *uchar3_n[32];
  // CHECK: int uchar3_o = sizeof(sycl::muchar3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muchar3 *> uchar3_e_acc_ct0(uchar3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muchar3 *> uchar3_cast_acc_ct1((sycl::muchar3 *)uchar3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::muchar3 uchar3_r = (sycl::muchar3){1,1,1};
  // CHECK-NEXT: auto uchar3_s = (sycl::muchar3){1,1,1};
  uchar3 uchar3_r = (uchar3){1,1,1};
  auto uchar3_s = (uchar3){1,1,1};
  return 0;
}

// CHECK: void func3_uchar4(sycl::muchar4 a, sycl::muchar4 b, sycl::muchar4 c) {
void func3_uchar4(uchar4 a, uchar4 b, uchar4 c) {
}
// CHECK: void func_uchar4(sycl::muchar4 a) {
void func_uchar4(uchar4 a) {
}
// CHECK: void kernel_uchar4(sycl::muchar4 *a, sycl::muchar4 *b) {
__global__ void kernel_uchar4(uchar4 *a, uchar4 *b) {
}

int main_uchar4() {
  // range default constructor does the right thing.
  // CHECK: sycl::muchar4 uchar4_a;
  uchar4 uchar4_a;
  // CHECK: sycl::muchar4 uchar4_b = sycl::muchar4(1, 2, 3, 4);
  uchar4 uchar4_b = make_uchar4(1, 2, 3, 4);
  // CHECK: sycl::muchar4 uchar4_c = sycl::muchar4(uchar4_b);
  uchar4 uchar4_c = uchar4(uchar4_b);
  // CHECK: sycl::muchar4 uchar4_d(uchar4_c);
  uchar4 uchar4_d(uchar4_c);
  // CHECK: func3_uchar4(uchar4_b, sycl::muchar4(uchar4_b), (sycl::muchar4)uchar4_b);
  func3_uchar4(uchar4_b, uchar4(uchar4_b), (uchar4)uchar4_b);
  // CHECK: sycl::muchar4 *uchar4_e;
  uchar4 *uchar4_e;
  // CHECK: sycl::muchar4 *uchar4_f;
  uchar4 *uchar4_f;
  // CHECK: unsigned char uchar4_g = uchar4_c[0];
  unsigned char uchar4_g = uchar4_c.x;
  // CHECK: uchar4_a[0] = uchar4_d[0];
  uchar4_a.x = uchar4_d.x;
  // CHECK: if (uchar4_b[0] == uchar4_d[0]) {}
  if (uchar4_b.x == uchar4_d.x) {}
  // CHECK: sycl::muchar4 uchar4_h[16];
  uchar4 uchar4_h[16];
  // CHECK: sycl::muchar4 uchar4_i[32];
  uchar4 uchar4_i[32];
  // CHECK: if (uchar4_h[12][0] == uchar4_i[12][0]) {}
  if (uchar4_h[12].x == uchar4_i[12].x) {}
  // CHECK: uchar4_f = (sycl::muchar4 *)uchar4_i;
  uchar4_f = (uchar4 *)uchar4_i;
  // CHECK: uchar4_a = (sycl::muchar4)uchar4_c;
  uchar4_a = (uchar4)uchar4_c;
  // CHECK: uchar4_b = sycl::muchar4(uchar4_b);
  uchar4_b = uchar4(uchar4_b);
  // CHECK: sycl::muchar4 uchar4_j, uchar4_k, uchar4_l, uchar4_m[16], *uchar4_n[32];
  uchar4 uchar4_j, uchar4_k, uchar4_l, uchar4_m[16], *uchar4_n[32];
  // CHECK: int uchar4_o = sizeof(sycl::muchar4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muchar4 *> uchar4_e_acc_ct0(uchar4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muchar4 *> uchar4_cast_acc_ct1((sycl::muchar4 *)uchar4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::muchar4 uchar4_r = (sycl::muchar4){1,1,1,1};
  // CHECK-NEXT: auto uchar4_s = (sycl::muchar4){1,1,1,1};
...
// CHECK: void func3_uint2(sycl::muint2 a, sycl::muint2 b, sycl::muint2 c) {
void func3_uint2(uint2 a, uint2 b, uint2 c) {
}
// CHECK: void func_uint2(sycl::muint2 a) {
void func_uint2(uint2 a) {
}
// CHECK: void kernel_uint2(sycl::muint2 *a, sycl::muint2 *b) {
__global__ void kernel_uint2(uint2 *a, uint2 *b) {
}

int main_uint2() {
  // range default constructor does the right thing.
  // CHECK: sycl::muint2 uint2_a;
  uint2 uint2_a;
  // CHECK: sycl::muint2 uint2_b = sycl::muint2(1, 2);
  uint2 uint2_b = make_uint2(1, 2);
  // CHECK: sycl::muint2 uint2_c = sycl::muint2(uint2_b);
  uint2 uint2_c = uint2(uint2_b);
  // CHECK: sycl::muint2 uint2_d(uint2_c);
  uint2 uint2_d(uint2_c);
  // CHECK: func3_uint2(uint2_b, sycl::muint2(uint2_b), (sycl::muint2)uint2_b);
  func3_uint2(uint2_b, uint2(uint2_b), (uint2)uint2_b);
  // CHECK: sycl::muint2 *uint2_e;
  uint2 *uint2_e;
  // CHECK: sycl::muint2 *uint2_f;
  uint2 *uint2_f;
  // CHECK: unsigned int uint2_g = uint2_c[0];
  unsigned int uint2_g = uint2_c.x;
  // CHECK: uint2_a[0] = uint2_d[0];
  uint2_a.x = uint2_d.x;
  // CHECK: if (uint2_b[0] == uint2_d[0]) {}
  if (uint2_b.x == uint2_d.x) {}
  // CHECK: sycl::muint2 uint2_h[16];
  uint2 uint2_h[16];
  // CHECK: sycl::muint2 uint2_i[32];
  uint2 uint2_i[32];
  // CHECK: if (uint2_h[12][0] == uint2_i[12][0]) {}
  if (uint2_h[12].x == uint2_i[12].x) {}
  // CHECK: uint2_f = (sycl::muint2 *)uint2_i;
  uint2_f = (uint2 *)uint2_i;
  // CHECK: uint2_a = (sycl::muint2)uint2_c;
  uint2_a = (uint2)uint2_c;
  // CHECK: uint2_b = sycl::muint2(uint2_b);
  uint2_b = uint2(uint2_b);
  // CHECK: sycl::muint2 uint2_j, uint2_k, uint2_l, uint2_m[16], *uint2_n[32];
  uint2 uint2_j, uint2_k, uint2_l, uint2_m[16], *uint2_n[32];
  // CHECK: int uint2_o = sizeof(sycl::muint2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muint2 *> uint2_e_acc_ct0(uint2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muint2 *> uint2_cast_acc_ct1((sycl::muint2 *)uint2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::muint2 uint2_r = (sycl::muint2){1,1};
  // CHECK-NEXT: auto uint2_s = (sycl::muint2){1,1};
  uint2 uint2_r = (uint2){1,1};
  auto uint2_s = (uint2){1,1};
  return 0;
}

// CHECK: void func3_uint3(sycl::muint3 a, sycl::muint3 b, sycl::muint3 c) {
void func3_uint3(uint3 a, uint3 b, uint3 c) {
}
// CHECK: void func_uint3(sycl::muint3 a) {
void func_uint3(uint3 a) {
}
// CHECK: void kernel_uint3(sycl::muint3 *a, sycl::muint3 *b) {
__global__ void kernel_uint3(uint3 *a, uint3 *b) {
}

int main_uint3() {
  // range default constructor does the right thing.
  // CHECK: sycl::muint3 uint3_a;
  uint3 uint3_a;
  // CHECK: sycl::muint3 uint3_b = sycl::muint3(1, 2, 3);
  uint3 uint3_b = make_uint3(1, 2, 3);
  // CHECK: sycl::muint3 uint3_c = sycl::muint3(uint3_b);
  uint3 uint3_c = uint3(uint3_b);
  // CHECK: sycl::muint3 uint3_d(uint3_c);
  uint3 uint3_d(uint3_c);
  // CHECK: func3_uint3(uint3_b, sycl::muint3(uint3_b), (sycl::muint3)uint3_b);
  func3_uint3(uint3_b, uint3(uint3_b), (uint3)uint3_b);
  // CHECK: sycl::muint3 *uint3_e;
  uint3 *uint3_e;
  // CHECK: sycl::muint3 *uint3_f;
  uint3 *uint3_f;
  // CHECK: unsigned int uint3_g = uint3_c[0];
  unsigned int uint3_g = uint3_c.x;
  // CHECK: uint3_a[0] = uint3_d[0];
  uint3_a.x = uint3_d.x;
  // CHECK: if (uint3_b[0] == uint3_d[0]) {}
  if (uint3_b.x == uint3_d.x) {}
  // CHECK: sycl::muint3 uint3_h[16];
  uint3 uint3_h[16];
  // CHECK: sycl::muint3 uint3_i[32];
  uint3 uint3_i[32];
  // CHECK: if (uint3_h[12][0] == uint3_i[12][0]) {}
  if (uint3_h[12].x == uint3_i[12].x) {}
  // CHECK: uint3_f = (sycl::muint3 *)uint3_i;
  uint3_f = (uint3 *)uint3_i;
  // CHECK: uint3_a = (sycl::muint3)uint3_c;
  uint3_a = (uint3)uint3_c;
  // CHECK: uint3_b = sycl::muint3(uint3_b);
  uint3_b = uint3(uint3_b);
  // CHECK: sycl::muint3 uint3_j, uint3_k, uint3_l, uint3_m[16], *uint3_n[32];
  uint3 uint3_j, uint3_k, uint3_l, uint3_m[16], *uint3_n[32];
  // CHECK: int uint3_o = sizeof(sycl::muint3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muint3 *> uint3_e_acc_ct0(uint3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muint3 *> uint3_cast_acc_ct1((sycl::muint3 *)uint3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::muint3 uint3_r = (sycl::muint3){1,1,1};
  // CHECK-NEXT: auto uint3_s = (sycl::muint3){1,1,1};
  uint3 uint3_r = (uint3){1,1,1};
  auto uint3_s = (uint3){1,1,1};
  return 0;
}

// CHECK: void func3_uint4(sycl::muint4 a, sycl::muint4 b, sycl::muint4 c) {
void func3_uint4(uint4 a, uint4 b, uint4 c) {
}
// CHECK: void func_uint4(sycl::muint4 a) {
void func_uint4(uint4 a) {
}
// CHECK: void kernel_uint4(sycl::muint4 *a, sycl::muint4 *b) {
__global__ void kernel_uint4(uint4 *a, uint4 *b) {
}

int main_uint4() {
  // range default constructor does the right thing.
  // CHECK: sycl::muint4 uint4_a;
  uint4 uint4_a;
  // CHECK: sycl::muint4 uint4_b = sycl::muint4(1, 2, 3, 4);
  uint4 uint4_b = make_uint4(1, 2, 3, 4);
  // CHECK: sycl::muint4 uint4_c = sycl::muint4(uint4_b);
  uint4 uint4_c = uint4(uint4_b);
  // CHECK: sycl::muint4 uint4_d(uint4_c);
  uint4 uint4_d(uint4_c);
  // CHECK: func3_uint4(uint4_b, sycl::muint4(uint4_b), (sycl::muint4)uint4_b);
  func3_uint4(uint4_b, uint4(uint4_b), (uint4)uint4_b);
  // CHECK: sycl::muint4 *uint4_e;
  uint4 *uint4_e;
  // CHECK: sycl::muint4 *uint4_f;
  uint4 *uint4_f;
  // CHECK: unsigned int uint4_g = uint4_c[0];
  unsigned int uint4_g = uint4_c.x;
  // CHECK: uint4_a[0] = uint4_d[0];
  uint4_a.x = uint4_d.x;
  // CHECK: if (uint4_b[0] == uint4_d[0]) {}
  if (uint4_b.x == uint4_d.x) {}
  // CHECK: sycl::muint4 uint4_h[16];
  uint4 uint4_h[16];
  // CHECK: sycl::muint4 uint4_i[32];
  uint4 uint4_i[32];
  // CHECK: if (uint4_h[12][0] == uint4_i[12][0]) {}
  if (uint4_h[12].x == uint4_i[12].x) {}
  // CHECK: uint4_f = (sycl::muint4 *)uint4_i;
  uint4_f = (uint4 *)uint4_i;
  // CHECK: uint4_a = (sycl::muint4)uint4_c;
  uint4_a = (uint4)uint4_c;
  // CHECK: uint4_b = sycl::muint4(uint4_b);
  uint4_b = uint4(uint4_b);
  // CHECK: sycl::muint4 uint4_j, uint4_k, uint4_l, uint4_m[16], *uint4_n[32];
  uint4 uint4_j, uint4_k, uint4_l, uint4_m[16], *uint4_n[32];
  // CHECK: int uint4_o = sizeof(sycl::muint4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muint4 *> uint4_e_acc_ct0(uint4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::muint4 *> uint4_cast_acc_ct1((sycl::muint4 *)uint4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::muint4 uint4_r = (sycl::muint4){1,1,1,1};
  // CHECK-NEXT: auto uint4_s = (sycl::muint4){1,1,1,1};
...
// CHECK: void func3_ulong2(sycl::mulong2 a, sycl::mulong2 b, sycl::mulong2 c) {
void func3_ulong2(ulong2 a, ulong2 b, ulong2 c) {
}
// CHECK: void func_ulong2(sycl::mulong2 a) {
void func_ulong2(ulong2 a) {
}
// CHECK: void kernel_ulong2(sycl::mulong2 *a, sycl::mulong2 *b) {
__global__ void kernel_ulong2(ulong2 *a, ulong2 *b) {
}

int main_ulong2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mulong2 ulong2_a;
  ulong2 ulong2_a;
  // CHECK: sycl::mulong2 ulong2_b = sycl::mulong2(1, 2);
  ulong2 ulong2_b = make_ulong2(1, 2);
  // CHECK: sycl::mulong2 ulong2_c = sycl::mulong2(ulong2_b);
  ulong2 ulong2_c = ulong2(ulong2_b);
  // CHECK: sycl::mulong2 ulong2_d(ulong2_c);
  ulong2 ulong2_d(ulong2_c);
  // CHECK: func3_ulong2(ulong2_b, sycl::mulong2(ulong2_b), (sycl::mulong2)ulong2_b);
  func3_ulong2(ulong2_b, ulong2(ulong2_b), (ulong2)ulong2_b);
  // CHECK: sycl::mulong2 *ulong2_e;
  ulong2 *ulong2_e;
  // CHECK: sycl::mulong2 *ulong2_f;
  ulong2 *ulong2_f;
  // CHECK: unsigned long ulong2_g = ulong2_c[0];
  unsigned long ulong2_g = ulong2_c.x;
  // CHECK: ulong2_a[0] = ulong2_d[0];
  ulong2_a.x = ulong2_d.x;
  // CHECK: if (ulong2_b[0] == ulong2_d[0]) {}
  if (ulong2_b.x == ulong2_d.x) {}
  // CHECK: sycl::mulong2 ulong2_h[16];
  ulong2 ulong2_h[16];
  // CHECK: sycl::mulong2 ulong2_i[32];
  ulong2 ulong2_i[32];
  // CHECK: if (ulong2_h[12][0] == ulong2_i[12][0]) {}
  if (ulong2_h[12].x == ulong2_i[12].x) {}
  // CHECK: ulong2_f = (sycl::mulong2 *)ulong2_i;
  ulong2_f = (ulong2 *)ulong2_i;
  // CHECK: ulong2_a = (sycl::mulong2)ulong2_c;
  ulong2_a = (ulong2)ulong2_c;
  // CHECK: ulong2_b = sycl::mulong2(ulong2_b);
  ulong2_b = ulong2(ulong2_b);
  // CHECK: sycl::mulong2 ulong2_j, ulong2_k, ulong2_l, ulong2_m[16], *ulong2_n[32];
  ulong2 ulong2_j, ulong2_k, ulong2_l, ulong2_m[16], *ulong2_n[32];
  // CHECK: int ulong2_o = sizeof(sycl::mulong2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulong2 *> ulong2_e_acc_ct0(ulong2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulong2 *> ulong2_cast_acc_ct1((sycl::mulong2 *)ulong2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mulong2 ulong2_r = (sycl::mulong2){1,1};
  // CHECK-NEXT: auto ulong2_s = (sycl::mulong2){1,1};
  ulong2 ulong2_r = (ulong2){1,1};
  auto ulong2_s = (ulong2){1,1};
  return 0;
}

// CHECK: void func3_ulong3(sycl::mulong3 a, sycl::mulong3 b, sycl::mulong3 c) {
void func3_ulong3(ulong3 a, ulong3 b, ulong3 c) {
}
// CHECK: void func_ulong3(sycl::mulong3 a) {
void func_ulong3(ulong3 a) {
}
// CHECK: void kernel_ulong3(sycl::mulong3 *a, sycl::mulong3 *b) {
__global__ void kernel_ulong3(ulong3 *a, ulong3 *b) {
}

int main_ulong3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mulong3 ulong3_a;
  ulong3 ulong3_a;
  // CHECK: sycl::mulong3 ulong3_b = sycl::mulong3(1, 2, 3);
  ulong3 ulong3_b = make_ulong3(1, 2, 3);
  // CHECK: sycl::mulong3 ulong3_c = sycl::mulong3(ulong3_b);
  ulong3 ulong3_c = ulong3(ulong3_b);
  // CHECK: sycl::mulong3 ulong3_d(ulong3_c);
  ulong3 ulong3_d(ulong3_c);
  // CHECK: func3_ulong3(ulong3_b, sycl::mulong3(ulong3_b), (sycl::mulong3)ulong3_b);
  func3_ulong3(ulong3_b, ulong3(ulong3_b), (ulong3)ulong3_b);
  // CHECK: sycl::mulong3 *ulong3_e;
  ulong3 *ulong3_e;
  // CHECK: sycl::mulong3 *ulong3_f;
  ulong3 *ulong3_f;
  // CHECK: unsigned long ulong3_g = ulong3_c[0];
  unsigned long ulong3_g = ulong3_c.x;
  // CHECK: ulong3_a[0] = ulong3_d[0];
  ulong3_a.x = ulong3_d.x;
  // CHECK: if (ulong3_b[0] == ulong3_d[0]) {}
  if (ulong3_b.x == ulong3_d.x) {}
  // CHECK: sycl::mulong3 ulong3_h[16];
  ulong3 ulong3_h[16];
  // CHECK: sycl::mulong3 ulong3_i[32];
  ulong3 ulong3_i[32];
  // CHECK: if (ulong3_h[12][0] == ulong3_i[12][0]) {}
  if (ulong3_h[12].x == ulong3_i[12].x) {}
  // CHECK: ulong3_f = (sycl::mulong3 *)ulong3_i;
  ulong3_f = (ulong3 *)ulong3_i;
  // CHECK: ulong3_a = (sycl::mulong3)ulong3_c;
  ulong3_a = (ulong3)ulong3_c;
  // CHECK: ulong3_b = sycl::mulong3(ulong3_b);
  ulong3_b = ulong3(ulong3_b);
  // CHECK: sycl::mulong3 ulong3_j, ulong3_k, ulong3_l, ulong3_m[16], *ulong3_n[32];
  ulong3 ulong3_j, ulong3_k, ulong3_l, ulong3_m[16], *ulong3_n[32];
  // CHECK: int ulong3_o = sizeof(sycl::mulong3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulong3 *> ulong3_e_acc_ct0(ulong3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulong3 *> ulong3_cast_acc_ct1((sycl::mulong3 *)ulong3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mulong3 ulong3_r = (sycl::mulong3){1,1,1};
  // CHECK-NEXT: auto ulong3_s = (sycl::mulong3){1,1,1};
  ulong3 ulong3_r = (ulong3){1,1,1};
  auto ulong3_s = (ulong3){1,1,1};
  return 0;
}

// CHECK: void func3_ulong4(sycl::mulong4 a, sycl::mulong4 b, sycl::mulong4 c) {
void func3_ulong4(ulong4 a, ulong4 b, ulong4 c) {
}
// CHECK: void func_ulong4(sycl::mulong4 a) {
void func_ulong4(ulong4 a) {
}
// CHECK: void kernel_ulong4(sycl::mulong4 *a, sycl::mulong4 *b) {
__global__ void kernel_ulong4(ulong4 *a, ulong4 *b) {
}

int main_ulong4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mulong4 ulong4_a;
  ulong4 ulong4_a;
  // CHECK: sycl::mulong4 ulong4_b = sycl::mulong4(1, 2, 3, 4);
  ulong4 ulong4_b = make_ulong4(1, 2, 3, 4);
  // CHECK: sycl::mulong4 ulong4_c = sycl::mulong4(ulong4_b);
  ulong4 ulong4_c = ulong4(ulong4_b);
  // CHECK: sycl::mulong4 ulong4_d(ulong4_c);
  ulong4 ulong4_d(ulong4_c);
  // CHECK: func3_ulong4(ulong4_b, sycl::mulong4(ulong4_b), (sycl::mulong4)ulong4_b);
  func3_ulong4(ulong4_b, ulong4(ulong4_b), (ulong4)ulong4_b);
  // CHECK: sycl::mulong4 *ulong4_e;
  ulong4 *ulong4_e;
  // CHECK: sycl::mulong4 *ulong4_f;
  ulong4 *ulong4_f;
  // CHECK: unsigned long ulong4_g = ulong4_c[0];
  unsigned long ulong4_g = ulong4_c.x;
  // CHECK: ulong4_a[0] = ulong4_d[0];
  ulong4_a.x = ulong4_d.x;
  // CHECK: if (ulong4_b[0] == ulong4_d[0]) {}
  if (ulong4_b.x == ulong4_d.x) {}
  // CHECK: sycl::mulong4 ulong4_h[16];
  ulong4 ulong4_h[16];
  // CHECK: sycl::mulong4 ulong4_i[32];
  ulong4 ulong4_i[32];
  // CHECK: if (ulong4_h[12][0] == ulong4_i[12][0]) {}
  if (ulong4_h[12].x == ulong4_i[12].x) {}
  // CHECK: ulong4_f = (sycl::mulong4 *)ulong4_i;
  ulong4_f = (ulong4 *)ulong4_i;
  // CHECK: ulong4_a = (sycl::mulong4)ulong4_c;
  ulong4_a = (ulong4)ulong4_c;
  // CHECK: ulong4_b = sycl::mulong4(ulong4_b);
  ulong4_b = ulong4(ulong4_b);
  // CHECK: sycl::mulong4 ulong4_j, ulong4_k, ulong4_l, ulong4_m[16], *ulong4_n[32];
  ulong4 ulong4_j, ulong4_k, ulong4_l, ulong4_m[16], *ulong4_n[32];
  // CHECK: int ulong4_o = sizeof(sycl::mulong4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulong4 *> ulong4_e_acc_ct0(ulong4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulong4 *> ulong4_cast_acc_ct1((sycl::mulong4 *)ulong4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mulong4 ulong4_r = (sycl::mulong4){1,1,1,1};
  // CHECK-NEXT: auto ulong4_s = (sycl::mulong4){1,1,1,1};
...
// CHECK: void func3_ulonglong2(sycl::mulonglong2 a, sycl::mulonglong2 b, sycl::mulonglong2 c) {
void func3_ulonglong2(ulonglong2 a, ulonglong2 b, ulonglong2 c) {
}
// CHECK: void func_ulonglong2(sycl::mulonglong2 a) {
void func_ulonglong2(ulonglong2 a) {
}
// CHECK: void kernel_ulonglong2(sycl::mulonglong2 *a, sycl::mulonglong2 *b) {
__global__ void kernel_ulonglong2(ulonglong2 *a, ulonglong2 *b) {
}

int main_ulonglong2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mulonglong2 ulonglong2_a;
  ulonglong2 ulonglong2_a;
  // CHECK: sycl::mulonglong2 ulonglong2_b = sycl::mulonglong2(1, 2);
  ulonglong2 ulonglong2_b = make_ulonglong2(1, 2);
  // CHECK: sycl::mulonglong2 ulonglong2_c = sycl::mulonglong2(ulonglong2_b);
  ulonglong2 ulonglong2_c = ulonglong2(ulonglong2_b);
  // CHECK: sycl::mulonglong2 ulonglong2_d(ulonglong2_c);
  ulonglong2 ulonglong2_d(ulonglong2_c);
  // CHECK: func3_ulonglong2(ulonglong2_b, sycl::mulonglong2(ulonglong2_b), (sycl::mulonglong2)ulonglong2_b);
  func3_ulonglong2(ulonglong2_b, ulonglong2(ulonglong2_b), (ulonglong2)ulonglong2_b);
  // CHECK: sycl::mulonglong2 *ulonglong2_e;
  ulonglong2 *ulonglong2_e;
  // CHECK: sycl::mulonglong2 *ulonglong2_f;
  ulonglong2 *ulonglong2_f;
  // CHECK: unsigned long long ulonglong2_g = ulonglong2_c[0];
  unsigned long long ulonglong2_g = ulonglong2_c.x;
  // CHECK: ulonglong2_a[0] = ulonglong2_d[0];
  ulonglong2_a.x = ulonglong2_d.x;
  // CHECK: if (ulonglong2_b[0] == ulonglong2_d[0]) {}
  if (ulonglong2_b.x == ulonglong2_d.x) {}
  // CHECK: sycl::mulonglong2 ulonglong2_h[16];
  ulonglong2 ulonglong2_h[16];
  // CHECK: sycl::mulonglong2 ulonglong2_i[32];
  ulonglong2 ulonglong2_i[32];
  // CHECK: if (ulonglong2_h[12][0] == ulonglong2_i[12][0]) {}
  if (ulonglong2_h[12].x == ulonglong2_i[12].x) {}
  // CHECK: ulonglong2_f = (sycl::mulonglong2 *)ulonglong2_i;
  ulonglong2_f = (ulonglong2 *)ulonglong2_i;
  // CHECK: ulonglong2_a = (sycl::mulonglong2)ulonglong2_c;
  ulonglong2_a = (ulonglong2)ulonglong2_c;
  // CHECK: ulonglong2_b = sycl::mulonglong2(ulonglong2_b);
  ulonglong2_b = ulonglong2(ulonglong2_b);
  // CHECK: sycl::mulonglong2 ulonglong2_j, ulonglong2_k, ulonglong2_l, ulonglong2_m[16], *ulonglong2_n[32];
  ulonglong2 ulonglong2_j, ulonglong2_k, ulonglong2_l, ulonglong2_m[16], *ulonglong2_n[32];
  // CHECK: int ulonglong2_o = sizeof(sycl::mulonglong2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulonglong2 *> ulonglong2_e_acc_ct0(ulonglong2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulonglong2 *> ulonglong2_cast_acc_ct1((sycl::mulonglong2 *)ulonglong2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mulonglong2 ulonglong2_r = (sycl::mulonglong2){1,1};
  // CHECK-NEXT: auto ulonglong2_s = (sycl::mulonglong2){1,1};
  ulonglong2 ulonglong2_r = (ulonglong2){1,1};
  auto ulonglong2_s = (ulonglong2){1,1};
  return 0;
}

// CHECK: void func3_ulonglong3(sycl::mulonglong3 a, sycl::mulonglong3 b, sycl::mulonglong3 c) {
void func3_ulonglong3(ulonglong3 a, ulonglong3 b, ulonglong3 c) {
}
// CHECK: void func_ulonglong3(sycl::mulonglong3 a) {
void func_ulonglong3(ulonglong3 a) {
}
// CHECK: void kernel_ulonglong3(sycl::mulonglong3 *a, sycl::mulonglong3 *b) {
__global__ void kernel_ulonglong3(ulonglong3 *a, ulonglong3 *b) {
}

int main_ulonglong3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mulonglong3 ulonglong3_a;
  ulonglong3 ulonglong3_a;
  // CHECK: sycl::mulonglong3 ulonglong3_b = sycl::mulonglong3(1, 2, 3);
  ulonglong3 ulonglong3_b = make_ulonglong3(1, 2, 3);
  // CHECK: sycl::mulonglong3 ulonglong3_c = sycl::mulonglong3(ulonglong3_b);
  ulonglong3 ulonglong3_c = ulonglong3(ulonglong3_b);
  // CHECK: sycl::mulonglong3 ulonglong3_d(ulonglong3_c);
  ulonglong3 ulonglong3_d(ulonglong3_c);
  // CHECK: func3_ulonglong3(ulonglong3_b, sycl::mulonglong3(ulonglong3_b), (sycl::mulonglong3)ulonglong3_b);
  func3_ulonglong3(ulonglong3_b, ulonglong3(ulonglong3_b), (ulonglong3)ulonglong3_b);
  // CHECK: sycl::mulonglong3 *ulonglong3_e;
  ulonglong3 *ulonglong3_e;
  // CHECK: sycl::mulonglong3 *ulonglong3_f;
  ulonglong3 *ulonglong3_f;
  // CHECK: unsigned long long ulonglong3_g = ulonglong3_c[0];
  unsigned long long ulonglong3_g = ulonglong3_c.x;
  // CHECK: ulonglong3_a[0] = ulonglong3_d[0];
  ulonglong3_a.x = ulonglong3_d.x;
  // CHECK: if (ulonglong3_b[0] == ulonglong3_d[0]) {}
  if (ulonglong3_b.x == ulonglong3_d.x) {}
  // CHECK: sycl::mulonglong3 ulonglong3_h[16];
  ulonglong3 ulonglong3_h[16];
  // CHECK: sycl::mulonglong3 ulonglong3_i[32];
  ulonglong3 ulonglong3_i[32];
  // CHECK: if (ulonglong3_h[12][0] == ulonglong3_i[12][0]) {}
  if (ulonglong3_h[12].x == ulonglong3_i[12].x) {}
  // CHECK: ulonglong3_f = (sycl::mulonglong3 *)ulonglong3_i;
  ulonglong3_f = (ulonglong3 *)ulonglong3_i;
  // CHECK: ulonglong3_a = (sycl::mulonglong3)ulonglong3_c;
  ulonglong3_a = (ulonglong3)ulonglong3_c;
  // CHECK: ulonglong3_b = sycl::mulonglong3(ulonglong3_b);
  ulonglong3_b = ulonglong3(ulonglong3_b);
  // CHECK: sycl::mulonglong3 ulonglong3_j, ulonglong3_k, ulonglong3_l, ulonglong3_m[16], *ulonglong3_n[32];
  ulonglong3 ulonglong3_j, ulonglong3_k, ulonglong3_l, ulonglong3_m[16], *ulonglong3_n[32];
  // CHECK: int ulonglong3_o = sizeof(sycl::mulonglong3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulonglong3 *> ulonglong3_e_acc_ct0(ulonglong3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulonglong3 *> ulonglong3_cast_acc_ct1((sycl::mulonglong3 *)ulonglong3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mulonglong3 ulonglong3_r = (sycl::mulonglong3){1,1,1};
  // CHECK-NEXT: auto ulonglong3_s = (sycl::mulonglong3){1,1,1};
  ulonglong3 ulonglong3_r = (ulonglong3){1,1,1};
  auto ulonglong3_s = (ulonglong3){1,1,1};
  return 0;
}

// CHECK: void func3_ulonglong4(sycl::mulonglong4 a, sycl::mulonglong4 b, sycl::mulonglong4 c) {
void func3_ulonglong4(ulonglong4 a, ulonglong4 b, ulonglong4 c) {
}
// CHECK: void func_ulonglong4(sycl::mulonglong4 a) {
void func_ulonglong4(ulonglong4 a) {
}
// CHECK: void kernel_ulonglong4(sycl::mulonglong4 *a, sycl::mulonglong4 *b) {
__global__ void kernel_ulonglong4(ulonglong4 *a, ulonglong4 *b) {
}

int main_ulonglong4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mulonglong4 ulonglong4_a;
  ulonglong4 ulonglong4_a;
  // CHECK: sycl::mulonglong4 ulonglong4_b = sycl::mulonglong4(1, 2, 3, 4);
  ulonglong4 ulonglong4_b = make_ulonglong4(1, 2, 3, 4);
  // CHECK: sycl::mulonglong4 ulonglong4_c = sycl::mulonglong4(ulonglong4_b);
  ulonglong4 ulonglong4_c = ulonglong4(ulonglong4_b);
  // CHECK: sycl::mulonglong4 ulonglong4_d(ulonglong4_c);
  ulonglong4 ulonglong4_d(ulonglong4_c);
  // CHECK: func3_ulonglong4(ulonglong4_b, sycl::mulonglong4(ulonglong4_b), (sycl::mulonglong4)ulonglong4_b);
  func3_ulonglong4(ulonglong4_b, ulonglong4(ulonglong4_b), (ulonglong4)ulonglong4_b);
  // CHECK: sycl::mulonglong4 *ulonglong4_e;
  ulonglong4 *ulonglong4_e;
  // CHECK: sycl::mulonglong4 *ulonglong4_f;
  ulonglong4 *ulonglong4_f;
  // CHECK: unsigned long long ulonglong4_g = ulonglong4_c[0];
  unsigned long long ulonglong4_g = ulonglong4_c.x;
  // CHECK: ulonglong4_a[0] = ulonglong4_d[0];
  ulonglong4_a.x = ulonglong4_d.x;
  // CHECK: if (ulonglong4_b[0] == ulonglong4_d[0]) {}
  if (ulonglong4_b.x == ulonglong4_d.x) {}
  // CHECK: sycl::mulonglong4 ulonglong4_h[16];
  ulonglong4 ulonglong4_h[16];
  // CHECK: sycl::mulonglong4 ulonglong4_i[32];
  ulonglong4 ulonglong4_i[32];
  // CHECK: if (ulonglong4_h[12][0] == ulonglong4_i[12][0]) {}
  if (ulonglong4_h[12].x == ulonglong4_i[12].x) {}
  // CHECK: ulonglong4_f = (sycl::mulonglong4 *)ulonglong4_i;
  ulonglong4_f = (ulonglong4 *)ulonglong4_i;
  // CHECK: ulonglong4_a = (sycl::mulonglong4)ulonglong4_c;
  ulonglong4_a = (ulonglong4)ulonglong4_c;
  // CHECK: ulonglong4_b = sycl::mulonglong4(ulonglong4_b);
  ulonglong4_b = ulonglong4(ulonglong4_b);
  // CHECK: sycl::mulonglong4 ulonglong4_j, ulonglong4_k, ulonglong4_l, ulonglong4_m[16], *ulonglong4_n[32];
  ulonglong4 ulonglong4_j, ulonglong4_k, ulonglong4_l, ulonglong4_m[16], *ulonglong4_n[32];
  // CHECK: int ulonglong4_o = sizeof(sycl::mulonglong4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulonglong4 *> ulonglong4_e_acc_ct0(ulonglong4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mulonglong4 *> ulonglong4_cast_acc_ct1((sycl::mulonglong4 *)ulonglong4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mulonglong4 ulonglong4_r = (sycl::mulonglong4){1,1,1,1};
  // CHECK-NEXT: auto ulonglong4_s = (sycl::mulonglong4){1,1,1,1};
...
// CHECK: void func3_ushort2(sycl::mushort2 a, sycl::mushort2 b, sycl::mushort2 c) {
void func3_ushort2(ushort2 a, ushort2 b, ushort2 c) {
}
// CHECK: void func_ushort2(sycl::mushort2 a) {
void func_ushort2(ushort2 a) {
}
// CHECK: void kernel_ushort2(sycl::mushort2 *a, sycl::mushort2 *b) {
__global__ void kernel_ushort2(ushort2 *a, ushort2 *b) {
}

int main_ushort2() {
  // range default constructor does the right thing.
  // CHECK: sycl::mushort2 ushort2_a;
  ushort2 ushort2_a;
  // CHECK: sycl::mushort2 ushort2_b = sycl::mushort2(1, 2);
  ushort2 ushort2_b = make_ushort2(1, 2);
  // CHECK: sycl::mushort2 ushort2_c = sycl::mushort2(ushort2_b);
  ushort2 ushort2_c = ushort2(ushort2_b);
  // CHECK: sycl::mushort2 ushort2_d(ushort2_c);
  ushort2 ushort2_d(ushort2_c);
  // CHECK: func3_ushort2(ushort2_b, sycl::mushort2(ushort2_b), (sycl::mushort2)ushort2_b);
  func3_ushort2(ushort2_b, ushort2(ushort2_b), (ushort2)ushort2_b);
  // CHECK: sycl::mushort2 *ushort2_e;
  ushort2 *ushort2_e;
  // CHECK: sycl::mushort2 *ushort2_f;
  ushort2 *ushort2_f;
  // CHECK: unsigned short ushort2_g = ushort2_c[0];
  unsigned short ushort2_g = ushort2_c.x;
  // CHECK: ushort2_a[0] = ushort2_d[0];
  ushort2_a.x = ushort2_d.x;
  // CHECK: if (ushort2_b[0] == ushort2_d[0]) {}
  if (ushort2_b.x == ushort2_d.x) {}
  // CHECK: sycl::mushort2 ushort2_h[16];
  ushort2 ushort2_h[16];
  // CHECK: sycl::mushort2 ushort2_i[32];
  ushort2 ushort2_i[32];
  // CHECK: if (ushort2_h[12][0] == ushort2_i[12][0]) {}
  if (ushort2_h[12].x == ushort2_i[12].x) {}
  // CHECK: ushort2_f = (sycl::mushort2 *)ushort2_i;
  ushort2_f = (ushort2 *)ushort2_i;
  // CHECK: ushort2_a = (sycl::mushort2)ushort2_c;
  ushort2_a = (ushort2)ushort2_c;
  // CHECK: ushort2_b = sycl::mushort2(ushort2_b);
  ushort2_b = ushort2(ushort2_b);
  // CHECK: sycl::mushort2 ushort2_j, ushort2_k, ushort2_l, ushort2_m[16], *ushort2_n[32];
  ushort2 ushort2_j, ushort2_k, ushort2_l, ushort2_m[16], *ushort2_n[32];
  // CHECK: int ushort2_o = sizeof(sycl::mushort2);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mushort2 *> ushort2_e_acc_ct0(ushort2_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mushort2 *> ushort2_cast_acc_ct1((sycl::mushort2 *)ushort2_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mushort2 ushort2_r = (sycl::mushort2){1,1};
  // CHECK-NEXT: auto ushort2_s = (sycl::mushort2){1,1};
  ushort2 ushort2_r = (ushort2){1,1};
  auto ushort2_s = (ushort2){1,1};
  return 0;
}

// CHECK: void func3_ushort3(sycl::mushort3 a, sycl::mushort3 b, sycl::mushort3 c) {
void func3_ushort3(ushort3 a, ushort3 b, ushort3 c) {
}
// CHECK: void func_ushort3(sycl::mushort3 a) {
void func_ushort3(ushort3 a) {
}
// CHECK: void kernel_ushort3(sycl::mushort3 *a, sycl::mushort3 *b) {
__global__ void kernel_ushort3(ushort3 *a, ushort3 *b) {
}

int main_ushort3() {
  // range default constructor does the right thing.
  // CHECK: sycl::mushort3 ushort3_a;
  ushort3 ushort3_a;
  // CHECK: sycl::mushort3 ushort3_b = sycl::mushort3(1, 2, 3);
  ushort3 ushort3_b = make_ushort3(1, 2, 3);
  // CHECK: sycl::mushort3 ushort3_c = sycl::mushort3(ushort3_b);
  ushort3 ushort3_c = ushort3(ushort3_b);
  // CHECK: sycl::mushort3 ushort3_d(ushort3_c);
  ushort3 ushort3_d(ushort3_c);
  // CHECK: func3_ushort3(ushort3_b, sycl::mushort3(ushort3_b), (sycl::mushort3)ushort3_b);
  func3_ushort3(ushort3_b, ushort3(ushort3_b), (ushort3)ushort3_b);
  // CHECK: sycl::mushort3 *ushort3_e;
  ushort3 *ushort3_e;
  // CHECK: sycl::mushort3 *ushort3_f;
  ushort3 *ushort3_f;
  // CHECK: unsigned short ushort3_g = ushort3_c[0];
  unsigned short ushort3_g = ushort3_c.x;
  // CHECK: ushort3_a[0] = ushort3_d[0];
  ushort3_a.x = ushort3_d.x;
  // CHECK: if (ushort3_b[0] == ushort3_d[0]) {}
  if (ushort3_b.x == ushort3_d.x) {}
  // CHECK: sycl::mushort3 ushort3_h[16];
  ushort3 ushort3_h[16];
  // CHECK: sycl::mushort3 ushort3_i[32];
  ushort3 ushort3_i[32];
  // CHECK: if (ushort3_h[12][0] == ushort3_i[12][0]) {}
  if (ushort3_h[12].x == ushort3_i[12].x) {}
  // CHECK: ushort3_f = (sycl::mushort3 *)ushort3_i;
  ushort3_f = (ushort3 *)ushort3_i;
  // CHECK: ushort3_a = (sycl::mushort3)ushort3_c;
  ushort3_a = (ushort3)ushort3_c;
  // CHECK: ushort3_b = sycl::mushort3(ushort3_b);
  ushort3_b = ushort3(ushort3_b);
  // CHECK: sycl::mushort3 ushort3_j, ushort3_k, ushort3_l, ushort3_m[16], *ushort3_n[32];
  ushort3 ushort3_j, ushort3_k, ushort3_l, ushort3_m[16], *ushort3_n[32];
  // CHECK: int ushort3_o = sizeof(sycl::mushort3);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mushort3 *> ushort3_e_acc_ct0(ushort3_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mushort3 *> ushort3_cast_acc_ct1((sycl::mushort3 *)ushort3_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mushort3 ushort3_r = (sycl::mushort3){1,1,1};
  // CHECK-NEXT: auto ushort3_s = (sycl::mushort3){1,1,1};
  ushort3 ushort3_r = (ushort3){1,1,1};
  auto ushort3_s = (ushort3){1,1,1};
  return 0;
}

// CHECK: void func3_ushort4(sycl::mushort4 a, sycl::mushort4 b, sycl::mushort4 c) {
void func3_ushort4(ushort4 a, ushort4 b, ushort4 c) {
}
// CHECK: void func_ushort4(sycl::mushort4 a) {
void func_ushort4(ushort4 a) {
}
// CHECK: void kernel_ushort4(sycl::mushort4 *a, sycl::mushort4 *b) {
__global__ void kernel_ushort4(ushort4 *a, ushort4 *b) {
}

int main_ushort4() {
  // range default constructor does the right thing.
  // CHECK: sycl::mushort4 ushort4_a;
  ushort4 ushort4_a;
  // CHECK: sycl::mushort4 ushort4_b = sycl::mushort4(1, 2, 3, 4);
  ushort4 ushort4_b = make_ushort4(1, 2, 3, 4);
  // CHECK: sycl::mushort4 ushort4_c = sycl::mushort4(ushort4_b);
  ushort4 ushort4_c = ushort4(ushort4_b);
  // CHECK: sycl::mushort4 ushort4_d(ushort4_c);
  ushort4 ushort4_d(ushort4_c);
  // CHECK: func3_ushort4(ushort4_b, sycl::mushort4(ushort4_b), (sycl::mushort4)ushort4_b);
  func3_ushort4(ushort4_b, ushort4(ushort4_b), (ushort4)ushort4_b);
  // CHECK: sycl::mushort4 *ushort4_e;
  ushort4 *ushort4_e;
  // CHECK: sycl::mushort4 *ushort4_f;
  ushort4 *ushort4_f;
  // CHECK: unsigned short ushort4_g = ushort4_c[0];
  unsigned short ushort4_g = ushort4_c.x;
  // CHECK: ushort4_a[0] = ushort4_d[0];
  ushort4_a.x = ushort4_d.x;
  // CHECK: if (ushort4_b[0] == ushort4_d[0]) {}
  if (ushort4_b.x == ushort4_d.x) {}
  // CHECK: sycl::mushort4 ushort4_h[16];
  ushort4 ushort4_h[16];
  // CHECK: sycl::mushort4 ushort4_i[32];
  ushort4 ushort4_i[32];
  // CHECK: if (ushort4_h[12][0] == ushort4_i[12][0]) {}
  if (ushort4_h[12].x == ushort4_i[12].x) {}
  // CHECK: ushort4_f = (sycl::mushort4 *)ushort4_i;
  ushort4_f = (ushort4 *)ushort4_i;
  // CHECK: ushort4_a = (sycl::mushort4)ushort4_c;
  ushort4_a = (ushort4)ushort4_c;
  // CHECK: ushort4_b = sycl::mushort4(ushort4_b);
  ushort4_b = ushort4(ushort4_b);
  // CHECK: sycl::mushort4 ushort4_j, ushort4_k, ushort4_l, ushort4_m[16], *ushort4_n[32];
  ushort4 ushort4_j, ushort4_k, ushort4_l, ushort4_m[16], *ushort4_n[32];
  // CHECK: int ushort4_o = sizeof(sycl::mushort4);
  ...
  // CHECK: dpct::get_default_queue().submit(
  // CHECK-NEXT:   [&](sycl::handler &cgh) {
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mushort4 *> ushort4_e_acc_ct0(ushort4_e, cgh);
  // CHECK-NEXT:     dpct::access_wrapper<sycl::mushort4 *> ushort4_cast_acc_ct1((sycl::mushort4 *)ushort4_cast, cgh);
  // CHECK-EMPTY:
  ...
  // CHECK: sycl::mushort4 ushort4_r = (sycl::mushort4){1,1,1,1};
  // CHECK-NEXT: auto ushort4_s = (sycl::mushort4){1,1,1,1};
...
// CHECK-NEXT: sycl::muint2 p_1;
// CHECK-NEXT: p_1 = ((const sycl::muint2 *)base)[0];
// CHECK-NEXT: sycl::mint2 p_2 = ((const sycl::mint2 *)base)[0];
// CHECK-NEXT: }
...
union struct_union {
  // CHECK: sycl::mfloat2 data{};
  float2 data;
};

int foo() {
  struct_union temp;
  // CHECK: int x = temp.data[0] + 2;
  int x = temp.data.x + 2;
}

// CHECK: std::vector<const char> const foo_char1(std::vector<const char> a);
// CHECK-NEXT: std::vector<sycl::mchar2> foo_char2(std::vector<sycl::mchar2> a);
// CHECK-NEXT: std::vector<sycl::mchar3> foo_char3(std::vector<sycl::mchar3> a);
// CHECK-NEXT: std::vector<sycl::mchar4> foo_char4(std::vector<sycl::mchar4> a);
...
// CHECK-NEXT: std::vector<sycl::muchar2> foo_uchar2(std::vector<sycl::muchar2> a);
// CHECK-NEXT: std::vector<sycl::muchar3> foo_uchar3(std::vector<sycl::muchar3> a);
// CHECK-NEXT: std::vector<sycl::muchar4> foo_uchar4(std::vector<sycl::muchar4> a);
...
// CHECK-NEXT: std::vector<sycl::mshort2> foo_short2(std::vector<sycl::mshort2> a);
// CHECK-NEXT: std::vector<sycl::mshort3> foo_short3(std::vector<sycl::mshort3> a);
// CHECK-NEXT: std::vector<sycl::mshort4> foo_short4(std::vector<sycl::mshort4> a);
...
// CHECK-NEXT: std::vector<sycl::mushort2> foo_ushort2(std::vector<sycl::mushort2> a);
// CHECK-NEXT: std::vector<sycl::mushort3> foo_ushort3(std::vector<sycl::mushort3> a);
// CHECK-NEXT: std::vector<sycl::mushort4> foo_ushort4(std::vector<sycl::mushort4> a);
...
// CHECK-NEXT: std::vector<sycl::mint2> foo_int2(std::vector<sycl::mint2> a);
// CHECK-NEXT: std::vector<sycl::mint3> foo_int3(std::vector<sycl::mint3> a);
// CHECK-NEXT: std::vector<sycl::mint4> foo_int4(std::vector<sycl::mint4> a);
...
// CHECK-NEXT: std::vector<sycl::muint2> foo_uint2(std::vector<sycl::muint2> a);
// CHECK-NEXT: std::vector<sycl::muint3> foo_uint3(std::vector<sycl::muint3> a);
// CHECK-NEXT: std::vector<sycl::muint4> foo_uint4(std::vector<sycl::muint4> a);
...
// CHECK-NEXT: std::vector<sycl::mlong2> foo_long2(std::vector<sycl::mlong2> a);
// CHECK-NEXT: std::vector<sycl::mlong3> foo_long3(std::vector<sycl::mlong3> a);
// CHECK-NEXT: std::vector<sycl::mlong4> foo_long4(std::vector<sycl::mlong4> a);
...
// CHECK-NEXT: std::vector<sycl::mulong2> foo_ulong2(std::vector<sycl::mulong2> a);
// CHECK-NEXT: std::vector<sycl::mulong3> foo_ulong3(std::vector<sycl::mulong3> a);
// CHECK-NEXT: std::vector<sycl::mulong4> foo_ulong4(std::vector<sycl::mulong4> a);
...
// CHECK-NEXT: std::vector<sycl::mfloat2> foo_float2(std::vector<sycl::mfloat2> a);
// CHECK-NEXT: std::vector<sycl::mfloat3> foo_float3(std::vector<sycl::mfloat3> a);
// CHECK-NEXT: std::vector<sycl::mfloat4> foo_float4(std::vector<sycl::mfloat4> a);
...
// CHECK-NEXT: std::vector<sycl::mlonglong2> foo_longlong2(std::vector<sycl::mlonglong2> a);
// CHECK-NEXT: std::vector<sycl::mlonglong3> foo_longlong3(std::vector<sycl::mlonglong3> a);
// CHECK-NEXT: std::vector<sycl::mlonglong4> foo_longlong4(std::vector<sycl::mlonglong4> a);
...
// CHECK-NEXT: std::vector<sycl::mulonglong2> foo_ulonglong2(std::vector<sycl::mulonglong2> a);
// CHECK-NEXT: std::vector<sycl::mulonglong3> foo_ulonglong3(std::vector<sycl::mulonglong3> a);
// CHECK-NEXT: std::vector<sycl::mulonglong4> foo_ulonglong4(std::vector<sycl::mulonglong4> a);
...
// CHECK-NEXT: std::vector<sycl::mdouble2> foo_double2(std::vector<sycl::mdouble2> a);
// CHECK-NEXT: std::vector<sycl::mdouble3> foo_double3(std::vector<sycl::mdouble3> a);
// CHECK-NEXT: std::vector<sycl::mdouble4> foo_double4(std::vector<sycl::mdouble4> a);
...
void bar(){
  int a;
  // CHECK: std::vector<sycl::mchar2> *bar_char2 = (std::vector<sycl::mchar2>*) a;
  // CHECK-NEXT: std::vector<sycl::muchar2> *bar_uchar2 = (std::vector<sycl::muchar2>*) a;
  // CHECK-NEXT: std::vector<sycl::mshort2> *bar_short2 = (std::vector<sycl::mshort2>*) a;
  // CHECK-NEXT: std::vector<sycl::mushort2> *bar_ushort2 = (std::vector<sycl::mushort2>*) a;
  // CHECK-NEXT: std::vector<sycl::mint2> *bar_int2 = (std::vector<sycl::mint2>*) a;
  // CHECK-NEXT: std::vector<sycl::muint2> *bar_uint2 = (std::vector<sycl::muint2>*) a;
  // CHECK-NEXT: std::vector<sycl::mlong2> *bar_long2 = (std::vector<sycl::mlong2>*) a;
  // CHECK-NEXT: std::vector<sycl::mulong2> *bar_ulong2 = (std::vector<sycl::mulong2>*) a;
  // CHECK-NEXT: std::vector<sycl::mfloat2> *bar_float2 = (std::vector<sycl::mfloat2>*) a;
  // CHECK-NEXT: std::vector<sycl::mlonglong2> *bar_longlong2 = (std::vector<sycl::mlonglong2>*) a;
  // CHECK-NEXT: std::vector<sycl::mulonglong2> *bar_ulonglong2 = (std::vector<sycl::mulonglong2>*) a;
  // CHECK-NEXT: std::vector<sycl::mdouble2> *bar_double2 = (std::vector<sycl::mdouble2>*) a;
...
// CHECK: #define vchar2_ptr std::vector<sycl::mchar2>*
// CHECK-NEXT: #define vuchar2_ptr std::vector<sycl::muchar2>*
// CHECK-NEXT: #define vshort2_ptr std::vector<sycl::mshort2>*
// CHECK-NEXT: #define vushort2_ptr std::vector<sycl::mushort2>*
// CHECK-NEXT: #define vint2_ptr std::vector<sycl::mint2>*
// CHECK-NEXT: #define vuint2_ptr std::vector<sycl::muint2>*
// CHECK-NEXT: #define vlong2_ptr std::vector<sycl::mlong2>*
// CHECK-NEXT: #define vulong2_ptr std::vector<sycl::mulong2>*
// CHECK-NEXT: #define vfloat2_ptr std::vector<sycl::mfloat2>*
// CHECK-NEXT: #define vlonglong2_ptr std::vector<sycl::mlonglong2>*
// CHECK-NEXT: #define vulonglong2_ptr std::vector<sycl::mulonglong2>*
// CHECK-NEXT: #define vdouble2_ptr std::vector<sycl::mdouble2>*
...
void test() {
  //CHECK: VT d2;
  //CHECK-NEXT: if (std::abs(d2[0]) >= 0.01) {}
  VT d2;
