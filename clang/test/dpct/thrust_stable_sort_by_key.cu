...
// RUN: %if build_lit %{icpx -c -fsycl %T/thrust_stable_sort_by_key/thrust_stable_sort_by_key.dp.cpp -o %T/thrust_stable_sort_by_key/thrust_stable_sort_by_key.dp.o %}
