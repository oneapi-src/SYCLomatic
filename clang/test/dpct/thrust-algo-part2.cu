...
void set_symmetric_difference() {
  ...
  // CHECK:  oneapi::dpl::set_symmetric_difference(oneapi::dpl::execution::par_noseq, A1, A1 + 4, A2, A2 + 2, result);
  ...
  // CHECK-NEXT:  oneapi::dpl::set_symmetric_difference(oneapi::dpl::execution::make_device_policy(q_ct1), d_A1.begin(), d_A1.end(), d_A2.begin(), d_A2.end(), d_result.begin(), oneapi::dpl::less<int>());
  // CHECK-NEXT:  oneapi::dpl::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A1.begin(), h_A1.end(), h_A2.begin(), h_A2.end(), h_result.begin());
  // CHECK-NEXT:  oneapi::dpl::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A1.begin(), h_A1.end(), h_A2.begin(), h_A2.end(), h_result.begin());
  // CHECK-NEXT:  oneapi::dpl::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A1.begin(), h_A1.end(), h_A2.begin(), h_A2.end(), h_result.begin(), oneapi::dpl::less<int>());
  // CHECK-NEXT:  oneapi::dpl::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A1.begin(), h_A1.end(), h_A2.begin(), h_A2.end(), h_result.begin(), oneapi::dpl::less<int>());
...
void set_symmetric_difference_by_key() {
  ...
  // CHECK:   dpct::set_symmetric_difference(oneapi::dpl::execution::par_noseq, A_keys, A_keys + 7, B_keys, B_keys + 5, A_vals, B_vals, keys_result, vals_result);
  ...
  // CHECK-NEXT:   dpct::set_symmetric_difference(oneapi::dpl::execution::make_device_policy(q_ct1), d_A_keys.begin(), d_A_keys.end(), d_B_keys.begin(), d_B_keys.end(), d_A_vals.begin(), d_B_vals.begin(), d_keys_result.begin(), d_vals_result.begin(), Compare());
  // CHECK-NEXT:   dpct::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A_keys.begin(), h_A_keys.end(), h_B_keys.begin(), h_B_keys.end(), h_A_vals.begin(), h_B_vals.begin(), h_keys_result.begin(), h_vals_result.begin());
  // CHECK-NEXT:   dpct::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A_keys.begin(), h_A_keys.end(), h_B_keys.begin(), h_B_keys.end(), h_A_vals.begin(), h_B_vals.begin(), h_keys_result.begin(), h_vals_result.begin());
  // CHECK-NEXT:   dpct::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A_keys.begin(), h_A_keys.end(), h_B_keys.begin(), h_B_keys.end(), h_A_vals.begin(), h_B_vals.begin(), h_keys_result.begin(), h_vals_result.begin(), Compare());
  // CHECK-NEXT:   dpct::set_symmetric_difference(oneapi::dpl::execution::par_noseq, h_A_keys.begin(), h_A_keys.end(), h_B_keys.begin(), h_B_keys.end(), h_A_vals.begin(), h_B_vals.begin(), h_keys_result.begin(), h_vals_result.begin(), Compare());
