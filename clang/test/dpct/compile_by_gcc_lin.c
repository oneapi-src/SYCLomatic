...
// CHECK: int a = 0;
// CHECK-NEXT: /*
// CHECK-NEXT: DPCT1056:{{[0-9]+}}: Intel(R) DPC++ Compatibility Tool did not detect that variable const_angle is used in device code. If this variable is also used in device code, you need to rewrite the code.
// CHECK-NEXT: */
