...
int main() {
  ...
  // CHECK-NEXT: mkl::blas::iamax(dpct::get_default_queue(), n, x_S_buff_ct1, incx, result_temp_buffer);
  ...
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamax(dpct::get_default_queue(), n, x_D_buff_ct1, incx, result_temp_buffer);
  ...
  *result = cublasIdamax(n, x_D, incx);
  ...
  // CHECK-NEXT: auto x_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_S);
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamin(dpct::get_default_queue(), n, x_S_buff_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: *result = result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  *result = cublasIsamin(n, x_S, incx);
  ...
  // CHECK-NEXT: auto x_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_D);
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamin(dpct::get_default_queue(), n, x_D_buff_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: *result = result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  *result = cublasIdamin(n, x_D, incx);
  ...
  // CHECK-NEXT: mkl::blas::asum(dpct::get_default_queue(), n, x_S_buff_ct1, incx, result_temp_buffer);
  ...
  *result_S = cublasSasum(n, x_S, incx);
  ...
  // CHECK-NEXT: mkl::blas::asum(dpct::get_default_queue(), n, x_D_buff_ct1, incx, result_temp_buffer);
  ...
  *result_D = cublasDasum(n, x_D, incx);
  ...
  // CHECK-NEXT: sycl::buffer<float> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::dot(dpct::get_default_queue(), n, x_S_buff_ct1, incx, y_S_buff_ct1, incy, result_temp_buffer);
  // CHECK-NEXT: *result_S = result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  *result_S = cublasSdot(n, x_S, incx, y_S, incy);
  ...
  // CHECK-NEXT: sycl::buffer<double> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::dot(dpct::get_default_queue(), n, x_D_buff_ct1, incx, y_D_buff_ct1, incy, result_temp_buffer);
  // CHECK-NEXT: *result_D = result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  *result_D = cublasDdot(n, x_D, incx, y_D, incy);
  ...
  // CHECK-NEXT: auto x_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_S);
  // CHECK-NEXT: sycl::buffer<float> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::nrm2(dpct::get_default_queue(), n, x_S_buff_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: *result_S = result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  *result_S = cublasSnrm2(n, x_S, incx);
  ...
  // CHECK-NEXT: auto x_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_D);
  // CHECK-NEXT: sycl::buffer<double> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::nrm2(dpct::get_default_queue(), n, x_D_buff_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: *result_D = result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  *result_D = cublasDnrm2(n, x_D, incx);
  ...
  // CHECK-NEXT: mkl::blas::axpy(dpct::get_default_queue(), n, alpha_S, x_S_buff_ct1, incx, result_S_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: mkl::blas::axpy(dpct::get_default_queue(), n, alpha_D, x_D_buff_ct1, incx, result_D_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::copy(dpct::get_default_queue(), n, x_S_buff_ct1, incx, result_S_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::copy(dpct::get_default_queue(), n, x_D_buff_ct1, incx, result_D_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  //cublas<t>rot
  // CHECK: {
  // CHECK-NEXT: auto x_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::rot(dpct::get_default_queue(), n, x_f_buff_ct1, incx, y_f_buff_ct1, incy, *x_S, *y_S);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::rot(dpct::get_default_queue(), n, x_d_buff_ct1, incx, y_d_buff_ct1, incy, *x_D, *y_D);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: auto x_f_buff_ct2 = dpct::mem_mgr::instance().get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buff_ct2 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::rotg(dpct::get_default_queue(), x_f_buff_ct1, y_f_buff_ct1, x_f_buff_ct2, y_f_buff_ct2);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: auto x_d_buff_ct2 = dpct::mem_mgr::instance().get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buff_ct2 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::rotg(dpct::get_default_queue(), x_d_buff_ct1, y_d_buff_ct1, x_d_buff_ct2, y_d_buff_ct2);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: auto x_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_S);
  // CHECK-NEXT: mkl::blas::rotm(dpct::get_default_queue(), n, x_f_buff_ct1, incx, y_f_buff_ct1, incy, x_S_buff_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: auto x_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_D);
  // CHECK-NEXT: mkl::blas::rotm(dpct::get_default_queue(), n, x_d_buff_ct1, incx, y_d_buff_ct1, incy, x_D_buff_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: auto y_f_buff_ct2 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: auto y_f_buff_ct3 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::rotmg(dpct::get_default_queue(), x_f_buff_ct1, y_f_buff_ct1, y_f_buff_ct2, *(x_S), y_f_buff_ct3);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: auto y_d_buff_ct2 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: auto y_d_buff_ct3 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::rotmg(dpct::get_default_queue(), x_d_buff_ct1, y_d_buff_ct1, y_d_buff_ct2, *(x_D), y_d_buff_ct3);
  // CHECK-NEXT: }
  ...
  // CHECK: {
  // CHECK-NEXT: auto x_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_f);
  // CHECK-NEXT: mkl::blas::scal(dpct::get_default_queue(), n, alpha_S, x_f_buff_ct1, incx);
  // CHECK-NEXT: }
  cublasSscal(n, alpha_S, x_f, incx);

  // CHECK: {
  // CHECK-NEXT: auto x_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_d);
  // CHECK-NEXT: mkl::blas::scal(dpct::get_default_queue(), n, alpha_D, x_d_buff_ct1, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::swap(dpct::get_default_queue(), n, x_f_buff_ct1, incx, y_f_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::swap(dpct::get_default_queue(), n, x_d_buff_ct1, incx, y_d_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::ger(dpct::get_default_queue(), m, n, alpha_S, x_S_buff_ct1, incx, y_S_buff_ct1, incy, result_S_buff_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::ger(dpct::get_default_queue(), m, n, alpha_D, x_D_buff_ct1, incx, y_D_buff_ct1, incy, result_D_buff_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::sbmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_S, x_S_buff_ct1, lda, y_S_buff_ct1, incx, beta_S, result_S_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::sbmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_D, x_D_buff_ct1, lda, y_D_buff_ct1, incx, beta_D, result_D_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::spmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_buff_ct1, y_S_buff_ct1, incx, beta_S, result_S_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::spmv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_buff_ct1, y_D_buff_ct1, incx, beta_D, result_D_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::spr(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_buff_ct1, incx, result_S_buff_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::spr(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_buff_ct1, incx, result_D_buff_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::spr2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_buff_ct1, incx, y_S_buff_ct1, incy, result_S_buff_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::spr2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_buff_ct1, incx, y_D_buff_ct1, incy, result_D_buff_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::symv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_buff_ct1, lda, y_S_buff_ct1, incx, beta_S, result_S_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::symv(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_buff_ct1, lda, y_D_buff_ct1, incx, beta_D, result_D_buff_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::syr(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_buff_ct1, incx, result_S_buff_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::syr(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_buff_ct1, incx, result_D_buff_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buff_ct1 = dpct::mem_mgr::instance().get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::syr2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_S, x_S_buff_ct1, incx, y_S_buff_ct1, incy, result_S_buff_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buff_ct1 = dpct::mem_mgr::instance().get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::syr2(dpct::get_default_queue(), (((fillmode_ct0)=='L'||(fillmode_ct0)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), n, alpha_D, x_D_buff_ct1, incx, y_D_buff_ct1, incy, result_D_buff_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: mkl::blas::symm(dpct::get_default_queue(), (((sidemode_ct0)=='L'||(sidemode_ct0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct1)=='L'||(fillmode_ct1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_S, A_S_buff_ct1, lda, B_S_buff_ct1, ldb, beta_S, C_S_buff_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: mkl::blas::symm(dpct::get_default_queue(), (((sidemode_ct0)=='L'||(sidemode_ct0)=='l')?(mkl::side::left):(mkl::side::right)), (((fillmode_ct1)=='L'||(fillmode_ct1)=='l')?(mkl::uplo::lower):(mkl::uplo::upper)), m, n, alpha_D, A_D_buff_ct1, lda, B_D_buff_ct1, ldb, beta_D, C_D_buff_ct1, ldc);
  // CHECK-NEXT: }
