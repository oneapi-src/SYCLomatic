...
// RUN: FileCheck %S/generated_schema.hpp.ref --match-full-lines --input-file %T/debug_test/all_public_dump_codepin_sycl/generated_schema.hpp
// RUN: FileCheck %S/generated_schema.hpp.cuda.ref --match-full-lines --input-file %T/debug_test/all_public_dump_codepin_cuda/generated_schema.hpp
