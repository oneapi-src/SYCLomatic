...
// RUN: %if build_lit %{icpx -c -fsycl %T/thrust-for-h2o4gpu-specific-case-noneusm/thrust-for-h2o4gpu-specific-case-noneusm.dp.cpp -o %T/thrust-for-h2o4gpu-specific-case-noneusm/thrust-for-h2o4gpu-specific-case-noneusm.dp.o %}
