...
// RUN: %if build_lit %{icpx -c -fsycl %T/driver_context_after_12.6/driver_context_after_12.6.dp.cpp -o %T/driver_context_after_12.6/driver_context_after_12.6.dp.o %}
#include <cuda.h>
