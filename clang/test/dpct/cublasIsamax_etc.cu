...
int main() {
  ...
  // cublas<T>syrk
  // CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syrk(handle->get_queue(), fill0 == 0 ? oneapi::mkl::uplo::lower : oneapi::mkl::uplo::upper, dpct::get_transpose(trans0), n, k, alpha_S, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<float>(A_S)), lda, beta_S, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<float>(C_S)), ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::syrk(handle->get_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, n, k, alpha_S, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<float>(A_S)), lda, beta_S, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<float>(C_S)), ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false));
  ...
  // CHECK: status = DPCT_CHECK_ERROR(oneapi::mkl::blas::column_major::syrk(handle->get_queue(), fill0 == 0 ? oneapi::mkl::uplo::lower : oneapi::mkl::uplo::upper, dpct::get_transpose(trans0), n, k, alpha_D, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<double>(A_D)), lda, beta_D, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<double>(C_D)), ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false)));
  // CHECK-NEXT: oneapi::mkl::blas::column_major::syrk(handle->get_queue(), oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, n, k, alpha_D, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<double>(A_D)), lda, beta_D, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<double>(C_D)), ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false));
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::trsm(handle->get_queue(), oneapi::mkl::side::left, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::nonunit, m, n, alpha_S, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<float>(A_S)), lda, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<float>(C_S)), ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false));
  ...
  // CHECK-NEXT: oneapi::mkl::blas::column_major::trsm(handle->get_queue(), oneapi::mkl::side::left, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::nonunit, m, n, alpha_D, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<double>(A_D)), lda, dpct::rvalue_ref_to_lvalue_ref(dpct::get_buffer<double>(C_D)), ldc, dpct::blas::deduce_compute_mode(std::nullopt, handle->get_math_mode(), false));
