...
int main() {
  ...
  // CHECK-NEXT: auto result_buf_ct1 = dpct::get_buffer<int>(result);
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamax(handle, n, x_S_buf_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: result_buf_ct1.get_access<sycl::access::mode::write>()[0] = (int)result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_buf_ct1 = dpct::get_buffer<int>(result);
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamax(handle, n, x_D_buf_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: result_buf_ct1.get_access<sycl::access::mode::write>()[0] = (int)result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_buf_ct1 = dpct::get_buffer<int>(result);
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamin(handle, n, x_S_buf_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: result_buf_ct1.get_access<sycl::access::mode::write>()[0] = (int)result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto result_buf_ct1 = dpct::get_buffer<int>(result);
  // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer(sycl::range<1>(1));
  // CHECK-NEXT: mkl::blas::iamin(handle, n, x_D_buf_ct1, incx, result_temp_buffer);
  // CHECK-NEXT: result_buf_ct1.get_access<sycl::access::mode::write>()[0] = (int)result_temp_buffer.get_access<sycl::access::mode::read>()[0];
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::asum(handle, n, x_S_buf_ct1, incx, result_S_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::asum(handle, n, x_D_buf_ct1, incx, result_D_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::axpy(handle, n, alpha_S, x_S_buf_ct1, incx, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::axpy(handle, n, alpha_D, x_D_buf_ct1, incx, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::copy(handle, n, x_S_buf_ct1, incx, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::copy(handle, n, x_D_buf_ct1, incx, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::dot(handle, n, x_S_buf_ct1, incx, y_S_buf_ct1, incy, result_S_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::dot(handle, n, x_D_buf_ct1, incx, y_D_buf_ct1, incy, result_D_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::nrm2(handle, n, x_S_buf_ct1, incx, result_S_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::nrm2(handle, n, x_D_buf_ct1, incx, result_D_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_f_buf_ct1 = dpct::get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buf_ct1 = dpct::get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::rot(handle, n, x_f_buf_ct1, incx, y_f_buf_ct1, incy, *(x_S), *(y_S));
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_d_buf_ct1 = dpct::get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buf_ct1 = dpct::get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::rot(handle, n, x_d_buf_ct1, incx, y_d_buf_ct1, incy, *(x_D), *(y_D));
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_f_buf_ct2 = dpct::get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buf_ct2 = dpct::get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::rotg(handle, x_f_buf_ct1, y_f_buf_ct1, x_f_buf_ct2, y_f_buf_ct2);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_d_buf_ct2 = dpct::get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buf_ct2 = dpct::get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::rotg(handle, x_d_buf_ct1, y_d_buf_ct1, x_d_buf_ct2, y_d_buf_ct2);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_f_buf_ct1 = dpct::get_buffer<float>(y_f);
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: mkl::blas::rotm(handle, n, x_f_buf_ct1, incx, y_f_buf_ct1, incy, x_S_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_d_buf_ct1 = dpct::get_buffer<double>(y_d);
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: mkl::blas::rotm(handle, n, x_d_buf_ct1, incx, y_d_buf_ct1, incy, x_D_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_f_buf_ct2 = dpct::get_buffer<float>(y_f);
  // CHECK-NEXT: auto y_f_buf_ct3 = dpct::get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::rotmg(handle, x_f_buf_ct1, y_f_buf_ct1, y_f_buf_ct2, *(x_S), y_f_buf_ct3);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_d_buf_ct2 = dpct::get_buffer<double>(y_d);
  // CHECK-NEXT: auto y_d_buf_ct3 = dpct::get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::rotmg(handle, x_d_buf_ct1, y_d_buf_ct1, y_d_buf_ct2, *(x_D), y_d_buf_ct3);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_f_buf_ct1 = dpct::get_buffer<float>(x_f);
  // CHECK-NEXT: mkl::blas::scal(handle, n, alpha_S, x_f_buf_ct1, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_d_buf_ct1 = dpct::get_buffer<double>(x_d);
  // CHECK-NEXT: mkl::blas::scal(handle, n, alpha_D, x_d_buf_ct1, incx);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_f_buf_ct1 = dpct::get_buffer<float>(x_f);
  // CHECK-NEXT: auto y_f_buf_ct1 = dpct::get_buffer<float>(y_f);
  // CHECK-NEXT: mkl::blas::swap(handle, n, x_f_buf_ct1, incx, y_f_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_d_buf_ct1 = dpct::get_buffer<double>(x_d);
  // CHECK-NEXT: auto y_d_buf_ct1 = dpct::get_buffer<double>(y_d);
  // CHECK-NEXT: mkl::blas::swap(handle, n, x_d_buf_ct1, incx, y_d_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::gbmv(handle, mkl::transpose::nontrans, m, n, m, n, alpha_S, x_S_buf_ct1, lda, y_S_buf_ct1, incx, beta_S, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::gbmv(handle, mkl::transpose::nontrans, m, n, m, n, alpha_D, x_D_buf_ct1, lda, y_D_buf_ct1, incx, beta_D, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::gemv(handle, mkl::transpose::nontrans, m, n, alpha_S, x_S_buf_ct1, lda, y_S_buf_ct1, incx, beta_S, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::gemv(handle, mkl::transpose::nontrans, m, n, alpha_D, x_D_buf_ct1, lda, y_D_buf_ct1, incx, beta_D, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::ger(handle, m, n, alpha_S, x_S_buf_ct1, incx, y_S_buf_ct1, incy, result_S_buf_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::ger(handle, m, n, alpha_D, x_D_buf_ct1, incx, y_D_buf_ct1, incy, result_D_buf_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::sbmv(handle, mkl::uplo::upper, m, n, alpha_S, x_S_buf_ct1, lda, y_S_buf_ct1, incx, beta_S, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::sbmv(handle, mkl::uplo::upper, m, n, alpha_D, x_D_buf_ct1, lda, y_D_buf_ct1, incx, beta_D, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::spmv(handle, mkl::uplo::upper, n, alpha_S, x_S_buf_ct1, y_S_buf_ct1, incx, beta_S, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::spmv(handle, mkl::uplo::upper, n, alpha_D, x_D_buf_ct1, y_D_buf_ct1, incx, beta_D, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::spr(handle, mkl::uplo::upper, n, alpha_S, x_S_buf_ct1, incx, result_S_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::spr(handle, mkl::uplo::upper, n, alpha_D, x_D_buf_ct1, incx, result_D_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::spr2(handle, mkl::uplo::upper, n, alpha_S, x_S_buf_ct1, incx, y_S_buf_ct1, incy, result_S_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::spr2(handle, mkl::uplo::upper, n, alpha_D, x_D_buf_ct1, incx, y_D_buf_ct1, incy, result_D_buf_ct1);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::symv(handle, mkl::uplo::upper, n, alpha_S, x_S_buf_ct1, lda, y_S_buf_ct1, incx, beta_S, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::symv(handle, mkl::uplo::upper, n, alpha_D, x_D_buf_ct1, lda, y_D_buf_ct1, incx, beta_D, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::syr(handle, mkl::uplo::upper, n, alpha_S, x_S_buf_ct1, incx, result_S_buf_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::syr(handle, mkl::uplo::upper, n, alpha_D, x_D_buf_ct1, incx, result_D_buf_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_S_buf_ct1 = dpct::get_buffer<float>(y_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::syr2(handle, mkl::uplo::upper, n, alpha_S, x_S_buf_ct1, incx, y_S_buf_ct1, incy, result_S_buf_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto y_D_buf_ct1 = dpct::get_buffer<double>(y_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::syr2(handle, mkl::uplo::upper, n, alpha_D, x_D_buf_ct1, incx, y_D_buf_ct1, incy, result_D_buf_ct1, lda);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::tbmv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, n, x_S_buf_ct1, lda, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::tbmv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, n, x_D_buf_ct1, lda, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::tbsv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, n, x_S_buf_ct1, lda, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::tbsv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, n, x_D_buf_ct1, lda, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::tpmv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_S_buf_ct1, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::tpmv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_D_buf_ct1, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::tpsv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_S_buf_ct1, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::tpsv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_D_buf_ct1, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::trmv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_S_buf_ct1, lda, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::trmv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_D_buf_ct1, lda, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_S_buf_ct1 = dpct::get_buffer<float>(x_S);
  // CHECK-NEXT: auto result_S_buf_ct1 = dpct::get_buffer<float>(result_S);
  // CHECK-NEXT: mkl::blas::trsv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_S_buf_ct1, lda, result_S_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto x_D_buf_ct1 = dpct::get_buffer<double>(x_D);
  // CHECK-NEXT: auto result_D_buf_ct1 = dpct::get_buffer<double>(result_D);
  // CHECK-NEXT: mkl::blas::trsv(handle, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::unit, n, x_D_buf_ct1, lda, result_D_buf_ct1, incy);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto B_S_buf_ct1 = dpct::get_buffer<float>(B_S);
  // CHECK-NEXT: auto C_S_buf_ct1 = dpct::get_buffer<float>(C_S);
  // CHECK-NEXT: mkl::blas::symm(handle, mkl::side::right, mkl::uplo::lower, m, n, alpha_S, A_S_buf_ct1, lda, B_S_buf_ct1, ldb, beta_S, C_S_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto B_D_buf_ct1 = dpct::get_buffer<double>(B_D);
  // CHECK-NEXT: auto C_D_buf_ct1 = dpct::get_buffer<double>(C_D);
  // CHECK-NEXT: mkl::blas::symm(handle, mkl::side::right, mkl::uplo::lower, m, n, alpha_D, A_D_buf_ct1, lda, B_D_buf_ct1, ldb, beta_D, C_D_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto A_S_buf_ct1 = dpct::get_buffer<float>(A_S);
  // CHECK-NEXT: auto C_S_buf_ct1 = dpct::get_buffer<float>(C_S);
  // CHECK-NEXT: mkl::blas::syrk(handle, mkl::uplo::upper, mkl::transpose::nontrans, n, k, alpha_S, A_S_buf_ct1, lda, beta_S, C_S_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto A_D_buf_ct1 = dpct::get_buffer<double>(A_D);
  // CHECK-NEXT: auto C_D_buf_ct1 = dpct::get_buffer<double>(C_D);
  // CHECK-NEXT: mkl::blas::syrk(handle, mkl::uplo::upper, mkl::transpose::nontrans, n, k, alpha_D, A_D_buf_ct1, lda, beta_D, C_D_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto B_S_buf_ct1 = dpct::get_buffer<float>(B_S);
  // CHECK-NEXT: auto C_S_buf_ct1 = dpct::get_buffer<float>(C_S);
  // CHECK-NEXT: mkl::blas::syr2k(handle, mkl::uplo::upper, mkl::transpose::nontrans, n, k, alpha_S, A_S_buf_ct1, lda, B_S_buf_ct1, ldb, beta_S, C_S_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto B_D_buf_ct1 = dpct::get_buffer<double>(B_D);
  // CHECK-NEXT: auto C_D_buf_ct1 = dpct::get_buffer<double>(C_D);
  // CHECK-NEXT: mkl::blas::syr2k(handle, mkl::uplo::upper, mkl::transpose::nontrans, n, k, alpha_D, A_D_buf_ct1, lda, B_D_buf_ct1, ldb, beta_D, C_D_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto A_S_buf_ct1 = dpct::get_buffer<float>(A_S);
  // CHECK-NEXT: auto C_S_buf_ct1 = dpct::get_buffer<float>(C_S);
  // CHECK-NEXT: mkl::blas::trsm(handle, mkl::side::left, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::nonunit, m, n, alpha_S, A_S_buf_ct1, lda, C_S_buf_ct1, ldc);
  // CHECK-NEXT: }
  ...
  // CHECK-NEXT: auto A_D_buf_ct1 = dpct::get_buffer<double>(A_D);
  // CHECK-NEXT: auto C_D_buf_ct1 = dpct::get_buffer<double>(C_D);
  // CHECK-NEXT: mkl::blas::trsm(handle, mkl::side::left, mkl::uplo::upper, mkl::transpose::nontrans, mkl::diag::nonunit, m, n, alpha_D, A_D_buf_ct1, lda, C_D_buf_ct1, ldc);
  // CHECK-NEXT: }
