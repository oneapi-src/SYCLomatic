...
// CHECK-NEXT:     _p_p[1] = !sycl::isnan(x) && !sycl::isnan(fp) && sycl::isequal(x, fp);
// CHECK-NEXT:     _p_p[2] = !sycl::isnan(x) && !sycl::isnan(fp) && sycl::isnotequal(x, fp);
// CHECK-NEXT:     _p_p[3] = !sycl::isnan(x) && !sycl::isnan(fp) && sycl::isless(x, fp);
// CHECK-NEXT:     _p_p[4] = !sycl::isnan(x) && !sycl::isnan(fp) && sycl::islessequal(x, fp);
// CHECK-NEXT:     _p_p[5] = !sycl::isnan(x) && !sycl::isnan(fp) && sycl::isgreater(x, fp);
// CHECK-NEXT:     _p_p[6] = !sycl::isnan(x) && !sycl::isnan(fp) && sycl::isgreaterequal(x, fp);
// CHECK-NEXT:     _p_p[7] = sycl::isnan(x) || sycl::isnan(fp) || sycl::isequal(x, fp);
// CHECK-NEXT:     _p_p[8] = sycl::isnan(x) || sycl::isnan(fp) || sycl::isnotequal(x, fp);
// CHECK-NEXT:     _p_p[9] = sycl::isnan(x) || sycl::isnan(fp) || sycl::isless(x, fp);
// CHECK-NEXT:     _p_p[10] = sycl::isnan(x) || sycl::isnan(fp) || sycl::islessequal(x, fp);
// CHECK-NEXT:     _p_p[11] = sycl::isnan(x) || sycl::isnan(fp) || sycl::isgreater(x, fp);
// CHECK-NEXT:     _p_p[12] = sycl::isnan(x) || sycl::isnan(fp) || sycl::isgreaterequal(x, fp);
