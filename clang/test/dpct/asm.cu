...
// CHECK-NEXT:     _p_p[1] = !sycl::isnan((float)x) && !sycl::isnan((float)fp) && sycl::isequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[2] = !sycl::isnan((float)x) && !sycl::isnan((float)fp) && sycl::isnotequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[3] = !sycl::isnan((float)x) && !sycl::isnan((float)fp) && sycl::isless((float)x, (float)fp);
// CHECK-NEXT:     _p_p[4] = !sycl::isnan((float)x) && !sycl::isnan((float)fp) && sycl::islessequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[5] = !sycl::isnan((float)x) && !sycl::isnan((float)fp) && sycl::isgreater((float)x, (float)fp);
// CHECK-NEXT:     _p_p[6] = !sycl::isnan((float)x) && !sycl::isnan((float)fp) && sycl::isgreaterequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[7] = sycl::isnan((float)x) || sycl::isnan((float)fp) || sycl::isequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[8] = sycl::isnan((float)x) || sycl::isnan((float)fp) || sycl::isnotequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[9] = sycl::isnan((float)x) || sycl::isnan((float)fp) || sycl::isless((float)x, (float)fp);
// CHECK-NEXT:     _p_p[10] = sycl::isnan((float)x) || sycl::isnan((float)fp) || sycl::islessequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[11] = sycl::isnan((float)x) || sycl::isnan((float)fp) || sycl::isgreater((float)x, (float)fp);
// CHECK-NEXT:     _p_p[12] = sycl::isnan((float)x) || sycl::isnan((float)fp) || sycl::isgreaterequal((float)x, (float)fp);
// CHECK-NEXT:     _p_p[13] = !sycl::isnan((float)x) && !sycl::isnan((float)fp);
// CHECK-NEXT:     _p_p[14] = sycl::isnan((float)x) || sycl::isnan((float)fp);
// CHECK-NEXT:     _p_p[1] = !sycl::isnan((double)x) && !sycl::isnan((double)fp) && sycl::isequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[2] = !sycl::isnan((double)x) && !sycl::isnan((double)fp) && sycl::isnotequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[3] = !sycl::isnan((double)x) && !sycl::isnan((double)fp) && sycl::isless((double)x, (double)fp);
// CHECK-NEXT:     _p_p[4] = !sycl::isnan((double)x) && !sycl::isnan((double)fp) && sycl::islessequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[5] = !sycl::isnan((double)x) && !sycl::isnan((double)fp) && sycl::isgreater((double)x, (double)fp);
// CHECK-NEXT:     _p_p[6] = !sycl::isnan((double)x) && !sycl::isnan((double)fp) && sycl::isgreaterequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[7] = sycl::isnan((double)x) || sycl::isnan((double)fp) || sycl::isequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[8] = sycl::isnan((double)x) || sycl::isnan((double)fp) || sycl::isnotequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[9] = sycl::isnan((double)x) || sycl::isnan((double)fp) || sycl::isless((double)x, (double)fp);
// CHECK-NEXT:     _p_p[10] = sycl::isnan((double)x) || sycl::isnan((double)fp) || sycl::islessequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[11] = sycl::isnan((double)x) || sycl::isnan((double)fp) || sycl::isgreater((double)x, (double)fp);
// CHECK-NEXT:     _p_p[12] = sycl::isnan((double)x) || sycl::isnan((double)fp) || sycl::isgreaterequal((double)x, (double)fp);
// CHECK-NEXT:     _p_p[13] = !sycl::isnan((double)x) && !sycl::isnan((double)fp);
// CHECK-NEXT:     _p_p[14] = sycl::isnan((double)x) || sycl::isnan((double)fp);
