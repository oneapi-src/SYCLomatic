...
// RUN: cd d_hd_constant_db
// RUN: cat %s > d_hd_constant_db.cpp
// RUN: cat %S/constant_header.h > constant_header.h
// RUN: dpct d_hd_constant_db.cpp --out-root=./out --cuda-include-path="%cuda-path/include" -- -x cuda --cuda-host-only
// RUN: echo "[" > compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"c++ d_hd_constant_db.cpp\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/d_hd_constant_db\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/d_hd_constant_db/d_hd_constant_db.cpp\"" >> compile_commands.json
// RUN: echo "    }," >> compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"nvcc d_hd_constant_db.cpp\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/d_hd_constant_db\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/d_hd_constant_db/d_hd_constant_db.cpp\"" >> compile_commands.json
// RUN: echo "    }" >> compile_commands.json
// RUN: echo "]" >> compile_commands.json
