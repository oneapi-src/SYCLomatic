...
// CHECK: /*
// CHECK: DPCT1127:{{[0-9]+}}: The constant compile-time initialization for device_globals is supported when compiling with C++20. You may need to adjust the compile commands.
// CHECK: */
