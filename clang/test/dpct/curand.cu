...
int main(){
  ...
  //CHECK-NEXT:the function call is redundant in SYCL.
  //CHECK-NEXT:*/
  ...
  //CHECK-NEXT: because the function call is redundant in SYCL.
  //CHECK-NEXT:*/
  //CHECK-NEXT:{
  //CHECK-NEXT:auto d_data_buf_ct{{[0-9]+}} = dpct::get_buffer<float>(d_data);
...
//CHECK-NEXT:0 because the function call is redundant in SYCL.
//CHECK-NEXT:*/
