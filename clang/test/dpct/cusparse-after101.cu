...
void foo1() {
  ...
  // CHECK: ws_size = 0;
  // CHECK-NEXT: dpct::sparse::csr2csc(*handle, 3, 4, a_val, a_row_ptr, a_col_ind, b_val, b_col_ptr, b_row_ind, dpct::library_data_t::real_float, oneapi::mkl::index_base::zero);
