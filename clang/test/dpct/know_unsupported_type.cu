...
int main(int argc, char **argv) {
    ...
    // CHECK: dpct::mem_cpy_parameter *p1c3d;
    cudaMemcpy3DParms *p1c3d;
    // CHECK: const dpct::mem_cpy_parameter *p2c3d;
    const cudaMemcpy3DParms *p2c3d;
    // CHECK: static dpct::mem_cpy_parameter *p3c3d;
    static cudaMemcpy3DParms *p3c3d;
    // CHECK: static volatile dpct::mem_cpy_parameter *p4c3d;
    static volatile cudaMemcpy3DParms *p4c3d;
    // CHECK: std::vector<dpct::mem_cpy_parameter *> vc3dp;
