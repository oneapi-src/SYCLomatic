...
// RUN: %if build_lit %{icpx -c -fsycl %T/anonymous_shared_var_macro/anonymous_shared_var_macro.dp.cpp -o %T/anonymous_shared_var_macro/anonymous_shared_var_macro.dp.o %}
