...
// RUN: cd hd_h_constant_db
// RUN: cat %s > hd_h_constant_db.cpp
// RUN: cat %S/constant_header.h > constant_header.h
// RUN: echo "[" > compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"c++ hd_h_constant_db.cpp\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/hd_h_constant_db\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/hd_h_constant_db/hd_h_constant_db.cpp\"" >> compile_commands.json
// RUN: echo "    }," >> compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"nvcc hd_h_constant_db.cpp\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/hd_h_constant_db\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/hd_h_constant_db/hd_h_constant_db.cpp\"" >> compile_commands.json
// RUN: echo "    }" >> compile_commands.json
// RUN: echo "]" >> compile_commands.json
...
// RUN: c2s hd_h_constant_db.cpp --out-root=./out --cuda-include-path="%cuda-path/include" -- -x c --cuda-host-only
// RUN: FileCheck %s --match-full-lines --input-file %T/hd_h_constant_db/out/constant_header.h
// RUN: cd ..
// RUN: rm -rf ./hd_h_constant_db
