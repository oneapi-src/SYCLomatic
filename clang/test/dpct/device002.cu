...
char pciBusId[80];
// CHECK:/*
// CHECK-NEXT:DPCT1004:{{[0-9]+}}: Get PCI BusId is not supported in DPC++
// CHECK-NEXT:*/
...
// CHECK:/*
// CHECK-NEXT:DPCT1010:{{[0-9]+}}: SYCL API uses exceptions to report errors and doesn't use the error codes. Hence, cudaPeekAtLastError was replaced with 0. You may need to rewrite this code.
// CHECK-NEXT:*/
// CHECK-NEXT: int e1 = 0;
// CHECK-NEXT:/*
// CHECK-NEXT:DPCT1010:{{[0-9]+}}: SYCL API uses exceptions to report errors and doesn't use the error codes. Hence, cudaPeekAtLastError was replaced with 0. You may need to rewrite this code.
