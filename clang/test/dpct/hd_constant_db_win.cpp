...
// RUN: cat %s > hd_constant_db_win.cpp
// RUN: cat %S/constant_header.h > constant_header.h
// RUN: echo "[" > compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"ClCompile hd_constant_db_win.cpp\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/hd_constant_db_win\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/hd_constant_db_win/hd_constant_db_win.cpp\"" >> compile_commands.json
// RUN: echo "    }," >> compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"CudaCompile hd_constant_db_win.cpp --x cu\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/hd_constant_db_win\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/hd_constant_db_win/hd_constant_db_win.cpp\"" >> compile_commands.json
// RUN: echo "    }" >> compile_commands.json
// RUN: echo "]" >> compile_commands.json
// RUN: dpct -p=. --out-root=./out --cuda-include-path="%cuda-path/include"
// RUN: FileCheck %s --match-full-lines --input-file %T/hd_constant_db_win/out/constant_header.h
// RUN: cd ..
