...
//CHECK:inline void d1(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:inline void d2(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:inline void d3(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d4(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d5(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d6(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d7(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d8(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:inline void d9(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d10();
//CHECK-NEXT:void d11(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:inline void d12(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:inline void d13(const sycl::nd_item<3> &item_ct1);
__device__ void d1();
__device__ void d2();
__device__ void d3();
__device__ void d4();
...
//CHECK:__dpct_inline__ void k1(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k2(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k3(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k4(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k5(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k6(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k7(const sycl::nd_item<3> &item_ct1);
//CHECK-NEXT:__dpct_inline__ void k8(const sycl::nd_item<3> &item_ct1);
__global__ void k1();
__global__ void k2();
__global__ void k3();
__global__ void k4();
...
//CHECK:inline void d2(const sycl::nd_item<1> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(0);
//CHECK-NEXT:  a = item_ct1.get_group(0);
//CHECK-NEXT:  a = item_ct1.get_local_range(0);
//CHECK-NEXT:  a = item_ct1.get_group_range(0);
...
//CHECK:inline void d3(const sycl::nd_item<3> &item_ct1) {
...
//CHECK:inline void d4(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_local_id(1);
//CHECK-NEXT:  a = item_ct1.get_local_id(0);
//CHECK-NEXT:  a = item_ct1.get_group(2);
...
//CHECK:inline void d5(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_group(2);
//CHECK-NEXT:  a = item_ct1.get_local_range(2);
//CHECK-NEXT:  a = item_ct1.get_group_range(2);
...
//CHECK:inline void d6(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_group(2);
//CHECK-NEXT:  a = item_ct1.get_local_range(2);
//CHECK-NEXT:  a = item_ct1.get_group_range(2);
...
//CHECK:inline void d7(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_local_id(1);
//CHECK-NEXT:  a = item_ct1.get_local_id(0);
//CHECK-NEXT:  a = item_ct1.get_group(2);
...
//CHECK:inline void d8(const sycl::nd_item<1> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(0);
//CHECK-NEXT:  d10();
//CHECK-NEXT:}
__device__ void d8() {
...
//CHECK:inline void d9(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  d10();
//CHECK-NEXT:}
__device__ void d9() {
...
//CHECK:inline void d12(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
...
//CHECK:inline void d13(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  d14(item_ct1);
//CHECK-NEXT:}
__device__ void d13() {
...
//CHECK:inline void d14(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
...
//CHECK:__dpct_inline__ void k2(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_local_id(1);
//CHECK-NEXT:  a = item_ct1.get_local_id(0);
//CHECK-NEXT:  a = item_ct1.get_group(2);
...
//CHECK:__dpct_inline__ void k3(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_group(2);
//CHECK-NEXT:  a = item_ct1.get_local_range(2);
//CHECK-NEXT:  a = item_ct1.get_group_range(2);
...
//CHECK:__dpct_inline__ void k4(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  a = item_ct1.get_local_id(1);
//CHECK-NEXT:  a = item_ct1.get_local_id(0);
//CHECK-NEXT:  a = item_ct1.get_group(2);
...
//CHECK:__dpct_inline__ void k5(const sycl::nd_item<1> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(0);
...
//CHECK:__dpct_inline__ void k6(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
...
//CHECK:__dpct_inline__ void k7(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
...
//CHECK:__dpct_inline__ void k8(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
...
//CHECK:inline void device1(const sycl::nd_item<1> &item_ct1);
//CHECK-NEXT:inline void device2(const sycl::nd_item<1> &item_ct1);
...
//CHECK:inline void device2(const sycl::nd_item<1> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(0);
...
//CHECK:inline void device3(const sycl::nd_item<3> &item_ct1) {
...
//CHECK:__dpct_inline__ void global2(const sycl::nd_item<3> &item_ct1) {
//CHECK-NEXT:  int a = item_ct1.get_local_id(2);
//CHECK-NEXT:  device3(item_ct1);
//CHECK-NEXT:}
...
// CHECK: __dpct_inline__ void global3(const sycl::nd_item<1> &item_ct1) {
...
// CHECK: __dpct_inline__ void global4(const sycl::nd_item<1> &item_ct1) {
//CHECK-NEXT:  int t = TIDx;
//CHECK-NEXT:}
...
//CHECK:__dpct_inline__ void global5(const sycl::nd_item<3> &item_ct1) {
...
//CHECK:__dpct_inline__ void global6(const sycl::nd_item<3> &item_ct1) {
