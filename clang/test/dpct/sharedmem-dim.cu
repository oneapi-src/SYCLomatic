...
// RUN: FileCheck %s --match-full-lines --input-file %T/sharedmem-dim.dp.cpp
...
// CHECK-NOT: DPCT1060:{{[0-9]+}}: DPC++ does not support the memory with dimension exceed 3. You may need to adjust the code.
