...
#define SIZEOF(x) sizeof(x)
  ...
  // CHECK:  /*
  // CHECK-NEXT:  DPCT1106:{{[0-9]+}}: 'cuMemGetInfo_v2' was migrated with Intel's Extensions for Device Information which may be not supported by all compilers or runtimes. You may need to adjust the code.
  // CHECK-NEXT:  */
  // CHECK-NEXT:  dpct::get_current_device().get_memory_info(free_mem, total_mem);
