...
int main(){
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::replace_if(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_S, pred, 0);
  //CHECK-NEXT: };
  ...
  //CHECK-NEXT: host_ptr_A[2]= 50;
  //CHECK-NEXT: host_ptr_A[3]= -395;
  //CHECK-NEXT: if (dpct::is_device_ptr(host_ptr_A)) {
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::replace_if(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, pred, 0);
  //CHECK-NEXT: };
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  //CHECK-NEXT: host_ptr_A[2]= 50;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::replace_if(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, pred, 0);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_A, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::replace_if(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_S, pred, 0);
  //CHECK-NEXT: };
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::remove_if(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, pred);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_A, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::remove_if(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, pred);
  //CHECK-NEXT: };
  host_ptr_A = (float*)std::malloc(20 * sizeof(float));
  host_ptr_R = (float*)std::malloc(20 * sizeof(float));
  host_ptr_S = (float*)std::malloc(20 * sizeof(float));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::remove_copy_if(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_R, pred);
  //CHECK-NEXT: };
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::remove_copy_if(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_R, pred);
  //CHECK-NEXT: };
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  //CHECK-NEXT: host_ptr_A[2]= 50;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::remove_copy_if(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_S, device_ptr_R, pred);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::remove_copy_if(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_S, host_ptr_R, pred);
  //CHECK-NEXT: };
  host_ptr_A = (float*)std::malloc(20 * sizeof(float));
  host_ptr_R = (float*)std::malloc(20 * sizeof(float));
  host_ptr_S = (float*)std::malloc(20 * sizeof(float));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::inclusive_scan(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_R);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::inclusive_scan(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_R, std::plus<float>());
  //CHECK-NEXT: };
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  //CHECK-NEXT: host_ptr_A[2]= 396;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::inclusive_scan(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_R, std::plus<float>());
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::inclusive_scan(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_R);
  //CHECK-NEXT: };
  host_ptr_A = (float*)std::malloc(20 * sizeof(float));
  host_ptr_R = (float*)std::malloc(20 * sizeof(float));
  host_ptr_S = (float*)std::malloc(20 * sizeof(float));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::adjacent_difference(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_R);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::adjacent_difference(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_R, std::minus<float>());
  //CHECK-NEXT: };
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  //CHECK-NEXT: host_ptr_A[2]= 396;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::adjacent_difference(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 10, device_ptr_R, std::minus<float>());
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   oneapi::dpl::adjacent_difference(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 10, host_ptr_R);
  //CHECK-NEXT: };
  host_ptr_A = (float*)std::malloc(20 * sizeof(float));
  host_ptr_R = (float*)std::malloc(20 * sizeof(float));
  host_ptr_S = (float*)std::malloc(20 * sizeof(float));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::gather(oneapi::dpl::execution::par_unseq, device_ptr_M, device_ptr_M + 4, device_ptr_A, device_ptr_R);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_M[0]= 3;
  //CHECK-NEXT: host_ptr_M[1]= 2;
  ...
  //CHECK-NEXT: host_ptr_A[2]= 396;
  //CHECK-NEXT: host_ptr_A[3]= -395;
  //CHECK-NEXT: if (dpct::is_device_ptr(host_ptr_M)) {
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::gather(oneapi::dpl::execution::par_unseq, host_ptr_M, host_ptr_M + 4, host_ptr_A, host_ptr_R);
  //CHECK-NEXT: };
  int *host_ptr_M;
  int *device_ptr_M;
  host_ptr_A = (float*)std::malloc(20 * sizeof(float));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::scatter(oneapi::dpl::execution::par_unseq, device_ptr_A, device_ptr_A + 4, device_ptr_M, device_ptr_R);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_R, device_ptr_R, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_M[0]= 2;
  //CHECK-NEXT: host_ptr_M[1]= 3;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::scatter(oneapi::dpl::execution::par_unseq, host_ptr_A, host_ptr_A + 4, host_ptr_M, host_ptr_R);
  //CHECK-NEXT: };
  host_ptr_A = (float*)std::malloc(20 * sizeof(float));
  host_ptr_R = (float*)std::malloc(20 * sizeof(float));
  host_ptr_S = (float*)std::malloc(20 * sizeof(float));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::unique_copy(oneapi::dpl::execution::par_unseq, device_ptr_K, device_ptr_K + 4, device_ptr_A, device_ptr_R, device_ptr_S, pred2);
  //CHECK-NEXT: };
  ...
  //CHECK-NEXT: host_ptr_A[2]= 396;
  //CHECK-NEXT: host_ptr_A[3]= -395;
  //CHECK-NEXT: if (dpct::is_device_ptr(host_ptr_K)) {
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::unique_copy(oneapi::dpl::execution::par_unseq, host_ptr_K, host_ptr_K + 10, host_ptr_A, host_ptr_R, host_ptr_S, pred2);
  //CHECK-NEXT: };
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  //CHECK-NEXT: host_ptr_A[2]= 396;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::unique_copy(oneapi::dpl::execution::par_unseq, device_ptr_K, device_ptr_K + 4, device_ptr_A, device_ptr_R, device_ptr_S);
  //CHECK-NEXT: };
  //CHECK-NEXT: dpct::dpct_memcpy(host_ptr_S, device_ptr_S, 20 * sizeof(float), dpct::device_to_host);
  //CHECK-NEXT: host_ptr_A[0]= -5;
  //CHECK-NEXT: host_ptr_A[1]= 8;
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   dpct::unique_copy(oneapi::dpl::execution::par_unseq, host_ptr_K, host_ptr_K + 10, host_ptr_A, host_ptr_R, host_ptr_S);
  //CHECK-NEXT: };
  float *host_ptr_K;
  float *device_ptr_K;
...
void foo()
{
  ...
  //CHECK-NEXT:  } else {
  //CHECK-NEXT:    dpct::stable_sort(oneapi::dpl::execution::par_unseq, keys, keys + N, values);
  //CHECK-NEXT:  };
  ...
  //CHECK-NEXT:  } else {
  //CHECK-NEXT:    dpct::stable_sort(oneapi::dpl::execution::par_unseq, keys, keys + N, values, std::greater<int>());
  //CHECK-NEXT:  };
  //CHECK-NEXT:  if (dpct::is_device_ptr(keys)) {
  //CHECK-NEXT:    dpct::stable_sort(oneapi::dpl::execution::make_device_policy(q_ct1), dpct::device_pointer<int>(keys), dpct::device_pointer<int>(keys + N), dpct::device_pointer<char>(values), std::greater<int>());
  //CHECK-NEXT:  } else {
