...
int main(int argc, char *argv[])
{
    ...
    // CHECK-NEXT: auto D_f_buff_ct1 = dpct::get_buffer<float>(&D_f);
    // CHECK-NEXT: auto E_f_buff_ct1 = dpct::get_buffer<float>(&E_f);
    // CHECK-NEXT: auto TAUQ_f_buff_ct1 = dpct::get_buffer<float>(&TAUQ_f);
    // CHECK-NEXT: auto TAUP_f_buff_ct1 = dpct::get_buffer<float>(&TAUP_f);
    ...
    // CHECK-NEXT: auto D_d_buff_ct1 = dpct::get_buffer<double>(&D_d);
    // CHECK-NEXT: auto E_d_buff_ct1 = dpct::get_buffer<double>(&E_d);
    // CHECK-NEXT: auto TAUQ_d_buff_ct1 = dpct::get_buffer<double>(&TAUQ_d);
    // CHECK-NEXT: auto TAUP_d_buff_ct1 = dpct::get_buffer<double>(&TAUP_d);
    ...
    // CHECK-NEXT: auto D_f_buff_ct1 = dpct::get_buffer<float>(&D_f);
    // CHECK-NEXT: auto E_f_buff_ct1 = dpct::get_buffer<float>(&E_f);
    // CHECK-NEXT: auto TAUQ_c_buff_ct1 = dpct::get_buffer<std::complex<float>>(&TAUQ_c);
    // CHECK-NEXT: auto TAUP_c_buff_ct1 = dpct::get_buffer<std::complex<float>>(&TAUP_c);
    ...
    // CHECK-NEXT: auto D_d_buff_ct1 = dpct::get_buffer<double>(&D_d);
    // CHECK-NEXT: auto E_d_buff_ct1 = dpct::get_buffer<double>(&E_d);
    // CHECK-NEXT: auto TAUQ_z_buff_ct1 = dpct::get_buffer<std::complex<double>>(&TAUQ_z);
    // CHECK-NEXT: auto TAUP_z_buff_ct1 = dpct::get_buffer<std::complex<double>>(&TAUP_z);
    ...
    // CHECK-NEXT: {
    // CHECK-NEXT: auto A_f_buff_ct1 = dpct::get_buffer<float>(&A_f);
    // CHECK-NEXT: auto S_f_buff_ct1 = dpct::get_buffer<float>(&S_f);
    // CHECK-NEXT: auto U_f_buff_ct1 = dpct::get_buffer<float>(&U_f);
    // CHECK-NEXT: auto VT_f_buff_ct1 = dpct::get_buffer<float>(&VT_f);
    // CHECK-NEXT: auto workspace_f_buff_ct1 = dpct::get_buffer<float>(&workspace_f);
    // CHECK-NEXT: auto devInfo_buff_ct1 = dpct::get_buffer<int>(&devInfo);
    ...
    // CHECK-NEXT: {
    // CHECK-NEXT: auto A_d_buff_ct1 = dpct::get_buffer<double>(&A_d);
    // CHECK-NEXT: auto S_d_buff_ct1 = dpct::get_buffer<double>(&S_d);
    // CHECK-NEXT: auto U_d_buff_ct1 = dpct::get_buffer<double>(&U_d);
    // CHECK-NEXT: auto VT_d_buff_ct1 = dpct::get_buffer<double>(&VT_d);
    // CHECK-NEXT: auto workspace_d_buff_ct1 = dpct::get_buffer<double>(&workspace_d);
    // CHECK-NEXT: auto devInfo_buff_ct1 = dpct::get_buffer<int>(&devInfo);
    // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer15(sycl::range<1>(1));
    ...
    // CHECK-NEXT: auto A_c_buff_ct1 = dpct::get_buffer<std::complex<float>>(&A_c);
    // CHECK-NEXT: auto S_f_buff_ct1 = dpct::get_buffer<float>(&S_f);
    // CHECK-NEXT: auto U_c_buff_ct1 = dpct::get_buffer<std::complex<float>>(&U_c);
    // CHECK-NEXT: auto VT_c_buff_ct1 = dpct::get_buffer<std::complex<float>>(&VT_c);
    // CHECK-NEXT: auto workspace_c_buff_ct1 = dpct::get_buffer<std::complex<float>>(&workspace_c);
    // CHECK-NEXT: auto Rwork_f_buff_ct1 = dpct::get_buffer<float>(&Rwork_f);
    // CHECK-NEXT: auto devInfo_buff_ct1 = dpct::get_buffer<int>(&devInfo);
    // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer15(sycl::range<1>(1));
    ...
    // CHECK-NEXT: auto A_z_buff_ct1 = dpct::get_buffer<std::complex<double>>(&A_z);
    // CHECK-NEXT: auto S_d_buff_ct1 = dpct::get_buffer<double>(&S_d);
    // CHECK-NEXT: auto U_z_buff_ct1 = dpct::get_buffer<std::complex<double>>(&U_z);
    // CHECK-NEXT: auto VT_z_buff_ct1 = dpct::get_buffer<std::complex<double>>(&VT_z);
    // CHECK-NEXT: auto workspace_z_buff_ct1 = dpct::get_buffer<std::complex<double>>(&workspace_z);
    // CHECK-NEXT: auto Rwork_d_buff_ct1 = dpct::get_buffer<double>(&Rwork_d);
    // CHECK-NEXT: auto devInfo_buff_ct1 = dpct::get_buffer<int>(&devInfo);
    // CHECK-NEXT: sycl::buffer<int64_t> result_temp_buffer15(sycl::range<1>(1));
