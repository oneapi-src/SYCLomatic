...
// CHECK: unsigned int test_min(unsigned int a, unsigned int b) { return dpct::dpct_min(a, b); }
unsigned int test_min(unsigned int a, unsigned int b) { return min(a, b); }

// CHECK: unsigned int test_min(int a, unsigned int b) { return dpct::dpct_min(a, b); }
unsigned int test_min(int a, unsigned int b) { return min(a, b); }

// CHECK: unsigned int test_min(unsigned int a, int b) { return dpct::dpct_min(a, b); }
unsigned int test_min(unsigned int a, int b) { return min(a, b); }

// CHECK: long int test_min(long int a, long int b) { return dpct::dpct_min(a, b); }
...
// CHECK:   return dpct::dpct_min(a, b);
// CHECK: }
...
// CHECK: long long int test_min(long long int a, long long int b) { return dpct::dpct_min(a, b); }
...
// CHECK: float test_min(float a, float b) { return dpct::dpct_min(a, b); }
float test_min(float a, float b) { return min(a, b); }

// CHECK: double test_min(double a, double b) { return dpct::dpct_min(a, b); }
double test_min(double a, double b) { return min(a, b); }

// CHECK: double test_min(float a, double b) { return dpct::dpct_min(a, b); }
double test_min(float a, double b) { return min(a, b); }

// CHECK: double test_min(double a, float b) { return dpct::dpct_min(a, b); }
double test_min(double a, float b) { return min(a, b); }

// CHECK: unsigned int test_max(unsigned int a, unsigned int b) { return dpct::dpct_max(a, b); }
unsigned int test_max(unsigned int a, unsigned int b) { return max(a, b); }

// CHECK: unsigned int test_max(int a, unsigned int b) { return dpct::dpct_max(a, b); }
unsigned int test_max(int a, unsigned int b) { return max(a, b); }

// CHECK: unsigned int test_max(unsigned int a, int b) { return dpct::dpct_max(a, b); }
unsigned int test_max(unsigned int a, int b) { return max(a, b); }

// CHECK: long int test_max(long int a, long int b) { return dpct::dpct_max(a, b); }
...
// CHECK:   return dpct::dpct_max(a, b);
// CHECK: }
...
// CHECK: long long int test_max(long long int a, long long int b) { return dpct::dpct_max(a, b); }
...
// CHECK: float test_max(float a, float b) { return dpct::dpct_max(a, b); }
float test_max(float a, float b) { return max(a, b); }

// CHECK: double test_max(double a, double b) { return dpct::dpct_max(a, b); }
double test_max(double a, double b) { return max(a, b); }

// CHECK: double test_max(float a, double b) { return dpct::dpct_max(a, b); }
double test_max(float a, double b) { return max(a, b); }

// CHECK: double test_max(double a, float b) { return dpct::dpct_max(a, b); }
