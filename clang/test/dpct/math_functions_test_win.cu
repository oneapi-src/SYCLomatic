...
// CHECK: unsigned int test_min(unsigned int a, unsigned int b) { return dpct::min(a, b); }
...
// CHECK: long int test_min(long int a, long int b) { return dpct::min(a, b); }
...
// CHECK: long long int test_min(long long int a, long long int b) { return dpct::min(a, b); }
...
// CHECK: float test_min(float a, float b) { return dpct::min(a, b); }
float test_min(float a, float b) { return min(a, b); }

// CHECK: double test_min(double a, double b) { return dpct::min(a, b); }
...
// CHECK: unsigned int test_max(unsigned int a, unsigned int b) { return dpct::max(a, b); }
...
// CHECK: long int test_max(long int a, long int b) { return dpct::max(a, b); }
...
// CHECK: long long int test_max(long long int a, long long int b) { return dpct::max(a, b); }
...
// CHECK: float test_max(float a, float b) { return dpct::max(a, b); }
