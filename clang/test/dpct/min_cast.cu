...
__global__ void func() {
  ...
  int CHUNK_SIZE0 = 64;
  int numz0;
  //CHECK: const int zlength0 = cl::sycl::min((unsigned int)(CHUNK_SIZE0), (unsigned int)(numz0 - item_ct1.get_group(2) * CHUNK_SIZE0));
  ...
  int numz1;
  //CHECK: const int zlength1 = cl::sycl::min(CHUNK_SIZE1, (unsigned int)(numz1 - item_ct1.get_group(2) * CHUNK_SIZE1));
