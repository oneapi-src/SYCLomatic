...
void testTemplate(){
  ...
  // CHECK-NEXT:          templateReverse<T>(d_d, n, [[ITEM]], dpct::dpct_accessor<dpct::byte_t, dpct::shared, 1>(dpct_extern_memory_acc_ct1, dpct_extern_memory_range_ct1));
  // CHECK-NEXT:        });
  // CHECK-NEXT:    });
  // CHECK-NEXT:}
...
int main(void) {
  ...
  // CHECK-NEXT:          staticReverse(d_d, n, [[ITEM]], dpct::dpct_accessor<dpct::byte_t, dpct::shared, 1>(dpct_extern_memory_acc_ct1, dpct_extern_memory_range_ct1));
  // CHECK-NEXT:        });
  // CHECK-NEXT:    });
  // CHECK-NEXT:}
  ...
  // CHECK-NEXT:        [=](cl::sycl::nd_item<3> [[ITEM:item_ct1]]) {
  // CHECK-NEXT:          int *d_d = (int*)(&d_d_acc[0] + d_d_offset);
  // CHECK-NEXT:          templateReverse<int>(d_d, n, [[ITEM]], dpct::dpct_accessor<dpct::byte_t, dpct::shared, 1>(dpct_extern_memory_acc_ct1, dpct_extern_memory_range_ct1));
  // CHECK-NEXT:        });
  // CHECK-NEXT:    });
  // CHECK-NEXT:}
