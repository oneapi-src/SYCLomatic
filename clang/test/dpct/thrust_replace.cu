...
// replace_if
  ...
  //CHECK:oneapi::dpl::replace_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), pred, 0);  
  ...
  //CHECK:dpct::replace_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), SD.begin(), pred, 0);  
  ...
  //CHECK:if (dpct::is_device_ptr(h_ptr + 4)) {
  ...
  //CHECK:if (dpct::is_device_ptr(d_ptr + 4)) {
  ...
  //CHECK:if (dpct::is_device_ptr(d_ptr)) {
  //CHECK-NEXT:  oneapi::dpl::replace_if(oneapi::dpl::execution::make_device_policy(q_ct1), dpct::device_pointer<int>(d_ptr), dpct::device_pointer<int>(d_ptr + 4), pred, 0);
  //CHECK-NEXT:} else {
  //CHECK-NEXT:  oneapi::dpl::replace_if(oneapi::dpl::execution::seq, d_ptr, d_ptr + 4, pred, 0);
  //CHECK-NEXT:};  
...
// replace_copy_if
  ...
  //CHECK:oneapi::dpl::replace_copy_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), BD.begin(), pred, 0);  
  ...
  //CHECK:dpct::replace_copy_if(oneapi::dpl::execution::make_device_policy(q_ct1), AD.begin(), AD.end(), SD.begin(), BD.begin(), pred, 0);  
