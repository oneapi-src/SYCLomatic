...
int foo1() {
  ...
  int lwork_s, lwork_d;
  int *devInfo;
  //CHECK:status = CHECK_SYCL_ERROR(lwork_s = oneapi::mkl::lapack::sygvd_scratchpad_size<float>(*handle, 1, oneapi::mkl::job::vec, oneapi::mkl::uplo::upper, 3, 3, 3));
  ...
  //CHECK:status = CHECK_SYCL_ERROR(lwork_d = oneapi::mkl::lapack::sygvd_scratchpad_size<double>(*handle, 1, oneapi::mkl::job::vec, oneapi::mkl::uplo::upper, 3, 3, 3));
...
int foo2() {
  ...
  //CHECK:status = CHECK_SYCL_ERROR(lwork_c = oneapi::mkl::lapack::hegvd_scratchpad_size<std::complex<float>>(*handle, 1, oneapi::mkl::job::vec, oneapi::mkl::uplo::upper, 3, 3, 3));
  ...
  //CHECK:status = CHECK_SYCL_ERROR(lwork_z = oneapi::mkl::lapack::hegvd_scratchpad_size<std::complex<double>>(*handle, 1, oneapi::mkl::job::vec, oneapi::mkl::uplo::upper, 3, 3, 3));
