...
int main() {
  ...
  // CHECK-NEXT: */
  // CHECK-NEXT: /*
  // CHECK-NEXT: DPCT1099:{{[0-9]+}}: Verify if the default value of the direction and placement used in the function "dpct::fft::fft_engine::estimate_size" is aligning with the related "compute" function call.
  // CHECK-NEXT: */
