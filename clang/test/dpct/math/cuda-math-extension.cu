...
__global__ void kernelFuncSIMD() {
  ...
  // CHECK: u_2 = sycl::ext::intel::math::vabs2<unsigned>(u);
  u_2 = __vabs2(u);
  // CHECK: u_2 = sycl::ext::intel::math::vabs4<unsigned>(u);
  u_2 = __vabs4(u);
  // CHECK: u_2 = sycl::ext::intel::math::vabsdiffs2<unsigned>(u, u_1);
  u_2 = __vabsdiffs2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vabsdiffs4<unsigned>(u, u_1);
  u_2 = __vabsdiffs4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vabsdiffu2<unsigned>(u, u_1);
  u_2 = __vabsdiffu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vabsdiffu4<unsigned>(u, u_1);
  u_2 = __vabsdiffu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vabsss2<unsigned>(u);
  u_2 = __vabsss2(u);
  // CHECK: u_2 = sycl::ext::intel::math::vabsss4<unsigned>(u);
  u_2 = __vabsss4(u);
  // CHECK: u_2 = sycl::ext::intel::math::vadd2<unsigned>(u, u_1);
  u_2 = __vadd2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vadd4<unsigned>(u, u_1);
  u_2 = __vadd4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vaddss2<unsigned>(u, u_1);
  u_2 = __vaddss2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vaddss4<unsigned>(u, u_1);
  u_2 = __vaddss4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vaddus2<unsigned>(u, u_1);
  u_2 = __vaddus2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vaddus4<unsigned>(u, u_1);
  u_2 = __vaddus4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vavgs2<unsigned>(u, u_1);
  u_2 = __vavgs2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vavgs4<unsigned>(u, u_1);
  u_2 = __vavgs4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vavgu2<unsigned>(u, u_1);
  u_2 = __vavgu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vavgu4<unsigned>(u, u_1);
  u_2 = __vavgu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpeq2<unsigned>(u, u_1);
  u_2 = __vcmpeq2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpeq4<unsigned>(u, u_1);
  u_2 = __vcmpeq4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpges2<unsigned>(u, u_1);
  u_2 = __vcmpges2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpges4<unsigned>(u, u_1);
  u_2 = __vcmpges4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpgeu2<unsigned>(u, u_1);
  u_2 = __vcmpgeu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpgeu4<unsigned>(u, u_1);
  u_2 = __vcmpgeu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpgts2<unsigned>(u, u_1);
  u_2 = __vcmpgts2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpgts4<unsigned>(u, u_1);
  u_2 = __vcmpgts4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpgtu2<unsigned>(u, u_1);
  u_2 = __vcmpgtu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpgtu4<unsigned>(u, u_1);
  u_2 = __vcmpgtu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmples2<unsigned>(u, u_1);
  u_2 = __vcmples2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmples4<unsigned>(u, u_1);
  u_2 = __vcmples4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpleu2<unsigned>(u, u_1);
  u_2 = __vcmpleu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpleu4<unsigned>(u, u_1);
  u_2 = __vcmpleu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmplts2<unsigned>(u, u_1);
  u_2 = __vcmplts2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmplts4<unsigned>(u, u_1);
  u_2 = __vcmplts4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpltu2<unsigned>(u, u_1);
  u_2 = __vcmpltu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpltu4<unsigned>(u, u_1);
  u_2 = __vcmpltu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpne2<unsigned>(u, u_1);
  u_2 = __vcmpne2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vcmpne4<unsigned>(u, u_1);
  u_2 = __vcmpne4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vhaddu2<unsigned>(u, u_1);
  u_2 = __vhaddu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vhaddu4<unsigned>(u, u_1);
  u_2 = __vhaddu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vmaxs2<unsigned>(u, u_1);
  u_2 = __vmaxs2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vmaxs4<unsigned>(u, u_1);
  u_2 = __vmaxs4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vmaxu2<unsigned>(u, u_1);
  u_2 = __vmaxu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vmaxu4<unsigned>(u, u_1);
  u_2 = __vmaxu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vmins2<unsigned>(u, u_1);
  u_2 = __vmins2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vmins4<unsigned>(u, u_1);
  u_2 = __vmins4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vminu2<unsigned>(u, u_1);
  u_2 = __vminu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vminu4<unsigned>(u, u_1);
  u_2 = __vminu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vneg2<unsigned>(u);
  u_2 = __vneg2(u);
  // CHECK: u_2 = sycl::ext::intel::math::vneg4<unsigned>(u);
  u_2 = __vneg4(u);
  // CHECK: u_2 = sycl::ext::intel::math::vnegss2<unsigned>(u);
  u_2 = __vnegss2(u);
  // CHECK: u_2 = sycl::ext::intel::math::vnegss4<unsigned>(u);
  u_2 = __vnegss4(u);
  // CHECK: u_2 = sycl::ext::intel::math::vsads2<unsigned>(u, u_1);
  u_2 = __vsads2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsads4<unsigned>(u, u_1);
  u_2 = __vsads4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsadu2<unsigned>(u, u_1);
  u_2 = __vsadu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsadu4<unsigned>(u, u_1);
  u_2 = __vsadu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vseteq2<unsigned>(u, u_1);
  u_2 = __vseteq2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vseteq4<unsigned>(u, u_1);
  u_2 = __vseteq4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetges2<unsigned>(u, u_1);
  u_2 = __vsetges2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetges4<unsigned>(u, u_1);
  u_2 = __vsetges4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetgeu2<unsigned>(u, u_1);
  u_2 = __vsetgeu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetgeu4<unsigned>(u, u_1);
  u_2 = __vsetgeu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetgts2<unsigned>(u, u_1);
  u_2 = __vsetgts2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetgts4<unsigned>(u, u_1);
  u_2 = __vsetgts4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetgtu2<unsigned>(u, u_1);
  u_2 = __vsetgtu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetgtu4<unsigned>(u, u_1);
  u_2 = __vsetgtu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetles2<unsigned>(u, u_1);
  u_2 = __vsetles2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetles4<unsigned>(u, u_1);
  u_2 = __vsetles4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetleu2<unsigned>(u, u_1);
  u_2 = __vsetleu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetleu4<unsigned>(u, u_1);
  u_2 = __vsetleu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetlts2<unsigned>(u, u_1);
  u_2 = __vsetlts2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetlts4<unsigned>(u, u_1);
  u_2 = __vsetlts4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetltu2<unsigned>(u, u_1);
  u_2 = __vsetltu2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetltu4<unsigned>(u, u_1);
  u_2 = __vsetltu4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetne2<unsigned>(u, u_1);
  u_2 = __vsetne2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsetne4<unsigned>(u, u_1);
  u_2 = __vsetne4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsub2<unsigned>(u, u_1);
  u_2 = __vsub2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsub4<unsigned>(u, u_1);
  u_2 = __vsub4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsubss2<unsigned>(u, u_1);
  u_2 = __vsubss2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsubss4<unsigned>(u, u_1);
  u_2 = __vsubss4(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsubus2<unsigned>(u, u_1);
  u_2 = __vsubus2(u, u_1);
  // CHECK: u_2 = sycl::ext::intel::math::vsubus4<unsigned>(u, u_1);
  u_2 = __vsubus4(u, u_1);

  // arg type conv.
  int i, i_1;
  // CHECK: u_2 = sycl::ext::intel::math::vsubss4<unsigned>(i, i_1);
  u_2 = __vsubss4(i, i_1);
}
