...
// RUN: %if build_lit %{icpx -c -fsycl -DNO_BUILD_TEST %T/math/cuda-math-syclcompat-cuda12-after/cuda-math-syclcompat-cuda12-after.dp.cpp -o %T/math/cuda-math-syclcompat-cuda12-after/cuda-math-syclcompat-cuda12-after.dp.o %}
