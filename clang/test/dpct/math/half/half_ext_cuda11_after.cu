...
// RUN: %if build_lit %{icpx -c -fsycl %T/math/half/half_ext_cuda11_after/half_ext_cuda11_after.dp.cpp -o %T/math/half/half_ext_cuda11_after/half_ext_cuda11_after.dp.o %}
