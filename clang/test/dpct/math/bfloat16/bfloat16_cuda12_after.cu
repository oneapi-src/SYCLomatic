...
// RUN: %if build_lit %{icpx -c -fsycl %T/math/bfloat16/bfloat16_cuda12_after/bfloat16_cuda12_after.dp.cpp -o %T/math/bfloat16/bfloat16_cuda12_after/bfloat16_cuda12_after.dp.o %}
