...
// RUN: %if build_lit %{icpx -c -DNO_BUILD_TEST -fsycl %T/math/bfloat16/bfloat16_ext/bfloat16_ext.dp.cpp -o %T/math/bfloat16/bfloat16_ext/bfloat16_ext.dp.o %}
...
__global__ void kernelFuncBfloat16Conversion() {
  ...
  unsigned short us;
  double d;
  // CHECK: f2 = sycl::float2(sycl::ext::intel::math::bfloat162float(bf162.x()), sycl::ext::intel::math::bfloat162float(bf162.y()));
