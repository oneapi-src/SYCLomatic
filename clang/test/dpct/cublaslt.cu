...
void foo1 () {
  ...
  // CHECK: dpct::dnnl::experimental::matrix_layout_ptr matLayout;
  // CHECK-NEXT: dpct::library_data_t type;
  // CHECK-NEXT: uint64_t rows;
  // CHECK-NEXT: uint64_t cols;
  // CHECK-NEXT: int64_t ld;
  // CHECK-NEXT: matLayout = std::make_shared<dpct::dnnl::experimental::matrix_layout_t>(type, rows, cols, ld);
  ...
  // CHECK: dpct::dnnl::experimental::matrix_layout_t::attribute attr1;
  ...
  // CHECK: dpct::dnnl::experimental::matmul_desc_ptr matmulDesc;
  // CHECK-NEXT: dpct::blas::compute_type computeType;
  // CHECK-NEXT: dpct::library_data_t scaleType;
  // CHECK-NEXT: matmulDesc = std::make_shared<dpct::dnnl::experimental::matmul_desc_t>(computeType, scaleType);
  cublasLtMatmulDesc_t matmulDesc;
  cublasComputeType_t computeType;
  cudaDataType_t scaleType;
  cublasLtMatmulDescCreate(&matmulDesc, computeType, scaleType);

  // CHECK: dpct::dnnl::experimental::matmul_desc_t::attribute attr2;
...
void foo2() {
  ...
  // CHECK-NEXT: dpct::dnnl::experimental::matmul_desc_ptr computeDesc;
  // CHECK-NEXT: const void *alpha;
  // CHECK-NEXT: const void *A;
  // CHECK-NEXT: dpct::dnnl::experimental::matrix_layout_ptr Adesc;
  // CHECK-NEXT: const void *B;
  // CHECK-NEXT: dpct::dnnl::experimental::matrix_layout_ptr Bdesc;
  // CHECK-NEXT: const void *beta;
  // CHECK-NEXT: const void *C;
  // CHECK-NEXT: dpct::dnnl::experimental::matrix_layout_ptr Cdesc;
  // CHECK-NEXT: void *D;
  // CHECK-NEXT: dpct::dnnl::experimental::matrix_layout_ptr Ddesc;
  // CHECK-NEXT: const int *algo;
  // CHECK-NEXT: void *workspace;
  // CHECK-NEXT: size_t workspaceSizeInBytes;
  // CHECK-NEXT: dpct::queue_ptr stream;
  // CHECK-NEXT: dpct::dnnl::experimental::matmul(computeDesc, alpha, A, Adesc, B, Bdesc, beta, C, Cdesc, D, Ddesc, stream);
...
void foo3() {
  // CHECK: dpct::dnnl::experimental::order_t a;
  // CHECK-NEXT: a = dpct::dnnl::experimental::order_t::col;
  // CHECK-NEXT: a = dpct::dnnl::experimental::order_t::row;
  // CHECK-NEXT: a = dpct::dnnl::experimental::order_t::col32;
  // CHECK-NEXT: a = dpct::dnnl::experimental::order_t::col4_4r2_8c;
  // CHECK-NEXT: a = dpct::dnnl::experimental::order_t::col32_2r_4r4;
  cublasLtOrder_t a;
  ...
  // CHECK: dpct::dnnl::experimental::pointer_mode_t b;
  // CHECK-NEXT: b = dpct::dnnl::experimental::pointer_mode_t::host;
  // CHECK-NEXT: b = dpct::dnnl::experimental::pointer_mode_t::device;
  // CHECK-NEXT: b = dpct::dnnl::experimental::pointer_mode_t::device_vector;
  // CHECK-NEXT: b = dpct::dnnl::experimental::pointer_mode_t::alpha_device_vector_beta_zero;
  // CHECK-NEXT: b = dpct::dnnl::experimental::pointer_mode_t::alpha_device_vector_beta_host;
  ...
  // CHECK: dpct::dnnl::experimental::matrix_layout_t::attribute c;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::type;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::order;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::rows;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::cols;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::ld;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::batch_count;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::strided_batch_offset;
  // CHECK-NEXT: c = dpct::dnnl::experimental::matrix_layout_t::attribute::plane_offset;
  ...
  // CHECK: dpct::dnnl::experimental::matmul_desc_t::attribute d;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::compute_type;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::scale_type;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::pointer_mode;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::trans_a;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::trans_b;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::trans_c;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::fill_mode;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::bias_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::bias_batch_stride;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue_aux_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue_aux_ld;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue_aux_batch_stride;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::alpha_vector_batch_stride;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::sm_count_target;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::a_scale_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::b_scale_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::c_scale_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::d_scale_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::amax_d_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue_aux_data_type;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue_aux_scale_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::epilogue_aux_amax_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::fast_accum;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::bias_data_type;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::atomic_sync_in_counters_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::atomic_sync_out_counters_pointer;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::atomic_sync_num_chunks_d_rows;
  // CHECK-NEXT: d = dpct::dnnl::experimental::matmul_desc_t::attribute::atomic_sync_num_chunks_d_cols;
