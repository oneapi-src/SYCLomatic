...
int main(){
  ...
  // CHECK: status = DPCT_CHECK_ERROR(dpct::blas::trmm(handle, (oneapi::mkl::side)side0, fill0 == 0 ? oneapi::mkl::uplo::lower : oneapi::mkl::uplo::upper, dpct::get_transpose(trans0), (oneapi::mkl::diag)diag0, m, n, &alpha_S, A_S, lda, B_S, ldb, C_S, ldc));
  // CHECK-NEXT: dpct::blas::trmm(handle, oneapi::mkl::side::left, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::nonunit, m, n, &alpha_S, A_S, lda, B_S, ldb, C_S, ldc);
  ...
  // CHECK: status = DPCT_CHECK_ERROR(dpct::blas::trmm(handle, (oneapi::mkl::side)side1, fill1 == 0 ? oneapi::mkl::uplo::lower : oneapi::mkl::uplo::upper, dpct::get_transpose(trans1), (oneapi::mkl::diag)diag1, m, n, &alpha_D, A_D, lda, B_D, ldb, C_D, ldc));
  // CHECK-NEXT: dpct::blas::trmm(handle, oneapi::mkl::side::left, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::nonunit, m, n, &alpha_D, A_D, lda, B_D, ldb, C_D, ldc);
  ...
  // CHECK: status = DPCT_CHECK_ERROR(dpct::blas::trmm(handle, oneapi::mkl::side::left, oneapi::mkl::uplo::lower, dpct::get_transpose(trans2), oneapi::mkl::diag::nonunit, m, n, &alpha_C, A_C, lda, B_C, ldb, C_C, ldc));
  // CHECK-NEXT: dpct::blas::trmm(handle, oneapi::mkl::side::left, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::nonunit, m, n, &alpha_C, A_C, lda, B_C, ldb, C_C, ldc);
  ...
  // CHECK: status = DPCT_CHECK_ERROR(dpct::blas::trmm(handle, oneapi::mkl::side::right, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::conjtrans, oneapi::mkl::diag::unit, m, n, &alpha_Z, A_Z, lda, B_Z, ldb, C_Z, ldc));
  // CHECK-NEXT: dpct::blas::trmm(handle, oneapi::mkl::side::left, oneapi::mkl::uplo::upper, oneapi::mkl::transpose::nontrans, oneapi::mkl::diag::nonunit, m, n, &alpha_Z, A_Z, lda, B_Z, ldb, C_Z, ldc);
  ...
  // CHECK: dpct::blas::trmm(handle, oneapi::mkl::side::left, oneapi::mkl::uplo::upper, dpct::get_transpose(foo1()), oneapi::mkl::diag::nonunit, m, n, &alpha_Z, A_Z, lda, B_Z, ldb, foo2(), ldc);
