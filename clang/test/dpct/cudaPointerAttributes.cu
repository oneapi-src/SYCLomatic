// UNSUPPORTED: v11.0, v11.1, v11.2, v11.3, v11.4, v11.5, v11.6, v11.7, v11.8, v12.0, v12.1, v12.2, v12.3 , v12.4, v12.5, v12.6, v12.8
// UNSUPPORTED: cuda-11.0, cuda-11.1, cuda-11.2, cuda-11.3, cuda-11.4, cuda-11.5, cuda-11.6, cuda-11.7, cuda-11.8, cuda-12.0, cuda-12.1, cuda-12.2, cuda-12.3, cuda-12.4, cuda-12.5, cuda-12.6, cuda-12.8
...
int main() {
  ...
  if (attributes3->memoryType == 0) {
    ...
    return 1;
  } else if (attributes3->memoryType == 2) {
    return 2;
  } else if (attributes3->memoryType == 3) {
    return 3;
  }
}
