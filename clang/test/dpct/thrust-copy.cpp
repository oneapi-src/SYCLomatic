...
int main(void) {
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   std::copy(oneapi::dpl::execution::par_unseq, data, data + N, dst_data);
  //CHECK-NEXT: };
  thrust::copy(data, data + N, dst_data);
  //CHECK: std::copy(oneapi::dpl::execution::par_unseq, host_input.begin(), host_input.end(), std::ostream_iterator<char>(std::cout, ""));
  ...
  //CHECK: std::copy_n(oneapi::dpl::execution::par_unseq, host_input.begin(), N, std::ostream_iterator<char>(std::cout, ""));
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   std::copy_n(oneapi::dpl::execution::par_unseq, data, N, std::ostream_iterator<char>(std::cout, ""));
  //CHECK-NEXT: };
  ...
  //CHECK-NEXT: } else {
  //CHECK-NEXT:   std::copy_n(oneapi::dpl::execution::par_unseq, data, N, dst_data);
  //CHECK-NEXT: };
