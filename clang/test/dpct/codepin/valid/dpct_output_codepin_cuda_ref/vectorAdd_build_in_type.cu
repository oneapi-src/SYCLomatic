...
//CHECK: dpctexp::codepin::gen_prolog_API_CP("{{[._-0-9a-zA-Z\/\(\)\:]+}}", 0, "d_A", d_A, "d_B", d_B, "d_C", d_C);
//CHECK: dpctexp::codepin::gen_epilog_API_CP("{{[._-0-9a-zA-Z\/\(\)\:]+}}", 0, "d_A", d_A, "d_B", d_B, "d_C", d_C);