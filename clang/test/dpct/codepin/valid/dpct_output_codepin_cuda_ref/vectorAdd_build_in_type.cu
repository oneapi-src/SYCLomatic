...
//CHECK: dpct::experimental::gen_prolog_API_CP("{{[._0-9a-zA-Z\/\(\)\:]+}}", 0, "d_A", d_A, "d_B", d_B, "d_C", d_C);
//CHECK: dpct::experimental::gen_epilog_API_CP("{{[._0-9a-zA-Z\/\(\)\:]+}}", 0, "d_A", d_A, "d_B", d_B, "d_C", d_C);