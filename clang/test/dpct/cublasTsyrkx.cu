...
int main() {
  ...
  //CHECK-NEXT: */
  //CHECK-NEXT: status = (mkl::blas::gemmt(*handle, fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, trans0==2 ? mkl::transpose::conjtrans : (mkl::transpose)trans0, trans0==0 ? mkl::transpose::trans : mkl::transpose::nontrans, n, k, dpct::get_value(&alpha_s, *handle), A_s_buf_ct{{[0-9]+}}, lda, B_s_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_s, *handle), C_s_buf_ct{{[0-9]+}}, ldc), 0);
  //CHECK-NEXT: }
  //CHECK-NEXT: {
  //CHECK-NEXT: auto A_s_buf_ct{{[0-9]+}} = dpct::get_buffer<float>(A_s);
  //CHECK-NEXT: auto B_s_buf_ct{{[0-9]+}} = dpct::get_buffer<float>(B_s);
  //CHECK-NEXT: auto C_s_buf_ct{{[0-9]+}} = dpct::get_buffer<float>(C_s);
  //CHECK-NEXT: mkl::blas::gemmt(*handle, fill1==0 ? mkl::uplo::lower : mkl::uplo::upper, trans1==2 ? mkl::transpose::conjtrans : (mkl::transpose)trans1, trans1==0 ? mkl::transpose::trans : mkl::transpose::nontrans, n, k, dpct::get_value(&alpha_s, *handle), A_s_buf_ct{{[0-9]+}}, lda, B_s_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_s, *handle), C_s_buf_ct{{[0-9]+}}, ldc);
  //CHECK-NEXT: }
  ...
  //CHECK-NEXT: */
  //CHECK-NEXT: status = (mkl::blas::gemmt(*handle, mkl::uplo::lower, mkl::transpose::nontrans, mkl::transpose::trans, n, k, dpct::get_value(&alpha_d, *handle), A_d_buf_ct{{[0-9]+}}, lda, B_d_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_d, *handle), C_d_buf_ct{{[0-9]+}}, ldc), 0);
  //CHECK-NEXT: }
  //CHECK-NEXT: {
  //CHECK-NEXT: auto A_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(A_d);
  //CHECK-NEXT: auto B_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(B_d);
  //CHECK-NEXT: auto C_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(C_d);
  //CHECK-NEXT: mkl::blas::gemmt(*handle, mkl::uplo::upper, mkl::transpose::trans, mkl::transpose::nontrans, n, k, dpct::get_value(&alpha_d, *handle), A_d_buf_ct{{[0-9]+}}, lda, B_d_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_d, *handle), C_d_buf_ct{{[0-9]+}}, ldc);
  //CHECK-NEXT: }
  ...
  //CHECK-NEXT: auto B_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(B_d);
  //CHECK-NEXT: auto C_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(C_d);
  //CHECK-NEXT: mkl::blas::gemmt(*handle, foo(), (int)macro_a==2 ? mkl::transpose::conjtrans : (mkl::transpose)macro_a, (int)macro_a==0 ? mkl::transpose::trans : mkl::transpose::nontrans, n, k, dpct::get_value(&alpha_d, *handle), A_d_buf_ct{{[0-9]+}}, lda, B_d_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_d, *handle), C_d_buf_ct{{[0-9]+}}, ldc);
  //CHECK-NEXT: }
  ...
  //CHECK-NEXT: mkl::blas::gemmt(*handle, (int)macro_b==0 ? mkl::uplo::lower : mkl::uplo::upper, bar_transpose_ct{{[0-9]+}}, bar_transpose_ct{{[0-9]+}}==mkl::transpose::nontrans ? mkl::transpose::trans : mkl::transpose::nontrans, n, k, dpct::get_value(&alpha_d, *handle), A_d_buf_ct{{[0-9]+}}, lda, B_d_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_d, *handle), C_d_buf_ct{{[0-9]+}}, ldc);
  //CHECK-NEXT: }
  ...
  //CHECK-NEXT: auto B_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(B_d);
  //CHECK-NEXT: auto C_d_buf_ct{{[0-9]+}} = dpct::get_buffer<double>(C_d);
  //CHECK-NEXT: mkl::blas::gemmt(*handle, mkl::uplo::lower, mkl::transpose::trans, mkl::transpose::nontrans, n, k, dpct::get_value(&alpha_d, *handle), A_d_buf_ct{{[0-9]+}}, lda, B_d_buf_ct{{[0-9]+}}, ldb, dpct::get_value(&beta_d, *handle), C_d_buf_ct{{[0-9]+}}, ldc);
  //CHECK-NEXT: }
