// RUN: c2s --format-range=none  --usm-level=none  --use-custom-helper=api -out-root %T/Memory/api_test42_out %s --cuda-include-path="%cuda-path/include" -- -x cuda --cuda-host-only
...
// CHECK: 35
// TEST_FEATURE: Memory_async_c2s_memset
// TEST_FEATURE: Memory_async_c2s_memset_2d
// TEST_FEATURE: Memory_async_c2s_memset_3d
