...
int foo() {
#ifndef BUILD_TEST
  // CHECK: DPCT1131:{{[0-9]+}}: The migration of "thrust::system::cuda::experimental::pinned_allocator" is not supported with SYCLcompat currently, please adjust the code manually.
  ...
  // CHECK: DPCT1131:{{[0-9]+}}: The migration of "thrust::device_allocator" is not supported with SYCLcompat currently, please adjust the code manually.
