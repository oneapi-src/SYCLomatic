...
void test_char3_canonical_type() {
  ...
  // CHECK: DPCT1083:{{[0-9]+}}: The result of sizeof operator in the migrated code may be different from the original code. Check that the size in the migrated code is correct.
  int size = sizeof(fp);
