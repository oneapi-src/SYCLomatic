...
__global__ void func() {
  ...
  int CHUNK_SIZE2 = 64;
  int numz2;
  //CHECK: const int zlength2 = dpct::dpct_min(CHUNK_SIZE2, numz2);
  ...
  int numz3;
  //CHECK: const int zlength3 = dpct::dpct_min(CHUNK_SIZE3, numz3);
  ...
  int CHUNK_SIZE0 = 64;
  int numz0;
  //CHECK: const int zlength0 = dpct::dpct_min(CHUNK_SIZE0, numz0 - item_ct1.get_group(2) * CHUNK_SIZE0);
  ...
  int numz1;
  //CHECK: const int zlength1 = dpct::dpct_min(CHUNK_SIZE1, numz1 - item_ct1.get_group(2) * CHUNK_SIZE1);
  ...
  T x;
  const T y(1.0f);
  //CHECK: dpct::dpct_min(dpct::dpct_max(x + y, y), y);
