...
void foo3() {
  ...
  //CHECK-NEXT:oneapi::mkl::blas::column_major::dgmm(*handle, oneapi::mkl::side::left, m, n, (std::complex<float>*)a_c, lda, (std::complex<float>*)x_c, incx, (std::complex<float>*)c_c, ldc);
