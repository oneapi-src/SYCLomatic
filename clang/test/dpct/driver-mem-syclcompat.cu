...
// RUN: %if build_lit %{icpx -c -fsycl -DNO_BUILD_TEST %T/driver-mem-syclcompat/driver-mem-syclcompat.dp.cpp -o %T/driver-mem-syclcompat/driver-mem-syclcompat.dp.o %}
