...
// RUN: cat %s > hdd_constant_db_win.cpp
// RUN: cat %S/constant_header.h > constant_header.h
// RUN: echo "[" > compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"ClCompile hdd_constant_db_win.cpp\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/hdd_constant_db_win\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/hdd_constant_db_win/hdd_constant_db_win.cpp\"" >> compile_commands.json
// RUN: echo "    }," >> compile_commands.json
// RUN: echo "    {" >> compile_commands.json
// RUN: echo "        \"command\": \"CudaCompile hdd_constant_db_win.cpp --x cu\"," >> compile_commands.json
// RUN: echo "        \"directory\": \"%/T/hdd_constant_db_win\"," >> compile_commands.json
// RUN: echo "        \"file\": \"%/T/hdd_constant_db_win/hdd_constant_db_win.cpp\"" >> compile_commands.json
// RUN: echo "    }," >> compile_commands.json
// RUN: echo "    {" >> compile_commands.json
...
// RUN: FileCheck %s --match-full-lines --input-file %T/hdd_constant_db_win/out/constant_header.h
// RUN: cd ..
// RUN: rm -rf ./hdd_constant_db_win
