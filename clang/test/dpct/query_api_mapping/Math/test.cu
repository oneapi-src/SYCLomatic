...
// RUN: dpct --query-api-mapping=__dadd_rd | FileCheck %s -check-prefix=__DADD_RD
// __DADD_RD: CUDA API:
...
// RUN: dpct --query-api-mapping=__dadd_rn | FileCheck %s -check-prefix=__DADD_RN
// __DADD_RN: CUDA API:
...
// RUN: dpct --query-api-mapping=__dadd_ru | FileCheck %s -check-prefix=__DADD_RU
// __DADD_RU: CUDA API:
...
// RUN: dpct --query-api-mapping=__dadd_rz | FileCheck %s -check-prefix=__DADD_RZ
// __DADD_RZ: CUDA API:
...
// RUN: dpct --query-api-mapping=__dmul_rn | FileCheck %s -check-prefix=__DMUL_RN
// __DMUL_RN: CUDA API:
...
// RUN: dpct --query-api-mapping=__dmul_ru | FileCheck %s -check-prefix=__DMUL_RU
// __DMUL_RU: CUDA API:
...
// RUN: dpct --query-api-mapping=__dmul_rz | FileCheck %s -check-prefix=__DMUL_RZ
// __DMUL_RZ: CUDA API:
...
// RUN: dpct --query-api-mapping=__dsub_rn | FileCheck %s -check-prefix=__DSUB_RN
// __DSUB_RN: CUDA API:
...
// RUN: dpct --query-api-mapping=__dsub_ru | FileCheck %s -check-prefix=__DSUB_RU
// __DSUB_RU: CUDA API:
...
// RUN: dpct --query-api-mapping=__dsub_rz | FileCheck %s -check-prefix=__DSUB_RZ
// __DSUB_RZ: CUDA API:
...
// RUN: dpct --query-api-mapping=__brev | FileCheck %s -check-prefix=__BREV
// __BREV: CUDA API:
// __BREV-NEXT:   __brev(u /*unsigned int*/);
// __BREV-NEXT: Is migrated to:
// __BREV-NEXT:   dpct::reverse_bits<unsigned int>(u);

// RUN: dpct --query-api-mapping=__brevll | FileCheck %s -check-prefix=__BREVLL
// __BREVLL: CUDA API:
...
// RUN: dpct --query-api-mapping=__byte_perm | FileCheck %s -check-prefix=__BYTE_PERM
