...
// RUN: dpct --query-api-mapping=__vabs2 | FileCheck %s -check-prefix=VABS2
// VABS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabs4 | FileCheck %s -check-prefix=VABS4
// VABS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabsdiffs2 | FileCheck %s -check-prefix=VABSDIFFS2
// VABSDIFFS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabsdiffs4 | FileCheck %s -check-prefix=VABSDIFFS4
// VABSDIFFS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabsdiffu2 | FileCheck %s -check-prefix=VABSDIFFU2
// VABSDIFFU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabsdiffu4 | FileCheck %s -check-prefix=VABSDIFFU4
// VABSDIFFU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabsss2 | FileCheck %s -check-prefix=VABSSS2
// VABSSS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vabsss4 | FileCheck %s -check-prefix=VABSSS4
// VABSSS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vadd2 | FileCheck %s -check-prefix=VADD2
// VADD2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vadd4 | FileCheck %s -check-prefix=VADD4
// VADD4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vaddss2 | FileCheck %s -check-prefix=VADDSS2
// VADDSS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vaddss4 | FileCheck %s -check-prefix=VADDSS4
// VADDSS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vaddus2 | FileCheck %s -check-prefix=VADDUS2
// VADDUS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vaddus4 | FileCheck %s -check-prefix=VADDUS4
// VADDUS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vavgs2 | FileCheck %s -check-prefix=VAVGS2
// VAVGS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vavgs4 | FileCheck %s -check-prefix=VAVGS4
// VAVGS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vavgu2 | FileCheck %s -check-prefix=VAVGU2
// VAVGU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vavgu4 | FileCheck %s -check-prefix=VAVGU4
// VAVGU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpeq2 | FileCheck %s -check-prefix=VCMPEQ2
// VCMPEQ2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpeq4 | FileCheck %s -check-prefix=VCMPEQ4
// VCMPEQ4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpges2 | FileCheck %s -check-prefix=VCMPGES2
// VCMPGES2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpges4 | FileCheck %s -check-prefix=VCMPGES4
// VCMPGES4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpgeu2 | FileCheck %s -check-prefix=VCMPGEU2
// VCMPGEU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpgeu4 | FileCheck %s -check-prefix=VCMPGEU4
// VCMPGEU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpgts2 | FileCheck %s -check-prefix=VCMPGTS2
// VCMPGTS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpgts4 | FileCheck %s -check-prefix=VCMPGTS4
// VCMPGTS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpgtu2 | FileCheck %s -check-prefix=VCMPGTU2
// VCMPGTU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpgtu4 | FileCheck %s -check-prefix=VCMPGTU4
// VCMPGTU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmples2 | FileCheck %s -check-prefix=VCMPLES2
// VCMPLES2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmples4 | FileCheck %s -check-prefix=VCMPLES4
// VCMPLES4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpleu2 | FileCheck %s -check-prefix=VCMPLEU2
// VCMPLEU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpleu4 | FileCheck %s -check-prefix=VCMPLEU4
// VCMPLEU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmplts2 | FileCheck %s -check-prefix=VCMPLTS2
// VCMPLTS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmplts4 | FileCheck %s -check-prefix=VCMPLTS4
// VCMPLTS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpltu2 | FileCheck %s -check-prefix=VCMPLTU2
// VCMPLTU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpltu4 | FileCheck %s -check-prefix=VCMPLTU4
// VCMPLTU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpne2 | FileCheck %s -check-prefix=VCMPNE2
// VCMPNE2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vcmpne4 | FileCheck %s -check-prefix=VCMPNE4
// VCMPNE4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vhaddu2 | FileCheck %s -check-prefix=VHADDU2
// VHADDU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vhaddu4 | FileCheck %s -check-prefix=VHADDU4
// VHADDU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vmaxs2 | FileCheck %s -check-prefix=VMAXS2
// VMAXS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vmaxs4 | FileCheck %s -check-prefix=VMAXS4
// VMAXS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vmaxu2 | FileCheck %s -check-prefix=VMAXU2
// VMAXU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vmaxu4 | FileCheck %s -check-prefix=VMAXU4
// VMAXU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vmins2 | FileCheck %s -check-prefix=VMINS2
// VMINS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vmins4 | FileCheck %s -check-prefix=VMINS4
// VMINS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vminu2 | FileCheck %s -check-prefix=VMINU2
// VMINU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vminu4 | FileCheck %s -check-prefix=VMINU4
// VMINU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vneg2 | FileCheck %s -check-prefix=VNEG2
// VNEG2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vneg4 | FileCheck %s -check-prefix=VNEG4
// VNEG4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vnegss2 | FileCheck %s -check-prefix=VNEGSS2
// VNEGSS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vnegss4 | FileCheck %s -check-prefix=VNEGSS4
// VNEGSS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsads2 | FileCheck %s -check-prefix=VSADS2
// VSADS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsads4 | FileCheck %s -check-prefix=VSADS4
// VSADS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsadu2 | FileCheck %s -check-prefix=VSADU2
// VSADU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsadu4 | FileCheck %s -check-prefix=VSADU4
// VSADU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vseteq2 | FileCheck %s -check-prefix=VSETEQ2
// VSETEQ2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vseteq4 | FileCheck %s -check-prefix=VSETEQ4
// VSETEQ4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetges2 | FileCheck %s -check-prefix=VSETGES2
// VSETGES2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetges4 | FileCheck %s -check-prefix=VSETGES4
// VSETGES4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetgeu2 | FileCheck %s -check-prefix=VSETGEU2
// VSETGEU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetgeu4 | FileCheck %s -check-prefix=VSETGEU4
// VSETGEU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetgts2 | FileCheck %s -check-prefix=VSETGTS2
// VSETGTS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetgts4 | FileCheck %s -check-prefix=VSETGTS4
// VSETGTS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetgtu2 | FileCheck %s -check-prefix=VSETGTU2
// VSETGTU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetgtu4 | FileCheck %s -check-prefix=VSETGTU4
// VSETGTU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetles2 | FileCheck %s -check-prefix=VSETLES2
// VSETLES2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetles4 | FileCheck %s -check-prefix=VSETLES4
// VSETLES4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetleu2 | FileCheck %s -check-prefix=VSETLEU2
// VSETLEU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetleu4 | FileCheck %s -check-prefix=VSETLEU4
// VSETLEU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetlts2 | FileCheck %s -check-prefix=VSETLTS2
// VSETLTS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetlts4 | FileCheck %s -check-prefix=VSETLTS4
// VSETLTS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetltu2 | FileCheck %s -check-prefix=VSETLTU2
// VSETLTU2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetltu4 | FileCheck %s -check-prefix=VSETLTU4
// VSETLTU4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetne2 | FileCheck %s -check-prefix=VSETNE2
// VSETNE2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsetne4 | FileCheck %s -check-prefix=VSETNE4
// VSETNE4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsub2 | FileCheck %s -check-prefix=VSUB2
// VSUB2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsub4 | FileCheck %s -check-prefix=VSUB4
// VSUB4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsubss2 | FileCheck %s -check-prefix=VSUBSS2
// VSUBSS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsubss4 | FileCheck %s -check-prefix=VSUBSS4
// VSUBSS4: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsubus2 | FileCheck %s -check-prefix=VSUBUS2
// VSUBUS2: CUDA API:
...
// RUN: dpct --query-api-mapping=__vsubus4 | FileCheck %s -check-prefix=VSUBUS4
// VSUBUS4: CUDA API:
