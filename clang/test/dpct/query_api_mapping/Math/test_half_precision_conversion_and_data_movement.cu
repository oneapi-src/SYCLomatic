...
// RUN: dpct --query-api-mapping=__float22half2_rn | FileCheck %s -check-prefix=__FLOAT22HALF2_RN
...
// RUN: dpct --query-api-mapping=__float2half | FileCheck %s -check-prefix=__FLOAT2HALF
...
// RUN: dpct --query-api-mapping=__float2half2_rn | FileCheck %s -check-prefix=__FLOAT2HALF2_RN
...
// RUN: dpct --query-api-mapping=__float2half_rd | FileCheck %s -check-prefix=__FLOAT2HALF_RD
...
// RUN: dpct --query-api-mapping=__float2half_rn | FileCheck %s -check-prefix=__FLOAT2HALF_RN
...
// RUN: dpct --query-api-mapping=__float2half_ru | FileCheck %s -check-prefix=__FLOAT2HALF_RU
...
// RUN: dpct --query-api-mapping=__float2half_rz | FileCheck %s -check-prefix=__FLOAT2HALF_RZ
...
// RUN: dpct --query-api-mapping=__floats2half2_rn | FileCheck %s -check-prefix=__FLOATS2HALF2_RN
...
// RUN: dpct --query-api-mapping=__half22float2 | FileCheck %s -check-prefix=__HALF22FLOAT2
...
// RUN: dpct --query-api-mapping=__half2float | FileCheck %s -check-prefix=__HALF2FLOAT
...
// RUN: dpct --query-api-mapping=__half2half2 | FileCheck %s -check-prefix=__HALF2HALF2
...
// RUN: dpct --query-api-mapping=__half2int_rd | FileCheck %s -check-prefix=__HALF2INT_RD
...
// RUN: dpct --query-api-mapping=__half2int_rn | FileCheck %s -check-prefix=__HALF2INT_RN
...
// RUN: dpct --query-api-mapping=__half2int_ru | FileCheck %s -check-prefix=__HALF2INT_RU
...
// RUN: dpct --query-api-mapping=__half2int_rz | FileCheck %s -check-prefix=__HALF2INT_RZ
...
// RUN: dpct --query-api-mapping=__half2ll_rd | FileCheck %s -check-prefix=__HALF2LL_RD
...
// RUN: dpct --query-api-mapping=__half2ll_rn | FileCheck %s -check-prefix=__HALF2LL_RN
...
// RUN: dpct --query-api-mapping=__half2ll_ru | FileCheck %s -check-prefix=__HALF2LL_RU
...
// RUN: dpct --query-api-mapping=__half2ll_rz | FileCheck %s -check-prefix=__HALF2LL_RZ
...
// RUN: dpct --query-api-mapping=__half2short_rd | FileCheck %s -check-prefix=__HALF2SHORT_RD
...
// RUN: dpct --query-api-mapping=__half2short_rn | FileCheck %s -check-prefix=__HALF2SHORT_RN
...
// RUN: dpct --query-api-mapping=__half2short_ru | FileCheck %s -check-prefix=__HALF2SHORT_RU
...
// RUN: dpct --query-api-mapping=__half2short_rz | FileCheck %s -check-prefix=__HALF2SHORT_RZ
...
// RUN: dpct --query-api-mapping=__half2uint_rd | FileCheck %s -check-prefix=__HALF2UINT_RD
...
// RUN: dpct --query-api-mapping=__half2uint_rn | FileCheck %s -check-prefix=__HALF2UINT_RN
...
// RUN: dpct --query-api-mapping=__half2uint_ru | FileCheck %s -check-prefix=__HALF2UINT_RU
...
// RUN: dpct --query-api-mapping=__half2uint_rz | FileCheck %s -check-prefix=__HALF2UINT_RZ
...
// RUN: dpct --query-api-mapping=__half2ull_rd | FileCheck %s -check-prefix=__HALF2ULL_RD
...
// RUN: dpct --query-api-mapping=__half2ull_rn | FileCheck %s -check-prefix=__HALF2ULL_RN
...
// RUN: dpct --query-api-mapping=__half2ull_ru | FileCheck %s -check-prefix=__HALF2ULL_RU
...
// RUN: dpct --query-api-mapping=__half2ull_rz | FileCheck %s -check-prefix=__HALF2ULL_RZ
...
// RUN: dpct --query-api-mapping=__half2ushort_rd | FileCheck %s -check-prefix=__HALF2USHORT_RD
...
// RUN: dpct --query-api-mapping=__half2ushort_rn | FileCheck %s -check-prefix=__HALF2USHORT_RN
...
// RUN: dpct --query-api-mapping=__half2ushort_ru | FileCheck %s -check-prefix=__HALF2USHORT_RU
...
// RUN: dpct --query-api-mapping=__half2ushort_rz | FileCheck %s -check-prefix=__HALF2USHORT_RZ
...
// RUN: dpct --query-api-mapping=__half_as_short | FileCheck %s -check-prefix=__HALF_AS_SHORT
...
// RUN: dpct --query-api-mapping=__half_as_ushort | FileCheck %s -check-prefix=__HALF_AS_USHORT
...
// RUN: dpct --query-api-mapping=__halves2half2 | FileCheck %s -check-prefix=__HALVES2HALF2
...
// RUN: dpct --query-api-mapping=__high2float | FileCheck %s -check-prefix=__HIGH2FLOAT
// __HIGH2FLOAT: CUDA API:
// __HIGH2FLOAT-NEXT:   __high2float(h /*__half2*/);
// __HIGH2FLOAT-NEXT: Is migrated to:
// __HIGH2FLOAT-NEXT:   h[1];

// RUN: dpct --query-api-mapping=__high2half | FileCheck %s -check-prefix=__HIGH2HALF
// __HIGH2HALF: CUDA API:
// __HIGH2HALF-NEXT:   __high2half(h /*__half2*/);
// __HIGH2HALF-NEXT: Is migrated to:
// __HIGH2HALF-NEXT:   h[1];

// RUN: dpct --query-api-mapping=__high2half2 | FileCheck %s -check-prefix=__HIGH2HALF2
...
// RUN: dpct --query-api-mapping=__highs2half2 | FileCheck %s -check-prefix=__HIGHS2HALF2
...
// RUN: dpct --query-api-mapping=__int2half_rd | FileCheck %s -check-prefix=__INT2HALF_RD
...
// RUN: dpct --query-api-mapping=__int2half_rn | FileCheck %s -check-prefix=__INT2HALF_RN
...
// RUN: dpct --query-api-mapping=__int2half_ru | FileCheck %s -check-prefix=__INT2HALF_RU
...
// RUN: dpct --query-api-mapping=__int2half_rz | FileCheck %s -check-prefix=__INT2HALF_RZ
...
// RUN: dpct --query-api-mapping=__ll2half_rd | FileCheck %s -check-prefix=__LL2HALF_RD
...
// RUN: dpct --query-api-mapping=__ll2half_rn | FileCheck %s -check-prefix=__LL2HALF_RN
...
// RUN: dpct --query-api-mapping=__ll2half_ru | FileCheck %s -check-prefix=__LL2HALF_RU
...
// RUN: dpct --query-api-mapping=__ll2half_rz | FileCheck %s -check-prefix=__LL2HALF_RZ
...
// RUN: dpct --query-api-mapping=__low2float | FileCheck %s -check-prefix=__LOW2FLOAT
// __LOW2FLOAT: CUDA API:
// __LOW2FLOAT-NEXT:   __low2float(h /*__half2*/);
// __LOW2FLOAT-NEXT: Is migrated to:
// __LOW2FLOAT-NEXT:   h[0];

// RUN: dpct --query-api-mapping=__low2half | FileCheck %s -check-prefix=__LOW2HALF
// __LOW2HALF: CUDA API:
// __LOW2HALF-NEXT:   __low2half(h /*__half2*/);
// __LOW2HALF-NEXT: Is migrated to:
// __LOW2HALF-NEXT:   h[0];

// RUN: dpct --query-api-mapping=__low2half2 | FileCheck %s -check-prefix=__LOW2HALF2
// __LOW2HALF2: CUDA API:
// __LOW2HALF2-NEXT:   __low2half2(h /*__half2*/);
// __LOW2HALF2-NEXT: Is migrated to:
// __LOW2HALF2-NEXT:   sycl::half2(h[0]);

// RUN: dpct --query-api-mapping=__lowhigh2highlow | FileCheck %s -check-prefix=__LOWHIGH2HIGHLOW
...
// RUN: dpct --query-api-mapping=__lows2half2 | FileCheck %s -check-prefix=__LOWS2HALF2
...
// RUN: dpct --query-api-mapping=__short2half_rd | FileCheck %s -check-prefix=__SHORT2HALF_RD
...
// RUN: dpct --query-api-mapping=__short2half_rn | FileCheck %s -check-prefix=__SHORT2HALF_RN
...
// RUN: dpct --query-api-mapping=__short2half_ru | FileCheck %s -check-prefix=__SHORT2HALF_RU
...
// RUN: dpct --query-api-mapping=__short2half_rz | FileCheck %s -check-prefix=__SHORT2HALF_RZ
...
// RUN: dpct --query-api-mapping=__short_as_half | FileCheck %s -check-prefix=__SHORT_AS_HALF
...
// RUN: dpct --query-api-mapping=__uint2half_rd | FileCheck %s -check-prefix=__UINT2HALF_RD
...
// RUN: dpct --query-api-mapping=__uint2half_rn | FileCheck %s -check-prefix=__UINT2HALF_RN
...
// RUN: dpct --query-api-mapping=__uint2half_ru | FileCheck %s -check-prefix=__UINT2HALF_RU
...
// RUN: dpct --query-api-mapping=__uint2half_rz | FileCheck %s -check-prefix=__UINT2HALF_RZ
...
// RUN: dpct --query-api-mapping=__ull2half_rd | FileCheck %s -check-prefix=__ULL2HALF_RD
...
// RUN: dpct --query-api-mapping=__ull2half_rn | FileCheck %s -check-prefix=__ULL2HALF_RN
...
// RUN: dpct --query-api-mapping=__ull2half_ru | FileCheck %s -check-prefix=__ULL2HALF_RU
...
// RUN: dpct --query-api-mapping=__ull2half_rz | FileCheck %s -check-prefix=__ULL2HALF_RZ
...
// RUN: dpct --query-api-mapping=__ushort2half_rd | FileCheck %s -check-prefix=__USHORT2HALF_RD
...
// RUN: dpct --query-api-mapping=__ushort2half_rn | FileCheck %s -check-prefix=__USHORT2HALF_RN
...
// RUN: dpct --query-api-mapping=__ushort2half_ru | FileCheck %s -check-prefix=__USHORT2HALF_RU
...
// RUN: dpct --query-api-mapping=__ushort2half_rz | FileCheck %s -check-prefix=__USHORT2HALF_RZ
...
// RUN: dpct --query-api-mapping=__ushort_as_half | FileCheck %s -check-prefix=__USHORT_AS_HALF
