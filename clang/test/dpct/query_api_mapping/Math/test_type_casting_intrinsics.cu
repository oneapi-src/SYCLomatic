...
// RUN: dpct --query-api-mapping=__double2float_rd | FileCheck %s -check-prefix=__DOUBLE2FLOAT_RD
...
// RUN: dpct --query-api-mapping=__double2float_rn | FileCheck %s -check-prefix=__DOUBLE2FLOAT_RN
...
// RUN: dpct --query-api-mapping=__double2float_ru | FileCheck %s -check-prefix=__DOUBLE2FLOAT_RU
...
// RUN: dpct --query-api-mapping=__double2float_rz | FileCheck %s -check-prefix=__DOUBLE2FLOAT_RZ
...
// RUN: dpct --query-api-mapping=__double2hiint | FileCheck %s -check-prefix=__DOUBLE2HIINT
...
// RUN: dpct --query-api-mapping=__double2int_rd | FileCheck %s -check-prefix=__DOUBLE2INT_RD
...
// RUN: dpct --query-api-mapping=__double2int_rn | FileCheck %s -check-prefix=__DOUBLE2INT_RN
...
// RUN: dpct --query-api-mapping=__double2int_ru | FileCheck %s -check-prefix=__DOUBLE2INT_RU
...
// RUN: dpct --query-api-mapping=__double2int_rz | FileCheck %s -check-prefix=__DOUBLE2INT_RZ
...
// RUN: dpct --query-api-mapping=__double2ll_rd | FileCheck %s -check-prefix=__DOUBLE2LL_RD
...
// RUN: dpct --query-api-mapping=__double2ll_rn | FileCheck %s -check-prefix=__DOUBLE2LL_RN
...
// RUN: dpct --query-api-mapping=__double2ll_ru | FileCheck %s -check-prefix=__DOUBLE2LL_RU
...
// RUN: dpct --query-api-mapping=__double2ll_rz | FileCheck %s -check-prefix=__DOUBLE2LL_RZ
...
// RUN: dpct --query-api-mapping=__double2loint | FileCheck %s -check-prefix=__DOUBLE2LOINT
...
// RUN: dpct --query-api-mapping=__double2uint_rd | FileCheck %s -check-prefix=__DOUBLE2UINT_RD
...
// RUN: dpct --query-api-mapping=__double2uint_rn | FileCheck %s -check-prefix=__DOUBLE2UINT_RN
...
// RUN: dpct --query-api-mapping=__double2uint_ru | FileCheck %s -check-prefix=__DOUBLE2UINT_RU
...
// RUN: dpct --query-api-mapping=__double2uint_rz | FileCheck %s -check-prefix=__DOUBLE2UINT_RZ
...
// RUN: dpct --query-api-mapping=__double2ull_rd | FileCheck %s -check-prefix=__DOUBLE2ULL_RD
...
// RUN: dpct --query-api-mapping=__double2ull_rn | FileCheck %s -check-prefix=__DOUBLE2ULL_RN
...
// RUN: dpct --query-api-mapping=__double2ull_ru | FileCheck %s -check-prefix=__DOUBLE2ULL_RU
...
// RUN: dpct --query-api-mapping=__double2ull_rz | FileCheck %s -check-prefix=__DOUBLE2ULL_RZ
...
// RUN: dpct --query-api-mapping=__double_as_longlong | FileCheck %s -check-prefix=__DOUBLE_AS_LONGLONG
...
// RUN: dpct --query-api-mapping=__float2int_rd | FileCheck %s -check-prefix=__FLOAT2INT_RD
...
// RUN: dpct --query-api-mapping=__float2int_rn | FileCheck %s -check-prefix=__FLOAT2INT_RN
...
// RUN: dpct --query-api-mapping=__float2int_ru | FileCheck %s -check-prefix=__FLOAT2INT_RU
...
// RUN: dpct --query-api-mapping=__float2int_rz | FileCheck %s -check-prefix=__FLOAT2INT_RZ
...
// RUN: dpct --query-api-mapping=__float2ll_rd | FileCheck %s -check-prefix=__FLOAT2LL_RD
...
// RUN: dpct --query-api-mapping=__float2ll_rn | FileCheck %s -check-prefix=__FLOAT2LL_RN
...
// RUN: dpct --query-api-mapping=__float2ll_ru | FileCheck %s -check-prefix=__FLOAT2LL_RU
...
// RUN: dpct --query-api-mapping=__float2ll_rz | FileCheck %s -check-prefix=__FLOAT2LL_RZ
...
// RUN: dpct --query-api-mapping=__float2uint_rd | FileCheck %s -check-prefix=__FLOAT2UINT_RD
...
// RUN: dpct --query-api-mapping=__float2uint_rn | FileCheck %s -check-prefix=__FLOAT2UINT_RN
...
// RUN: dpct --query-api-mapping=__float2uint_ru | FileCheck %s -check-prefix=__FLOAT2UINT_RU
...
// RUN: dpct --query-api-mapping=__float2uint_rz | FileCheck %s -check-prefix=__FLOAT2UINT_RZ
...
// RUN: dpct --query-api-mapping=__float2ull_rd | FileCheck %s -check-prefix=__FLOAT2ULL_RD
...
// RUN: dpct --query-api-mapping=__float2ull_rn | FileCheck %s -check-prefix=__FLOAT2ULL_RN
...
// RUN: dpct --query-api-mapping=__float2ull_ru | FileCheck %s -check-prefix=__FLOAT2ULL_RU
...
// RUN: dpct --query-api-mapping=__float2ull_rz | FileCheck %s -check-prefix=__FLOAT2ULL_RZ
...
// RUN: dpct --query-api-mapping=__float_as_int | FileCheck %s -check-prefix=__FLOAT_AS_INT
...
// RUN: dpct --query-api-mapping=__float_as_uint | FileCheck %s -check-prefix=__FLOAT_AS_UINT
...
// RUN: dpct --query-api-mapping=__hiloint2double | FileCheck %s -check-prefix=__HILOINT2DOUBLE
...
// RUN: dpct --query-api-mapping=__int2double_rn | FileCheck %s -check-prefix=__INT2DOUBLE_RN
...
// RUN: dpct --query-api-mapping=__int2float_rd | FileCheck %s -check-prefix=__INT2FLOAT_RD
...
// RUN: dpct --query-api-mapping=__int2float_rn | FileCheck %s -check-prefix=__INT2FLOAT_RN
...
// RUN: dpct --query-api-mapping=__int2float_ru | FileCheck %s -check-prefix=__INT2FLOAT_RU
...
// RUN: dpct --query-api-mapping=__int2float_rz | FileCheck %s -check-prefix=__INT2FLOAT_RZ
...
// RUN: dpct --query-api-mapping=__int_as_float | FileCheck %s -check-prefix=__INT_AS_FLOAT
...
// RUN: dpct --query-api-mapping=__ll2double_rd | FileCheck %s -check-prefix=__LL2DOUBLE_RD
...
// RUN: dpct --query-api-mapping=__ll2double_rn | FileCheck %s -check-prefix=__LL2DOUBLE_RN
...
// RUN: dpct --query-api-mapping=__ll2double_ru | FileCheck %s -check-prefix=__LL2DOUBLE_RU
...
// RUN: dpct --query-api-mapping=__ll2double_rz | FileCheck %s -check-prefix=__LL2DOUBLE_RZ
...
// RUN: dpct --query-api-mapping=__ll2float_rd | FileCheck %s -check-prefix=__LL2FLOAT_RD
...
// RUN: dpct --query-api-mapping=__ll2float_rn | FileCheck %s -check-prefix=__LL2FLOAT_RN
...
// RUN: dpct --query-api-mapping=__ll2float_ru | FileCheck %s -check-prefix=__LL2FLOAT_RU
...
// RUN: dpct --query-api-mapping=__ll2float_rz | FileCheck %s -check-prefix=__LL2FLOAT_RZ
...
// RUN: dpct --query-api-mapping=__longlong_as_double | FileCheck %s -check-prefix=__LONGLONG_AS_DOUBLE
...
// RUN: dpct --query-api-mapping=__uint2double_rn | FileCheck %s -check-prefix=__UINT2DOUBLE_RN
...
// RUN: dpct --query-api-mapping=__uint2float_rd | FileCheck %s -check-prefix=__UINT2FLOAT_RD
...
// RUN: dpct --query-api-mapping=__uint2float_rn | FileCheck %s -check-prefix=__UINT2FLOAT_RN
...
// RUN: dpct --query-api-mapping=__uint2float_ru | FileCheck %s -check-prefix=__UINT2FLOAT_RU
...
// RUN: dpct --query-api-mapping=__uint2float_rz | FileCheck %s -check-prefix=__UINT2FLOAT_RZ
...
// RUN: dpct --query-api-mapping=__uint_as_float | FileCheck %s -check-prefix=__UINT_AS_FLOAT
...
// RUN: dpct --query-api-mapping=__ull2double_rd | FileCheck %s -check-prefix=__ULL2DOUBLE_RD
...
// RUN: dpct --query-api-mapping=__ull2double_rn | FileCheck %s -check-prefix=__ULL2DOUBLE_RN
...
// RUN: dpct --query-api-mapping=__ull2double_ru | FileCheck %s -check-prefix=__ULL2DOUBLE_RU
...
// RUN: dpct --query-api-mapping=__ull2double_rz | FileCheck %s -check-prefix=__ULL2DOUBLE_RZ
...
// RUN: dpct --query-api-mapping=__ull2float_rd | FileCheck %s -check-prefix=__ULL2FLOAT_RD
...
// RUN: dpct --query-api-mapping=__ull2float_rn | FileCheck %s -check-prefix=__ULL2FLOAT_RN
...
// RUN: dpct --query-api-mapping=__ull2float_ru | FileCheck %s -check-prefix=__ULL2FLOAT_RU
...
// RUN: dpct --query-api-mapping=__ull2float_rz | FileCheck %s -check-prefix=__ULL2FLOAT_RZ
