...
// __DOUBLE2FLOAT_RD-NEXT:   sycl::vec<double, 1>{d}.template convert<float, sycl::rounding_mode::rtn>()[0];
...
// __DOUBLE2FLOAT_RN-NEXT:   sycl::vec<double, 1>{d}.template convert<float, sycl::rounding_mode::rte>()[0];
...
// __DOUBLE2FLOAT_RU-NEXT:   sycl::vec<double, 1>{d}.template convert<float, sycl::rounding_mode::rtp>()[0];
...
// __DOUBLE2FLOAT_RZ-NEXT:   sycl::vec<double, 1>{d}.template convert<float, sycl::rounding_mode::rtz>()[0];
...
// __DOUBLE2INT_RD-NEXT:   sycl::vec<double, 1>{d}.template convert<int, sycl::rounding_mode::rtn>()[0];
...
// __DOUBLE2INT_RN-NEXT:   sycl::vec<double, 1>{d}.template convert<int, sycl::rounding_mode::rte>()[0];
...
// __DOUBLE2INT_RU-NEXT:   sycl::vec<double, 1>{d}.template convert<int, sycl::rounding_mode::rtp>()[0];
...
// __DOUBLE2INT_RZ-NEXT:   sycl::vec<double, 1>{d}.template convert<int, sycl::rounding_mode::rtz>()[0];
...
// __DOUBLE2LL_RD-NEXT:   sycl::vec<double, 1>{d}.template convert<long long, sycl::rounding_mode::rtn>()[0];
...
// __DOUBLE2LL_RN-NEXT:   sycl::vec<double, 1>{d}.template convert<long long, sycl::rounding_mode::rte>()[0];
...
// __DOUBLE2LL_RU-NEXT:   sycl::vec<double, 1>{d}.template convert<long long, sycl::rounding_mode::rtp>()[0];
...
// __DOUBLE2LL_RZ-NEXT:   sycl::vec<double, 1>{d}.template convert<long long, sycl::rounding_mode::rtz>()[0];
...
// __DOUBLE2UINT_RD-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rtn>()[0];
...
// __DOUBLE2UINT_RN-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rte>()[0];
...
// __DOUBLE2UINT_RU-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rtp>()[0];
...
// __DOUBLE2UINT_RZ-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rtz>()[0];
...
// __DOUBLE2ULL_RD-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rtn>()[0];
...
// __DOUBLE2ULL_RN-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rte>()[0];
...
// __DOUBLE2ULL_RU-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rtp>()[0];
...
// __DOUBLE2ULL_RZ-NEXT:   sycl::vec<double, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rtz>()[0];
...
// __FLOAT2INT_RD-NEXT:   sycl::vec<float, 1>{d}.template convert<int, sycl::rounding_mode::rtn>()[0];
...
// __FLOAT2INT_RN-NEXT:   sycl::vec<float, 1>{d}.template convert<int, sycl::rounding_mode::rte>()[0];
...
// __FLOAT2INT_RU-NEXT:   sycl::vec<float, 1>{d}.template convert<int, sycl::rounding_mode::rtp>()[0];
...
// __FLOAT2INT_RZ-NEXT:   sycl::vec<float, 1>{d}.template convert<int, sycl::rounding_mode::rtz>()[0];
...
// __FLOAT2LL_RD-NEXT:   sycl::vec<float, 1>{d}.template convert<long long, sycl::rounding_mode::rtn>()[0];
...
// __FLOAT2LL_RN-NEXT:   sycl::vec<float, 1>{d}.template convert<long long, sycl::rounding_mode::rte>()[0];
...
// __FLOAT2LL_RU-NEXT:   sycl::vec<float, 1>{d}.template convert<long long, sycl::rounding_mode::rtp>()[0];
...
// __FLOAT2LL_RZ-NEXT:   sycl::vec<float, 1>{d}.template convert<long long, sycl::rounding_mode::rtz>()[0];
...
// __FLOAT2UINT_RD-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rtn>()[0];
...
// __FLOAT2UINT_RN-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rte>()[0];
...
// __FLOAT2UINT_RU-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rtp>()[0];
...
// __FLOAT2UINT_RZ-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned int, sycl::rounding_mode::rtz>()[0];
...
// __FLOAT2ULL_RD-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rtn>()[0];
...
// __FLOAT2ULL_RN-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rte>()[0];
...
// __FLOAT2ULL_RU-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rtp>()[0];
...
// __FLOAT2ULL_RZ-NEXT:   sycl::vec<float, 1>{d}.template convert<unsigned long long, sycl::rounding_mode::rtz>()[0];
...
// __INT2DOUBLE_RN-NEXT:   sycl::vec<int, 1>{i}.template convert<double, sycl::rounding_mode::rte>()[0];
...
// __INT2FLOAT_RD-NEXT:   sycl::vec<int, 1>{i}.template convert<float, sycl::rounding_mode::rtn>()[0];
...
// __INT2FLOAT_RN-NEXT:   sycl::vec<int, 1>{i}.template convert<float, sycl::rounding_mode::rte>()[0];
...
// __INT2FLOAT_RU-NEXT:   sycl::vec<int, 1>{i}.template convert<float, sycl::rounding_mode::rtp>()[0];
...
// __INT2FLOAT_RZ-NEXT:   sycl::vec<int, 1>{i}.template convert<float, sycl::rounding_mode::rtz>()[0];
...
// __LL2DOUBLE_RD-NEXT:   sycl::vec<long long, 1>{ll}.template convert<double, sycl::rounding_mode::rtn>()[0];
...
// __LL2DOUBLE_RN-NEXT:   sycl::vec<long long, 1>{ll}.template convert<double, sycl::rounding_mode::rte>()[0];
...
// __LL2DOUBLE_RU-NEXT:   sycl::vec<long long, 1>{ll}.template convert<double, sycl::rounding_mode::rtp>()[0];
...
// __LL2DOUBLE_RZ-NEXT:   sycl::vec<long long, 1>{ll}.template convert<double, sycl::rounding_mode::rtz>()[0];
...
// __LL2FLOAT_RD-NEXT:   sycl::vec<long long, 1>{ll}.template convert<float, sycl::rounding_mode::rtn>()[0];
...
// __LL2FLOAT_RN-NEXT:   sycl::vec<long long, 1>{ll}.template convert<float, sycl::rounding_mode::rte>()[0];
...
// __LL2FLOAT_RU-NEXT:   sycl::vec<long long, 1>{ll}.template convert<float, sycl::rounding_mode::rtp>()[0];
...
// __LL2FLOAT_RZ-NEXT:   sycl::vec<long long, 1>{ll}.template convert<float, sycl::rounding_mode::rtz>()[0];
...
// __UINT2DOUBLE_RN-NEXT:   sycl::vec<unsigned int, 1>{u}.template convert<double, sycl::rounding_mode::rte>()[0];
...
// __UINT2FLOAT_RD-NEXT:   sycl::vec<unsigned int, 1>{u}.template convert<float, sycl::rounding_mode::rtn>()[0];
...
// __UINT2FLOAT_RN-NEXT:   sycl::vec<unsigned int, 1>{u}.template convert<float, sycl::rounding_mode::rte>()[0];
...
// __UINT2FLOAT_RU-NEXT:   sycl::vec<unsigned int, 1>{u}.template convert<float, sycl::rounding_mode::rtp>()[0];
...
// __UINT2FLOAT_RZ-NEXT:   sycl::vec<unsigned int, 1>{u}.template convert<float, sycl::rounding_mode::rtz>()[0];
...
// __ULL2DOUBLE_RD-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<double, sycl::rounding_mode::rtn>()[0];
...
// __ULL2DOUBLE_RN-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<double, sycl::rounding_mode::rte>()[0];
...
// __ULL2DOUBLE_RU-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<double, sycl::rounding_mode::rtp>()[0];
...
// __ULL2DOUBLE_RZ-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<double, sycl::rounding_mode::rtz>()[0];
...
// __ULL2FLOAT_RD-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<float, sycl::rounding_mode::rtn>()[0];
...
// __ULL2FLOAT_RN-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<float, sycl::rounding_mode::rte>()[0];
...
// __ULL2FLOAT_RU-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<float, sycl::rounding_mode::rtp>()[0];
...
// __ULL2FLOAT_RZ-NEXT:   sycl::vec<unsigned long long, 1>{ull}.template convert<float, sycl::rounding_mode::rtz>()[0];
