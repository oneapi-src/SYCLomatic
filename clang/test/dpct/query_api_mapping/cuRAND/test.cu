...
// RUN: dpct --query-api-mapping=curandCreateGenerator | FileCheck %s -check-prefix=CURANDCREATEGENERATOR
...
// RUN: dpct --query-api-mapping=curandCreateGeneratorHost | FileCheck %s -check-prefix=CURANDCREATEGENERATORHOST
...
// RUN: dpct --query-api-mapping=curandDestroyGenerator | FileCheck %s -check-prefix=CURANDDESTROYGENERATOR
...
// RUN: dpct --query-api-mapping=curandGenerate | FileCheck %s -check-prefix=CURANDGENERATE
...
// RUN: dpct --query-api-mapping=curandGenerateLogNormal | FileCheck %s -check-prefix=CURANDGENERATELOGNORMAL
...
// RUN: dpct --query-api-mapping=curandGenerateLogNormalDouble | FileCheck %s -check-prefix=CURANDGENERATELOGNORMALDOUBLE
...
// RUN: dpct --query-api-mapping=curandGenerateLongLong | FileCheck %s -check-prefix=CURANDGENERATELONGLONG
...
// RUN: dpct --query-api-mapping=curandGenerateNormal | FileCheck %s -check-prefix=CURANDGENERATENORMAL
...
// RUN: dpct --query-api-mapping=curandGenerateNormalDouble | FileCheck %s -check-prefix=CURANDGENERATENORMALDOUBLE
...
// RUN: dpct --query-api-mapping=curandGeneratePoisson | FileCheck %s -check-prefix=CURANDGENERATEPOISSON
...
// RUN: dpct --query-api-mapping=curandGenerateUniform | FileCheck %s -check-prefix=CURANDGENERATEUNIFORM
...
// RUN: dpct --query-api-mapping=curandGenerateUniformDouble | FileCheck %s -check-prefix=CURANDGENERATEUNIFORMDOUBLE
...
// RUN: dpct --query-api-mapping=curandSetGeneratorOffset | FileCheck %s -check-prefix=CURANDSETGENERATOROFFSET
...
// RUN: dpct --query-api-mapping=curandSetPseudoRandomGeneratorSeed | FileCheck %s -check-prefix=CURANDSETPSEUDORANDOMGENERATORSEED
...
// RUN: dpct --query-api-mapping=curandSetQuasiRandomGeneratorDimensions | FileCheck %s -check-prefix=CURANDSETQUASIRANDOMGENERATORDIMENSIONS
...
// RUN: dpct --query-api-mapping=curandSetStream | FileCheck %s -check-prefix=CURANDSETSTREAM
...
// RUN: dpct --query-api-mapping=curand | FileCheck %s -check-prefix=CURAND
// CURAND: CUDA API:
...
// RUN: dpct --query-api-mapping=curand4 | FileCheck %s -check-prefix=CURAND4
// CURAND4: CUDA API:
...
// RUN: dpct --query-api-mapping=curand_init | FileCheck %s -check-prefix=CURAND_INIT
...
// RUN: dpct --query-api-mapping=curand_log_normal | FileCheck %s -check-prefix=CURAND_LOG_NORMAL
...
// RUN: dpct --query-api-mapping=curand_log_normal2 | FileCheck %s -check-prefix=CURAND_LOG_NORMAL2
...
// RUN: dpct --query-api-mapping=curand_log_normal2_double | FileCheck %s -check-prefix=CURAND_LOG_NORMAL2_DOUBLE
...
// RUN: dpct --query-api-mapping=curand_log_normal4 | FileCheck %s -check-prefix=CURAND_LOG_NORMAL4
...
// RUN: dpct --query-api-mapping=curand_log_normal_double | FileCheck %s -check-prefix=CURAND_LOG_NORMAL_DOUBLE
...
// RUN: dpct --query-api-mapping=curand_normal | FileCheck %s -check-prefix=CURAND_NORMAL
...
// RUN: dpct --query-api-mapping=curand_normal2 | FileCheck %s -check-prefix=CURAND_NORMAL2
...
// RUN: dpct --query-api-mapping=curand_normal2_double | FileCheck %s -check-prefix=CURAND_NORMAL2_DOUBLE
...
// RUN: dpct --query-api-mapping=curand_normal4 | FileCheck %s -check-prefix=CURAND_NORMAL4
...
// RUN: dpct --query-api-mapping=curand_normal_double | FileCheck %s -check-prefix=CURAND_NORMAL_DOUBLE
...
// RUN: dpct --query-api-mapping=curand_poisson | FileCheck %s -check-prefix=CURAND_POISSON
...
// RUN: dpct --query-api-mapping=curand_poisson4 | FileCheck %s -check-prefix=CURAND_POISSON4
...
// RUN: dpct --query-api-mapping=curand_uniform | FileCheck %s -check-prefix=CURAND_UNIFORM
...
// RUN: dpct --query-api-mapping=curand_uniform2_double | FileCheck %s -check-prefix=CURAND_UNIFORM2_DOUBLE
...
// RUN: dpct --query-api-mapping=curand_uniform4 | FileCheck %s -check-prefix=CURAND_UNIFORM4
...
// RUN: dpct --query-api-mapping=curand_uniform_double | FileCheck %s -check-prefix=CURAND_UNIFORM_DOUBLE
...
// RUN: dpct --query-api-mapping=skipahead_sequence | FileCheck %s -check-prefix=SKIPAHEAD_SEQUENCE
...
// RUN: dpct --query-api-mapping=skipahead_subsequence | FileCheck %s -check-prefix=SKIPAHEAD_SUBSEQUENCE
