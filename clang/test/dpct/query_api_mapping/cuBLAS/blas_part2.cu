...
// RUN: dpct --query-api-mapping=cublasDotEx | FileCheck %s -check-prefix=cublasDotEx
...
// RUN: dpct --query-api-mapping=cublasDtbmv | FileCheck %s -check-prefix=cublasDtbmv
...
// RUN: dpct --query-api-mapping=cublasCgemv | FileCheck %s -check-prefix=cublasCgemv
...
// RUN: dpct --query-api-mapping=cublasCsyr | FileCheck %s -check-prefix=cublasCsyr
// cublasCsyr: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasZcopy | FileCheck %s -check-prefix=cublasZcopy
...
// RUN: dpct --query-api-mapping=cublasDspmv | FileCheck %s -check-prefix=cublasDspmv
...
// RUN: dpct --query-api-mapping=cublasZtrsm | FileCheck %s -check-prefix=cublasZtrsm
...
// RUN: dpct --query-api-mapping=cublasSasum | FileCheck %s -check-prefix=cublasSasum
...
// RUN: dpct --query-api-mapping=cublasCsyr2k | FileCheck %s -check-prefix=cublasCsyr2k
...
// RUN: dpct --query-api-mapping=cublasZtrsv | FileCheck %s -check-prefix=cublasZtrsv
...
// RUN: dpct --query-api-mapping=cublasCrotg | FileCheck %s -check-prefix=cublasCrotg
...
// RUN: dpct --query-api-mapping=cublasZtbsv | FileCheck %s -check-prefix=cublasZtbsv
...
// RUN: dpct --query-api-mapping=cublasCscal | FileCheck %s -check-prefix=cublasCscal
...
// RUN: dpct --query-api-mapping=cublasDsyrk | FileCheck %s -check-prefix=cublasDsyrk
...
// RUN: dpct --query-api-mapping=cublasDswap | FileCheck %s -check-prefix=cublasDswap
...
// RUN: dpct --query-api-mapping=cublasZher2 | FileCheck %s -check-prefix=cublasZher2
...
// RUN: dpct --query-api-mapping=cublasCtbmv | FileCheck %s -check-prefix=cublasCtbmv
...
// RUN: dpct --query-api-mapping=cublasZgemm | FileCheck %s -check-prefix=cublasZgemm
...
// RUN: dpct --query-api-mapping=cublasCher2k | FileCheck %s -check-prefix=cublasCher2k
...
// RUN: dpct --query-api-mapping=cublasCcopy | FileCheck %s -check-prefix=cublasCcopy
...
// RUN: dpct --query-api-mapping=cublasSscal | FileCheck %s -check-prefix=cublasSscal
...
// RUN: dpct --query-api-mapping=cublasIzamax | FileCheck %s -check-prefix=cublasIzamax
...
// RUN: dpct --query-api-mapping=cublasScnrm2 | FileCheck %s -check-prefix=cublasScnrm2
...
// RUN: dpct --query-api-mapping=cublasSrot | FileCheck %s -check-prefix=cublasSrot
// cublasSrot: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasZtpsv | FileCheck %s -check-prefix=cublasZtpsv
