...
// RUN: dpct --query-api-mapping=cublasDsyr | FileCheck %s -check-prefix=cublasDsyr
// cublasDsyr: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasZhpr2 | FileCheck %s -check-prefix=cublasZhpr2
...
// RUN: dpct --query-api-mapping=cublasZtpmv | FileCheck %s -check-prefix=cublasZtpmv
...
// RUN: dpct --query-api-mapping=cublasZherkx | FileCheck %s -check-prefix=cublasZherkx
...
// RUN: dpct --query-api-mapping=cublasChbmv | FileCheck %s -check-prefix=cublasChbmv
...
// RUN: dpct --query-api-mapping=cublasSrotm | FileCheck %s -check-prefix=cublasSrotm
...
// RUN: dpct --query-api-mapping=cublasCher | FileCheck %s -check-prefix=cublasCher
// cublasCher: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasSgemm | FileCheck %s -check-prefix=cublasSgemm
...
// RUN: dpct --query-api-mapping=cublasSsyrk | FileCheck %s -check-prefix=cublasSsyrk
...
// RUN: dpct --query-api-mapping=cublasZhemm | FileCheck %s -check-prefix=cublasZhemm
...
// RUN: dpct --query-api-mapping=cublasSetMatrixAsync | FileCheck %s -check-prefix=cublasSetMatrixAsync
...
// RUN: dpct --query-api-mapping=cublasSaxpy | FileCheck %s -check-prefix=cublasSaxpy
...
// RUN: dpct --query-api-mapping=cublasSetAtomicsMode | FileCheck %s -check-prefix=cublasSetAtomicsMode
...
// RUN: dpct --query-api-mapping=cublasDsymv | FileCheck %s -check-prefix=cublasDsymv
...
// RUN: dpct --query-api-mapping=cublasDsymm | FileCheck %s -check-prefix=cublasDsymm
...
// RUN: dpct --query-api-mapping=cublasChpr2 | FileCheck %s -check-prefix=cublasChpr2
...
// RUN: dpct --query-api-mapping=cublasCtbsv | FileCheck %s -check-prefix=cublasCtbsv
...
// RUN: dpct --query-api-mapping=cublasDsbmv | FileCheck %s -check-prefix=cublasDsbmv
...
// RUN: dpct --query-api-mapping=cublasCgemmEx | FileCheck %s -check-prefix=cublasCgemmEx
...
// RUN: dpct --query-api-mapping=cublasIsamax | FileCheck %s -check-prefix=cublasIsamax
...
// RUN: dpct --query-api-mapping=cublasGetMatrix | FileCheck %s -check-prefix=cublasGetMatrix
...
// RUN: dpct --query-api-mapping=cublasZgeam | FileCheck %s -check-prefix=cublasZgeam
...
// RUN: dpct --query-api-mapping=cublasCsyr2 | FileCheck %s -check-prefix=cublasCsyr2
...
// RUN: dpct --query-api-mapping=cublasZsyrkx | FileCheck %s -check-prefix=cublasZsyrkx
...
// RUN: dpct --query-api-mapping=cublasZsyr2 | FileCheck %s -check-prefix=cublasZsyr2
