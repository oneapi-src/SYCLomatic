...
// RUN: dpct --query-api-mapping=cublasCsscal | FileCheck %s -check-prefix=cublasCsscal
...
// RUN: dpct --query-api-mapping=cublasIdamin | FileCheck %s -check-prefix=cublasIdamin
...
// RUN: dpct --query-api-mapping=cublasSetMatrix | FileCheck %s -check-prefix=cublasSetMatrix
...
// RUN: dpct --query-api-mapping=cublasZscal | FileCheck %s -check-prefix=cublasZscal
...
// RUN: dpct --query-api-mapping=cublasCtrmv | FileCheck %s -check-prefix=cublasCtrmv
...
// RUN: dpct --query-api-mapping=cublasZrot | FileCheck %s -check-prefix=cublasZrot
// cublasZrot: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasSetVector | FileCheck %s -check-prefix=cublasSetVector
...
// RUN: dpct --query-api-mapping=cublasSetStream | FileCheck %s -check-prefix=cublasSetStream
...
// RUN: dpct --query-api-mapping=cublasZdgmm | FileCheck %s -check-prefix=cublasZdgmm
...
// RUN: dpct --query-api-mapping=cublasZdrot | FileCheck %s -check-prefix=cublasZdrot
...
// RUN: dpct --query-api-mapping=cublasZhpr | FileCheck %s -check-prefix=cublasZhpr
// cublasZhpr: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasCtpmv | FileCheck %s -check-prefix=cublasCtpmv
...
// RUN: dpct --query-api-mapping=cublasDtrmv | FileCheck %s -check-prefix=cublasDtrmv
...
// RUN: dpct --query-api-mapping=cublasCtrsm | FileCheck %s -check-prefix=cublasCtrsm
...
// RUN: dpct --query-api-mapping=cublasCsyrk | FileCheck %s -check-prefix=cublasCsyrk
...
// RUN: dpct --query-api-mapping=cublasDsyr2 | FileCheck %s -check-prefix=cublasDsyr2
...
// RUN: dpct --query-api-mapping=cublasIdamax | FileCheck %s -check-prefix=cublasIdamax
...
// RUN: dpct --query-api-mapping=cublasZgemv | FileCheck %s -check-prefix=cublasZgemv
...
// RUN: dpct --query-api-mapping=cublasIsamin | FileCheck %s -check-prefix=cublasIsamin
...
// RUN: dpct --query-api-mapping=cublasZswap | FileCheck %s -check-prefix=cublasZswap
...
// RUN: dpct --query-api-mapping=cublasSspr | FileCheck %s -check-prefix=cublasSspr
// cublasSspr: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasDdot | FileCheck %s -check-prefix=cublasDdot
// cublasDdot: CUDA API:
...
// RUN: dpct --query-api-mapping=cublasCsymv | FileCheck %s -check-prefix=cublasCsymv
...
// RUN: dpct --query-api-mapping=cublasDspr2 | FileCheck %s -check-prefix=cublasDspr2
...
// RUN: dpct --query-api-mapping=cublasZherk | FileCheck %s -check-prefix=cublasZherk
