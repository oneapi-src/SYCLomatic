...
// cublasGemmBatchedEx-NEXT:   dpct::blas::gemm_batch(handle->get_queue(), transa, transb, m, n, k, alpha, const_cast<void const **>(a), atype, lda, const_cast<void const **>(b), btype, ldb, beta, const_cast<void **>(c), ctype, ldc, group_count, computetype_computeType_t);
// cublasGemmBatchedEx-NEXT:   dpct::blas::gemm_batch(handle->get_queue(), transa, transb, m, n, k, alpha, const_cast<void const **>(a), atype, lda, const_cast<void const **>(b), btype, ldb, beta, const_cast<void **>(c), ctype, ldc, group_count, computetype_dataType);
...
// cublasGemmEx-NEXT:   dpct::blas::gemm(handle->get_queue(), transa, transb, m, n, k, alpha, a, atype, lda, b, btype, ldb, beta, c, ctype, ldc, computetype_computeType_t);
// cublasGemmEx-NEXT:   dpct::blas::gemm(handle->get_queue(), transa, transb, m, n, k, alpha, a, atype, lda, b, btype, ldb, beta, c, ctype, ldc, computetype_dataType);
...
// cublasGemmStridedBatchedEx-NEXT:   dpct::blas::gemm_batch(handle->get_queue(), transa, transb, m, n, k, alpha, a, atype, lda, stridea, b, btype, ldb, strideb, beta, c, ctype, ldc, stridec, group_count, computetype_computeType_t);
// cublasGemmStridedBatchedEx-NEXT:   dpct::blas::gemm_batch(handle->get_queue(), transa, transb, m, n, k, alpha, a, atype, lda, stridea, b, btype, ldb, strideb, beta, c, ctype, ldc, stridec, group_count, computetype_dataType);
