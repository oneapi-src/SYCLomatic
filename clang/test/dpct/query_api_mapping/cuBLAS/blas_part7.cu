...
// RUN: dpct --query-api-mapping=cublasZher2k | FileCheck %s -check-prefix=cublasZher2k
...
// RUN: dpct --query-api-mapping=cublasDsyr2k | FileCheck %s -check-prefix=cublasDsyr2k
...
// RUN: dpct --query-api-mapping=cublasDgemm | FileCheck %s -check-prefix=cublasDgemm
...
// RUN: dpct --query-api-mapping=cublasGetPointerMode | FileCheck %s -check-prefix=cublasGetPointerMode
...
// RUN: dpct --query-api-mapping=cublasSrotg | FileCheck %s -check-prefix=cublasSrotg
...
// RUN: dpct --query-api-mapping=cublasSgemmEx | FileCheck %s -check-prefix=cublasSgemmEx
...
// RUN: dpct --query-api-mapping=cublasDrotmg | FileCheck %s -check-prefix=cublasDrotmg
...
// RUN: dpct --query-api-mapping=cublasStpmv | FileCheck %s -check-prefix=cublasStpmv
...
// RUN: dpct --query-api-mapping=cublasStrsv | FileCheck %s -check-prefix=cublasStrsv
...
// RUN: dpct --query-api-mapping=cublasStbmv | FileCheck %s -check-prefix=cublasStbmv
...
// RUN: dpct --query-api-mapping=cublasStpsv | FileCheck %s -check-prefix=cublasStpsv
...
// RUN: dpct --query-api-mapping=cublasCherkx | FileCheck %s -check-prefix=cublasCherkx
...
// RUN: dpct --query-api-mapping=cublasCgeam | FileCheck %s -check-prefix=cublasCgeam
...
// RUN: dpct --query-api-mapping=cublasZrotg | FileCheck %s -check-prefix=cublasZrotg
...
// RUN: dpct --query-api-mapping=cublasHgemm | FileCheck %s -check-prefix=cublasHgemm
...
// RUN: dpct --query-api-mapping=cublasSgemv | FileCheck %s -check-prefix=cublasSgemv
...
// RUN: dpct --query-api-mapping=cublasSrotmg | FileCheck %s -check-prefix=cublasSrotmg
...
// RUN: dpct --query-api-mapping=cublasZhbmv | FileCheck %s -check-prefix=cublasZhbmv
...
// RUN: dpct --query-api-mapping=cublasCswap | FileCheck %s -check-prefix=cublasCswap
...
// RUN: dpct --query-api-mapping=cublasCher2 | FileCheck %s -check-prefix=cublasCher2
...
// RUN: dpct --query-api-mapping=cublasCaxpy | FileCheck %s -check-prefix=cublasCaxpy
...
// RUN: dpct --query-api-mapping=cublasDaxpy | FileCheck %s -check-prefix=cublasDaxpy
...
// RUN: dpct --query-api-mapping=cublasDscal | FileCheck %s -check-prefix=cublasDscal
...
// RUN: dpct --query-api-mapping=cublasCtrmm | FileCheck %s -check-prefix=cublasCtrmm
...
// RUN: dpct --query-api-mapping=cublasCgbmv | FileCheck %s -check-prefix=cublasCgbmv
