...
// cublasIcamin-NEXT:   [&]() {
// cublasIcamin-NEXT:   dpct::blas::out_mem_int_t res(handle->get_queue(), res);
// cublasIcamin-NEXT:   oneapi::mkl::blas::column_major::iamin(handle->get_queue(), n, (std::complex<float>*)x, incx, res.get_memory(), oneapi::mkl::index_base::one);
...
// cublasIcamax-NEXT:   [&]() {
// cublasIcamax-NEXT:   dpct::blas::out_mem_int_t res(handle->get_queue(), res);
// cublasIcamax-NEXT:   oneapi::mkl::blas::column_major::iamax(handle->get_queue(), n, (std::complex<float>*)x, incx, res.get_memory(), oneapi::mkl::index_base::one);
...
// cublasCreate-NEXT:   handle->get_queue() = new dpct::blas::descriptor();
