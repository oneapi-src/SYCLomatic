...
// RUN: dpct --query-api-mapping=ncclGetVersion | FileCheck %s -check-prefix=ncclGetVersion
...
// RUN: dpct --query-api-mapping=ncclGetUniqueId | FileCheck %s -check-prefix=ncclGetUniqueId
...
// RUN: dpct --query-api-mapping=ncclCommInitRank | FileCheck %s -check-prefix=ncclCommInitRank
...
// RUN: dpct --query-api-mapping=ncclCommDestroy | FileCheck %s -check-prefix=ncclCommDestroy
...
// RUN: dpct --query-api-mapping=ncclCommCount | FileCheck %s -check-prefix=ncclCommCount
...
// RUN: dpct --query-api-mapping=ncclCommCuDevice | FileCheck %s -check-prefix=ncclCommCuDevice
...
// RUN: dpct --query-api-mapping=ncclCommUserRank | FileCheck %s -check-prefix=ncclCommUserRank
...
// RUN: dpct --query-api-mapping=ncclAllReduce | FileCheck %s -check-prefix=ncclAllReduce
...
// RUN: dpct --query-api-mapping=ncclBroadcast | FileCheck %s -check-prefix=ncclBroadcast
...
// RUN: dpct --query-api-mapping=ncclReduce | FileCheck %s -check-prefix=ncclReduce
// ncclReduce: CUDA API:
...
// RUN: dpct --query-api-mapping=ncclReduceScatter | FileCheck %s -check-prefix=ncclReduceScatter
...
// RUN: dpct --query-api-mapping=ncclBcast | FileCheck %s -check-prefix=ncclBcast
// ncclBcast: CUDA API:
