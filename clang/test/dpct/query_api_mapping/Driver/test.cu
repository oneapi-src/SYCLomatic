...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuInit | FileCheck %s -check-prefix=CUINIT
// CUINIT: CUDA API:
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDriverGetVersion | FileCheck %s -check-prefix=CUDRIVERGETVERSION
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDeviceGet | FileCheck %s -check-prefix=CUDEVICEGET
// CUDEVICEGET: CUDA API:
// CUDEVICEGET-NEXT:   cuDeviceGet(pd /*CUdevice **/, i /*int*/);
// CUDEVICEGET-NEXT: Is migrated to:
// CUDEVICEGET-NEXT:   *pd = i;

// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDeviceGetCount | FileCheck %s -check-prefix=CUDEVICEGETCOUNT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDeviceGetName | FileCheck %s -check-prefix=CUDEVICEGETNAME
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDeviceTotalMem | FileCheck %s -check-prefix=CUDEVICETOTALMEM
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDeviceComputeCapability | FileCheck %s -check-prefix=CUDEVICECOMPUTECAPABILITY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDevicePrimaryCtxRelease | FileCheck %s -check-prefix=CUDEVICEPRIMARYCTXRELEASE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuDevicePrimaryCtxRetain | FileCheck %s -check-prefix=CUDEVICEPRIMARYCTXRETAIN
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxDestroy | FileCheck %s -check-prefix=CUCTXDESTROY
// CUCTXDESTROY: CUDA API:
// CUCTXDESTROY-NEXT:   cuCtxDestroy(c /*CUcontext*/);
// CUCTXDESTROY-NEXT: The API is Removed.

// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxGetApiVersion | FileCheck %s -check-prefix=CUCTXGETAPIVERSION
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxGetCurrent | FileCheck %s -check-prefix=CUCTXGETCURRENT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxGetDevice | FileCheck %s -check-prefix=CUCTXGETDEVICE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxSetCacheConfig | FileCheck %s -check-prefix=CUCTXSETCACHECONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxSetCurrent | FileCheck %s -check-prefix=CUCTXSETCURRENT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuCtxSynchronize | FileCheck %s -check-prefix=CUCTXSYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuModuleGetFunction | FileCheck %s -check-prefix=CUMODULEGETFUNCTION
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuModuleLoad | FileCheck %s -check-prefix=CUMODULELOAD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuModuleLoadData | FileCheck %s -check-prefix=CUMODULELOADDATA
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuModuleLoadDataEx | FileCheck %s -check-prefix=CUMODULELOADDATAEX
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuModuleUnload | FileCheck %s -check-prefix=CUMODULEUNLOAD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuModuleGetTexRef | FileCheck %s -check-prefix=CUMODULEGETTEXREF
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuArrayDestroy | FileCheck %s -check-prefix=CUARRAYDESTROY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemAlloc | FileCheck %s -check-prefix=CUMEMALLOC
// CUMEMALLOC: CUDA API:
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemAllocHost | FileCheck %s -check-prefix=CUMEMALLOCHOST
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemAllocManaged | FileCheck %s -check-prefix=CUMEMALLOCMANAGED
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemAllocPitch | FileCheck %s -check-prefix=CUMEMALLOCPITCH
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemFree | FileCheck %s -check-prefix=CUMEMFREE
// CUMEMFREE: CUDA API:
// CUMEMFREE-NEXT:   cuMemFree(d /*CUdeviceptr*/);
// CUMEMFREE-NEXT: Is migrated to:
// CUMEMFREE-NEXT:   sycl::free(d, dpct::get_in_order_queue());

// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemFreeHost | FileCheck %s -check-prefix=CUMEMFREEHOST
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemGetInfo | FileCheck %s -check-prefix=CUMEMGETINFO
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemHostAlloc | FileCheck %s -check-prefix=CUMEMHOSTALLOC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemHostGetDevicePointer | FileCheck %s -check-prefix=CUMEMHOSTGETDEVICEPOINTER
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemHostGetFlags | FileCheck %s -check-prefix=CUMEMHOSTGETFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemHostRegister | FileCheck %s -check-prefix=CUMEMHOSTREGISTER
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemHostUnregister | FileCheck %s -check-prefix=CUMEMHOSTUNREGISTER
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpy | FileCheck %s -check-prefix=CUMEMCPY
// CUMEMCPY: CUDA API:
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyAsync | FileCheck %s -check-prefix=CUMEMCPYASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyAtoA | FileCheck %s -check-prefix=CUMEMCPYATOA
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyAtoD | FileCheck %s -check-prefix=CUMEMCPYATOD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyAtoH | FileCheck %s -check-prefix=CUMEMCPYATOH
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyAtoHAsync | FileCheck %s -check-prefix=CUMEMCPYATOHASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyDtoA | FileCheck %s -check-prefix=CUMEMCPYDTOA
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyDtoD | FileCheck %s -check-prefix=CUMEMCPYDTOD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyDtoDAsync | FileCheck %s -check-prefix=CUMEMCPYDTODASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyDtoH | FileCheck %s -check-prefix=CUMEMCPYDTOH
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyDtoHAsync | FileCheck %s -check-prefix=CUMEMCPYDTOHASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyHtoA | FileCheck %s -check-prefix=CUMEMCPYHTOA
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyHtoAAsync | FileCheck %s -check-prefix=CUMEMCPYHTOAASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyHtoD | FileCheck %s -check-prefix=CUMEMCPYHTOD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemcpyHtoDAsync | FileCheck %s -check-prefix=CUMEMCPYHTODASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemAdvise | FileCheck %s -check-prefix=CUMEMADVISE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuMemPrefetchAsync | FileCheck %s -check-prefix=CUMEMPREFETCHASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuStreamAddCallback | FileCheck %s -check-prefix=CUSTREAMADDCALLBACK
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuStreamAttachMemAsync | FileCheck %s -check-prefix=CUSTREAMATTACHMEMASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuStreamCreate | FileCheck %s -check-prefix=CUSTREAMCREATE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuStreamDestroy | FileCheck %s -check-prefix=CUSTREAMDESTROY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuStreamSynchronize | FileCheck %s -check-prefix=CUSTREAMSYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuStreamWaitEvent | FileCheck %s -check-prefix=CUSTREAMWAITEVENT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuEventCreate | FileCheck %s -check-prefix=CUEVENTCREATE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuEventDestroy | FileCheck %s -check-prefix=CUEVENTDESTROY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuEventElapsedTime | FileCheck %s -check-prefix=CUEVENTELAPSEDTIME
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuEventQuery | FileCheck %s -check-prefix=CUEVENTQUERY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuEventRecord | FileCheck %s -check-prefix=CUEVENTRECORD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuEventSynchronize | FileCheck %s -check-prefix=CUEVENTSYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuFuncGetAttribute | FileCheck %s -check-prefix=CUFUNCGETATTRIBUTE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuFuncSetCacheConfig | FileCheck %s -check-prefix=CUFUNCSETCACHECONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuLaunchKernel | FileCheck %s -check-prefix=CULAUNCHKERNEL
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefGetAddressMode | FileCheck %s -check-prefix=CUTEXREFGETADDRESSMODE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefGetFilterMode | FileCheck %s -check-prefix=CUTEXREFGETFILTERMODE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefGetFlags | FileCheck %s -check-prefix=CUTEXREFGETFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetAddress | FileCheck %s -check-prefix=CUTEXREFSETADDRESS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetAddress2D | FileCheck %s -check-prefix=CUTEXREFSETADDRESS2D
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetAddressMode | FileCheck %s -check-prefix=CUTEXREFSETADDRESSMODE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetArray | FileCheck %s -check-prefix=CUTEXREFSETARRAY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetFilterMode | FileCheck %s -check-prefix=CUTEXREFSETFILTERMODE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetFlags | FileCheck %s -check-prefix=CUTEXREFSETFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexRefSetFormat | FileCheck %s -check-prefix=CUTEXREFSETFORMAT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexObjectCreate | FileCheck %s -check-prefix=CUTEXOBJECTCREATE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexObjectDestroy | FileCheck %s -check-prefix=CUTEXOBJECTDESTROY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexObjectGetResourceDesc | FileCheck %s -check-prefix=CUTEXOBJECTGETRESOURCEDESC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cuTexObjectGetTextureDesc | FileCheck %s -check-prefix=CUTEXOBJECTGETTEXTUREDESC
