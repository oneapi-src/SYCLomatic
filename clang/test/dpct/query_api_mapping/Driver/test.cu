...
// RUN: dpct --query-api-mapping=cuInit | FileCheck %s -check-prefix=CUINIT
// CUINIT: CUDA API:
...
// RUN: dpct --query-api-mapping=cuDriverGetVersion | FileCheck %s -check-prefix=CUDRIVERGETVERSION
...
// RUN: dpct --query-api-mapping=cuDeviceGet | FileCheck %s -check-prefix=CUDEVICEGET
// CUDEVICEGET: CUDA API:
// CUDEVICEGET-NEXT:   cuDeviceGet(pd /*CUdevice **/, i /*int*/);
// CUDEVICEGET-NEXT: Is migrated to:
// CUDEVICEGET-NEXT:   *pd = i;

// RUN: dpct --query-api-mapping=cuDeviceGetCount | FileCheck %s -check-prefix=CUDEVICEGETCOUNT
...
// RUN: dpct --query-api-mapping=cuDeviceGetName | FileCheck %s -check-prefix=CUDEVICEGETNAME
...
// RUN: dpct --query-api-mapping=cuDeviceTotalMem | FileCheck %s -check-prefix=CUDEVICETOTALMEM
...
// RUN: dpct --query-api-mapping=cuDeviceComputeCapability | FileCheck %s -check-prefix=CUDEVICECOMPUTECAPABILITY
...
// RUN: dpct --query-api-mapping=cuDevicePrimaryCtxRelease | FileCheck %s -check-prefix=CUDEVICEPRIMARYCTXRELEASE
...
// RUN: dpct --query-api-mapping=cuDevicePrimaryCtxRetain | FileCheck %s -check-prefix=CUDEVICEPRIMARYCTXRETAIN
...
// RUN: dpct --query-api-mapping=cuCtxDestroy | FileCheck %s -check-prefix=CUCTXDESTROY
// CUCTXDESTROY: CUDA API:
// CUCTXDESTROY-NEXT:   cuCtxDestroy(c /*CUcontext*/);
// CUCTXDESTROY-NEXT: The API is Removed.

// RUN: dpct --query-api-mapping=cuCtxGetApiVersion | FileCheck %s -check-prefix=CUCTXGETAPIVERSION
...
// RUN: dpct --query-api-mapping=cuCtxGetCurrent | FileCheck %s -check-prefix=CUCTXGETCURRENT
...
// RUN: dpct --query-api-mapping=cuCtxGetDevice | FileCheck %s -check-prefix=CUCTXGETDEVICE
...
// RUN: dpct --query-api-mapping=cuCtxSetCacheConfig | FileCheck %s -check-prefix=CUCTXSETCACHECONFIG
...
// RUN: dpct --query-api-mapping=cuCtxSetCurrent | FileCheck %s -check-prefix=CUCTXSETCURRENT
...
// RUN: dpct --query-api-mapping=cuCtxSynchronize | FileCheck %s -check-prefix=CUCTXSYNCHRONIZE
...
// RUN: dpct --query-api-mapping=cuModuleGetFunction | FileCheck %s -check-prefix=CUMODULEGETFUNCTION
...
// RUN: dpct --query-api-mapping=cuModuleLoad | FileCheck %s -check-prefix=CUMODULELOAD
...
// RUN: dpct --query-api-mapping=cuModuleLoadData | FileCheck %s -check-prefix=CUMODULELOADDATA
...
// RUN: dpct --query-api-mapping=cuModuleLoadDataEx | FileCheck %s -check-prefix=CUMODULELOADDATAEX
...
// RUN: dpct --query-api-mapping=cuModuleUnload | FileCheck %s -check-prefix=CUMODULEUNLOAD
...
// RUN: dpct --query-api-mapping=cuModuleGetTexRef | FileCheck %s -check-prefix=CUMODULEGETTEXREF
...
// RUN: dpct --query-api-mapping=cuArrayDestroy | FileCheck %s -check-prefix=CUARRAYDESTROY
...
// RUN: dpct --query-api-mapping=cuMemAlloc | FileCheck %s -check-prefix=CUMEMALLOC
// CUMEMALLOC: CUDA API:
...
// RUN: dpct --query-api-mapping=cuMemAllocHost | FileCheck %s -check-prefix=CUMEMALLOCHOST
...
// RUN: dpct --query-api-mapping=cuMemAllocManaged | FileCheck %s -check-prefix=CUMEMALLOCMANAGED
...
// RUN: dpct --query-api-mapping=cuMemAllocPitch | FileCheck %s -check-prefix=CUMEMALLOCPITCH
...
// RUN: dpct --query-api-mapping=cuMemFree | FileCheck %s -check-prefix=CUMEMFREE
// CUMEMFREE: CUDA API:
// CUMEMFREE-NEXT:   cuMemFree(d /*CUdeviceptr*/);
// CUMEMFREE-NEXT: Is migrated to:
// CUMEMFREE-NEXT:   sycl::free(d, dpct::get_in_order_queue());

// RUN: dpct --query-api-mapping=cuMemFreeHost | FileCheck %s -check-prefix=CUMEMFREEHOST
...
// RUN: dpct --query-api-mapping=cuMemGetInfo | FileCheck %s -check-prefix=CUMEMGETINFO
...
// RUN: dpct --query-api-mapping=cuMemHostAlloc | FileCheck %s -check-prefix=CUMEMHOSTALLOC
...
// RUN: dpct --query-api-mapping=cuMemHostGetDevicePointer | FileCheck %s -check-prefix=CUMEMHOSTGETDEVICEPOINTER
...
// RUN: dpct --query-api-mapping=cuMemHostGetFlags | FileCheck %s -check-prefix=CUMEMHOSTGETFLAGS
...
// RUN: dpct --query-api-mapping=cuMemHostRegister | FileCheck %s -check-prefix=CUMEMHOSTREGISTER
...
// RUN: dpct --query-api-mapping=cuMemHostUnregister | FileCheck %s -check-prefix=CUMEMHOSTUNREGISTER
...
// RUN: dpct --query-api-mapping=cuMemcpy | FileCheck %s -check-prefix=CUMEMCPY
// CUMEMCPY: CUDA API:
...
// RUN: dpct --query-api-mapping=cuMemcpyAsync | FileCheck %s -check-prefix=CUMEMCPYASYNC
...
// RUN: dpct --query-api-mapping=cuMemcpyAtoA | FileCheck %s -check-prefix=CUMEMCPYATOA
...
// RUN: dpct --query-api-mapping=cuMemcpyAtoD | FileCheck %s -check-prefix=CUMEMCPYATOD
...
// RUN: dpct --query-api-mapping=cuMemcpyAtoH | FileCheck %s -check-prefix=CUMEMCPYATOH
...
// RUN: dpct --query-api-mapping=cuMemcpyAtoHAsync | FileCheck %s -check-prefix=CUMEMCPYATOHASYNC
...
// RUN: dpct --query-api-mapping=cuMemcpyDtoA | FileCheck %s -check-prefix=CUMEMCPYDTOA
...
// RUN: dpct --query-api-mapping=cuMemcpyDtoD | FileCheck %s -check-prefix=CUMEMCPYDTOD
...
// RUN: dpct --query-api-mapping=cuMemcpyDtoDAsync | FileCheck %s -check-prefix=CUMEMCPYDTODASYNC
...
// RUN: dpct --query-api-mapping=cuMemcpyDtoH | FileCheck %s -check-prefix=CUMEMCPYDTOH
...
// RUN: dpct --query-api-mapping=cuMemcpyDtoHAsync | FileCheck %s -check-prefix=CUMEMCPYDTOHASYNC
...
// RUN: dpct --query-api-mapping=cuMemcpyHtoA | FileCheck %s -check-prefix=CUMEMCPYHTOA
...
// RUN: dpct --query-api-mapping=cuMemcpyHtoAAsync | FileCheck %s -check-prefix=CUMEMCPYHTOAASYNC
...
// RUN: dpct --query-api-mapping=cuMemcpyHtoD | FileCheck %s -check-prefix=CUMEMCPYHTOD
...
// RUN: dpct --query-api-mapping=cuMemcpyHtoDAsync | FileCheck %s -check-prefix=CUMEMCPYHTODASYNC
...
// RUN: dpct --query-api-mapping=cuMemAdvise | FileCheck %s -check-prefix=CUMEMADVISE
...
// RUN: dpct --query-api-mapping=cuMemPrefetchAsync | FileCheck %s -check-prefix=CUMEMPREFETCHASYNC
...
// RUN: dpct --query-api-mapping=cuStreamAddCallback | FileCheck %s -check-prefix=CUSTREAMADDCALLBACK
...
// RUN: dpct --query-api-mapping=cuStreamAttachMemAsync | FileCheck %s -check-prefix=CUSTREAMATTACHMEMASYNC
...
// RUN: dpct --query-api-mapping=cuStreamCreate | FileCheck %s -check-prefix=CUSTREAMCREATE
...
// RUN: dpct --query-api-mapping=cuStreamDestroy | FileCheck %s -check-prefix=CUSTREAMDESTROY
...
// RUN: dpct --query-api-mapping=cuStreamSynchronize | FileCheck %s -check-prefix=CUSTREAMSYNCHRONIZE
...
// RUN: dpct --query-api-mapping=cuStreamWaitEvent | FileCheck %s -check-prefix=CUSTREAMWAITEVENT
...
// RUN: dpct --query-api-mapping=cuEventCreate | FileCheck %s -check-prefix=CUEVENTCREATE
...
// RUN: dpct --query-api-mapping=cuEventDestroy | FileCheck %s -check-prefix=CUEVENTDESTROY
...
// RUN: dpct --query-api-mapping=cuEventElapsedTime | FileCheck %s -check-prefix=CUEVENTELAPSEDTIME
...
// RUN: dpct --query-api-mapping=cuEventQuery | FileCheck %s -check-prefix=CUEVENTQUERY
...
// RUN: dpct --query-api-mapping=cuEventRecord | FileCheck %s -check-prefix=CUEVENTRECORD
...
// RUN: dpct --query-api-mapping=cuEventSynchronize | FileCheck %s -check-prefix=CUEVENTSYNCHRONIZE
...
// RUN: dpct --query-api-mapping=cuFuncGetAttribute | FileCheck %s -check-prefix=CUFUNCGETATTRIBUTE
...
// RUN: dpct --query-api-mapping=cuFuncSetCacheConfig | FileCheck %s -check-prefix=CUFUNCSETCACHECONFIG
...
// RUN: dpct --query-api-mapping=cuLaunchKernel | FileCheck %s -check-prefix=CULAUNCHKERNEL
...
// RUN: dpct --query-api-mapping=cuTexRefGetAddressMode | FileCheck %s -check-prefix=CUTEXREFGETADDRESSMODE
...
// RUN: dpct --query-api-mapping=cuTexRefGetFilterMode | FileCheck %s -check-prefix=CUTEXREFGETFILTERMODE
...
// RUN: dpct --query-api-mapping=cuTexRefGetFlags | FileCheck %s -check-prefix=CUTEXREFGETFLAGS
...
// RUN: dpct --query-api-mapping=cuTexRefSetAddress | FileCheck %s -check-prefix=CUTEXREFSETADDRESS
...
// RUN: dpct --query-api-mapping=cuTexRefSetAddress2D | FileCheck %s -check-prefix=CUTEXREFSETADDRESS2D
...
// RUN: dpct --query-api-mapping=cuTexRefSetAddressMode | FileCheck %s -check-prefix=CUTEXREFSETADDRESSMODE
...
// RUN: dpct --query-api-mapping=cuTexRefSetArray | FileCheck %s -check-prefix=CUTEXREFSETARRAY
...
// RUN: dpct --query-api-mapping=cuTexRefSetFilterMode | FileCheck %s -check-prefix=CUTEXREFSETFILTERMODE
...
// RUN: dpct --query-api-mapping=cuTexRefSetFlags | FileCheck %s -check-prefix=CUTEXREFSETFLAGS
...
// RUN: dpct --query-api-mapping=cuTexRefSetFormat | FileCheck %s -check-prefix=CUTEXREFSETFORMAT
...
// RUN: dpct --query-api-mapping=cuTexObjectCreate | FileCheck %s -check-prefix=CUTEXOBJECTCREATE
...
// RUN: dpct --query-api-mapping=cuTexObjectDestroy | FileCheck %s -check-prefix=CUTEXOBJECTDESTROY
...
// RUN: dpct --query-api-mapping=cuTexObjectGetResourceDesc | FileCheck %s -check-prefix=CUTEXOBJECTGETRESOURCEDESC
...
// RUN: dpct --query-api-mapping=cuTexObjectGetTextureDesc | FileCheck %s -check-prefix=CUTEXOBJECTGETTEXTUREDESC
