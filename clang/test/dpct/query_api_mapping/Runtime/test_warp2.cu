...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__reduce_add_sync | FileCheck %s -check-prefix=__reduce_add_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__reduce_and_sync | FileCheck %s -check-prefix=__reduce_and_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__reduce_max_sync | FileCheck %s -check-prefix=__reduce_max_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__reduce_min_sync | FileCheck %s -check-prefix=__reduce_min_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__reduce_or_sync | FileCheck %s -check-prefix=__reduce_or_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__reduce_xor_sync | FileCheck %s -check-prefix=__reduce_xor_sync
