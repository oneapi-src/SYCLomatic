...
// RUN: dpct --query-api-mapping=make_uchar1 | FileCheck %s -check-prefix=MAKE_UCHAR1
...
// RUN: dpct --query-api-mapping=make_uchar2 | FileCheck %s -check-prefix=MAKE_UCHAR2
...
// RUN: dpct --query-api-mapping=make_uchar3 | FileCheck %s -check-prefix=MAKE_UCHAR3
...
// RUN: dpct --query-api-mapping=make_uchar4 | FileCheck %s -check-prefix=MAKE_UCHAR4
...
// RUN: dpct --query-api-mapping=make_short1 | FileCheck %s -check-prefix=MAKE_SHORT1
// MAKE_SHORT1: CUDA API:
// MAKE_SHORT1-NEXT:   make_short1(s /*short*/);
// MAKE_SHORT1-NEXT: Is migrated to:
// MAKE_SHORT1-NEXT:   int16_t(s);

// RUN: dpct --query-api-mapping=make_short2 | FileCheck %s -check-prefix=MAKE_SHORT2
...
// RUN: dpct --query-api-mapping=make_short3 | FileCheck %s -check-prefix=MAKE_SHORT3
...
// RUN: dpct --query-api-mapping=make_short4 | FileCheck %s -check-prefix=MAKE_SHORT4
...
// RUN: dpct --query-api-mapping=make_ushort1 | FileCheck %s -check-prefix=MAKE_USHORT1
...
// RUN: dpct --query-api-mapping=make_ushort2 | FileCheck %s -check-prefix=MAKE_USHORT2
...
// RUN: dpct --query-api-mapping=make_ushort3 | FileCheck %s -check-prefix=MAKE_USHORT3
...
// RUN: dpct --query-api-mapping=make_ushort4 | FileCheck %s -check-prefix=MAKE_USHORT4
...
// RUN: dpct --query-api-mapping=make_uint4 | FileCheck %s -check-prefix=MAKE_UINT4
// MAKE_UINT4: CUDA API:
...
// RUN: dpct --query-api-mapping=make_ulong1 | FileCheck %s -check-prefix=MAKE_ULONG1
...
// RUN: dpct --query-api-mapping=make_ulong2 | FileCheck %s -check-prefix=MAKE_ULONG2
...
// RUN: dpct --query-api-mapping=make_ulong3 | FileCheck %s -check-prefix=MAKE_ULONG3
...
// RUN: dpct --query-api-mapping=make_ulong4 | FileCheck %s -check-prefix=MAKE_ULONG4
...
// RUN: dpct --query-api-mapping=make_longlong1 | FileCheck %s -check-prefix=MAKE_LONGLONG1
...
// RUN: dpct --query-api-mapping=make_longlong2 | FileCheck %s -check-prefix=MAKE_LONGLONG2
...
// RUN: dpct --query-api-mapping=make_longlong3 | FileCheck %s -check-prefix=MAKE_LONGLONG3
...
// RUN: dpct --query-api-mapping=make_longlong4 | FileCheck %s -check-prefix=MAKE_LONGLONG4
...
// RUN: dpct --query-api-mapping=make_ulonglong1 | FileCheck %s -check-prefix=MAKE_ULONGLONG1
...
// RUN: dpct --query-api-mapping=make_ulonglong2 | FileCheck %s -check-prefix=MAKE_ULONGLONG2
...
// RUN: dpct --query-api-mapping=make_ulonglong3 | FileCheck %s -check-prefix=MAKE_ULONGLONG3
...
// RUN: dpct --query-api-mapping=make_ulonglong4 | FileCheck %s -check-prefix=MAKE_ULONGLONG4
...
// RUN: dpct --query-api-mapping=make_float1 | FileCheck %s -check-prefix=MAKE_FLOAT1
// MAKE_FLOAT1: CUDA API:
// MAKE_FLOAT1-NEXT:   make_float1(f /*float*/);
// MAKE_FLOAT1-NEXT: Is migrated to:
// MAKE_FLOAT1-NEXT:   float(f);

// RUN: dpct --query-api-mapping=make_float2 | FileCheck %s -check-prefix=MAKE_FLOAT2
...
// RUN: dpct --query-api-mapping=make_float3 | FileCheck %s -check-prefix=MAKE_FLOAT3
...
// RUN: dpct --query-api-mapping=make_float4 | FileCheck %s -check-prefix=MAKE_FLOAT4
...
// RUN: dpct --query-api-mapping=make_double1 | FileCheck %s -check-prefix=MAKE_DOUBLE1
// MAKE_DOUBLE1: CUDA API:
// MAKE_DOUBLE1-NEXT:   make_double1(d /*double*/);
// MAKE_DOUBLE1-NEXT: Is migrated to:
// MAKE_DOUBLE1-NEXT:   double(d);

// RUN: dpct --query-api-mapping=make_double2 | FileCheck %s -check-prefix=MAKE_DOUBLE2
...
// RUN: dpct --query-api-mapping=make_double3 | FileCheck %s -check-prefix=MAKE_DOUBLE3
...
// RUN: dpct --query-api-mapping=make_double4 | FileCheck %s -check-prefix=MAKE_DOUBLE4
