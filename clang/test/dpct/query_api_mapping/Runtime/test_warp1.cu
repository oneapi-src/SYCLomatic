...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__any | FileCheck %s -check-prefix=__any
// __any: CUDA API:
// __any-NEXT:   r = __any(pred /*int*/);
// __any-NEXT: Is migrated to:
// __any-NEXT:   r = sycl::any_of_group(item_ct1.get_sub_group(), pred);

// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__all | FileCheck %s -check-prefix=__all
// __all: CUDA API:
// __all-NEXT:   r = __all(pred /*int*/);
// __all-NEXT: Is migrated to:
// __all-NEXT:   r = sycl::all_of_group(item_ct1.get_sub_group(), pred);

// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__ballot | FileCheck %s -check-prefix=__ballot
// __ballot: CUDA API:
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_down | FileCheck %s -check-prefix=__shfl_down
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl | FileCheck %s -check-prefix=__shfl
// __shfl: CUDA API:
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_up | FileCheck %s -check-prefix=__shfl_up
// __shfl_up: CUDA API:
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_xor | FileCheck %s -check-prefix=__shfl_xor
// __shfl_xor: CUDA API:
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__activemask | FileCheck %s -check-prefix=__activemask
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__all_sync | FileCheck %s -check-prefix=__all_sync
// __all_sync: CUDA API:
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__any_sync | FileCheck %s -check-prefix=__any_sync
// __any_sync: CUDA API:
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__ballot_sync | FileCheck %s -check-prefix=__ballot_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__match_all_sync | FileCheck %s -check-prefix=__match_all_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__match_any_sync | FileCheck %s -check-prefix=__match_any_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_down_sync | FileCheck %s -check-prefix=__shfl_down_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_sync | FileCheck %s -check-prefix=__shfl_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_up_sync | FileCheck %s -check-prefix=__shfl_up_sync
...
// RUN: dpct --no-dpcpp-extensions=free-function-queries --cuda-include-path="%cuda-path/include" --query-api-mapping=__shfl_xor_sync | FileCheck %s -check-prefix=__shfl_xor_sync
