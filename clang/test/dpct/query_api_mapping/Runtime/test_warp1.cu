...
// __any-NEXT:   r = sycl::any_of_group(sycl::ext::oneapi::this_work_item::get_sub_group(), pred);
...
// __all-NEXT:   r = sycl::all_of_group(sycl::ext::oneapi::this_work_item::get_sub_group(), pred);
...
// __ballot-NEXT:   r = sycl::reduce_over_group(sycl::ext::oneapi::this_work_item::get_sub_group(), pred ? (0x1 << sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_id()) : 0, sycl::ext::oneapi::plus<>());
...
// __shfl_down-NEXT:   r = dpct::shift_sub_group_left(sycl::ext::oneapi::this_work_item::get_sub_group(), var, delta, width);
...
// __shfl-NEXT:   r = dpct::select_from_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), var, src_lane, width);
...
// __shfl_up-NEXT:   r = dpct::shift_sub_group_right(sycl::ext::oneapi::this_work_item::get_sub_group(), var, delta, width);
...
// __shfl_xor-NEXT:   r = dpct::permute_sub_group_by_xor(sycl::ext::oneapi::this_work_item::get_sub_group(), var, lane, width);
...
// __all_sync-NEXT:   r = sycl::all_of_group(sycl::ext::oneapi::this_work_item::get_sub_group(), (~mask & (0x1 << sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_id())) || pred);
...
// __any_sync-NEXT:   r = sycl::any_of_group(sycl::ext::oneapi::this_work_item::get_sub_group(), (mask & (0x1 << sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_id())) && pred);
...
// __ballot_sync-NEXT:   r = sycl::reduce_over_group(sycl::ext::oneapi::this_work_item::get_sub_group(), (mask & (0x1 << sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_id())) && pred ? (0x1 << sycl::ext::oneapi::this_work_item::get_sub_group().get_local_linear_id()) : 0, sycl::ext::oneapi::plus<>());
...
// __match_all_sync-NEXT:   r = dpct::match_all_over_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), mask, value, pred);
...
// __match_any_sync-NEXT:   r = dpct::match_any_over_sub_group(sycl::ext::oneapi::this_work_item::get_sub_group(), mask, value);
...
// __shfl_down_sync-NEXT:   r = dpct::experimental::shift_sub_group_left(mask, sycl::ext::oneapi::this_work_item::get_sub_group(), var, delta, width);
...
// __shfl_sync-NEXT:   r = dpct::experimental::select_from_sub_group(mask, sycl::ext::oneapi::this_work_item::get_sub_group(), var, src_lane, width);
...
// __shfl_up_sync-NEXT:   r = dpct::experimental::shift_sub_group_right(mask, sycl::ext::oneapi::this_work_item::get_sub_group(), var, delta, width);
...
// __shfl_xor_sync-NEXT:   r = dpct::experimental::permute_sub_group_by_xor(mask, sycl::ext::oneapi::this_work_item::get_sub_group(), var, lane, width);
