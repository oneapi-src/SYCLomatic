...
// RUN: dpct --query-api-mapping=cudaArrayGetInfo | FileCheck %s -check-prefix=CUDAARRAYGETINFO
...
// RUN: dpct --query-api-mapping=cudaFree | FileCheck %s -check-prefix=CUDAFREE
// CUDAFREE: CUDA API:
// CUDAFREE-NEXT:   cudaFree(pDev /*void **/);
// CUDAFREE-NEXT: Is migrated to:
// CUDAFREE-NEXT:   dpct::dpct_free(pDev, dpct::get_in_order_queue());

// RUN: dpct --query-api-mapping=cudaFreeArray | FileCheck %s -check-prefix=CUDAFREEARRAY
...
// RUN: dpct --query-api-mapping=cudaFreeHost | FileCheck %s -check-prefix=CUDAFREEHOST
...
// RUN: dpct --query-api-mapping=cudaGetSymbolAddress | FileCheck %s -check-prefix=CUDAGETSYMBOLADDRESS
...
// RUN: dpct --query-api-mapping=cudaGetSymbolSize | FileCheck %s -check-prefix=CUDAGETSYMBOLSIZE
...
// RUN: dpct --query-api-mapping=cudaHostAlloc | FileCheck %s -check-prefix=CUDAHOSTALLOC
...
// RUN: dpct --query-api-mapping=cudaHostGetDevicePointer | FileCheck %s -check-prefix=CUDAHOSTGETDEVICEPOINTER
...
// RUN: dpct --query-api-mapping=cudaHostGetFlags | FileCheck %s -check-prefix=CUDAHOSTGETFLAGS
...
// RUN: dpct --query-api-mapping=cudaHostRegister | FileCheck %s -check-prefix=CUDAHOSTREGISTER
...
// RUN: dpct --query-api-mapping=cudaHostUnregister | FileCheck %s -check-prefix=CUDAHOSTUNREGISTER
...
// RUN: dpct --query-api-mapping=cudaMalloc | FileCheck %s -check-prefix=CUDAMALLOC
// CUDAMALLOC: CUDA API:
...
// RUN: dpct --query-api-mapping=cudaMalloc3D | FileCheck %s -check-prefix=CUDAMALLOC3D
...
// RUN: dpct --query-api-mapping=cudaMalloc3DArray | FileCheck %s -check-prefix=CUDAMALLOC3DARRAY
...
// RUN: dpct --query-api-mapping=cudaMallocArray | FileCheck %s -check-prefix=CUDAMALLOCARRAY
...
// RUN: dpct --query-api-mapping=cudaMallocHost | FileCheck %s -check-prefix=CUDAMALLOCHOST
...
// RUN: dpct --query-api-mapping=cudaMallocManaged | FileCheck %s -check-prefix=CUDAMALLOCMANAGED
...
// RUN: dpct --query-api-mapping=cudaMallocPitch | FileCheck %s -check-prefix=CUDAMALLOCPITCH
...
// RUN: dpct --query-api-mapping=cudaMemAdvise | FileCheck %s -check-prefix=CUDAMEMADVISE
...
// RUN: dpct --query-api-mapping=cudaMemGetInfo | FileCheck %s -check-prefix=CUDAMEMGETINFO
...
// RUN: dpct --query-api-mapping=cudaMemPrefetchAsync | FileCheck %s -check-prefix=CUDAMEMPREFETCHASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpy | FileCheck %s -check-prefix=CUDAMEMCPY
// CUDAMEMCPY: CUDA API:
...
// RUN: dpct --query-api-mapping=cudaMemcpy2D | FileCheck %s -check-prefix=CUDAMEMCPY2D
...
// RUN: dpct --query-api-mapping=cudaMemcpy2DArrayToArray | FileCheck %s -check-prefix=CUDAMEMCPY2DARRAYTOARRAY
...
// RUN: dpct --query-api-mapping=cudaMemcpy2DAsync | FileCheck %s -check-prefix=CUDAMEMCPY2DASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpy2DFromArray | FileCheck %s -check-prefix=CUDAMEMCPY2DFROMARRAY
...
// RUN: dpct --query-api-mapping=cudaMemcpy2DFromArrayAsync | FileCheck %s -check-prefix=CUDAMEMCPY2DFROMARRAYASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpy2DToArray | FileCheck %s -check-prefix=CUDAMEMCPY2DTOARRAY
...
// RUN: dpct --query-api-mapping=cudaMemcpy2DToArrayAsync | FileCheck %s -check-prefix=CUDAMEMCPY2DTOARRAYASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpy3D | FileCheck %s -check-prefix=CUDAMEMCPY3D
...
// RUN: dpct --query-api-mapping=cudaMemcpy3DAsync | FileCheck %s -check-prefix=CUDAMEMCPY3DASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpyAsync | FileCheck %s -check-prefix=CUDAMEMCPYASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpyFromSymbol | FileCheck %s -check-prefix=CUDAMEMCPYFROMSYMBOL
...
// RUN: dpct --query-api-mapping=cudaMemcpyFromSymbolAsync | FileCheck %s -check-prefix=CUDAMEMCPYFROMSYMBOLASYNC
...
// RUN: dpct --query-api-mapping=cudaMemcpyToSymbol | FileCheck %s -check-prefix=CUDAMEMCPYTOSYMBOL
...
// RUN: dpct --query-api-mapping=cudaMemcpyToSymbolAsync | FileCheck %s -check-prefix=CUDAMEMCPYTOSYMBOLASYNC
...
// RUN: dpct --query-api-mapping=cudaMemset | FileCheck %s -check-prefix=CUDAMEMSET
// CUDAMEMSET: CUDA API:
...
// RUN: dpct --query-api-mapping=cudaMemset2D | FileCheck %s -check-prefix=CUDAMEMSET2D
...
// RUN: dpct --query-api-mapping=cudaMemset2DAsync | FileCheck %s -check-prefix=CUDAMEMSET2DASYNC
...
// RUN: dpct --query-api-mapping=cudaMemset3D | FileCheck %s -check-prefix=CUDAMEMSET3D
...
// RUN: dpct --query-api-mapping=cudaMemset3DAsync | FileCheck %s -check-prefix=CUDAMEMSET3DASYNC
...
// RUN: dpct --query-api-mapping=cudaMemsetAsync | FileCheck %s -check-prefix=CUDAMEMSETASYNC
...
// RUN: dpct --query-api-mapping=make_cudaExtent | FileCheck %s -check-prefix=MAKE_CUDAEXTENT
...
// RUN: dpct --query-api-mapping=make_cudaPitchedPtr | FileCheck %s -check-prefix=MAKE_CUDAPITCHEDPTR
...
// RUN: dpct --query-api-mapping=make_cudaPos | FileCheck %s -check-prefix=MAKE_CUDAPOS
