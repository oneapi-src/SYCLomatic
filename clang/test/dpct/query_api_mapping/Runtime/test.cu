...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceGetCacheConfig | FileCheck %s -check-prefix=CUDADEVICEGETCACHECONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceGetLimit | FileCheck %s -check-prefix=CUDADEVICEGETLIMIT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceReset | FileCheck %s -check-prefix=CUDADEVICERESET
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceSetCacheConfig | FileCheck %s -check-prefix=CUDADEVICESETCACHECONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceSetLimit | FileCheck %s -check-prefix=CUDADEVICESETLIMIT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceSetSharedMemConfig | FileCheck %s -check-prefix=CUDADEVICESETSHAREDMEMCONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceSynchronize | FileCheck %s -check-prefix=CUDADEVICESYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetDevice | FileCheck %s -check-prefix=CUDAGETDEVICE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetDeviceCount | FileCheck %s -check-prefix=CUDAGETDEVICECOUNT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetDeviceProperties | FileCheck %s -check-prefix=CUDAGETDEVICEPROPERTIES
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaSetDevice | FileCheck %s -check-prefix=CUDASETDEVICE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaSetDeviceFlags | FileCheck %s -check-prefix=CUDASETDEVICEFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaThreadExit | FileCheck %s -check-prefix=CUDATHREADEXIT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaThreadSetLimit | FileCheck %s -check-prefix=CUDATHREADSETLIMIT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaThreadSynchronize | FileCheck %s -check-prefix=CUDATHREADSYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetLastError | FileCheck %s -check-prefix=CUDAGETLASTERROR
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaPeekAtLastError | FileCheck %s -check-prefix=CUDAPEEKATLASTERROR
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamAddCallback | FileCheck %s -check-prefix=CUDASTREAMADDCALLBACK
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamAttachMemAsync | FileCheck %s -check-prefix=CUDASTREAMATTACHMEMASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamCreate | FileCheck %s -check-prefix=CUDASTREAMCREATE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamCreateWithFlags | FileCheck %s -check-prefix=CUDASTREAMCREATEWITHFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamCreateWithPriority | FileCheck %s -check-prefix=CUDASTREAMCREATEWITHPRIORITY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamDestroy | FileCheck %s -check-prefix=CUDASTREAMDESTROY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamGetFlags | FileCheck %s -check-prefix=CUDASTREAMGETFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamGetPriority | FileCheck %s -check-prefix=CUDASTREAMGETPRIORITY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamQuery | FileCheck %s -check-prefix=CUDASTREAMQUERY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamSynchronize | FileCheck %s -check-prefix=CUDASTREAMSYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaStreamWaitEvent | FileCheck %s -check-prefix=CUDASTREAMWAITEVENT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventCreate | FileCheck %s -check-prefix=CUDAEVENTCREATE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventCreateWithFlags | FileCheck %s -check-prefix=CUDAEVENTCREATEWITHFLAGS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventDestroy | FileCheck %s -check-prefix=CUDAEVENTDESTROY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventElapsedTime | FileCheck %s -check-prefix=CUDAEVENTELAPSEDTIME
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventQuery | FileCheck %s -check-prefix=CUDAEVENTQUERY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventRecord | FileCheck %s -check-prefix=CUDAEVENTRECORD
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaEventSynchronize | FileCheck %s -check-prefix=CUDAEVENTSYNCHRONIZE
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaFuncGetAttributes | FileCheck %s -check-prefix=CUDAFUNCGETATTRIBUTES
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaFuncSetCacheConfig | FileCheck %s -check-prefix=CUDAFUNCSETCACHECONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaFuncSetSharedMemConfig | FileCheck %s -check-prefix=CUDAFUNCSETSHAREDMEMCONFIG
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaOccupancyMaxActiveBlocksPerMultiprocessor | FileCheck %s -check-prefix=CUDAOCCUPANCYMAXACTIVEBLOCKSPERMULTIPROCESSOR
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaMemcpyArrayToArray | FileCheck %s -check-prefix=CUDAMEMCPYARRAYTOARRAY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaMemcpyFromArray | FileCheck %s -check-prefix=CUDAMEMCPYFROMARRAY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaMemcpyFromArrayAsync | FileCheck %s -check-prefix=CUDAMEMCPYFROMARRAYASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaMemcpyToArray | FileCheck %s -check-prefix=CUDAMEMCPYTOARRAY
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaMemcpyToArrayAsync | FileCheck %s -check-prefix=CUDAMEMCPYTOARRAYASYNC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaPointerGetAttributes | FileCheck %s -check-prefix=CUDAPOINTERGETATTRIBUTES
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceCanAccessPeer | FileCheck %s -check-prefix=CUDADEVICECANACCESSPEER
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceDisablePeerAccess | FileCheck %s -check-prefix=CUDADEVICEDISABLEPEERACCESS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDeviceEnablePeerAccess | FileCheck %s -check-prefix=CUDADEVICEENABLEPEERACCESS
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaCreateChannelDesc | FileCheck %s -check-prefix=CUDACREATECHANNELDESC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaCreateTextureObject | FileCheck %s -check-prefix=CUDACREATETEXTUREOBJECT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDestroyTextureObject | FileCheck %s -check-prefix=CUDADESTROYTEXTUREOBJECT
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetChannelDesc | FileCheck %s -check-prefix=CUDAGETCHANNELDESC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetTextureObjectResourceDesc | FileCheck %s -check-prefix=CUDAGETTEXTUREOBJECTRESOURCEDESC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaGetTextureObjectTextureDesc | FileCheck %s -check-prefix=CUDAGETTEXTUREOBJECTTEXTUREDESC
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaDriverGetVersion | FileCheck %s -check-prefix=CUDADRIVERGETVERSION
...
// RUN: dpct --enable-profiling=0 --cuda-include-path="%cuda-path/include" --query-api-mapping=cudaRuntimeGetVersion | FileCheck %s -check-prefix=CUDARUNTIMEGETVERSION
