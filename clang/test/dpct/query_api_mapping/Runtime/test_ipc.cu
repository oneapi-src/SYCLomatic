...
// CUDA_IPC_OPEN_MEM_HANDLE-NEXT:  cudaIpcOpenMemHandle((void **)&ptr, *handle, cudaIpcMemLazyEnablePeerAccess);
...
// CUDA_IPC_CLOSE_MEM_HANDLE-NEXT:  cudaIpcCloseMemHandle(ptr);
...
// CUDA_IPC_GET_MEM_HANDLE-NEXT:  cudaIpcGetMemHandle(handle, ptr);
