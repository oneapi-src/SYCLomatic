// UNSUPPORTED: cuda-8.0, cuda-9.0, cuda-9.1, cuda-11.0, cuda-11.1, cuda-11.2, cuda-11.3, cuda-11.4, cuda-11.5, cuda-11.6, cuda-11.7, cuda-11.8, cuda-12.0, cuda-12.1, cuda-12.2, cuda-12.3, cuda-12.4, cuda-12.5, cuda-12.6, cuda-12.8, cuda-12.9
// UNSUPPORTED: v8.0, v9.0, v9.1, v9.2, v10.0, v11.0, v11.1, v11.2, v11.3, v11.4, v11.5, v11.6, v11.7, v11.8, v12.0, v12.1, v12.2, v12.3, v12.4, v12.5, v12.6, v12.8, v12.9
...
// cusparseScsrmv-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseDcsrmv-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseCcsrmv-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseZcsrmv-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseScsrmv_mp-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseDcsrmv_mp-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseCcsrmv_mp-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseZcsrmv_mp-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, desc, value, row_ptr, col_idx, x, beta, y);
...
// cusparseScsrsv_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseDcsrsv_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseCcsrsv_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseZcsrsv_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseScsrmm-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseDcsrmm-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseCcsrmm-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseZcsrmm-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseScsrmm2-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans_a, trans_b, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseDcsrmm2-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans_a, trans_b, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseCcsrmm2-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans_a, trans_b, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
...
// cusparseZcsrmm2-NEXT:   dpct::sparse::csrmm(handle->get_queue(), trans_a, trans_b, m, n, k, nnz, alpha, desc, value, row_ptr, col_idx, B, ldb, beta, C, ldc);
