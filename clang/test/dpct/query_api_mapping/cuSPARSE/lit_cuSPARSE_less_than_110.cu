...
// cusparseScsrmv-NEXT:                  desc /*const cusparseMatDescr_t*/, value /*const float **/,
...
// cusparseDcsrmv-NEXT:                  desc /*const cusparseMatDescr_t*/, value /*const double **/,
...
// cusparseCcsrmv-NEXT:                  desc /*const cusparseMatDescr_t*/, value /*const cuComplex **/,
...
// cusparseZcsrmv-NEXT:                  alpha /*const cuDoubleComplex **/,
// cusparseZcsrmv-NEXT:                  desc /*const cusparseMatDescr_t*/,
...
// cusparseScsrmv_mp-NEXT:                     desc /*const cusparseMatDescr_t*/, value /*const float **/,
...
// cusparseCcsrmv_mp-NEXT:   cusparseCcsrmv_mp(
// cusparseCcsrmv_mp-NEXT:       handle /*cusparseHandle_t*/, trans /*cusparseOperation_t*/, m /*int*/,
// cusparseCcsrmv_mp-NEXT:       n /*int*/, nnz /*int*/, alpha /*const cuComplex **/,
// cusparseCcsrmv_mp-NEXT:       desc /*const cusparseMatDescr_t*/, value /*const cuComplex **/,
// cusparseCcsrmv_mp-NEXT:       row_ptr /*const int **/, col_idx /*const int **/, x /*const cuComplex **/,
...
// cusparseZcsrmv_mp-NEXT:                     desc /*const cusparseMatDescr_t*/,
...
// cusparseScsrsv_analysis-NEXT:   cusparseScsrsv_analysis(
// cusparseScsrsv_analysis-NEXT:       handle /*cusparseHandle_t*/, trans /*cusparseOperation_t*/, m /*int*/,
// cusparseScsrsv_analysis-NEXT:       nnz /*int*/, desc /*const cusparseMatDescr_t*/, value /*const float **/,
...
// cusparseDcsrsv_analysis-NEXT:   cusparseDcsrsv_analysis(
// cusparseDcsrsv_analysis-NEXT:       handle /*cusparseHandle_t*/, trans /*cusparseOperation_t*/, m /*int*/,
// cusparseDcsrsv_analysis-NEXT:       nnz /*int*/, desc /*const cusparseMatDescr_t*/, value /*const double **/,
...
// cusparseCcsrsv_analysis-NEXT:       nnz /*int*/, desc /*const cusparseMatDescr_t*/,
// cusparseCcsrsv_analysis-NEXT:       value /*const cuComplex **/, row_ptr /*const int **/,
// cusparseCcsrsv_analysis-NEXT:       col_idx /*const int **/, info /*cusparseSolveAnalysisInfo_t*/);
...
// cusparseZcsrsv_analysis-NEXT:       nnz /*int*/, desc /*const cusparseMatDescr_t*/,
...
// cusparseCsrsv_analysisEx-NEXT:       nnz /*int*/, desc /*const cusparseMatDescr_t*/, value /*const void **/,
...
// cusparseScsrsv_solve-NEXT:       alpha /*const float **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseDcsrsv_solve-NEXT:       alpha /*const double **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseCcsrsv_solve-NEXT:       alpha /*const cuComplex **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseZcsrsv_solve-NEXT:       alpha /*const cuDoubleComplex **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseCsrsv_solveEx-NEXT:       desc /*const cusparseMatDescr_t*/, value /*const void **/,
...
// cusparseScsrmm-NEXT:                  alpha /*const float **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseDcsrmm-NEXT:                  alpha /*const double **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseCcsrmm-NEXT:                  alpha /*const cuComplex **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseZcsrmm-NEXT:   cusparseZcsrmm(
// cusparseZcsrmm-NEXT:       handle /*cusparseHandle_t*/, trans /*cusparseOperation_t*/, m /*int*/,
// cusparseZcsrmm-NEXT:       n /*int*/, k /*int*/, nnz /*int*/, alpha /*const cuDoubleComplex **/,
// cusparseZcsrmm-NEXT:       desc /*const cusparseMatDescr_t*/, value /*const cuDoubleComplex **/,
// cusparseZcsrmm-NEXT:       row_ptr /*const int **/, col_idx /*const int **/,
// cusparseZcsrmm-NEXT:       B /*const cuDoubleComplex **/, ldb /*int*/,
// cusparseZcsrmm-NEXT:       beta /*const cuDoubleComplex **/, C /*cuDoubleComplex **/, ldc /*int*/);
...
// cusparseScsrmm2-NEXT:                   desc /*const cusparseMatDescr_t*/, value /*const float **/,
...
// cusparseDcsrmm2-NEXT:                   desc /*const cusparseMatDescr_t*/, value /*const double **/,
...
// cusparseCcsrmm2-NEXT:                   desc /*const cusparseMatDescr_t*/,
// cusparseCcsrmm2-NEXT:                   value /*const cuComplex **/, row_ptr /*const int **/,
// cusparseCcsrmm2-NEXT:                   col_idx /*const int **/, B /*const cuComplex **/, ldb /*int*/,
...
// cusparseZcsrmm2-NEXT:                   desc /*const cusparseMatDescr_t*/,
...
// cusparseScsrsv2_solve-NEXT:       nnz /*int*/, alpha /*const float **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseDcsrsv2_solve-NEXT:       nnz /*int*/, alpha /*const double **/, desc /*const cusparseMatDescr_t*/,
...
// cusparseCcsrsv2_solve-NEXT:       nnz /*int*/, alpha /*const cuComplex **/,
// cusparseCcsrsv2_solve-NEXT:       desc /*const cusparseMatDescr_t*/, value /*const cuComplex **/,
// cusparseCcsrsv2_solve-NEXT:       row_ptr /*const int **/, col_idx /*const int **/, info /*csrsv2Info_t*/,
// cusparseCcsrsv2_solve-NEXT:       f /*const cuComplex **/, x /*cuComplex **/,
// cusparseCcsrsv2_solve-NEXT:       policy /*cusparseSolvePolicy_t*/, buffer /*void **/);
...
// cusparseZcsrsv2_solve-NEXT:       desc /*const cusparseMatDescr_t*/, value /*const cuDoubleComplex **/,
