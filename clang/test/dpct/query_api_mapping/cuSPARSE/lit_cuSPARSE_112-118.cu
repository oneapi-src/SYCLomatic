// UNSUPPORTED: cuda-8.0, cuda-9.0, cuda-9.1, cuda-9.2, cuda-10.0, cuda-10.1, cuda-10.2, cuda-11.0, cuda-11.1, cuda-12.0, cuda-12.1, cuda-12.2, cuda-12.3, cuda-12.4, cuda-12.5, cuda-12.6, cuda-12.8, cuda-12.9
// UNSUPPORTED: v8.0, v9.0, v9.1, v9.2, v10.0, v10.1, v10.2, v11.0, v11.1, v12.0, v12.1, v12.2, v12.3, v12.4, v12.5, v12.6, v12.8, v12.9
...
// cusparseCsrmvEx-NEXT:   dpct::sparse::csrmv(handle->get_queue(), trans, m, n, nnz, alpha, alpha_type, desc, value, value_type, row_ptr, col_idx, x, x_type, beta, beta_type, y, y_type);
...
// cusparseScsrsv2_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseDcsrsv2_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseCcsrsv2_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
...
// cusparseZcsrsv2_analysis-NEXT:   dpct::sparse::optimize_csrsv(handle->get_queue(), trans, m, nnz, desc, value, row_ptr, col_idx, info);
