...
int main() {
  ...
  // CHECK: dpct::blas::gemm_batch(handle->get_queue(), trans3, trans3, N, N, N, &alpha_H, (const void**)d_A_H, dpct::library_data_t::real_half, N, (const void**)d_B_H, dpct::library_data_t::real_half, N, &beta_H, (void**)d_C_H, dpct::library_data_t::real_half, N, 10, dpct::library_data_t::real_half);
