...
void k() {
  ...
  // CHECK: std::exclusive_scan(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), (decltype(v2.begin())::value_type)0);
  ...
  // CHECK: std::exclusive_scan(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), (decltype(v2.begin())::value_type)4);
  ...
  // CHECK: std::exclusive_scan(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), (decltype(v2.begin())::value_type)1, binary_op);
  ...
  // CHECK: oneapi::dpl::exclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin());
  // CHECK: oneapi::dpl::exclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin());
  ...
  // CHECK: oneapi::dpl::exclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), 1);
  // CHECK: oneapi::dpl::exclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), 1);
  ...
  // CHECK: oneapi::dpl::exclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), 1, bp);
  // CHECK: oneapi::dpl::exclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), 1, bp);
  ...
  // CHECK: oneapi::dpl::inclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin());
  // CHECK: oneapi::dpl::inclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin());
  ...
  // CHECK: oneapi::dpl::inclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), bp);
  // CHECK: oneapi::dpl::inclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), bp);
  ...
  // CHECK: oneapi::dpl::inclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), bp, bo);
  // CHECK: oneapi::dpl::inclusive_scan_by_segment(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v3.begin(), bp, bo);
  ...
  // CHECK: dpct::partition_point(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), up);
  ...
  // CHECK: oneapi::dpl::binary_search(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());
  ...
  // CHECK: oneapi::dpl::binary_search(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin(), bp);
  ...
  // CHECK: oneapi::dpl::binary_search(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), 1);
  thrust::binary_search(thrust::seq, v.begin(), v.end(), 1);

  // CHECK:  oneapi::dpl::binary_search(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), 1);
  thrust::binary_search(v.begin(), v.end(), 1);

  // CHECK: oneapi::dpl::binary_search(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), 1, bp);
  ...
  // CHECK: oneapi::dpl::lower_bound(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());
  ...
  // CHECK: oneapi::dpl::lower_bound(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin(), bp);
  ...
  // CHECK: oneapi::dpl::upper_bound(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());
  ...
  // CHECK: oneapi::dpl::upper_bound(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin(), bp);
  ...
  // count
  // CHECK: std::count(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), 23);
  ...
  // generate
  // CHECK: std::generate(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), gen);
  ...
  // generate_n
  // CHECK: std::generate_n(oneapi::dpl::execution::par_unseq, v.begin(), 23, gen);
  ...
  // CHECK: std::merge(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());
  thrust::merge(thrust::seq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());
  // CHECK: std::merge(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());
  thrust::merge(v.begin(), v.end(), v2.begin(), v2.end(), v3.begin());

  // CHECK: std::merge(oneapi::dpl::execution::par_unseq, v.begin(), v.end(), v2.begin(), v2.end(), v3.begin(), bp);
...
void foo(cudaStream_t stream) {
  ...
  //thrust::find
  //CHECK:oneapi::dpl::find(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), 1);
  //CHECK-NEXT:oneapi::dpl::find(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), 1);
  ...
  //thrust::sort_by_key
  //CHECK:dpct::sort(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), std::greater<int>());
  //CHECK-NEXT:dpct::sort(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin());
  ...
  //CHECK-NEXT:dpct::sort(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), std::greater<int>());
  ...
  //CHECK:dpct::inner_product(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), 1);
  //CHECK-NEXT:dpct::inner_product(oneapi::dpl::execution::make_device_policy(q_ct1), d.begin(), d.end(), d.begin(), 1, bo1, bo2);
  //CHECK-NEXT:dpct::inner_product(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), 1);
  //CHECK-NEXT:dpct::inner_product(oneapi::dpl::execution::make_device_policy(q_ct1), d.begin(), d.end(), d.begin(), 1);
  //CHECK-NEXT:dpct::inner_product(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), 1, bo1, bo2);
  //CHECK-NEXT:dpct::inner_product(oneapi::dpl::execution::make_device_policy(q_ct1), d.begin(), d.end(), d.begin(), 1, bo1, bo2);
  ...
  //CHECK:oneapi::dpl::reduce_by_segment(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), h.end(), h.begin(), bp, bo1);
  ...
  //CHECK-NEXT:oneapi::dpl::reduce_by_segment(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), h.end(), h.begin(), bp, bo1);
  ...
  //CHECK-NEXT:oneapi::dpl::reduce_by_segment(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), dpct::constant_iterator<int>(1), h.end(), h.begin());
  //CHECK-NEXT:oneapi::dpl::reduce_by_segment(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), h.end(), h.begin(), bp);
  //CHECK-NEXT:oneapi::dpl::reduce_by_segment(oneapi::dpl::execution::make_device_policy(q_ct1), d.begin(), d.end(), d.begin(), d.end(), d.begin(), bp);
  //CHECK-NEXT:oneapi::dpl::reduce_by_segment(oneapi::dpl::execution::par_unseq, h.begin(), h.end(), h.begin(), h.end(), h.begin());
...
// CHECK:dpct::unique(oneapi::dpl::execution::par_unseq, h_keys.begin(), h_keys.end(), h_values.begin());
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, h_keys.begin(), h_keys.end(), h_values.begin());
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, h_keys.begin(), h_keys.end(), h_values.begin(), binary_pred);
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, h_keys.begin(), h_keys.end(), h_values.begin(), binary_pred);
...
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::make_device_policy(q_ct1), d_keys.begin(), d_keys.end(), d_values.begin(), binary_pred);
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, A, A + N, B);
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, A, A + N, B);
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, A, A + N, B, binary_pred);
// CHECK-NEXT:dpct::unique(oneapi::dpl::execution::par_unseq, A, A + N, B, binary_pred);
...
// CHECK:  oneapi::dpl::minmax_element(oneapi::dpl::execution::par_unseq, h_values.begin(), h_values.end());
// CHECK-NEXT:	oneapi::dpl::minmax_element(oneapi::dpl::execution::par_unseq, h_values.begin(), h_values.end());
// CHECK-NEXT:  oneapi::dpl::minmax_element(oneapi::dpl::execution::par_unseq, h_values.begin(), h_values.begin() + 4, compare_key_value());
// CHECK-NEXT:  oneapi::dpl::minmax_element(oneapi::dpl::execution::par_unseq, h_values.begin(), h_values.begin() + 4, compare_key_value());
...
// CHECK:    oneapi::dpl::is_sorted(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end());
// CHECK-NEXT:    oneapi::dpl::is_sorted(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end());
// CHECK-NEXT:    oneapi::dpl::is_sorted(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end(), comp);
// CHECK-NEXT:    oneapi::dpl::is_sorted(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end(), comp);
...
// CHECK:  oneapi::dpl::partition(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end(), is_even());
// CHECK-NEXT:  oneapi::dpl::partition(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end(), is_even());
// CHECK-NEXT:  dpct::partition(oneapi::dpl::execution::par_unseq, h_vdata.begin(), h_vdata.end(), h_vstencil.begin(), is_even());
// CHECK-NEXT:  dpct::partition(oneapi::dpl::execution::par_unseq, h_vdata.begin(), h_vdata.end(), h_vstencil.begin(), is_even());
...
// CHECK:  oneapi::dpl::unique_copy(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_result.begin());
// CHECK-NEXT:  oneapi::dpl::unique_copy(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_result.begin());
// CHECK-NEXT:  oneapi::dpl::unique_copy(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_result.begin(), oneapi::dpl::equal_to<int>());
// CHECK-NEXT:  oneapi::dpl::unique_copy(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_result.begin(), oneapi::dpl::equal_to<int>());
...
void stable_sort_test() {
  ...
  thrust::host_vector<int> h_v(datas,datas+N);
  thrust::device_vector<int> d_v(datas,datas+N);
// CHECK:  oneapi::dpl::stable_sort(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end());
// CHECK-NEXT:  oneapi::dpl::stable_sort(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end());
// CHECK-NEXT:  oneapi::dpl::stable_sort(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end(), std::greater<int>());
// CHECK-NEXT:  oneapi::dpl::stable_sort(oneapi::dpl::execution::par_unseq, h_v.begin(), h_v.end(), std::greater<int>());
...
// CHECK:  dpct::set_difference(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VBvalue.begin(), h_VCkey.begin(), h_VCvalue.begin());
// CHECK-NEXT:  dpct::set_difference(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VBvalue.begin(), h_VCkey.begin(), h_VCvalue.begin());
// CHECK-NEXT:  dpct::set_difference(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VBvalue.begin(), h_VCkey.begin(), h_VCvalue.begin(), std::greater<int>());
// CHECK-NEXT:  dpct::set_difference(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VBvalue.begin(), h_VCkey.begin(), h_VCvalue.begin(), std::greater<int>());
...
// CHECK:  oneapi::dpl::set_difference(oneapi::dpl::execution::par_unseq, h_VA.begin(), h_VA.end(), h_VB.begin(), h_VB.end(), h_VC.begin());
// CHECK-NEXT:  oneapi::dpl::set_difference(oneapi::dpl::execution::par_unseq, h_VA.begin(), h_VA.end(), h_VB.begin(), h_VB.end(), h_VC.begin());
// CHECK-NEXT:  oneapi::dpl::set_difference(oneapi::dpl::execution::par_unseq, h_VA.begin(), h_VA.end(), h_VB.begin(), h_VB.end(), h_VC.begin(), std::greater<int>());
// CHECK-NEXT:  oneapi::dpl::set_difference(oneapi::dpl::execution::par_unseq, h_VA.begin(), h_VA.end(), h_VB.begin(), h_VB.end(), h_VC.begin(), std::greater<int>());
...
// CHECK:  oneapi::dpl::for_each_n(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.size(), add_functor());
// CHECK-NEXT:  oneapi::dpl::for_each_n(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.size(), add_functor());
// CHECK-NEXT:  oneapi::dpl::for_each_n(oneapi::dpl::execution::make_device_policy(q_ct1), d_V.begin(), d_V.size(), add_functor());
// CHECK-NEXT:  oneapi::dpl::for_each_n(oneapi::dpl::execution::par_unseq, d_V.begin(), d_V.size(), add_functor());
...
// CHECK:  dpct::for_each_index(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), std::negate<int>());
// CHECK-NEXT:  dpct::for_each_index(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), std::negate<int>());
...
// CHECK:  oneapi::dpl::remove_copy(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_result.begin(), 0);
// CHECK-NEXT:  oneapi::dpl::remove_copy(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_result.begin(), 0);
...
// CHECK:  oneapi::dpl::transform_exclusive_scan(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_V.begin(), 4, binary_op, unary_op);
// CHECK-NEXT:  oneapi::dpl::transform_exclusive_scan(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_V.begin(), 4, binary_op, unary_op);
...
// CHECK:  dpct::set_intersection(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VCkey.begin(), h_VCvalue.begin());
// CHECK-NEXT:  dpct::set_intersection(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VCkey.begin(), h_VCvalue.begin());
// CHECK-NEXT:  dpct::set_intersection(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VCkey.begin(), h_VCvalue.begin(), std::greater<int>());
// CHECK-NEXT:  dpct::set_intersection(oneapi::dpl::execution::par_unseq, h_VAkey.begin(), h_VAkey.end(), h_VBkey.begin(), h_VBkey.end(), h_VAvalue.begin(), h_VCkey.begin(), h_VCvalue.begin(), std::greater<int>());
...
// CHECK:    oneapi::dpl::partition_copy(oneapi::dpl::execution::par_unseq, data, data + N, evens, odds, is_even());
// CHECK-NEXT:  oneapi::dpl::partition_copy(oneapi::dpl::execution::par_unseq, host_a.begin(), host_a.begin() + N, host_evens.begin(), host_odds.begin(), is_even());
...
// CHECK-NEXT:  dpct::partition_copy(oneapi::dpl::execution::par_unseq, host_a.begin(), host_a.begin() + N, host_S.begin(), host_evens.begin(), host_odds.begin(), is_even());
...
// CHECK:    dpct::stable_partition_copy(oneapi::dpl::execution::par_unseq, data, data + N, evens, odds, is_even());
// CHECK-NEXT:  dpct::stable_partition_copy(oneapi::dpl::execution::par_unseq, host_a.begin(), host_a.begin() + N, host_evens.begin(), host_odds.begin(), is_even());
...
// CHECK-NEXT:  dpct::stable_partition_copy(oneapi::dpl::execution::par_unseq, host_a.begin(), host_a.begin() + N, host_S.begin(), host_evens.begin(), host_odds.begin(), is_even());
...
// CHECK:  oneapi::dpl::stable_partition(oneapi::dpl::execution::par_unseq, data, data + N, is_even());
// CHECK-NEXT:  oneapi::dpl::stable_partition(oneapi::dpl::execution::par_unseq, host_data.begin(), host_data.begin() + N, is_even());
...
// CHECK-NEXT:  dpct::stable_partition(oneapi::dpl::execution::par_unseq, host_data.begin(), host_data.begin() + N, host_S.begin(), is_even());
...
// CHECK:  oneapi::dpl::remove(oneapi::dpl::execution::par_unseq, data, data + N, 1);
// CHECK-NEXT:  oneapi::dpl::remove(oneapi::dpl::execution::par_unseq, host_data.begin(), host_data.begin() + N, 1);
...
void find_if_test() {
  ...
  // CHECK:oneapi::dpl::find_if(oneapi::dpl::execution::par_unseq, data, data+3, greater_than_four());
  ...
  // CHECK-NEXT:oneapi::dpl::find_if(oneapi::dpl::execution::par_unseq, host_data.begin(), host_data.end(), greater_than_four());
...
void find_if_not_test() {
  ...
  // CHECK:oneapi::dpl::find_if_not(oneapi::dpl::execution::par_unseq, data, data+3, greater_than_four());
  ...
  // CHECK-NEXT:oneapi::dpl::find_if_not(oneapi::dpl::execution::par_unseq, host_data.begin(), host_data.end(), greater_than_four());
...
void mismatch_test() {
  ...
  // CHECK:  oneapi::dpl::mismatch(oneapi::dpl::execution::par_unseq, VA.begin(), VA.end(), VB.begin());
  // CHECK-NEXT:  oneapi::dpl::mismatch(oneapi::dpl::execution::par_unseq, VA.begin(), VA.end(), VB.begin());
  // CHECK-NEXT:  oneapi::dpl::mismatch(oneapi::dpl::execution::par_unseq, VA.begin(), VA.end(), VB.begin(), oneapi::dpl::equal_to<int>());
  // CHECK-NEXT:  oneapi::dpl::mismatch(oneapi::dpl::execution::par_unseq, VA.begin(), VA.end(), VB.begin(), oneapi::dpl::equal_to<int>());
...
void replace_copy_test() {
  ...
  // CHECK-NEXT:  oneapi::dpl::replace_copy(oneapi::dpl::execution::par_unseq, h_data.begin(), h_data.end(), h_result.begin(), 1, 99);
...
void reverse() {
  ...
  // CHECK-NEXT:  oneapi::dpl::reverse(oneapi::dpl::execution::par_unseq, host_data.begin(), host_data.end());
...
void equal_range() {
  ...
  // CHECK-NEXT:  dpct::equal_range(oneapi::dpl::execution::make_device_policy(q_ct1), device_vec.begin(), device_vec.end(), 0, oneapi::dpl::less<int>());
  // CHECK-NEXT:  dpct::equal_range(oneapi::dpl::execution::par_unseq, host_vec.begin(), host_vec.end(), 0); 
  // CHECK-NEXT:  dpct::equal_range(oneapi::dpl::execution::par_unseq, host_vec.begin(), host_vec.end(), 0);
  // CHECK-NEXT:  dpct::equal_range(oneapi::dpl::execution::par_unseq, host_vec.begin(), host_vec.end(), 0, oneapi::dpl::less<int>());
  // CHECK-NEXT:  dpct::equal_range(oneapi::dpl::execution::par_unseq, host_vec.begin(), host_vec.end(), 0, oneapi::dpl::less<int>());
...
void transform_inclusive_scan() {
  ...
  // CHECK:  oneapi::dpl::transform_inclusive_scan(oneapi::dpl::execution::par_unseq, data, data + N, data, binary_op, unary_op);
  // CHECK-NEXT:  oneapi::dpl::transform_inclusive_scan(oneapi::dpl::execution::par_unseq, h_vec_data.begin(), h_vec_data.end(), h_vec_data.begin(), binary_op, unary_op);
...
void scatter_if() {
  ...
  // CHECK-NEXT:  DPCT1107:{{[0-9]+}}: Migration for this overload of thrust::scatter_if is not supported.
  // CHECK-NEXT:  */
  // CHECK-NEXT:  thrust::scatter_if(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_M.begin(), h_S.begin(), h_D.begin());
  // CHECK-NEXT:  /*
  // CHECK-NEXT:  DPCT1107:{{[0-9]+}}: Migration for this overload of thrust::scatter_if is not supported.
  // CHECK-NEXT:  */
  // CHECK-NEXT:  thrust::scatter_if(h_V.begin(), h_V.end(), h_M.begin(), h_S.begin(),  h_D.begin());
  // CHECK-NEXT:  dpct::scatter_if(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_M.begin(), h_S.begin(), h_D.begin(), pred);
  // CHECK-NEXT:  dpct::scatter_if(oneapi::dpl::execution::par_unseq, h_V.begin(), h_V.end(), h_M.begin(), h_S.begin(), h_D.begin(), pred);
...
void uninitialized_copy() {
  ...
  // CHECK-NEXT:  oneapi::dpl::uninitialized_copy(oneapi::dpl::execution::par_unseq, data, data + N, h_array);
...
void uninitialized_copy_n() {
  ...
  // CHECK-NEXT:  oneapi::dpl::uninitialized_copy_n(oneapi::dpl::execution::par_unseq, h_data, N, h_array);
...
void equal() {
  ...
  // CHECK:  oneapi::dpl::equal(oneapi::dpl::execution::par_unseq, A1, A1 + N, A2);
  ...
  // CHECK-NEXT:  oneapi::dpl::equal(oneapi::dpl::execution::par_unseq, x, x + N, y, compare_modulo_two());
  // CHECK-NEXT:  oneapi::dpl::equal(oneapi::dpl::execution::par_unseq, h_A1.begin(), h_A1.end(), h_A2.begin());
  // CHECK-NEXT:  oneapi::dpl::equal(oneapi::dpl::execution::par_unseq, h_A1.begin(), h_A1.end(), h_A2.begin());
  // CHECK-NEXT:  oneapi::dpl::equal(oneapi::dpl::execution::par_unseq, h_x.begin(), h_x.end(), h_y.begin(), compare_modulo_two());
  // CHECK-NEXT:  oneapi::dpl::equal(oneapi::dpl::execution::par_unseq, h_x.begin(), h_x.end(), h_y.begin(), compare_modulo_two());
