...
__global__ void kernelFuncHalf(double *deviceArrayDouble) {
  ...
  // CHECK: b = dpct::compare2_both(h2, h2_1, std::equal_to<>());
  b = __hbeq2(h2, h2_1);
  // CHECK: b = dpct::unordered_compare2_both(h2, h2_1, std::equal_to<>());
  b = __hbequ2(h2, h2_1);
  // CHECK: b = dpct::compare2_both(h2, h2_1, std::greater_equal<>());
  b = __hbge2(h2, h2_1);
  // CHECK: b = dpct::unordered_compare2_both(h2, h2_1, std::greater_equal<>());
  b = __hbgeu2(h2, h2_1);
  // CHECK: b = dpct::compare2_both(h2, h2_1, std::greater<>());
  b = __hbgt2(h2, h2_1);
  // CHECK: b = dpct::unordered_compare2_both(h2, h2_1, std::greater<>());
  b = __hbgtu2(h2, h2_1);
  // CHECK: b = dpct::compare2_both(h2, h2_1, std::less_equal<>());
  b = __hble2(h2, h2_1);
  // CHECK: b = dpct::unordered_compare2_both(h2, h2_1, std::less_equal<>());
  b = __hbleu2(h2, h2_1);
  // CHECK: b = dpct::compare2_both(h2, h2_1, std::less<>());
  b = __hblt2(h2, h2_1);
  // CHECK: b = dpct::unordered_compare2_both(h2, h2_1, std::less<>());
  b = __hbltu2(h2, h2_1);
  // CHECK: b = dpct::compare2_both(h2, h2_1, std::not_equal_to<>());
  b = __hbne2(h2, h2_1);
  // CHECK: b = dpct::unordered_compare2_both(h2, h2_1, std::not_equal_to<>());
  b = __hbneu2(h2, h2_1);
  // CHECK: h2_2 = dpct::compare2(h2, h2_1, std::equal_to<>());
  h2_2 = __heq2(h2, h2_1);
  // CHECK: h2_2 = dpct::unordered_compare2(h2, h2_1, std::equal_to<>());
  h2_2 = __hequ2(h2, h2_1);
  // CHECK: h2_2 = dpct::compare2(h2, h2_1, std::greater_equal<>());
  h2_2 = __hge2(h2, h2_1);
  // CHECK: h2_2 = dpct::unordered_compare2(h2, h2_1, std::greater_equal<>());
  h2_2 = __hgeu2(h2, h2_1);
  // CHECK: h2_2 = dpct::compare2(h2, h2_1, std::greater<>());
  h2_2 = __hgt2(h2, h2_1);
  // CHECK: h2_2 = dpct::unordered_compare2(h2, h2_1, std::greater<>());
  h2_2 = __hgtu2(h2, h2_1);
  // CHECK: h2_2 = dpct::isnan(h2);
  h2_2 = __hisnan2(h2);
  // CHECK: h2_2 = dpct::compare2(h2, h2_1, std::less_equal<>());
  h2_2 = __hle2(h2, h2_1);
  // CHECK: h2_2 = dpct::unordered_compare2(h2, h2_1, std::less_equal<>());
  h2_2 = __hleu2(h2, h2_1);
  // CHECK: h2_2 = dpct::compare2(h2, h2_1, std::less<>());
  h2_2 = __hlt2(h2, h2_1);
  // CHECK: h2_2 = dpct::unordered_compare2(h2, h2_1, std::less<>());
  h2_2 = __hltu2(h2, h2_1);
  // CHECK: h2_2 = dpct::compare2(h2, h2_1, std::not_equal_to<>());
  h2_2 = __hne2(h2, h2_1);
  // CHECK: h2_2 = dpct::unordered_compare2(h2, h2_1, std::not_equal_to<>());
