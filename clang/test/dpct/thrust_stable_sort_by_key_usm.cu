...
// RUN: %if build_lit %{icpx -c -fsycl %T/thrust_stable_sort_by_key_usm/thrust_stable_sort_by_key_usm.dp.cpp -o %T/thrust_stable_sort_by_key_usm/thrust_stable_sort_by_key_usm.dp.o %}
