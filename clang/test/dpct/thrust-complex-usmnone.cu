...
// CHECK: __forceinline void kernel(std::complex<double> *p, std::complex<double> c, std::complex<double> *d,
...
// CHECK: __forceinline void template_kernel(T *, std::complex<T> *s) {
template<class T>
