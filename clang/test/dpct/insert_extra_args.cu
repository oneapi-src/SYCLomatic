...
//CHECK: inline void deviceFoo(int i, int j, const sycl::nd_item<3> &item_ct1){
...
//CHECK: inline void deviceFoo1(int i, const sycl::nd_item<3> &item_ct1, int j = 0){
//CHECK-NEXT:   int a = item_ct1.get_group(2);
//CHECK-NEXT: }
...
//CHECK: __dpct_inline__ void kernelFoo(int i, int j, const sycl::nd_item<3> &item_ct1){
//CHECK-NEXT: int a = item_ct1.get_group(2);
//CHECK-NEXT: }
...
//CHECK: __dpct_inline__ void kernelFoo1(int i, const sycl::nd_item<3> &item_ct1, int j = 0){
//CHECK-NEXT:   int a = item_ct1.get_group(2);
//CHECK-NEXT: }
...
//CHECK: __dpct_inline__ void kernelFoo2(const sycl::nd_item<3> &item_ct1, int i = 0, int j = 0){
//CHECK-NEXT:   int a = item_ct1.get_group(2);
//CHECK-NEXT: }
...
//CHECK: inline float foo(float a, float b, int c, const sycl::nd_item<3> &item_ct1) {
