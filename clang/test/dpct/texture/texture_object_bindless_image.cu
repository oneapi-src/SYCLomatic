...
void driverMemoryManagement() {
  ...
  p2d.dstPitch = s;
  // CHECK: p2d.sizeXByte = s;
  p2d.WidthInBytes = s;
  // CHECK: p2d.size[1] = s;
  p2d.Height = s;
  // CHECK: dpct::memcpy_parameter p3d;
  CUDA_MEMCPY3D p3d;
  // CHECK: p3d.from.offsetXByte = s;
  p3d.srcXInBytes = s;
