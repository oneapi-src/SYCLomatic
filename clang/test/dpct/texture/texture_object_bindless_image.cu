...
void driverMemoryManagement() {
  ...
  // CHECK: ;
  p2d.srcMemoryType;
  // CHECK: p2d.from.pitched.set_data_ptr((void *)pV);
  p2d.srcHost = pV;
  // CHECK: p2d.from.pitched.set_data_ptr((void *)pD);
  p2d.srcDevice = pD;
  ...
  // CHECK: ;
  p2d.dstMemoryType;
  // CHECK: p2d.to.pitched.set_data_ptr((void *)pV);
  p2d.dstHost = pV;
  // CHECK: p2d.to.pitched.set_data_ptr((void *)pD);
  p2d.dstDevice = pD;
  ...
  // CHECK: ;
  p3d.srcMemoryType;
  // CHECK: p3d.from.pitched.set_data_ptr((void *)pV);
  p3d.srcHost = pV;
  // CHECK: p3d.from.pitched.set_data_ptr((void *)pD);
  p3d.srcDevice = pD;
  ...
  // CHECK: ;
  p3d.dstMemoryType;
  // CHECK: p3d.to.pitched.set_data_ptr((void *)pV);
  p3d.dstHost = pV;
  // CHECK: p3d.to.pitched.set_data_ptr((void *)pD);
  p3d.dstDevice = pD;
...
void driver() {
  ...
  // CHECK: p3dp.from.pitched.set_data_ptr((void *)v);
  p3dp.srcHost = v;
  // CHECK: p3dp.from.pitched.set_data_ptr((void *)dp);
  p3dp.srcDevice = dp;
  ...
  // CHECK: p3dp.to.pitched.set_data_ptr((void *)v);
  p3dp.dstHost = v;
  // CHECK: p3dp.to.pitched.set_data_ptr((void *)dp);
  p3dp.dstDevice = dp;
