...
void driverMemoryManagement() {
  ...
  p2d.dstPitch = s;
  // CHECK: p2d.size_x_byte = s;
  p2d.WidthInBytes = s;
  // CHECK: p2d.size[1] = s;
  p2d.Height = s;
  // CHECK: dpct::memcpy_parameter p3d;
  CUDA_MEMCPY3D p3d;
  // CHECK: p3d.from.pos_x_byte = s;
  p3d.srcXInBytes = s;
