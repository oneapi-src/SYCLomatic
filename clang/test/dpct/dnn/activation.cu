...
void test1() {
    ...
    // CHECK: /*
    // CHECK: DPCT1026:{{[0-9]+}}: The call to cudnnCreateTensorDescriptor was removed because the function call is redundant in SYCL.
    // CHECK: */
    // CHECK: /*
    // CHECK: DPCT1026:{{[0-9]+}}: The call to cudnnCreateTensorDescriptor was removed because the function call is redundant in SYCL.
    // CHECK: */
    ...
    // CHECK: /*
    // CHECK: DPCT1026:{{[0-9]+}}: The call to cudnnCreateActivationDescriptor was removed because the function call is redundant in SYCL.
    // CHECK: */
    // CHECK: /*
