...
void test1() {
    ...
    // CHECK: /*
    // CHECK: DPCT1097:{{[0-9]+}}: The function "pooling_backward" may require the workspace used to save intermediate results from the function "pooling_forward". By default, a workspace from engine_ext is selected according to the source data pointer, but this may be incorrect and cause a workspace data race. You may need to rewrite this code.
    // CHECK: */
    // CHECK: /*
