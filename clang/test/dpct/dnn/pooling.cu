...
void test1() {
    ...
    // CHECK: */
    // CHECK: auto s = CHECK_SYCL_ERROR(handle.async_pooling_backward(desc, alpha, outTensor, out, diffoutTensor, diffout, dataTensor, data, beta, diffdataTensor, diffdata));
