...
int main() {
    ...
    // CHECK: auto status = (handle.batch_normalization_forward_inference_ex(dpct::dnnl::batch_normalization_mode::per_activation, dpct::dnnl::batch_normalization_ops::none, ActivationDesc, eps, alpha, dataTensor, data, beta, outTensor, out, dataTensor, z, scalebiasTensor, scale, bias, scalebiasTensor, smean, svar), 0);
