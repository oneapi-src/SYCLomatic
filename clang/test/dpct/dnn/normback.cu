...
int main() {
    ...
    // CHECK: handle.batch_normalization_forward_training_ex(dpct::dnnl::batch_normalization_mode::spatial, dpct::dnnl::batch_normalization_ops::none, ActivationDesc, eps, factor, alpha, dataTensor, data, beta, outTensor, out, dataTensor, z, scalebiasTensor, scale, bias, scalebiasTensor, rmean, rvar, smean, svar);
    ...
    // CHECK: */
    // CHECK: handle.batch_normalization_backward_ex(dpct::dnnl::batch_normalization_mode::spatial, dpct::dnnl::batch_normalization_ops::none, eps, alpha, dataTensor, data, outTensor, out, outTensor, diffout, beta, dataTensor, diffdata, outTensor, diffz, alpha, scale, bias, beta, diffscale, diffbias, scalebiasTensor, smean, svar);
