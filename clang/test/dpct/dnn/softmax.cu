...
void test1() {
    ...
    // CHECK: auto s = CHECK_SYCL_ERROR(handle.async_softmax_backward(dpct::dnnl::softmax_algorithm::normal, dpct::dnnl::softmax_mode::channel, alpha, outTensor, out, diffoutTensor, diffout, beta, diffdataTensor, diffdata));
