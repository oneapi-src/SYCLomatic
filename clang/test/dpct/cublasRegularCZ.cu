...
int main(){
  ...
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: status = (mkl::blas::gbmv(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, m, n, kl, ku, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, lda, x_c_buf_ct2, incx, std::complex<float>((beta_c)->x(),(beta_c)->y()), y_c_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  ...
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: status = (mkl::blas::gbmv(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, m, n, kl, ku, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, lda, x_z_buf_ct2, incx, std::complex<double>((beta_z)->x(),(beta_z)->y()), y_z_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: status = (mkl::blas::gemv(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, m, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, lda, x_c_buf_ct2, incx, std::complex<float>((beta_c)->x(),(beta_c)->y()), y_c_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::tbmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, mkl::transpose::trans, (mkl::diag)diag0, n, k, x_c_buf_ct1, lda, result_c_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::tbmv(handle, (int)fill1==0 ? mkl::uplo::lower : mkl::uplo::upper, mkl::transpose::conjtrans, (mkl::diag)diag1, n, k, x_z_buf_ct1, lda, result_z_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::tbsv(handle, mkl::uplo::lower, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, mkl::diag::nonunit,  n, k, x_c_buf_ct1, lda, result_c_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::tbsv(handle, mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, mkl::diag::unit,  n, k, x_z_buf_ct1, lda, result_z_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::tpmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_c_buf_ct1, result_c_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::tpmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_z_buf_ct1, result_z_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::tpsv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_c_buf_ct1, result_c_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::tpsv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_z_buf_ct1, result_z_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::trmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_c_buf_ct1, lda, result_c_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::trmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_z_buf_ct1, lda, result_z_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::trsv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_c_buf_ct1, lda, result_c_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::trsv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, (mkl::diag)diag0, n, x_z_buf_ct1, lda, result_z_buf_ct1, incx), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: status = (mkl::blas::hemv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, lda, x_c_buf_ct2, incx, std::complex<float>((beta_c)->x(),(beta_c)->y()), y_c_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: status = (mkl::blas::hemv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, lda, x_z_buf_ct2, incx, std::complex<double>((beta_z)->x(),(beta_z)->y()), y_z_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: status = (mkl::blas::hbmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, k, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, lda, x_c_buf_ct2, incx, std::complex<float>((beta_c)->x(),(beta_c)->y()), y_c_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: status = (mkl::blas::hbmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, k, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, lda, x_z_buf_ct2, incx, std::complex<double>((beta_z)->x(),(beta_z)->y()), y_z_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: status = (mkl::blas::hpmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, x_c_buf_ct2, incx, std::complex<float>((beta_c)->x(),(beta_c)->y()), y_c_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto x_c_buf_ct2 = dpct::get_buffer<std::complex<float>>(x_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: status = (mkl::blas::hpmv(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, x_z_buf_ct2, incx, std::complex<double>((beta_z)->x(),(beta_z)->y()), y_z_buf_ct1, incy), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto x_z_buf_ct2 = dpct::get_buffer<std::complex<double>>(x_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::her(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, *(alpha_f), x_c_buf_ct1, incx, result_c_buf_ct1, lda), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::her(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, *(alpha_d), x_z_buf_ct1, incx, result_z_buf_ct1, lda), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::her2(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, incx, y_c_buf_ct1, incy, result_c_buf_ct1, lda), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  ...
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::her2(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, incx, y_z_buf_ct1, incy, result_z_buf_ct1, lda), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  ...
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::hpr(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, *(alpha_f), x_c_buf_ct1, incx, result_c_buf_ct1), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  ...
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::hpr(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, *(alpha_d), x_z_buf_ct1, incx, result_z_buf_ct1), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  ...
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::hpr2(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, incx, y_c_buf_ct1, incy, result_c_buf_ct1), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  ...
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::hpr2(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, incx, y_z_buf_ct1, incy, result_z_buf_ct1), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  ...
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  // CHECK-NEXT: auto result_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(result_c);
  // CHECK-NEXT: status = (mkl::blas::gemm(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, N, N, N, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), x_c_buf_ct1, N, y_c_buf_ct1, N, std::complex<float>((beta_c)->x(),(beta_c)->y()), result_c_buf_ct1, N), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(x_c);
  // CHECK-NEXT: auto y_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(y_c);
  ...
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  // CHECK-NEXT: auto result_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(result_z);
  // CHECK-NEXT: status = (mkl::blas::gemm(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, N, N, N, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), x_z_buf_ct1, N, y_z_buf_ct1, N, std::complex<double>((beta_z)->x(),(beta_z)->y()), result_z_buf_ct1, N), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto x_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(x_z);
  // CHECK-NEXT: auto y_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(y_z);
  ...
  // CHECK-NEXT: status = (mkl::blas::cgemm3m(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, m, n, k, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, B_c_buf_ct1, ldb, std::complex<float>((beta_c)->x(),(beta_c)->y()), C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  ...
  // CHECK-NEXT: status = (mkl::blas::zgemm3m(handle, (int)transpose_ct1==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct1, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, m, n, k, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, B_z_buf_ct1, ldb, std::complex<double>((beta_z)->x(),(beta_z)->y()), C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  ...
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  // CHECK-NEXT: status = (mkl::blas::symm(handle, (mkl::side)side0, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, m, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, B_c_buf_ct1, ldb, std::complex<float>((beta_c)->x(),(beta_c)->y()), C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  ...
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  // CHECK-NEXT: status = (mkl::blas::symm(handle, (mkl::side)side1, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, m, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, B_z_buf_ct1, ldb, std::complex<double>((beta_z)->x(),(beta_z)->y()), C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  ...
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  // CHECK-NEXT: status = (mkl::blas::syrk(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, std::complex<float>((beta_c)->x(),(beta_c)->y()), C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  ...
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  // CHECK-NEXT: status = (mkl::blas::syrk(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, std::complex<double>((beta_z)->x(),(beta_z)->y()), C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  ...
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  // CHECK-NEXT: status = (mkl::blas::syr2k(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, B_c_buf_ct1, ldb, std::complex<float>((beta_c)->x(),(beta_c)->y()), C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  ...
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  // CHECK-NEXT: status = (mkl::blas::syr2k(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, B_z_buf_ct1, ldb, std::complex<double>((beta_z)->x(),(beta_z)->y()), C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  ...
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  // CHECK-NEXT: status = (mkl::blas::trsm(handle, mkl::side::left, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct3==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct3, (mkl::diag)diag0, m, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, B_c_buf_ct1, ldb), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  ...
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  // CHECK-NEXT: status = (mkl::blas::trsm(handle, mkl::side::right, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct3==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct3, (mkl::diag)diag0, m, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, B_z_buf_ct1, ldb), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  ...
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  // CHECK-NEXT: status = (mkl::blas::hemm(handle, (mkl::side)side0, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, m, n, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, B_c_buf_ct1, ldb, std::complex<float>((beta_c)->x(),(beta_c)->y()), C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  ...
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  // CHECK-NEXT: status = (mkl::blas::hemm(handle, (mkl::side)side0, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, m, n, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, B_z_buf_ct1, ldb, std::complex<double>((beta_z)->x(),(beta_z)->y()), C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  ...
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  // CHECK-NEXT: status = (mkl::blas::herk(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, alpha_s, A_c_buf_ct1, lda, beta_s, C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  ...
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  // CHECK-NEXT: status = (mkl::blas::herk(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, *(alpha_d), A_z_buf_ct1, lda, beta_d, C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  ...
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  // CHECK-NEXT: auto C_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(C_c);
  // CHECK-NEXT: status = (mkl::blas::her2k(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, std::complex<float>((alpha_c)->x(),(alpha_c)->y()), A_c_buf_ct1, lda, B_c_buf_ct1, ldb, beta_s, C_c_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(A_c);
  // CHECK-NEXT: auto B_c_buf_ct1 = dpct::get_buffer<std::complex<float>>(B_c);
  ...
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
  // CHECK-NEXT: auto C_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(C_z);
  // CHECK-NEXT: status = (mkl::blas::her2k(handle, (int)fill0==0 ? mkl::uplo::lower : mkl::uplo::upper, (int)transpose_ct2==2 ? mkl::transpose::conjtrans : (mkl::transpose)transpose_ct2, n, k, std::complex<double>((alpha_z)->x(),(alpha_z)->y()), A_z_buf_ct1, lda, B_z_buf_ct1, ldb, beta_d, C_z_buf_ct1, ldc), 0);
  // CHECK-NEXT: }
  // CHECK-NEXT: {
  // CHECK-NEXT: auto A_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(A_z);
  // CHECK-NEXT: auto B_z_buf_ct1 = dpct::get_buffer<std::complex<double>>(B_z);
