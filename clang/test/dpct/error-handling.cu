...
// CHECK-NEXT:  const dpct::err_tmp0 err = 0;
// CHECK-NEXT:}
...
// CHECK-NEXT:  typedef dpct::err_tmp0 someError_t;
...
// CHECK-NEXT:*/
// CHECK-NEXT:  if (err = (* 0 = dpct::dpct_malloc(0), 0)) {
// CHECK-NEXT:    printf("error!\n");
// CHECK-NEXT:  }
// CHECK-NEXT:}
...
// CHECK:void test_1(dpct::err_tmp0 err, int arg) {
...
// CHECK:void test_12(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:  if (err) {
// CHECK-NEXT:  } else {
// CHECK-NEXT:  {{ +}}
// CHECK-NEXT:  }
...
// CHECK:void test_13(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:}
...
// CHECK:void test_14(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:  if (arg == 1) {
// CHECK-NEXT:    return;
// CHECK-NEXT:  }
// CHECK-NEXT  if (arg != 0) {
...
// CHECK:void test_15(dpct::err_tmp0 err, int arg) try {
// CHECK-NEXT:/*
// CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You
// CHECK-NEXT:may need to rewrite this code.
// CHECK-NEXT:*/
// CHECK-NEXT:  if ((* 0 = dpct::dpct_malloc(0), 0)) {
// CHECK-NEXT:  }
// CHECK-NEXT:}
// CHECK-NEXT: catch (sycl::exception const &exc) {
// CHECK-NEXT:   std::cerr << exc.what() << "Exception caught at file:" << __FILE__
...
// CHECK:void test_16(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:  if (err) {
// CHECK-NEXT:    printf("error!\n");
// CHECK-NEXT:    exit(1);
// CHECK-NEXT:  } else {
...
// CHECK:void test_17(dpct::err_tmp0 err, int arg)  try {
// CHECK-NEXT:/*
// CHECK-NEXT:DPCT1003:{{[0-9]+}}: Migrated API does not return error code. (*, 0) is inserted. You
// CHECK-NEXT:may need to rewrite this code.
// CHECK-NEXT:*/
...
// CHECK:void test_18(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:  if (err)
// CHECK-NEXT:    printf("error!\n");
// CHECK-NEXT:  else
...
// CHECK:void test_19(dpct::err_tmp0 err, int arg) {
...
// CHECK:void test_compare_to_3(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:  if (err != 3) {
// CHECK-NEXT:  }
// CHECK-NEXT:}
...
// CHECK:void test_21(const dpct::err_tmp0 &err, int arg) {
// CHECK-NEXT:}
...
// CHECK:void test_no_side_effects(dpct::err_tmp0 err, int arg) {
// CHECK-NEXT:}
...
// CHECK:void test_side_effects(dpct::err_tmp0 err, int arg, int x, int y, int z) {
// CHECK:/*
// CHECK-NEXT:DPCT1000:{{[0-9]+}}: Error handling if-stmt was detected but could not be rewritten.
// CHECK-NEXT:*/
// CHECK-NEXT:  if (err)
...
// CHECK-NEXT:   may need to rewrite this code.
// CHECK-NEXT:   */
// CHECK-NEXT:   for (; (* 0 = dpct::dpct_malloc(0), 0);) {
// CHECK-NEXT:     printf("efef");
// CHECK-NEXT:   }
// CHECK-NEXT: }
// CHECK-NEXT: catch (sycl::exception const &exc) {
...
// CHECK-NEXT:   may need to rewrite this code.
// CHECK-NEXT:   */
// CHECK-NEXT:   } while ((* 0 = dpct::dpct_malloc(0), 0));
// CHECK-NEXT: }
// CHECK-NEXT: catch (sycl::exception const &exc) {
// CHECK-NEXT:   std::cerr << exc.what() << "Exception caught at file:" << __FILE__
// CHECK-NEXT:             << ", line:" << __LINE__ << std::endl;
...
// CHECK-NEXT:   may need to rewrite this code.
// CHECK-NEXT:   */
// CHECK-NEXT:   a = (* 0 = dpct::dpct_malloc(0), 0);
// CHECK-NEXT: }
void foo6(){
  int a;
  a = cudaMalloc(0, 0);
...
// CHECK-NEXT:   may need to rewrite this code.
// CHECK-NEXT:   */
// CHECK-NEXT:   int a = (* 0 = dpct::dpct_malloc(0), 0);
...
//CHECK-NEXT:   may need to rewrite this code.
//CHECK-NEXT:   */
//CHECK-NEXT:   return (*0 = dpct::dpct_malloc(0), 0);
//CHECK-NEXT: }
//CHECK-NEXT: catch (sycl::exception const &exc) {
//CHECK-NEXT: std::cerr << exc.what() << "Exception caught at file:" << __FILE__
// CHECK-NEXT:             << ", line:" << __LINE__ << std::endl;
...
//CHECK-NEXT:   may need to rewrite this code.
//CHECK-NEXT:   */
//CHECK-NEXT:   switch ((* 0 = dpct::dpct_malloc(0), 0)) {
//CHECK-NEXT:     case 0:
//CHECK-NEXT:       break;
//CHECK-NEXT:     case 1:
//CHECK-NEXT:       break;
...
// CHECK: __dpct_inline__ dpct::err_tmp0 foo13(dpct::err_tmp0 error, const char *filename,
// CHECK-NEXT:                                 int line) {
// CHECK-NEXT:  dpct::err_tmp0 error_1 = 0;
...
// CHECK: __dpct_inline__ dpct::err_tmp0 *foo14(dpct::err_tmp0 error,
// CHECK-NEXT:                                  const char *filename, int line) {
