...
See the
`descriptor<precision, domain>::commit function <https://software.intel.com/content/www/us/en/develop/documentation/oneapi-mkl-dpcpp-developer-reference/top/fourier-transform-functions/descriptorprecision-domain-commit.html>`_ for more information.
