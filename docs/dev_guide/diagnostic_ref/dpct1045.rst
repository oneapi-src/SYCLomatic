...
* Non-general: manually fix the code according to `sparse-blas-routines <https://software.intel.com/content/www/us/en/develop/documentation/oneapi-mkl-dpcpp-developer-reference/top/blas-and-sparse-blas-routines/sparse-blas-routines.html>`_.
