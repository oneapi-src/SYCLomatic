...
.. code-block:: cpp
   ...
   // new_a_col_ind = [0, 2, 1, 2, 0, 1, 2]
    void test_cusparseTcsrmm(sycl::queue *handle,
      ...
      float* new_a_val = sycl::malloc_shared<float>(7, *handle);
      int* new_a_row_ptr = sycl::malloc_shared<int>(4, *handle);
      int* new_a_col_ind = sycl::malloc_shared<int>(7, *handle);
      new_a_val = {1, 2, 3, 4, 2, 4, 5};
      new_a_row_ptr = {0, 2, 4, 7};
      new_a_col_ind = {0, 2, 1, 2, 0, 1, 2};
      dpct::sparse::csrmm(*handle, oneapi::mkl::transpose::nontrans, 4, 2, 5,
                          &alpha, descrA, new_a_val, new_a_row_ptr, new_a_col_ind,
                          &beta, 5, b, c, 4);
    }
